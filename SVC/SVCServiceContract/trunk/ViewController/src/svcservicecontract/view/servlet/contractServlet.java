package svcservicecontract.view.servlet;
...
public class contractServlet extends HttpServlet {
    ...
    private void openReportFun(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            String cntrctNo=(String)request.getParameter("cntrctNo");
           ...
           // JasperReport report = JasperCompileManager.compileReport(design);
            ...
            JasperReport report =(JasperReport) JRLoader.loadObject(path + "SVC_ServiceContract.jasper");
