...
public class ServiceReqRegistrationSearchBean {
    private RichPanelFormLayout searchForm;
    private RichPanelGroupLayout searchPanelR;
    private RichTable tableBind;

    public ServiceReqRegistrationSearchBean() {
    }

    public void ServiceRegistrationAddAction(ActionEvent actionEvent) {
        // Add event code here...
    }
    ...
    private static ADFLogger adflog= ADFLogger.createADFLogger(ServiceReqRegistrationSearchBean.class);
