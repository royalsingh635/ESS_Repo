...
// ---    Fri Nov 07 11:44:27 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SvcInvcOcEOImpl extends EntityImpl {
    /**
     ...
     */
    public EntityImpl getSvcInvcSrc() {
        return (EntityImpl) getAttributeInternal(SVCINVCSRC);
    }

    /**
     * Sets <code>value</code> as the associated entity oracle.jbo.server.EntityImpl.
     */
    public void setSvcInvcSrc(EntityImpl value) {
    ...
    public static Key createPrimaryKey(String cldId, Integer slocId, String orgId, String docId, String docIdSrc,
                                       Integer coaId) {
        return new Key(new Object[] { cldId, slocId, orgId, docId, docIdSrc, coaId });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("svcinvoiceapp.model.entities.SvcInvcOcEO");
    }
