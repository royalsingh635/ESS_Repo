package svcinvoiceapp.view.servlet;
...
public class invoiceServlet extends HttpServlet {
    ...
    private void openReportFun(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            String invcNo=(String)request.getParameter("invcNo");
           ...
           // JasperReport report = JasperCompileManager.compileReport(design);
            ...
            JasperReport report =(JasperReport) JRLoader.loadObject(path + "SVC_ServiceInvoice.jasper");
