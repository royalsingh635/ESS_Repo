...
// ---    Tue Jun 09 10:56:20 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MmOcImpVwVoRowImpl extends ViewRowImpl {
    /**
    ...
    public static final int TRANSROWCOUNTFOROC = AttributesEnum.TransRowCountForOc.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MmOcImpVwVoRowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransRowCountForOc.
     * @return the TransRowCountForOc
     */
    public Integer getTransRowCountForOc() {
        if (getAm() != null) {
            RowQualifier Rq = new RowQualifier("OcId='" + this.getOcId() + "'");
            Row[] Fr = getAm().getMmScoOcVO1().getFilteredRows(Rq);
            return Fr.length;
        }
        return (Integer) getAttributeInternal(TRANSROWCOUNTFOROC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransRowCountForOc.
     * @param value value to set the  TransRowCountForOc
     */
    public void setTransRowCountForOc(Integer value) {
        setAttributeInternal(TRANSROWCOUNTFOROC, value);
    }
