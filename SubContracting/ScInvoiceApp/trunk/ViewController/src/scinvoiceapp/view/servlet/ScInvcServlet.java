package scinvoiceapp.view.servlet;
...
@WebServlet(name = "ScInvcServlet", urlPatterns = { "/scinvcservlet" })
public class ScInvcServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
           ...
           try {
              ...
              // System.out.println("Path       " + path);
               JasperReport report = (JasperReport) JRLoader.loadObject(path + "SCInvoice_Print.jasper");
               ...
               if (reporttype.equalsIgnoreCase("pdf")) {
                   ...
                   response.setHeader("Content-Disposition", "attachement; filename=\"SCInvoice_Print.pdf\"");
