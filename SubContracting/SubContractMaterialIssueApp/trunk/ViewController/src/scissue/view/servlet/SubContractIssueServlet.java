...
@WebServlet(name = "SubContractIssueServlet", urlPatterns = { "/subcontractissueservlet" })
public class SubContractIssueServlet extends HttpServlet {
    @SuppressWarnings("compatibility:-2404201482941185240")
    private static final long serialVersionUID = -8211420391771848834L;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String doc_id = String.valueOf(request.getParameter("InvDocId"));
            System.out.println("Path       " + path);
            JasperReport report = (JasperReport) JRLoader.loadObject(path + "Issue_AnnexureIIChallan.jasper");
            ...
            parameters.put("InvDocId", doc_id);
            ...
            if (reporttype.equalsIgnoreCase("pdf")) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Issue_AnnexureIIChallan.pdf\"");
