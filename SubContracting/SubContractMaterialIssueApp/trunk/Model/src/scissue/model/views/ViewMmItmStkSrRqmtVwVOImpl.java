...
import scissue.model.views.common.ViewMmItmStkSrRqmtVwVO;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Thu Jul 02 14:40:57 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ViewMmItmStkSrRqmtVwVOImpl extends ViewObjectImpl implements ViewMmItmStkSrRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public ViewMmItmStkSrRqmtVwVOImpl() {
    }
    ...
    public Number getTotalSRIssuQtyInward() {
        ...
        for (Row r : rr) {
            if (r.getAttribute("TransSelectSrCBInward") != null) {
                if ("Y".equalsIgnoreCase(r.getAttribute("TransSelectSrCBInward").toString())) {
