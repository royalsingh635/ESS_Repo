...
import scissue.model.views.common.ViewMmItmStkBinRqmtVwVO;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Thu Jul 02 17:24:20 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ViewMmItmStkBinRqmtVwVOImpl extends ViewObjectImpl implements ViewMmItmStkBinRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public ViewMmItmStkBinRqmtVwVOImpl() {
    }
    ...
    public Number getTotalBinIssuQtyInward() {
        ...
        for (Row r : rr) {
            if (r.getAttribute("TransIssueQtyInward") != null) {
                if (((Number) r.getAttribute("TransIssueQtyInward")).compareTo(zero) > 0) {
                    totIssu = totIssu.add((Number) r.getAttribute("TransIssueQtyInward"));
                }
            }
        }
        return totIssu;
