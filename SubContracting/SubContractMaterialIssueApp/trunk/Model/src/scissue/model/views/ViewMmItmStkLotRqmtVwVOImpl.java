...
import scissue.model.views.common.ViewMmItmStkLotRqmtVwVO;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Thu Jul 02 17:47:42 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ViewMmItmStkLotRqmtVwVOImpl extends ViewObjectImpl implements ViewMmItmStkLotRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public ViewMmItmStkLotRqmtVwVOImpl() {
    }
    ...
    public Number getTotalIssuQtyInward() {
        ...
        for (Row r : rr) {
            if (r.getAttribute("TransIssuQtyValueInward") != null) {
                if (((Number) r.getAttribute("TransIssuQtyValueInward")).compareTo(zero) > 0) {
                    totIssu = totIssu.add((Number) r.getAttribute("TransIssuQtyValueInward"));
                }
            }
        }
        return totIssu;
