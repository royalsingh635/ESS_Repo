...
// ---    Fri Jun 26 17:51:10 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MmScRcptTrEOImpl extends EntityImpl {
    /**
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("subcontractreceiptapp.model.entities.MmScRcptTrEO");
    }
    ...
    protected void setAttributeInternal(int index, Object val){
        if(val instanceof oracle.jbo.domain.Number){
            ...
            val=ADFBeanUtils.roundOff((oracle.jbo.domain.Number)val);
        }
