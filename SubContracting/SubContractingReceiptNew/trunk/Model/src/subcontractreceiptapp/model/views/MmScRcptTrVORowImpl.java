...
// ---------------------------------------------------------------------
public class MmScRcptTrVORowImpl extends ViewRowImpl {


    public static final int ENTITY_MMSCRCPTTREO = 0;
    ...
    public static final int MMSCRCPTTRLINES = AttributesEnum.MmScRcptTrLines.index();
    public static final int LOVTAXRULEVO1 = AttributesEnum.LovTaxRuleVO1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MmScRcptTrVORowImpl() {
    }

    /**
     * Gets MmScRcptTrEO entity object.
     * @return the MmScRcptTrEO
     */
    public EntityImpl getMmScRcptTrEO() {
        return (EntityImpl) getEntity(ENTITY_MMSCRCPTTREO);
    }
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link MmScRcptTrLines.
     */
    public RowIterator getMmScRcptTrLines() {
        return (RowIterator) getAttributeInternal(MMSCRCPTTRLINES);
    }
