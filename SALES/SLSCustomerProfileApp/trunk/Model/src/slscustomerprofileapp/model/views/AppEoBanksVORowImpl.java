...
import slscustomerprofileapp.model.entitiy.AppEoBanksEOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Wed Feb 05 21:18:33 IST 2014
...
public class AppEoBanksVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        AddressValueTrans {
            public Object get(AppEoBanksVORowImpl obj) {
                return obj.getAddressValueTrans();
            }

            public void put(AppEoBanksVORowImpl obj, Object value) {
                obj.setAddressValueTrans((String) value);
            }
        }
        ,
        BankAddsTrans {
            public Object get(AppEoBanksVORowImpl obj) {
                return obj.getBankAddsTrans();
            }

            public void put(AppEoBanksVORowImpl obj, Object value) {
                obj.setBankAddsTrans((String) value);
            }
        }
        ,
        LOVUserVO1 {
    ...
    public static final int ADDRESSVALUETRANS = AttributesEnum.AddressValueTrans.index();
    public static final int BANKADDSTRANS = AttributesEnum.BankAddsTrans.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute AddressValueTrans.
     * @return the AddressValueTrans
     */
    public String getAddressValueTrans() {
        
        return this.getAddsId();
        
        //return (String) getAttributeInternal(ADDRESSVALUETRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute AddressValueTrans.
     * @param value value to set the  AddressValueTrans
     */
    public void setAddressValueTrans(String value) {
        setAttributeInternal(ADDRESSVALUETRANS, value);
    }

    /**
     * Gets the attribute value for the calculated attribute BankAddsTrans.
     * @return the BankAddsTrans
     */
    public String getBankAddsTrans() {
        if(getAddsId()!=null){
            
        }
        return (String) getAttributeInternal(BANKADDSTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute BankAddsTrans.
     * @param value value to set the  BankAddsTrans
     */
    public void setBankAddsTrans(String value) {
        setAttributeInternal(BANKADDSTRANS, value);
    }
