...
public class DailyCallAMImpl extends ApplicationModuleImpl implements DailyCallAM {
    ...
    public void filterDetailPageWithSelectedDocId() {
        ...
        if (docId != null) {
            ...
            FacesMessage message = new FacesMessage(resolvElDCMsg("#{bundle['MSG.1781']}").toString());
    ...
    public Boolean saveAction() {
        ...
        if (assignTo != null) {
            ...
            FacesMessage message = new FacesMessage(resolvElDCMsg("#{bundle['MSG.1730']}").toString());
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(null, message);
            b = false;
        }
        ...
        if (crow.getAttribute("DcId") == null && crow != null) {
            ...
            try {
                ...
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.1782']}").toString());//"There have been an error in calling function 'GEN_DISP_DOC_ID' !");
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext.getCurrentInstance().addMessage(null, message);
                e.printStackTrace();
            }
    ...
    public void setInitialParams() {
        ...
        String checkSLSProfileValues = EbizParamsSLSUtils.checkSLSProfileValues(this, "SHOW_USR_WISE_DC_DATA");
        if("Y".equals(checkSLSProfileValues)){
            dcVO.setNamedWhereClauseParam("UsrIdCreateBind", EbizParams.GLBL_APP_USR());
        }
        //
    }
...
System.out.println("The value of returned function is :-"+exec);
    ...
    public String getFyIdFromDocIdAndDate(){
           ...
           if(res==-1){
               ADFModelUtils.showFormattedFacesMessage("Financial Year is not Open for this Organisation on Current Date! ", "Please Open Financial Year for Current Date before creating any document !", FacesMessage.SEVERITY_ERROR);
               Flag="N";
           }
           else{
               Flag="Y";
    ...
    /**
     * Container's getter for LovEoAddsVO1.
     * @return LovEoAddsVO1
     */
