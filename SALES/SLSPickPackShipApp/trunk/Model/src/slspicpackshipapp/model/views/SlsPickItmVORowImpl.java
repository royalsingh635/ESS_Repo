...
public class SlsPickItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        SoTypeTrans {
            public Object get(SlsPickItmVORowImpl obj) {
                return obj.getSoTypeTrans();
            }

            public void put(SlsPickItmVORowImpl obj, Object value) {
                obj.setSoTypeTrans((Integer) value);
            }
        },
        ViewMmStkSummLot {
            public Object get(SlsPickItmVORowImpl obj) {
    ...
    public static final int SOTYPETRANS = AttributesEnum.SoTypeTrans.index();
    ...
    public String getItmNmTrans() {
        if ((getAttributeInternal(ITMNMTRANS) == null || getTransItmSerializedFlg() == null ||
             getTransItmPickOrder() == null || getisItmSerializedTrans() == null) && this.getItmId() != null) {
            RowSet frmIdVO1 = this.getLovItmNmFrmIdVO1();
        ...
        if (getAttributeInternal(SOIDTRANS) == null) {
            if (this.getSoId() != null) {
                ...
                for (Row r : allRowsInRange) {
                    ...
                    soTypeO = r.getAttribute("OrderType");
                }
                setSoIdTrans(s.toString());
                setSoTypeTrans((Integer) soTypeO);
            }
        }
    ...
    /**
     * Gets the attribute value for the calculated attribute SoTypeTrans.
     * @return the SoTypeTrans
     */
    public Integer getSoTypeTrans() {
        return (Integer) getAttributeInternal(SOTYPETRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute SoTypeTrans.
     * @param value value to set the  SoTypeTrans
     */
    public void setSoTypeTrans(Integer value) {
        setAttributeInternal(SOTYPETRANS, value);
    }
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link SlsPickSrNote.
     */
