...
// ---------------------------------------------------------------------
public class SLSPckMtlSRVORowImpl extends ViewRowImpl {

    public static final int ENTITY_SLSPCKMTLSREO = 0;
    ...
    public enum AttributesEnum {
        CldId {
            public Object get(SLSPckMtlSRVORowImpl obj) {
                return obj.getCldId();
            }

            public void put(SLSPckMtlSRVORowImpl obj, Object value) {
        ...
        public abstract Object get(SLSPckMtlSRVORowImpl object);

        public abstract void put(SLSPckMtlSRVORowImpl object, Object value);
     ...
     */
    public SLSPckMtlSRVORowImpl() {
    }

    /**
     * Gets SLSPckMtlSREO entity object.
     * @return the SLSPckMtlSREO
     */
    public EntityImpl getSLSPckMtlSREO() {
        return (EntityImpl) getEntity(ENTITY_SLSPCKMTLSREO);
    }
    ...
    public void setPrjId(String value) {
        // if(getWhId()!=null){
        //  String projId = EbizParamsAPPUtils.getPrjIdFrmWhId(getAm(), getWhId());
        //  setPrjId(projId);
        //  }
