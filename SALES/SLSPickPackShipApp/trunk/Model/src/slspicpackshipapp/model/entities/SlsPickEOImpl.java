...
public class SlsPickEOImpl extends EntityImpl {
    ...
    /**
     * Gets the attribute value for PickMode, using the alias name PickMode.
    ...
    /**
     * Sets <code>value</code> as the attribute value for PickMode.
     * @param value value to set the PickMode
     */
    ...
    protected Object callStoredFunction(int sqlReturnType, String stmt, Object[] bindVars) {
        ...
        return ADFModelUtils.callFunction(am, new StringBuilder(stmt), bindVars, sqlReturnType);
    }
    ...
    protected void create(AttributeList attributeList) {
        String dcId = (String) ((callStoredFunction(Types.VARCHAR, "app.get_txn_id (?,?,?,?,?,?)", new Object[] {
                                                    ...
                                                    new Integer(21506), new Integer(0)
        })));
        Object projId = ADFModelUtils.resolvEl("#{pageFlowScope.GLBL_ORG_PROJ_ID}");
        String defaultProjId = projId == null ? "PROJ0000" : projId.toString();
        Object projIdApplicable = ADFModelUtils.resolvEl("#{pageFlowScope.GLBL_ORG_PROJ_ALW}");
        String isPrjAlw = projIdApplicable == null ? "N" : projIdApplicable.toString();
        setDocId(dcId);
        putGlobalPickId(dcId);
        ...
        pickPackShipAMImpl am =
            (pickPackShipAMImpl) ADFModelUtils.resolvEl("#{data.pickPackShipAMDataControl.dataProvider}");
        Integer fyId = EbizParamsAPPUtils.getFyIdOnCurrDtAndCurrOrg(am);
        setFyId(fyId);
        setCloseFlg("Y");
        setPickMode(313);
        setFreeze("N");
        if (isPrjAlw.equalsIgnoreCase("N")) {
    ...
    protected void putGlobalPickId(String docId){
       // PICK_DOC_ID
       RequestContext.getCurrentInstance().getPageFlowScope().put("PICK_DOC_ID", docId);
    }
