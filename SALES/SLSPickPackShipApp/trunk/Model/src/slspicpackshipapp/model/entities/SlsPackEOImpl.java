...
public class SlsPackEOImpl extends EntityImpl {
    ...
    /**
     * Gets the attribute value for FreezePackItm, using the alias name FreezePackItm.
     * @return the value of FreezePackItm
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for FreezePackItm.
     * @param value value to set the FreezePackItm
     */
    ...
    /**
     * Gets the attribute value for PackStat, using the alias name PackStat.
     * @return the value of PackStat
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for PackStat.
     * @param value value to set the PackStat
     */
    ...
    protected void create(AttributeList attributeList) {
        ...
        String driver = getdrivername();
        if (driver.equalsIgnoreCase("MySQL-AB JDBC Driver")) {
            dcId = (String) ((callStoredFunction(Types.VARCHAR, "call get_txn_id (?,?,?,?,?,?)", new Object[] {
                                                 p_cld_id, SlocId, p_org_id, p_user_id, new Integer(21506),
                                                 new Integer(0)
            })));
        } else {
            dcId = (String) ((callStoredFunction(Types.VARCHAR, "app.get_txn_id (?,?,?,?,?,?)", new Object[] {
                                                 p_cld_id, SlocId, p_org_id, p_user_id, new Integer(21503),
                                                 new Integer(0)
            })));
        }
