...
public class SlsPickItmEOImpl extends EntityImpl {
    ...
    public static final int SLSPICKSRNOTE = AttributesEnum.SlsPickSrNote.index();
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getSlsPickSrNote() {
        return (RowIterator) getAttributeInternal(SLSPICKSRNOTE);
    }
