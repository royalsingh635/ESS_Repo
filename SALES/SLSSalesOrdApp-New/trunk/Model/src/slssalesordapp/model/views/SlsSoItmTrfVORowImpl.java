...
public class SlsSoItmTrfVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ItmNmFrTrf {
            public Object get(SlsSoItmTrfVORowImpl obj) {
                return obj.getItmNmFrTrf();
            }

            public void put(SlsSoItmTrfVORowImpl obj, Object value) {
                obj.setItmNmFrTrf((String) value);
            }
        }
        ,
        SlsSoDlvSchdl {
    ...
    public static final int ITMNMFRTRF = AttributesEnum.ItmNmFrTrf.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute ItmNmFrTrf.
     * @return the ItmNmFrTrf
     */
    public String getItmNmFrTrf() {
        if(getAttributeInternal(ITMNMFRTRF) == null){
            String descFrmItmId = EbizParams.getItemDescFrmItmId((salesOrderAMImpl)getApplicationModule(), getItmId());
            setItmNmFrTrf(descFrmItmId);
        }
        return (String) getAttributeInternal(ITMNMFRTRF);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ItmNmFrTrf.
     * @param value value to set the  ItmNmFrTrf
     */
    public void setItmNmFrTrf(String value) {
        setAttributeInternal(ITMNMFRTRF, value);
    }


    /**
     * Gets the associated <code>Row</code> using master-detail link SlsSoDlvSchdl.
     */
    public Row getSlsSoDlvSchdl() {
        return (Row) getAttributeInternal(SLSSODLVSCHDL);
    }

    /**
     * Sets the master-detail link SlsSoDlvSchdl between this object and <code>value</code>.
     */
    public void setSlsSoDlvSchdl(Row value) {
        setAttributeInternal(SLSSODLVSCHDL, value);
    }
