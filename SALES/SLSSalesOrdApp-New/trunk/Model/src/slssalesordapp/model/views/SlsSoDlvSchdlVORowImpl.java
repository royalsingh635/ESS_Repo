...
import slssalesordapp.model.entities.SlsSoDlvSchdlEOImpl;


// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Sat Jan 04 10:57:02 IST 2014
...
public class SlsSoDlvSchdlVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ,
        SLSChkFrSoItmPickNewVO1 {
            public Object get(SlsSoDlvSchdlVORowImpl obj) {
                return obj.getSLSChkFrSoItmPickNewVO1();
            }
    ...
    public static final int SLSCHKFRSOITMPICKNEWVO1 = AttributesEnum.SLSChkFrSoItmPickNewVO1.index();
    ...
    public String getIsItemPicked() {
        if(getAttributeInternal(ISITEMPICKED) == null){
            RowSet chkFrSoItmPickNewVO1 = this.getSLSChkFrSoItmPickNewVO1();
            chkFrSoItmPickNewVO1.setNamedWhereClauseParam("CldIdBind", getCldId());
            chkFrSoItmPickNewVO1.setNamedWhereClauseParam("SlocIdBind", getSlocId());
            chkFrSoItmPickNewVO1.setNamedWhereClauseParam("OrgIdBind", getOrgId());
            chkFrSoItmPickNewVO1.setNamedWhereClauseParam("HoOrgIdBind", getHoOrgId());
            chkFrSoItmPickNewVO1.setNamedWhereClauseParam("SoIdBind", getDocId());
            chkFrSoItmPickNewVO1.setNamedWhereClauseParam("ItmIdBind", getItmId());
            chkFrSoItmPickNewVO1.executeQuery();
            Row[] allRowsInRange = chkFrSoItmPickNewVO1.getAllRowsInRange();
    ...
    public String getItmNmTrans() {
        if(getAttributeInternal(ITMNMTRANS) == null && getItmId() != null){
            RowSet itmNmVo = this.getLovItmNmVo1();
            itmNmVo.setNamedWhereClauseParam("ItmIdBind", this.getItmId());
            itmNmVo.setNamedWhereClauseParam("CldIdBind", this.getCldId());
            itmNmVo.setNamedWhereClauseParam("SlocIdBind", this.getSlocId());
            itmNmVo.setNamedWhereClauseParam("HoOrgIdBind", this.getHoOrgId());
            itmNmVo.setNamedWhereClauseParam("ItmDescBind", null);
            itmNmVo.executeQuery();
            Row[] allRowsInRange = itmNmVo.getAllRowsInRange();
            //System.out.println("Count is : "+allRowsInRange.length);
            if(allRowsInRange.length > 0){
                Object a = allRowsInRange[0].getAttribute("ItmDesc");
                String itmNm = (a == null ? null : a.toString());
                setItmNmTrans(itmNm);
            }
        }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> SLSChkFrSoItmPickNewVO1.
     */
    public RowSet getSLSChkFrSoItmPickNewVO1() {
        return (RowSet) getAttributeInternal(SLSCHKFRSOITMPICKNEWVO1);
    }
