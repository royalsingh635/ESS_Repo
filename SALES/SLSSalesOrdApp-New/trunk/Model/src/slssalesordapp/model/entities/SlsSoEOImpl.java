...
public class SlsSoEOImpl extends EntityImpl {
    ...
    public static final int SLSSOFLXEO = AttributesEnum.SlsSoFlxEO.index();
    ...
    public void setDiscType(String value) {
        System.out.println("Setting discType to : " + value);
        if (value != null) {
    ...
    public void setDiscVal(Number value) {
        System.out.println("Setting discVal to : " + value);
        if (value != null) {
    ...
    public void setUsrIdMod(Integer value) {
        //System.out.println("Setting setUsrIdMod to : "+value);
        if (value != null) {
    ...
    /**
     * Gets the attribute value for SoSubType, using the alias name SoSubType.
     * @return the value of SoSubType
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for SoSubType.
     * @param value value to set the SoSubType
     */
    ...
    /**
     * Gets the attribute value for RefTypSrc, using the alias name RefTypSrc.
     * @return the value of RefTypSrc
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for RefTypSrc.
     * @param value value to set the RefTypSrc
     */
    ...
    /**
     * Gets the attribute value for EoCatgId, using the alias name EoCatgId.
     * @return the value of EoCatgId
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for EoCatgId.
     * @param value value to set the EoCatgId
     */
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getSlsSoFlxEO() {
        return (RowIterator) getAttributeInternal(SLSSOFLXEO);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        //Get the default project ID from global values

        String dcId = (String) ((callStoredFunction(Types.VARCHAR, "app.get_txn_id (?,?,?,?,?,?)", new Object[] {
                                                    EbizParams.GLBL_APP_CLD_ID(), EbizParams.GLBL_APP_SERV_LOC(),
                                                    EbizParams.GLBL_APP_USR_ORG(), EbizParams.GLBL_APP_USR(),
                                                    new Integer(21503), new Integer(0)
        })));
        String defultWhId = fatchWhId();
        ...
        setPrjId(EbizParamsAPPUtils.getPrjIdFrmWhId(getApplicationModule(), defultWhId)); //Inserting default project Id
    ...
    private void checkInconsistentAttrs() {
        ...
        this.refresh(REFRESH_CONTAINEES);
    ...
    /**
     * method to get the Warehouse ID for current organization
     */
    protected String fatchWhId() {
