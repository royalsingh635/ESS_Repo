...
public class MmSoEOImpl extends EntityImpl {
    ...
    protected Object callStoredFunction(int sqlReturnType, String stmt, Object[] bindVars) {
            salesOrderAMImpl am = (salesOrderAMImpl)ADFModelUtils.resolvEl("#{data.salesOrderAMDataControl.dataProvider}");
    ...
    protected void create(AttributeList attributeList) {
        ...
        String docId = getDocId(EbizParams.GLBL_APP_USR(), EbizParams.GLBL_APP_USR_ORG(), EbizParams.GLBL_APP_SERV_LOC(), 18501, EbizParams.GLBL_APP_CLD_ID());
        String soId =
            (String)callStoredFunction(Types.VARCHAR, "MM.FN_MM_GEN_ID (?,?,?,?,?,?)", new Object[] { EbizParams.GLBL_APP_SERV_LOC(), EbizParams.GLBL_APP_CLD_ID(),
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation == DML_UPDATE) {
            Integer p_user_id = (Integer)(ADFModelUtils.resolvEl("#{pageFlowScope.GLBL_APP_USR}"));
