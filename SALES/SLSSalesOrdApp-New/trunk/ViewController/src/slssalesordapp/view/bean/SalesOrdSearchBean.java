...
public class SalesOrdSearchBean {
    ...
    private RichOutputText addsIdBindVar;
    private RichInputText extDocNoBind;


    public SalesOrdSearchBean() {
        NumberRange sliderValue = new NumberRange(0,200);
    ...
    public void searchAction(ActionEvent actionEvent) {
        ...
        if (searchVo.getResult() != null) {
            ...
            vo.setNamedWhereClauseParam("DispIdBind", dispDocIdBinding.getValue());
            ...
            vo.setNamedWhereClauseParam("BindShipId", addsIdBindVar.getValue());
            vo.setNamedWhereClauseParam("BindExtDocNo", extDocNoBind.getValue());
    ...
    public void resetAction(ActionEvent actionEvent) {
        ...
        if (searchVo.getResult() != null) {
            ...
            vo.setNamedWhereClauseParam("DispIdBind", null);
            vo.setNamedWhereClauseParam("SoModeBind",null);
            vo.setNamedWhereClauseParam("BindShipId",null);
            vo.setNamedWhereClauseParam("BindExtDocNo",null);
            vo.executeQuery();
    ...
    public void setSoDocId(String soDocId) {
        this.soDocId = soDocId;
    }
    ...
    public void ViewSalesOrderACTION(ActionEvent actionEvent) {
       Object docIdO =  actionEvent.getComponent().getAttributes().get("docId");
       if(docIdO != null){
           soDocId = docIdO.toString();
       }
    }
    ...
    public void setAddsIdBindVar(RichOutputText addsIdBindVar) {
        this.addsIdBindVar = addsIdBindVar;
    }

    public RichOutputText getAddsIdBindVar() {
        return addsIdBindVar;
    }

    public void setExtDocNoBind(RichInputText extDocNoBind) {
        this.extDocNoBind = extDocNoBind;
    }

    public RichInputText getExtDocNoBind() {
        return extDocNoBind;
    }
}
