...
public class AddEditTempVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        taxReversalTrans {
            public Object get(AddEditTempVORowImpl obj) {
                return obj.gettaxReversalTrans();
            }

            public void put(AddEditTempVORowImpl obj, Object value) {
                obj.settaxReversalTrans((String) value);
            }
        }
        ,
        LovEoIdVO1 {
    ...
    public static final int TAXREVERSALTRANS = AttributesEnum.taxReversalTrans.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute taxReversalTrans.
     * @return the taxReversalTrans
     */
    public String gettaxReversalTrans() {
        return (String) getAttributeInternal(TAXREVERSALTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute taxReversalTrans.
     * @param value value to set the  taxReversalTrans
     */
    public void settaxReversalTrans(String value) {
        setAttributeInternal(TAXREVERSALTRANS, value);
    }
