...
public class LovItmGrpVOImpl extends ViewObjectImpl {
    ...
    /**
     * Returns the variable value for GrpNmTrans.
     * @return variable value for GrpNmTrans
     */
    public String getGrpNmTrans() {
        return (String) ensureVariableManager().getVariableValue("GrpNmTrans");
    }

    /**
     * Sets <code>value</code> for variable GrpNmTrans.
     * @param value value to bind as GrpNmTrans
     */
    public void setGrpNmTrans(String value) {
        ensureVariableManager().setVariableValue("GrpNmTrans", value);
    }
