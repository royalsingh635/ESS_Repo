...
public class LovItmIdVoImpl extends ViewObjectImpl {
    ...
    /**
     * Returns the variable value for ItemDescBind.
     * @return variable value for ItemDescBind
     */
    public String getItemDescBind() {
        return (String) ensureVariableManager().getVariableValue("ItemDescBind");
    }

    /**
     * Sets <code>value</code> for variable ItemDescBind.
     * @param value value to bind as ItemDescBind
     */
    public void setItemDescBind(String value) {
        ensureVariableManager().setVariableValue("ItemDescBind", value);
    }
