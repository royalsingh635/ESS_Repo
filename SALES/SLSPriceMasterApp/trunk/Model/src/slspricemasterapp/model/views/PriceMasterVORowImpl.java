...
public class PriceMasterVORowImpl extends ViewRowImpl {
    ...
    /**
     * Gets the attribute value for TOT_MRP_RATE using the alias name TotMrpRate.
     * @return the TOT_MRP_RATE
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for TOT_MRP_RATE using the alias name TotMrpRate.
     * @param value value to set the TOT_MRP_RATE
     */
    ...
    public String getItmDesc() {
        if(getItmId() != null && itmDesc == null){
         ...
         itmDesc=   EbizParams.getItemDescFrmItmId((SLSPriceMasterAppAMImpl)getApplicationModule(), getItmId());
            /* if(o != null){
                itmDesc = o.toString();
            } */
        }
