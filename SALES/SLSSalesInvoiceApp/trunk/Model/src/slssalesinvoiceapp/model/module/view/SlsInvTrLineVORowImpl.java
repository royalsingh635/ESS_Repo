...
public class SlsInvTrLineVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TaxCoaDescTrans {
            public Object get(SlsInvTrLineVORowImpl obj) {
                return obj.getTaxCoaDescTrans();
            }

            public void put(SlsInvTrLineVORowImpl obj, Object value) {
                obj.setTaxCoaDescTrans((String) value);
            }
        }
        ,
        LOVCoaForTaxVO1 {
    ...
    public static final int TAXCOADESCTRANS = AttributesEnum.TaxCoaDescTrans.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute TaxCoaDescTrans.
     * @return the TaxCoaDescTrans
     */
    public String getTaxCoaDescTrans() {
        if (getAttributeInternal(TAXCOADESCTRANS) == null && getTaxCoaId() != null) {
            ApplicationModuleImpl am = (ApplicationModuleImpl) getApplicationModule();
            Object coaNmO = EbizParamsAPPUtils.getCoaNameFrmCoaId(am, getTaxCoaId());
            if (coaNmO != null) {
                setTaxCoaDescTrans(coaNmO.toString());
            }
        }
        return (String) getAttributeInternal(TAXCOADESCTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TaxCoaDescTrans.
     * @param value value to set the  TaxCoaDescTrans
     */
    public void setTaxCoaDescTrans(String value) {
        setAttributeInternal(TAXCOADESCTRANS, value);
    }
