...
public class TempSearchPanelVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        InvoiceStatus {
            ...
            public void put(TempSearchPanelVORowImpl obj, Object value) {
                obj.setInvoiceStatus((Integer) value);
            }
        }
        ,
        InvoiceMode {
            public Object get(TempSearchPanelVORowImpl obj) {
                return obj.getInvoiceMode();
            }

            public void put(TempSearchPanelVORowImpl obj, Object value) {
                obj.setInvoiceMode((Integer) value);
            }
        }
        ,
        InvIdTxtTrans {
            public Object get(TempSearchPanelVORowImpl obj) {
                return obj.getInvIdTxtTrans();
            }

            public void put(TempSearchPanelVORowImpl obj, Object value) {
                obj.setInvIdTxtTrans((String) value);
            }
        }
        ,
        LOVInvoiceTypeVO1 {
        ...
        LOVInvoiceStatus {
            public Object get(TempSearchPanelVORowImpl obj) {
                return obj.getLOVInvoiceStatus();
            }
        ...
        LOVInvoiceModeVO {
            public Object get(TempSearchPanelVORowImpl obj) {
                return obj.getLOVInvoiceModeVO();
            }
    ...
    public static final int INVOICEMODE = AttributesEnum.InvoiceMode.index();
    public static final int INVIDTXTTRANS = AttributesEnum.InvIdTxtTrans.index();
    ...
    public static final int LOVINVOICESTATUS = AttributesEnum.LOVInvoiceStatus.index();
    public static final int LOVINVOICEMODEVO = AttributesEnum.LOVInvoiceModeVO.index();
    ...
    public Integer getCurrIdBs(String OrgId) {
        return (Integer) callStoredFunction(Types.INTEGER, "app.pkg_app.get_org_def_curr_bs1(?)", new Object[] {
                                            OrgId });
    }
    ...
    public Integer getInvoiceStatus() {
        return (Integer) getAttributeInternal(INVOICESTATUS);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute InvoiceMode.
     * @return the InvoiceMode
     */
    public Integer getInvoiceMode() {
        return (Integer) getAttributeInternal(INVOICEMODE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute InvoiceMode.
     * @param value value to set the  InvoiceMode
     */
    public void setInvoiceMode(Integer value) {
        setAttributeInternal(INVOICEMODE, value);
    }

    /**
     * Gets the attribute value for the calculated attribute InvIdTxtTrans.
     * @return the InvIdTxtTrans
     */
    public String getInvIdTxtTrans() {
        return (String) getAttributeInternal(INVIDTXTTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute InvIdTxtTrans.
     * @param value value to set the  InvIdTxtTrans
     */
    public void setInvIdTxtTrans(String value) {
        setAttributeInternal(INVIDTXTTRANS, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LOVInvoiceStatus.
     */
    public RowSet getLOVInvoiceStatus() {
        return (RowSet) getAttributeInternal(LOVINVOICESTATUS);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LOVInvoiceModeVO.
     */
    public RowSet getLOVInvoiceModeVO() {
        return (RowSet) getAttributeInternal(LOVINVOICEMODEVO);
    }
