...
public class Custom {
     ...
     * @return
     */
    public static Object getClassIntace(ApplicationModuleImpl am,Integer slocId,String cldId,Integer docId,Integer docTypeId,Integer action,Integer order,StringBuilder jar){
    Object obj=null;
     ...
     * @throws SQLException
     */
    public static ArrayList getClsDetail(ApplicationModuleImpl am,Integer slocId,String cldId,Integer docId,Integer docTypeId,Integer action,Integer order,
                                         @SuppressWarnings("unused") StringBuilder jar) throws SQLException {
       ...
       return ADFModelUtils.callDbProcedure(am, new StringBuilder("app.PROC_GET_CLS_DTL(?,?,?,?,?,?,?,?,?)"), params);
    }
