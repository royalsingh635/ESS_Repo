...
public class SlsRmaAppAMImpl extends ApplicationModuleImpl implements SlsRmaAppAM {
    ...
    public void insertItemToRmaFrmShpmnt() {
        ...
        while (itmCtr.hasNext()) {
            ...
            if (rejQty.compareTo(StaticValue.NUMBER_ZERO) > 0) {
                ...
                itmRow.setAttribute("CurrIdBs", row.getAttribute("CurrIdBs"));
                itmRow.setAttribute("CurrIdSp", row.getAttribute("CurrIdSp"));
                ...
                itmRow.setAttribute("ItmQtyBs", ADFBeanUtils.roundOff(rejQty.multiply(uomConvFctr)));
        ...
        Row _shipVoRow = this.getSlsRmaShipmnt2().getCurrentRow();
        ViewObjectImpl vo = this.getshpmntItmViewVO1();
        RowSetIterator ctr = vo.createRowSetIterator(null);
        ...
        String invId = null;
        ViewObjectImpl slsShipItmVo = this.getSlsShipItmVO1();
        ViewObjectImpl dtlVO1 = this.getSLSInvItmDtlVO1();
        // RowQualifier shiItmRq = new RowQualifier(slsShipItmVo);

        dtlVO1.setNamedWhereClauseParam("SLOC_ID", getparamSlocId());
        dtlVO1.setNamedWhereClauseParam("CLD_ID", getparamCldId());
        dtlVO1.setNamedWhereClauseParam("ORG_ID", getparamOrgId());
        dtlVO1.setNamedWhereClauseParam("HO_ORG_ID", getparamHoOrgId());
        dtlVO1.setNamedWhereClauseParam("SHIPIDBIND", _shipVoRow.getAttribute("ShipmntId"));
        dtlVO1.executeQuery();
        RowSetIterator invCtr = dtlVO1.createRowSetIterator(null);
        while (invCtr.hasNext()) {
            Row next = invCtr.next();
            invId = next.getAttribute("InvDocId").toString();
        }
        int j = dtlVO1.getRangeSize();
                ...
                while (soItr.hasNext()) {
                    ...
                    if (balanceQty.compareTo(0) == 1) {
                        ...
                        if (shipItmFltRow.length > 0) {
                            ...
                            for (Row shipItmRow : shipItmFltRow) {
                                String SoDocId = (String) shipItmRow.getAttribute("SoId");
                                String pickId = (String) shipItmRow.getAttribute("PickId");
                                ...
                                if (balanceQty.compareTo(new Number(0)) > 0) {
                                    ...
                                    if (balanceQty.compareTo(shipItmQty) >= 0) {
                                        ...
                                        slsRMaItmRow.setAttribute("ItmQtyBs", shipItmQty);
                                        slsRMaItmRow.setAttribute("ShipmntDt", shipDate);
                                        ...
                                        slsRMaItmRow.setAttribute("InvId", invId);
                                        slsRMaItmRow.setAttribute("PickId", pickId);
                                        ...
                                        slsRMaItmRow.setAttribute("ItmUom", shipItmRow.getAttribute("ItmUom"));
                                        slsRMaItmRow.setAttribute("ItmUomBs", shipItmRow.getAttribute("ItmUomBs"));
                                        Number itmPrce = (Number) shipItmRow.getAttribute("ItmPrice");
                                        Number totItmPrice = balanceQty.multiply(itmPrce);
                                        slsRMaItmRow.setAttribute("ItmPrice", itmPrce);
                                        slsRMaItmRow.setAttribute("WhId", _wareHouse);
                                        slsRMaItmRow.setAttribute("ShipmntDt", shipDate);
                                        // slsRMaItmRow.setAttribute("ItmAmtSp", shipItmRow.getAttribute("ItmAmtSp"));
                                        slsRMaItmRow.setAttribute("ItmAmtSp", totItmPrice);
                                        Number ItmBs =
                                            totItmPrice.multiply((Number) viewRow.getAttribute("CurrConvFctr"));
                                        slsRMaItmRow.setAttribute("ItmAmtBs", ItmBs);
                                        slsRMaItmRow.setAttribute("UomConvFctr",
                                                                  shipItmRow.getAttribute("UomConvFctr"));
                                        slsRMaItmRow.setAttribute("CurrIdSp", viewRow.getAttribute("CurrIdSp"));
                                        slsRMaItmRow.setAttribute("CurrIdBs", viewRow.getAttribute("CurrIdBs"));
                                        ...
                                        slsRMaItmRow.setAttribute("InvId", invId);
                                        slsRMaItmRow.setAttribute("PickId", pickId);
                                        slsRMaItmRow.setAttribute("CurrConvFctr", viewRow.getAttribute("CurrConvFctr"));
                                        balanceQty = new Number(0);
                                    }
                                }
                                _log.info("=================================333==============================================");
    ...
    protected void insertShipSrToRmaLotBin(String itmId, Object binId, Object lotId, Object shpDate, Number approvQty,
        ...
        if (chkBin.equalsIgnoreCase("Y")) {
            ...
            newBinRow.setAttribute("RejQty", rwrkQty);
            newBinRow.setAttribute("RejQtyBs", ADFBeanUtils.roundOff(rwrkQty.multiply(convFactor)));
