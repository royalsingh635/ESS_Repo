...
public class LotData {
    ...
    public Number getTotRejQtyForLot(String lotId){
        Number i = new Number(0);
        for(LotRow row : data){
            if(row.getLotId().equals(lotId)){
                i = i.add(row.getRejQty());
            }
        }
        System.out.println("Total Rejected Quantity for Lot :"+lotId+" is : "+i);
        return i;
    }
    public Number getTotRwkQtyForLot(String lotId){
        Number i = new Number(0);
        for(LotRow row : data){
            if(row.getLotId().equals(lotId)){
                i = i.add(row.getRwkQty());
            }
        }
        System.out.println("Total Reworkable Quantity for Lot :"+lotId+" is : "+i);
        return i;
    }
    ...
    public Number getTotRejQtyForLotBin(String lotId,String binId){
        Number i = new Number(0);
        for(LotRow row : data){
            if(row.getLotId().equals(lotId) && row.getBinId().equals(binId)){
                i = i.add(row.getRejQty());
        ...
        System.out.println("Total Rejected Quantity for Lot :"+lotId+" Bin :"+binId+" is : "+i);
        return i;
    }
    public Number getTotRwkQtyForLotBin(String lotId,String binId){
        Number i = new Number(0);
        for(LotRow row : data){
            if(row.getLotId().equals(lotId) && row.getBinId().equals(binId)){
                i = i.add(row.getRwkQty());
        ...
        System.out.println("Total Reworkable Quantity for Lot :"+lotId+" Bin :"+binId+" is : "+i);
        return i;
    }
