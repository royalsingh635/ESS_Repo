package slsrmaapp.view.servlet;
...
public class SLSRMAServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            path=path+ "SLS/" ;
            if (linkType.equalsIgnoreCase("rmadetail")) {
                reportName = "SLS_RMA_Detail_Report";
            }
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Sales RMA Report.pdf\"");
