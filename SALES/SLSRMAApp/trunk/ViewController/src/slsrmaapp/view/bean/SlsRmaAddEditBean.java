...
public class SlsRmaAddEditBean {
    ...
    public String rma_SaveActionListener() {
        ...
        if (isGe == 1) {
            ...
            if (result) {
                ...
                if (rmatypeBVar.getValue().equals(401)) {
                    ...
                    if (!pass) {
                        ...
                        FacesMessage message =
                            ...
                            new FacesMessage(resolvEl("#{bundle['MSG.1143']}")); //MSG.1757
               ...
               new StringBuilder("<html><body><b><p style='color:red'>" + resolvEl("#{bundle['MSG.1269']}") +
                                 "</p></b>");
                    ...
                    flag = "N";
                    FacesMessage message =
                        new FacesMessage("<html><body>" + resolvEl("#{bundle['MSG.1143']}") + "</body></html>");
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext.getCurrentInstance().addMessage(null, message);
                }
                                ...
                                new FacesMessage(resolvEl("#{bundle['MSG.1071']}")  + dispId.substring(2)  +
                                    ...
                                    FacesMessage msg =
                                        new FacesMessage("<html><body>" + resolvEl("#{bundle['MSG.1071']}") +
                                                         ...
                                                         (resolvEl("#{bundle['MSG.347']}")) + "</body></html>");
    ...
    public void editRma_ActionListener(ActionEvent actionEvent) {
        ...
        if (pending.compareTo(new Integer(-1)) == 0 || pending.compareTo(UsrId) == 0) {
            ...
            String msg2 = resolvEl("#{bundle['MSG.1758']}") + nm + resolvEl("#{bundle['MSG.1759']}");
            FacesMessage message2 = new FacesMessage(msg2);
 ...
 */
                  ...
                  new StringBuilder("<html><body><b><p style='color:red'>" + resolvEl("#{bundle['MSG.1144']}") +
                                ...
                                if (okRejRwkQntValid.getResult() != null) {
                                    ...
                                    if (valtToShow.size() !=
                                        ...
                                        saveMsg.append("<ul style='color:darkgreen'><li>" +
                                                       resolvEl("#{bundle['MSG.1270']}") + "</li><li></b>");
                                        saveMsg.append("</body></html>");
                                        FacesMessage msg = new FacesMessage(saveMsg.toString());
                                        msg.setSeverity(FacesMessage.SEVERITY_WARN);
                                        FacesContext.getCurrentInstance().addMessage(null, msg);
                                            ...
                                            if ("S".equalsIgnoreCase(saveMode)) {
                                                ...
                                                FacesMessage msg =
                                                    new FacesMessage("<html><body>" +
                                                                     resolvEl("#{bundle['MSG.1071']}") +
                                                                     " <b style='color:darkGreen'> " +
                                                                     dispId.substring(2) + " </b>" +
                                                                     (resolvEl("#{bundle['MSG.347']}")) +
                                                                     "</body></html>");
                                                msg.setSeverity(FacesMessage.SEVERITY_INFO);
                                                FacesContext ctx = FacesContext.getCurrentInstance();
                                                ctx.addMessage(null, msg);
            ...
            if (shpmntQuantPopBind.getValue() != null) {
                ...
                if (b) {
                    if (rejectQty.compareTo(0) < 0) {
                        ...
                        throw new ValidatorException(new FacesMessage(resolvEl("#{bundle['MSG.1760']}")));
                    ...
                    // System.out.println("-------------");
                    throw new ValidatorException(new FacesMessage(resolvEl("#{bundle['MSG.1266']}")));
                }
            }
    ...
    public void wareHouseValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object == null) {
            //System.out.println(object);
            throw new ValidatorException(new FacesMessage(resolvEl("#{bundle['MSG.1761']}")));
    ...
    public void addShipmtFns() {
        ...
        if ("Y".equalsIgnoreCase(rtnRst)) {
            if (true) {
                ...
                FacesMessage message = new FacesMessage(resolvEl("#{bundle['MSG.1762']}"));
    ...
    public void shipWiseLotDiolugeListener(DialogEvent dialogEvent) {
        ...
        if (dialogEvent.getOutcome().name().equalsIgnoreCase("ok")) {
            ...
            if (validQntInLot.getResult() != null) {
                ...
                if ("OK".equalsIgnoreCase(rst)) {
                    ...
                    if (chkOkRejRwkQnt.getResult() != null) {
                        ...
                        if (okQnt.compareTo(enterOkQnt) == -1 || okQnt.compareTo(enterOkQnt) == 1) {
                            ...
                            FacesMessage message = new FacesMessage(resolvEl("#{bundle['MSG.1274']}"));
                            message.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext fc = FacesContext.getCurrentInstance();
                            fc.addMessage(null, message);
                        } else if (rejQnt.compareTo(enterrejQnt) == -1 || rejQnt.compareTo(enterrejQnt) == 1) {
                            //  System.out.println("In Rej If");
                            FacesMessage message = new FacesMessage(resolvEl("#{bundle['MSG.1275']}"));
                            message.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext fc = FacesContext.getCurrentInstance();
                            fc.addMessage(null, message);
                        } else if (rwkont.compareTo(enterRwkQnt) == -1 || rwkont.compareTo(enterRwkQnt) == 1) {
                            // System.out.println("In rwk if");
                            FacesMessage message = new FacesMessage(resolvEl("#{bundle['MSG.1276']}")); //new FacesMessage("You have Entered Wrong Reworkable Quantity ..");
                            message.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext fc = FacesContext.getCurrentInstance();
                            fc.addMessage(null, message);
                    ...
                    FacesMessage message =
                        new FacesMessage(resolvEl("#{bundle['MSG.1277']}")); // new FacesMessage("Item is not received with full quantity in lot table.");
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message);
                }
                ...
                FacesMessage message =
                    new FacesMessage(resolvEl("#{bundle['MSG.1278']}")); //new FacesMessage("there is no data in lot table.");
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message);
            }
    ...
    public void rejtQtyValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (n.compareTo(Number.zero()) <
                ...
                //                            null));
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              resolvEl("#{bundle['MSG.1763']}"), null));

            } else {
                boolean b = isPrecisionValid(26, 6, n);
                if (!b) {
                    throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                  resolvEl("#{bundle['MSG.1266']}"), null));
                }
            }
    ...
    public void rwkQntValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            if (n.compareTo(Number.zero()) < 0) {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              resolvEl("#{bundle['MSG.1763']}"), // "Quantity can not either negative or less then zero",
                                                              null));
            } /* else if ((rcptQnt.compareTo(n) == -1 ||
    ...
    public void addShipmentAction(ActionEvent actionEvent) {
        ...
        if (i == 6) {
            ADFModelUtils.showFacesMessage("Customer Name have not been selected !", "Please select Customer Name.",
                                           FacesMessage.SEVERITY_ERROR,
                                           getComponentCliendIdFromId(actionEvent.getComponent(), "soc5"));
        } else if (i == 1) {
            ADFModelUtils.showFacesMessage("RMA Type have not been selected !", "Please select RMA Type.",
                                           FacesMessage.SEVERITY_ERROR,
                                           getComponentCliendIdFromId(actionEvent.getComponent(), "soc5"));
        } else if (i == 2) {
            ADFModelUtils.showFacesMessage("WareHouse have not been selected !", "Please select Warehouse.",
                                           FacesMessage.SEVERITY_ERROR,
                                           getComponentCliendIdFromId(actionEvent.getComponent(), "soc23"));
        } else if (i == 3) {
            ADFModelUtils.showFacesMessage("Shipment have not been selected !", "Please select Shipment.",
                                           FacesMessage.SEVERITY_ERROR,
