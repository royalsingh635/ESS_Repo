...
public class SlsDlvSchdlBean {
    ...
    private RichPopup itmAddPopBind;
    private RichPanelGroupLayout wholePagePglBind;
    private Boolean chkItemBasis = null;
    private RichPanelFormLayout itmDetailFormBinding;
    private RichSelectOneChoice tlrTypBinding;

    public Boolean getChkItemBasis() {
        if (chkItemBasis == null) {
            OperationBinding ob = ADFBeanUtils.findOperation("isItemBasisApplicable");
            ob.execute();
            chkItemBasis = ob.getResult() == null ? false : (Boolean) ob.getResult();
        }
        return chkItemBasis;
    }
        ...
        if (true) {
            ...
            if (operationBinding.getResult() != null) {
                ...
                if (retval.equalsIgnoreCase("D")) {
                    ...
                    FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.411"));
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message);
                } else if (retval.equalsIgnoreCase("S")) {
                    FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.413"));
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message);
                } else {
            ...
            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.252"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        }
    ...
    public void deleteButton(ActionEvent actionEvent) {
        ...
        ADFBeanUtils.getOperationBinding("deleteDlvSchdl").execute();
        ...
        if (object != null) {
            ...
            if (qty.compareTo(0) == -1) {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              ADFModelUtils.resolvRsrc("MSG.553"), null));
            }

            if (qty.compareTo(0) == 0) {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              ADFModelUtils.resolvRsrc("MSG.87"), null));
    ...
    public void amendOrderAction(ActionEvent actionEvent) {
        ...
        if (pending.compareTo(new Integer(-1)) == 0 || pending.compareTo(EbizParams.GLBL_APP_USR()) == 0) {
            app_mode = "E";
            ...
            setAmd.getParamsMap().put("amdNo", amd_No);
            setAmd.execute();
            ...
            if (uNm.getResult() != null) {
                ...
                String msg2 =
                    "<html><body> <p>" + ADFModelUtils.resolvRsrc("MSG.824") + "<b><i> [ " +
                    uNm.getResult().toString() + " ] </i></b>" + ADFModelUtils.resolvRsrc("MSG.1085") +
    ...
    public void saveOrderAction(ActionEvent actionEvent) {
        ...
        if (dcbind.getDataControl().isTransactionModified()) {
            ...
            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.970"));
    ...
    public void ToAmountValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (amtToVar.getValue() != null && amtFromVar.getValue() != null) {
            ...
            if (amtto.compareTo(amtfrom) == -1) {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              ADFModelUtils.resolvRsrc("MSG.832"), null));
    ...
    public void RateContractValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (amt.compareTo(0) == -1 || amt.compareTo(0) == 0) {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              ADFModelUtils.resolvRsrc("MSG.730"), null));
            }
        }
    }
    ...
    public void deliveryDateValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            Timestamp t1 = StaticValue.getTruncatedDt(ts1);
            Timestamp t2 = StaticValue.getTruncatedDt(ts2);
            System.out.println("First TimeStamp :::::: " + t1);
            System.out.println("First TimeStamp :::::: " + t2);
            try {
                if (t2.dateValue().compareTo(t1.dateValue()) <= 0) {
                    if (t2.dateValue().toString().equals(t1.dateValue().toString())) {
                        //  System.out.println("Dates are same.");

                    } else {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      ADFModelUtils.resolvRsrc("MSG.1012"), null));
                    }
                }
            ...
            if (Integer.parseInt(orderTypePgBinding.getValue().toString()) == 311) {
                ...
                Timestamp t3 = StaticValue.getTruncatedDt(ts3);
                System.out.println("Third TimeStamp :::::: " + t3);
                //System.out.println("++++++  " + ts2.compareTo(ts3));
                try {
                    if ((t2.dateValue()).compareTo((t3.dateValue())) > 0) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      ADFModelUtils.resolvRsrc("MSG.1117"),
    ...
    public void InsertNewRecordAL(ActionEvent actionEvent) {
        ...
        if (existval) {
            ...
            if (orgidsrcPopUpBind.getValue() != null && orgIdDescPopUpBind.getValue() != null &&
                ...
                poperrormsg = true;
                if (orgidsrcPopUpBind.getValue() == null || orgIdDescPopUpBind.getValue() == null) {
                    displayErrorMsgOnPoup(ADFModelUtils.resolvRsrc("MSG.1118")); //"Please Select Organisation...!!");
                } else if (whIdSrcPopUpBind.getValue() == null || whIdDescPopUpBind.getValue() == null) {
                    displayErrorMsgOnPoup(ADFModelUtils.resolvRsrc("MSG.411")); //"Please Select WareHouse...!!!");
                } else if (itmTransferQtyPgBind.getValue() == null && !assignRetVal) {
                    displayErrorMsgOnPoup(ADFModelUtils.resolvRsrc("MSG.1137")); //"Please Enter Transfer Quantity...!!!");
                } else if (assignRetVal) {
                    displayErrorMsgOnPoup(ADFModelUtils.resolvRsrc("MSG.1136")); //"Invalid Precision (26 , 6) For Transfer Order. Please Change Its Value");
                }
                AdfFacesContext.getCurrentInstance().addPartialTarget(popUpErrorMsgPgBind);
    ...
    public void OrgIdDescVCL(ValueChangeEvent vce) {
        ...
        if (vce.getNewValue() != null && orgidsrcPopUpBind.getValue() != null) {
            ...
            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.1118"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void WhIdSrcVCL(ValueChangeEvent vce) {
        if (vce.getNewValue() != null && orgidsrcPopUpBind.getValue() != null) {
            System.out.println("In Source WH_ID VCL :: ");
            AdfFacesContext.getCurrentInstance().addPartialTarget(popUpTablePgBinding);
            BindingContainer bindings = getBindings();
    ...
    public void popUpOkButtonAL(ActionEvent actionEvent) {
        OperationBinding binding = ADFBeanUtils.getOperationBinding("validateTransferOrder");
        binding.execute();
    ...
    public void transferQtyValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            Integer b = ADFBeanUtils.isAmountValid((Number) object);
            if (b == -1) {
                throw new ValidatorException(new FacesMessage(ADFModelUtils.resolvRsrc("MSG.730")));
            } else if (b == -2) {
                throw new ValidatorException(new FacesMessage(ADFModelUtils.resolvRsrc("MSG.1266"),
                                                              ADFModelUtils.resolvRsrc("MSG.1062")));
            }
        }
    ...
    public void transferOrderAL(ActionEvent actionEvent) {
        ...
        if (orgidsrcPopUpBind.getValue() != null && orgIdDescPopUpBind.getValue() != null &&
            ...
            if (trfqty.compareTo(0) >= 0) {
                ...
                FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.653"));
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void whIdDescValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (val) {
                ...
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              ADFModelUtils.resolvRsrc("MSG.1120"),
                                                              null)); //"Duplicate WareHouse Found..!!"
            }
        }
    }
    ...
    public void CreateItemAL(ActionEvent actionEvent) {
        ...
        if (Integer.parseInt(operationBinding.getResult().toString()) == 0 && this.chkerror.equalsIgnoreCase("no")) {
            ...
            ADFModelUtils.showFormattedFacesMessage("", ADFModelUtils.resolvRsrc("MSG.2215"),
                                                    FacesMessage.SEVERITY_ERROR);

        } else if (Integer.parseInt(operationBinding.getResult().toString()) == 2) {

            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2214"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            ...
            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2213"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
            ...
            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2212"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        }
    ...
    public void DeleteItemAL(ActionEvent actionEvent) {
        ...
        operationBinding.execute();
        // this.setItm_mode("C");itemTablePgBind
        AdfFacesContext.getCurrentInstance().addPartialTarget(itmDetailFormBinding);
        AdfFacesContext.getCurrentInstance().addPartialTarget(namePgBind);
    ...
    public void ItemDetailsPopUpDL(DialogEvent dialogEvent) {
        if (dialogEvent.getOutcome().name().equalsIgnoreCase("ok") && this.chkerror.equalsIgnoreCase("no")) {
            ...
            System.out.println("value in return is: " + operationBinding.getResult());
            System.out.println(Integer.parseInt(operationBinding.getResult().toString()) == 2);
            if (Integer.parseInt(operationBinding.getResult().toString()) == 0) {
                ...
                AdfFacesContext.getCurrentInstance().addPartialTarget(wholePagePglBind);
            } else if (Integer.parseInt(operationBinding.getResult().toString()) == 1) {

                FacesMessage message =
                    new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2215")); //"Please Select Item Name."
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                ...
                System.out.println("Came in error message..");
                FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2214")); //Please enter quantity.
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                // fc.addMessage(itemQtyPgBind.getClientId(), message);
                fc.addMessage(null, message);
                ...
                FacesMessage message =
                    new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2213")); //Price field cannot be empty.
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message);
            ...
            FacesMessage message =
                new FacesMessage(ADFModelUtils.resolvRsrc("MSG.2212")); //Please check Customer Price policy.
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        }
        ...
        if (!contractBasisPgBind.getValue().toString().equalsIgnoreCase("488")) {
            ...
            if (vce.getNewValue() != null) {
                ...
                if (ob.getResult() != null && ((Number) ob.getResult()).compareTo(new Number(-2)) != 0) {
                    ...
                    this.chkerror = "yes";
                    //MSG.1299 Unable to fetch Item Price according to Customer Price policy!
                    FacesMessage msg =
        ...
        if (object != null) {
            ...
            if (ob.getResult() != null) {
                ...
                if ("Y".equalsIgnoreCase(flg)) {
                    String msg2 = ADFModelUtils.resolvRsrc("MSG.427");
                    FacesMessage message2 = new FacesMessage(msg2);
                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
    ...
    public void deleteRowOnPop(ActionEvent actionEvent) {
        getBindings().getOperationBinding("Delete3").execute();
        getBindings().getOperationBinding("Execute2").execute();
    }

    public void addItemToOrder(ActionEvent actionEvent) {
        // Add event code here...
        getBindings().getOperationBinding("ExceuteItmVo").execute();
        showPopup(itmAddPopBind, true);
    }
    ...
    public void setItmAddPopBind(RichPopup itmAddPopBind) {
        this.itmAddPopBind = itmAddPopBind;
    }

    public RichPopup getItmAddPopBind() {
        return itmAddPopBind;
    }

    public void saveTrfOrdrDialogList(DialogEvent dialogEvent) {
        System.out.println("Dialog event outcome : " + dialogEvent.getOutcome());
        if (dialogEvent.getOutcome().equals("ok")) {
            OperationBinding binding = ADFBeanUtils.getOperationBinding("validateTransferOrder");
            binding.execute();
            Object object = binding.getResult();
            Integer i = (object == null ? -1 : (Integer) object);
    ...
    public void setWholePagePglBind(RichPanelGroupLayout wholePagePglBind) {
        this.wholePagePglBind = wholePagePglBind;
    }

    public RichPanelGroupLayout getWholePagePglBind() {
        return wholePagePglBind;
    }

    public void dlvSchdlDL(DisclosureEvent disclosureEvent) {
        if (app_mode != "V") {
            OperationBinding binding = ADFBeanUtils.getOperationBinding("executeBalanceVw");
            binding.execute();
        }
    }
    ...
    public void toleranceQtyValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            if (tlrTypBinding.getValue() != null) {
                if (itemQtyPgBind.getValue() != null) {
                    String tlrTyp = tlrTypBinding.getValue().toString();
                    oracle.jbo.domain.Number qty = (oracle.jbo.domain.Number) itemQtyPgBind.getValue();
                    oracle.jbo.domain.Number tlrVal = (oracle.jbo.domain.Number) object;
                    if(tlrTyp.equalsIgnoreCase("A")){
                       
                        if (!isPrecisionValid(26, 6, tlrVal)) {
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                          ADFModelUtils.resolvRsrc("MSG.57"),
                                                                          null)); //Invalid Precision(26,6)
                        }
                        if(tlrVal.compareTo(qty)==1){
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                          ADFModelUtils.resolvRsrc("MSG.866"),//Tolerance Amount should be less than Item quantity
                                                                          null)); 
                        }
                    }
                    else if(tlrTyp.equalsIgnoreCase("P")){
                        
                        if (!isPrecisionValid(5, 2, tlrVal)) {
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                          ADFModelUtils.resolvRsrc("MSG.58"),//Invalid Precision (5,2).
                                                                          null));
                        }
                        if (tlrVal.compareTo(100) == 1) {
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                          ADFModelUtils.resolvRsrc("MSG.303"), null));//Invalid percentage Vale
                        }
                    }
                    if (tlrVal.compareTo(0) == -1) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      ADFModelUtils.resolvRsrc("MSG.553"), null));
                    }
    ...
    public void setItmDetailFormBinding(RichPanelFormLayout itmDetailFormBinding) {
        this.itmDetailFormBinding = itmDetailFormBinding;
    }

    public RichPanelFormLayout getItmDetailFormBinding() {
        return itmDetailFormBinding;
    }

    public void setTlrTypBinding(RichSelectOneChoice tlrTypBinding) {
        this.tlrTypBinding = tlrTypBinding;
    }

    public RichSelectOneChoice getTlrTypBinding() {
        return tlrTypBinding;
    }
}
