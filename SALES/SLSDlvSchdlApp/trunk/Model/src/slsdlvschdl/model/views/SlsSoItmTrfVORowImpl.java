...
import slsdlvschdl.model.entity.SlsSoItmTrfEOImpl;
import slsdlvschdl.model.services.SLSDlvSchdlAMImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Mon Jan 20 18:29:18 IST 2014
...
public class SlsSoItmTrfVORowImpl extends ViewRowImpl {
    ...
    public static final int APPORGVO1 = AttributesEnum.AppOrgVO1.index();
    ...
    public static final int LOVWAREHOUSEVO2 = AttributesEnum.LOVWareHouseVO2.index();
    ...
    public Number getAvlQty() {
        ...
        if (getWhIdSrc() != null) {
            ...
            System.out.println("WhId : " + (String)getAttributeInternal(WHIDSRC));
    ...
    public String getItmDescTrans() {
        if(getAttributeInternal(ITMDESCTRANS) == null && getItmId() != null){
           Object itmNmO =  ADFModelUtils.callFunction((ApplicationModuleImpl) this.getApplicationModule(),
                                           new StringBuilder("FN_GET_ITM_DESC_FRM_ID(?,?,?,?)"), 
                                       new Object[]{
                                           getSlocId(),
                                           getCldId(),
                                           getHoOrgId(),
           ...
           if(itmNmO != null){
               setItmDescTrans(itmNmO.toString());
           }
        }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> AppOrgVO1.
     */
    public RowSet getAppOrgVO1() {
        return (RowSet)getAttributeInternal(APPORGVO1);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LOVWareHouseVO2.
     */
    public RowSet getLOVWareHouseVO2() {
        return (RowSet)getAttributeInternal(LOVWAREHOUSEVO2);
    }
