...
public class SlsSoDlvSchdlVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ,
        NewItemNameFromItmIdTrans {
            public Object get(SlsSoDlvSchdlVORowImpl obj) {
                return obj.getNewItemNameFromItmIdTrans();
            }

            public void put(SlsSoDlvSchdlVORowImpl obj, Object value) {
                obj.setNewItemNameFromItmIdTrans((String) value);
            }
        }
        ,
        ItmPickedQtyTrans {
            public Object get(SlsSoDlvSchdlVORowImpl obj) {
                return obj.getItmPickedQtyTrans();
            }

            public void put(SlsSoDlvSchdlVORowImpl obj, Object value) {
                obj.setItmPickedQtyTrans((Number) value);
            }
        }
        ,
        SlsSoItmTrf {
    ...
    public static final int NEWITEMNAMEFROMITMIDTRANS = AttributesEnum.NewItemNameFromItmIdTrans.index();
    public static final int ITMPICKEDQTYTRANS = AttributesEnum.ItmPickedQtyTrans.index();
    ...
    public String getIsItemPicked() {
        if(getAttributeInternal(ISITEMPICKED) == null){
            SLSDlvSchdlAMImpl am = (SLSDlvSchdlAMImpl)this.getApplicationModule();
            ViewObjectImpl slsPick = am.getChkFrPickedItmsVO1();
            slsPick.setNamedWhereClauseParam("CldIdBind", getCldId());
            slsPick.setNamedWhereClauseParam("SlocIdBind", getSlocId());
            slsPick.setNamedWhereClauseParam("OrgIdBind", getOrgId());
            slsPick.setNamedWhereClauseParam("HoOrgIdBind", getHoOrgId());
            slsPick.setNamedWhereClauseParam("SoIdBind", getDocId());
            slsPick.setNamedWhereClauseParam("ItmIdBind", getItmId());
            slsPick.executeQuery();
            Row[] allRowsInRange = slsPick.getAllRowsInRange();
    ...
    /**
     * Gets the attribute value for the calculated attribute NewItemNameFromItmIdTrans.
     * @return the NewItemNameFromItmIdTrans
     */
    public String getNewItemNameFromItmIdTrans() {
        if(getAttributeInternal(NEWITEMNAMEFROMITMIDTRANS) == null && getItmId() != null){
            String descFrmItmId = EbizParamsAPPUtils.getItemDescFrmItmId((ApplicationModuleImpl)getApplicationModule(), getItmId());
            setNewItemNameFromItmIdTrans(descFrmItmId);
        }
       return (String)getAttributeInternal(NEWITEMNAMEFROMITMIDTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute NewItemNameFromItmIdTrans.
     * @param value value to set the  NewItemNameFromItmIdTrans
     */
    public void setNewItemNameFromItmIdTrans(String value) {
        setAttributeInternal(NEWITEMNAMEFROMITMIDTRANS, value);
    }

    /**
     * Gets the attribute value for the calculated attribute ItmPickedQtyTrans.
     * @return the ItmPickedQtyTrans
     */
    public Number getItmPickedQtyTrans() {
        if (getAttributeInternal(ITMPICKEDQTYTRANS) == null) {
            Object callFunction =
                ADFModelUtils.callFunction((ApplicationModuleImpl) getApplicationModule(),
                                           new StringBuilder("SLS.FN_GET_PICK_QTY(?,?,?,?,?,?,?)"), new Object[] {
                                           getCldId(), getSlocId(), getOrgId(), getItmId(), getWhId(), getDlvDt(),
                                           getDocId()
            }, Types.NUMERIC);
            try {
                setItmPickedQtyTrans(callFunction == null ? StaticValue.NUMBER_ZERO : new Number(callFunction));
            } catch (SQLException e) {
                e.printStackTrace();
            }
        }
        return (Number) getAttributeInternal(ITMPICKEDQTYTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ItmPickedQtyTrans.
     * @param value value to set the  ItmPickedQtyTrans
     */
    public void setItmPickedQtyTrans(Number value) {
        setAttributeInternal(ITMPICKEDQTYTRANS, value);
    }
