...
public class SlsSoItemVORowImpl extends ViewRowImpl {
    ...
    public static final int LOVITMBASISVO = AttributesEnum.LOVItmBasisVO.index();
    ...
    public String getItemNmeTrans() {
        if(itmDesc == null && getItmId() != null){
            Object o = EbizParamsAPPUtils.getItemDescFrmItmId(getAm(), getItmId());
            if(o != null){
                itmDesc = o.toString();
            }    
        }
    ...
    public Integer getCustomerId() {
       ...
       // Integer custId =  getAm().getCustmrId();
        //return custId;
     ...
     */
    private Integer custmrId = null;
    public Integer getTransEoId() {
        if(custmrId ==null){
            custmrId = getAm().fatchCustmrId();
        }
        System.out.println( custmrId + " The eo id in trans cusstomer");
        return custmrId;
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LOVItmBasisVO.
     */
    public RowSet getLOVItmBasisVO() {
        return (RowSet) getAttributeInternal(LOVITMBASISVO);
    }
    ...
    /**
     * method to get the AM 
     */
    public SLSDlvSchdlAMImpl getAm(){
        return  (SLSDlvSchdlAMImpl) getApplicationModule();
    }
}
