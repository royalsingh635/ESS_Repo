...
public class SlsQuotationSearchBean {
    ...
    public String createQuotationACTION() {
        OperationBinding binding = this.getBindings().getOperationBinding("getFyIdFromDocIdAndDate");
        binding.execute();
    ...
    public void negativeNumberVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if(object != null){
            ...
            if(i == -1){
                FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.827"),ADFModelUtils.resolvRsrc("MSG.828")+"!");  //"Invalid number!"&& "Cannot enter negative value!"
        ...
        if(object != null){
          ...
          //  System.out.println("Return :"+binding.getResult());
            if(binding.getResult().equals((Object)false)){
                FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,ADFModelUtils.resolvRsrc("MSG.829"),null);  //"From item should be less than or equal to TO Item."  
                throw new ValidatorException(message);
            }
        }
    ...
    public void ItemRangeToVALID(FacesContext facesContext, UIComponent uIComponent, Object object) {
       ...
       // System.out.println("Object :"+object);
        if(object != null){
          ...
          //  System.out.println("Return :"+binding.getResult());
            if(binding.getResult().equals((Object)false)){
                FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,ADFModelUtils.resolvRsrc("MSG.830"),null); //"To item should be greater than or equal to  from Item."   
                throw new ValidatorException(message);
            }
        }
    }
    ...
    public void QuantityRangeFromVALID(FacesContext facesContext, UIComponent uIComponent, Object object) {
       ...
       // System.out.println("Object :"+object);
        if(object != null){
          ...
          //  System.out.println("Return :"+binding.getResult());
            if(binding.getResult().equals((Object)false)){
                FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,ADFModelUtils.resolvRsrc("MSG.831"),null);  //"From Amount should be less than or equal to To amount."  
                throw new ValidatorException(message);
            }
        }
    ...
    public void QuantityRangeToVALID(FacesContext facesContext, UIComponent uIComponent, Object object) {
       ...
       // System.out.println("Object :"+object);
        if(object != null){
           ...
           // System.out.println("Return :"+binding.getResult());
            if(binding.getResult().equals((Object)false)){
                FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,ADFModelUtils.resolvRsrc("MSG.832"),null);  //"To Amount should be greater than or equal to From amount."  
                throw new ValidatorException(message);
            }
        }
