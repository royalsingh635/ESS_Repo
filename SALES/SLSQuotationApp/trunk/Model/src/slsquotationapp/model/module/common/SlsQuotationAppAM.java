...
public interface SlsQuotationAppAM extends ApplicationModule {
    ...
    ArrayList<String> getCustomerSuggestions(String custNm);

    String getFyIdFromDocIdAndDate();

    String getEoPricePlcMethod();

    void setOputunityStatus();

    Integer getItemLineRowCount(String itemNm);

    Boolean insertOtherDetails();

    Boolean validationOnAddItem();
