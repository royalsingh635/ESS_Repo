...
public class OpportunityBean {
    ...
    private RichLink addItemBinding;
    private RichLink editItmBinding;
    ...
    private RichLink itemaddBinding;
    ...
    private RichLink importExcelLinkBind;
        ...
        if (binding.getResult().equals((Boolean) false)) {
            ...
            if (retValfromAmImpl != null && retValfromAmImpl) {
                if (currencyBinding.getValue() != null && currencyBinding.getValue() != "") {
                    ...
                    FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.21")); //Currency is Required
                ...
                FacesMessage message =
                    new FacesMessage(ADFModelUtils.resolvRsrc("MSG.1018")); //Customer Name is Required
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message);
            ...
            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.951"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
    ...
    //Method to get the workflow id for current document
    public Boolean callWfId() {
        Boolean res = false;
        OperationBinding ob = ADFBeanUtils.findOperation("getWfId");
        ob.execute();
        if (ob != null) {
            String wId = (String) ob.getResult();
            // System.out.println(wId + " This is the WorkFlow Id for this document");
            setWfId(wId);
            res = true;
        }
        return res;
    ...
    /**
     *Method to save and forward opportunity
     * @return
     */

    public String saveAndForwardAction() {
        String retur_val = null;
        OperationBinding b = ADFBeanUtils.findOperation("areItemValuesValid");
        b.execute();
        Boolean chk = (Boolean) b.getResult();
        System.out.println("Are Items Valid : " + b.getResult());
        if (chk) {
            if (itmpriceusevalidator && quantityusevalidato) {
                if (callWfId()) {
                    //            ADFBeanUtils.findOperation("Commit").execute();
                    getBindings().getOperationBinding("getDispDocId").execute();
                ...
                if (!itmpriceusevalidator) {
                    FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.1133"));
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                ...
                if (retchkval) {
                    ...
                    if ((!modeItm.equalsIgnoreCase("V")) || (modeOpp.equalsIgnoreCase("E"))) {
                        ...
                        if (Integer.parseInt(ob.getResult().toString()) == 1 ||
                            ...
                            FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.1134"));
                            message.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext fc = FacesContext.getCurrentInstance();
                            fc.addMessage(null, message);
                            ...
                            setModeItm("V");
                            editmode = "V";
                            String msg = ADFModelUtils.resolvRsrc("MSG.818"); //Record Saved Successfully!
                            FacesMessage message = new FacesMessage(msg);
                        ...
                        String msg = ADFModelUtils.resolvRsrc("MSG.952"); //At least one Item detail is necessary
                        FacesMessage message = new FacesMessage(msg);
                        message.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                        fc.addMessage(null, message);
            ...
            if ((eoNameBinding.getValue() != null) && (eoTypeBinding.getValue() != null) &&
                ...
                if (ob.getResult() != null) {
                    ...
                    if (eoidnew.equalsIgnoreCase("true")) {
                        ...
                        FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.1180"));
                        message.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                ...
                FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.117")); //You must enter a value
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(eoNameBinding.getClientId(), message);
            }
    ...
    public void showFacesMessage(String mesg, String sev, Boolean chk, String typFlg, String clientId) {
        ...
        if (chk == true) {
            ...
            String msg = ADFModelUtils.resolvRsrc(mesg);
    ...
    public void resetMasterTable() {
        ...
        OperationBinding resetOB = getBindings().getOperationBinding("");
        resetOB.execute();
    }
        ...
        if (valueChangeEvent.getNewValue() != null) {
            ...
            if (specificAmountItemBinding.getValue() != null) {
                ...
                if (ispositiveNum(amtBs)) {
                    ...
                    FacesMessage message = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.954"));
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void categoryValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            adfLog.info("value :" + object);
            FacesMessage message =
                new FacesMessage(ADFModelUtils.resolvRsrc("MSG.960")); //This field is Mandatory to fill ,You can't left this field blank or null
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
        ...
        if (object != null) {
            ...
            if ("Y".equals(res)) {
                ...
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              ADFModelUtils.resolvRsrc("MSG.46"), null));
            }
            /*  } else {
    ...
    public void itemPriceValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            if (num.compareTo(zero) == -1 || num.compareTo(0) == 0) {
                ...
                showFacesMessage("MSG.1063", "E", true, "V", uIComponent.getClientId()); //Value Must be positive Number
    ...
    public void quantityValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            } else if (!ADFBeanUtils.isPrecisionValid(num)) { //edit for precision on 5th may 2014
                showFacesMessage("MSG.1062", "E", true, "V",
                                 uIComponent.getClientId()); //Invalid Precision.Please put the corrert precision.
            }
        } else {
    ...
    public void setAddItemBinding(RichLink addItemBinding) {
        this.addItemBinding = addItemBinding;
    }

    public RichLink getAddItemBinding() {
        return addItemBinding;
    }

    public void setEditItmBinding(RichLink editItmBinding) {
        this.editItmBinding = editItmBinding;
    }

    public RichLink getEditItmBinding() {
    ...
    public String createOppFromSearch() {
        // Add event code here...
        OperationBinding ob = getBindings().getOperationBinding("getFyIdFromDocIdAndDate");
        ob.execute();
        ...
        if (object != null) {
            ...
            if (od != null) {
                ...
                if (ed.compareTo(od) == -1) {
                    ...
                    throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                  ADFModelUtils.resolvRsrc("MSG.1259"), null));
    ...
    public void CustomerNameValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (matcher.matches()) {
            ...
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                          ADFModelUtils.resolvRsrc("MSG.1056"),
    ...
    public void setItemaddBinding(RichLink itemaddBinding) {
        this.itemaddBinding = itemaddBinding;
    }

    public RichLink getItemaddBinding() {
    ...
    public void ItemIdValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (execute == null || execute.toString().equalsIgnoreCase("Y")) {
            FacesMessage msg = new FacesMessage(ADFModelUtils.resolvRsrc("MSG.427")); //Item already exists
    ...
    public void setImportExcelLinkBind(RichLink importExcelLinkBind) {
        this.importExcelLinkBind = importExcelLinkBind;
    }

    public RichLink getImportExcelLinkBind() {
        return importExcelLinkBind;
    }

    public void oppLostDialogList(DialogEvent dialogEvent) {
        System.out.println("OutCome  : "+dialogEvent.getOutcome());
        //if(dialogEvent.getOutcome())
        ADFBeanUtils.getOperationBinding("markOppAsLost").execute();
        AdfFacesContext.getCurrentInstance().addPartialTarget(lovStatusBind);
    }
}
