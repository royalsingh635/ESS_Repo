...
public class SearchOppVORowImpl extends ViewRowImpl {
    ...
    public static final int OPPMODEDESC = AttributesEnum.OppModeDesc.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute OppModeDesc.
     * @return the OppModeDesc
     */
    public String getOppModeDesc() {
        return (String) getAttributeInternal(OPPMODEDESC);
    }

    /**
     * Gets the attribute value for the calculated attribute OppMode.
     * @return the OppMode
     */
