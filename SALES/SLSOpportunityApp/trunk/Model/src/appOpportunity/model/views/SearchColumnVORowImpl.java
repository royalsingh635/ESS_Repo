...
public class SearchColumnVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        OppModeTrans {
            public Object get(SearchColumnVORowImpl obj) {
                return obj.getOppModeTrans();
            }

            public void put(SearchColumnVORowImpl obj, Object value) {
                obj.setOppModeTrans((Integer) value);
            }
        }
        ,
        SearchColumnVO {
    ...
    public static final int OPPMODETRANS = AttributesEnum.OppModeTrans.index();
    ...
    public Integer getCurrIdTrans() {
        System.out.println("In gettter");
        System.out.println("(Integer) getAttributeInternal(CURRIDTRANS)"+(Integer) getAttributeInternal(CURRIDTRANS));
    ...
    public void setCurrIdTrans(Integer value) {
        System.out.println("In setter::::"+value);
    ...
    public Integer getCurrIdBsTrans() {
        if(getAttributeInternal(CURRIDBSTRANS) == null){
            Integer bsForCurrOrg = EbizParams.getCurrIdBsForCurrOrg((AppOpportunityAMImpl)getApplicationModule());
            setCurrIdBsTrans(bsForCurrOrg);
        }
    ...
    /**
     * Gets the attribute value for the calculated attribute OppModeTrans.
     * @return the OppModeTrans
     */
    public Integer getOppModeTrans() {
        return (Integer) getAttributeInternal(OPPMODETRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute OppModeTrans.
     * @param value value to set the  OppModeTrans
     */
    public void setOppModeTrans(Integer value) {
        setAttributeInternal(OPPMODETRANS, value);
    }
