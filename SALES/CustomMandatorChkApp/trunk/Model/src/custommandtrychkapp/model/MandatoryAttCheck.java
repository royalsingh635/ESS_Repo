...
public class MandatoryAttCheck {
    ...
    private StringBuilder cldId;
    private Integer slocId;
    private StringBuilder orgId;
    private CustomMandatoryChkAMImpl am = null;
    /**
     * Initialising Bean
     * @param appModule
     * @param cldId
     ...
     * @param slocId
     */
    public MandatoryAttCheck(ApplicationModuleImpl appModule, StringBuilder cldId,StringBuilder orgId,Integer slocId ) {
        super();
    ...
    public void setCldId(StringBuilder cldId) {
        this.cldId = cldId;
    }
    ...
    public void setOrgId(StringBuilder orgId) {
        this.orgId = orgId;
    }
    ...
    public Boolean isMandatoryAttributesEntered(Integer docId, StringBuilder viewObjectNm, StringBuilder tableNm,
