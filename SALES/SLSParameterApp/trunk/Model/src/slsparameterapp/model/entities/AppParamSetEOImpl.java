...
// ---    Mon Oct 26 12:08:45 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class AppParamSetEOImpl extends EntityImpl {
    /**
    ...
    public static final int APPPARAM1 = AttributesEnum.AppParam1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public AppParamSetEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("slsparameterapp.model.entities.AppParamSetEO");
    }
     ...
     */
    public RowIterator getAppParam1() {
        return (RowIterator) getAttributeInternal(APPPARAM1);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        setParamSetId(getParamSetIdFromFun(getSlocId(),getCldId(),getHoOrgId(),getHoOrgId(),2078,0,"APP$PARAM$SET",0));
