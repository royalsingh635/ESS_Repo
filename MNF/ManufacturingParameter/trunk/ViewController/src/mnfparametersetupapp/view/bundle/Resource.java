package mnfparametersetupapp.view.bundle;
...
public class Resource extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        try {
             ...
             */
            String p_path = resolvEl("#{pageFlowScope.GLBL_RES_PATH}").toString();
            String p_file=resolvEl("#{pageFlowScope.GLBL_RES_FILE}").toString();
