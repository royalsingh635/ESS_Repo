package mnfroutecard.view.servlet;
...
@WebServlet(name = "RouteCardServletClass", urlPatterns = { "/routecardservletclass" })
public class RouteCardServletClass extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String doc_id = String.valueOf(request.getParameter("RcDocId"));
            System.out.println("Path       "+path);
            JasperReport report =(JasperReport)JRLoader.loadObject(path+"Route_Card_Print.jasper");
            ...
            if (reporttype.equalsIgnoreCase("pdf")) {
                response.setContentType("application/pdf");
                                       response.setHeader("Content-Disposition", "attachement; filename=\"Route_Card_Print.pdf\"");
