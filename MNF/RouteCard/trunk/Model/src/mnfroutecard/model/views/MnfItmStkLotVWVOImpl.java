...
import mnfroutecard.model.views.common.MnfItmStkLotVWVO;
...
// ---    Thu Oct 02 17:00:34 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfItmStkLotVWVOImpl extends ViewObjectImpl implements MnfItmStkLotVWVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfItmStkLotVWVOImpl() {
    }
        ...
        for (Row r : rr) {
            if (r.getAttribute("TransIssuQtyValue") != null) {
                if (((Number) r.getAttribute("TransIssuQtyValue")).compareTo(zero) > 0) {
                    ...
                    System.out.println("The total issue qty fr itm is : " +totIssue );
                }
            }
        }
        return totIssue;
