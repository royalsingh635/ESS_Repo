...
import mnfroutecard.model.views.common.MnfItmStkBinRqmtVwVO;
...
// ---    Tue Jan 13 16:27:07 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfItmStkBinRqmtVwVOImpl extends ViewObjectImpl implements MnfItmStkBinRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfItmStkBinRqmtVwVOImpl() {
    }
    ...
    /**
     * Returns the bind variable value for BindRqmtArId.
     * @return bind variable value for BindRqmtArId
     */
    public Integer getBindRqmtArId() {
        return (Integer) getNamedWhereClauseParam("BindRqmtArId");
    }

    /**
     * Sets <code>value</code> for bind variable BindRqmtArId.
     * @param value value to bind as BindRqmtArId
     */
    public void setBindRqmtArId(Integer value) {
        setNamedWhereClauseParam("BindRqmtArId", value);
    }
    
    /**Method to calculate total issue quantity
     * @return
     */
    public Number getTotalIssueQtyBin_SF() {
        ...
        for (Row r : rr) {
            if (r.getAttribute("TransIssueQty_SF") != null) {
                if (((Number) r.getAttribute("TransIssueQty_SF")).compareTo(zero) > 0) {
                    totIssue = totIssue.add((Number) r.getAttribute("TransIssueQty_SF"));
                    System.out.println("total qty issue is : " + totIssue);
                }
            }
        }
        return totIssue;
