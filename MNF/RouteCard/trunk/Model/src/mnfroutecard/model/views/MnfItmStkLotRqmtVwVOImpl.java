...
import mnfroutecard.model.views.common.MnfItmStkLotRqmtVwVO;
...
// ---    Tue Jan 13 14:41:14 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfItmStkLotRqmtVwVOImpl extends ViewObjectImpl implements MnfItmStkLotRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfItmStkLotRqmtVwVOImpl() {
    }
     ...
     */
    public Number getTotalIssueQtyLot_SF() {
        ...
        for (Row r : rr) {
            if (r.getAttribute("TransIssuQtyValue_SF") != null) {
                if (((Number) r.getAttribute("TransIssuQtyValue_SF")).compareTo(zero) > 0) {
                    totIssue = totIssue.add((Number) r.getAttribute("TransIssuQtyValue_SF"));
                }
            }
        }
        return totIssue;
