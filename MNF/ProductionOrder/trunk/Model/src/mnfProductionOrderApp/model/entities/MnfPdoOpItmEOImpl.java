...
// ---    Fri Sep 19 14:31:18 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfPdoOpItmEOImpl extends EntityImpl {
    /**
    ...
    public static final int MNFPDOEO1 = AttributesEnum.MnfPDOEO1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MnfPdoOpItmEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("mnfProductionOrderApp.model.entities.MnfPdoOpItmEO");
    }
    ...
    /**
     * @return the associated entity MnfPdoOpEOImpl.
     */
    public MnfPdoOpEOImpl getMnfPdoOpEO() {
        return (MnfPdoOpEOImpl) getAttributeInternal(MNFPDOOPEO);
    }

    /**
     * Sets <code>value</code> as the associated entity MnfPdoOpEOImpl.
     */
    public void setMnfPdoOpEO(MnfPdoOpEOImpl value) {
        setAttributeInternal(MNFPDOOPEO, value);
    }
     ...
     * @return the associated entity MnfPDOEOImpl.
     */
    public MnfPDOEOImpl getMnfPDOEO1() {
        return (MnfPDOEOImpl) getAttributeInternal(MNFPDOEO1);
    }

    /**
     * Sets <code>value</code> as the associated entity MnfPDOEOImpl.
     */
    public void setMnfPDOEO1(MnfPDOEOImpl value) {
        setAttributeInternal(MNFPDOEO1, value);
    }
    ...
    public static Key createPrimaryKey(String cldId, Integer slocId, String hoOrgId, String docId, String opId,
                                       Number opSrNo, Integer itmType, String itmId) {
        return new Key(new Object[] { cldId, slocId, hoOrgId, docId, opId, opSrNo, itmType, itmId });
    }
