...
// ---    Mon Nov 17 18:02:53 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class PDOSearchVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public PDOSearchVOImpl() {
    }

    /**
     * Returns the bind variable value for BindPdoId.
     * @return bind variable value for BindPdoId
     */
    public String getBindPdoId() {
        return (String) getNamedWhereClauseParam("BindPdoId");
    }

    /**
     * Sets <code>value</code> for bind variable BindPdoId.
     * @param value value to bind as BindPdoId
     */
    public void setBindPdoId(String value) {
        setNamedWhereClauseParam("BindPdoId", value);
    }

    /**
     * Returns the bind variable value for BindCreateDt.
     * @return bind variable value for BindCreateDt
     */
    public Timestamp getBindCreateDt() {
        return (Timestamp) getNamedWhereClauseParam("BindCreateDt");
    }

    /**
     * Sets <code>value</code> for bind variable BindCreateDt.
     * @param value value to bind as BindCreateDt
     */
    public void setBindCreateDt(Timestamp value) {
        setNamedWhereClauseParam("BindCreateDt", value);
    }

    /**
     * Returns the bind variable value for BindCreateToDt.
     * @return bind variable value for BindCreateToDt
     */
    public Timestamp getBindCreateToDt() {
        return (Timestamp) getNamedWhereClauseParam("BindCreateToDt");
    }

    /**
     * Sets <code>value</code> for bind variable BindCreateToDt.
     * @param value value to bind as BindCreateToDt
     */
    public void setBindCreateToDt(Timestamp value) {
        setNamedWhereClauseParam("BindCreateToDt", value);
    }
    ...
    /**
     * Returns the bind variable value for BindBomId.
     * @return bind variable value for BindBomId
     */
    public String getBindBomId() {
        return (String) getNamedWhereClauseParam("BindBomId");
    }

    /**
     * Sets <code>value</code> for bind variable BindBomId.
     * @param value value to bind as BindBomId
     */
    public void setBindBomId(String value) {
        setNamedWhereClauseParam("BindBomId", value);
    }

    /**
     * Returns the bind variable value for BindRtId.
     * @return bind variable value for BindRtId
     */
    public String getBindRtId() {
        return (String) getNamedWhereClauseParam("BindRtId");
    }

    /**
     * Sets <code>value</code> for bind variable BindRtId.
     * @param value value to bind as BindRtId
     */
    public void setBindRtId(String value) {
        setNamedWhereClauseParam("BindRtId", value);
    }
