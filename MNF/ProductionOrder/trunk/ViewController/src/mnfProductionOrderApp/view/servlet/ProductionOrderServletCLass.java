package mnfProductionOrderApp.view.servlet;
...
@WebServlet(name = "ProductionOrderServletCLass", urlPatterns = { "/productionorderservletclass" })
public class ProductionOrderServletCLass extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String doc_id = String.valueOf(request.getParameter("PdoDocId"));
            System.out.println("Path       "+path );
            System.out.println("" + doc_id +"  " + cld_id +" "+sloc_id + org_id + ho_org_id);
            JasperReport report =(JasperReport)JRLoader.loadObject(path+"Production_Order_Print.jasper");
            String reporttype =  "pdf";
                            ...
                            parameters.put("PdoDocId", doc_id);
            ...
            if (reporttype.equalsIgnoreCase("pdf")) {
                response.setContentType("application/pdf");
                                       response.setHeader("Content-Disposition", "attachement; filename=\"PDO.pdf\"");
