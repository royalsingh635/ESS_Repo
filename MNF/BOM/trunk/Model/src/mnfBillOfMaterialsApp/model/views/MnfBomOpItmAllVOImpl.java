...
// ---    Thu Oct 16 10:56:39 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfBomOpItmAllVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfBomOpItmAllVOImpl() {
    }

    /**
     * Returns the variable value for BindSlcId.
     * @return variable value for BindSlcId
     */
    public Integer getBindSlcId() {
        return (Integer) ensureVariableManager().getVariableValue("BindSlcId");
    }

    /**
     * Sets <code>value</code> for variable BindSlcId.
     * @param value value to bind as BindSlcId
     */
    public void setBindSlcId(Integer value) {
        ensureVariableManager().setVariableValue("BindSlcId", value);
    }

    /**
     * Returns the variable value for BindItmtype.
     * @return variable value for BindItmtype
     */
    public Integer getBindItmtype() {
        return (Integer) ensureVariableManager().getVariableValue("BindItmtype");
    }

    /**
     * Sets <code>value</code> for variable BindItmtype.
     * @param value value to bind as BindItmtype
     */
    public void setBindItmtype(Integer value) {
        ensureVariableManager().setVariableValue("BindItmtype", value);
    }
