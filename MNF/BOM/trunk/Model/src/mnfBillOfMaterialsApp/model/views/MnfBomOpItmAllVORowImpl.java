...
// ---    Mon Oct 06 17:15:42 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfBomOpItmAllVORowImpl extends ViewRowImpl {
    ...
    public static final int ITMDESCALL = AttributesEnum.ItmDescAll.index();
    public static final int PRNCPLINPT = AttributesEnum.PrncplInpt.index();
    public static final int OPDESCALL = AttributesEnum.OpDescAll.index();
    public static final int LOVITEMTYPEVO = AttributesEnum.LOVItemTypeVO.index();
    public static final int LOVOPERATIONVO = AttributesEnum.LOVOperationVO.index();
     ...
     */
    public MnfBomOpItmAllVORowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute ItmDescAll.
     * @return the ItmDescAll
     */
    public String getItmDescAll() {
        if (getItmId() != null) {
        ...
        return (String) getAttributeInternal(ITMDESCALL);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ItmDescAll.
     * @param value value to set the  ItmDescAll
     */
    public void setItmDescAll(String value) {
        setAttributeInternal(ITMDESCALL, value);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute OpDescAll.
     * @return the OpDescAll
     */
    public String getOpDescAll() {
        if (getOpId() != null) {
        ...
        return (String) getAttributeInternal(OPDESCALL);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute OpDescAll.
     * @param value value to set the  OpDescAll
     */
    public void setOpDescAll(String value) {
        setAttributeInternal(OPDESCALL, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LOVOperationVO.
     */
    public RowSet getLOVOperationVO() {
        return (RowSet) getAttributeInternal(LOVOPERATIONVO);
    }
