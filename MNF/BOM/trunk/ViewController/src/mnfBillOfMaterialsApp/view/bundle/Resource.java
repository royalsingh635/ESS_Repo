package mnfBillOfMaterialsApp.view.bundle;
...
public class Resource extends ListResourceBundle {
    ...
    private static final Object[][] contents = new Object[20000][2];
    ...
    public Object[][] getContents() {
        try {
            ...
            if (JSFUtils.resolveExpression("#{pageFlowScope.GLBL_RES_PATH}") != null) {
                p_path = JSFUtils.resolveExpression("#{pageFlowScope.GLBL_RES_PATH}").toString();
            }

            if (JSFUtils.resolveExpression("#{pageFlowScope.GLBL_RES_FILE}") != null) {
                p_file = JSFUtils.resolveExpression("#{pageFlowScope.GLBL_RES_FILE}").toString();
            }

            adflog.info("     " + p_path + "    " + p_file);

            String path = "home/mousham/DeployMent/Resource/";
