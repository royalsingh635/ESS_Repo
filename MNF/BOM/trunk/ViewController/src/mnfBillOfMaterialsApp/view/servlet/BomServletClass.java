...
@WebServlet(name = "BomServletClass", urlPatterns = { "/bomservletclass" })
public class BomServletClass extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String doc_id = String.valueOf(request.getParameter("BomDocId"));
            System.out.println("Path       "+path);
            JasperReport report =(JasperReport)JRLoader.loadObject(path+"BOM_Explosion.jasper");
            String reporttype =  "pdf";
                            ...
                            parameters.put("BomDocId", doc_id);
            ...
            if (reporttype.equalsIgnoreCase("pdf")) {
                response.setContentType("application/pdf");
                                       response.setHeader("Content-Disposition", "attachement; filename=\"BOM.pdf\"");
