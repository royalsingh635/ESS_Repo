package mnfWorkStationApp.view.Utils;

import java.io.InputStream;

import org.apache.myfaces.trinidad.model.UploadedFile;

public class wsAttachDocument {
    ...
    public wsAttachDocument() {
        
    }

    public wsAttachDocument(String filename, String attchedFileExtension, String attchedFilePath,
                         String attchedFileDispName, InputStream file, String ext){
        super();
        System.out.println("inside wsattachdoc java class");
    ...
    public void setFileInputStream(InputStream fileInputStream) {
        System.out.println("Fileinputstream at wsattachdoc  " + fileInputStream);
