...
// ---    Fri May 22 19:06:23 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfAdhocOutItmVORowImpl extends ViewRowImpl {
     ...
     */
    public MnfAdhocOutItmVORowImpl() {
    }
    ...
    public String getItemDescTrans() {
        ...
        if(this.getItmId()!=null){
            Row[] rw=this.getLOVItemNameVO1().getFilteredRows("ItmId", this.getItmId());
            if(rw.length>0){
