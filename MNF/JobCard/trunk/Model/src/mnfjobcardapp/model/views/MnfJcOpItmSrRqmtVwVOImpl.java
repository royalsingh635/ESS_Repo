...
import mnfjobcardapp.model.views.common.MnfJcOpItmSrRqmtVwVO;
...
// ---    Wed Jan 07 13:20:45 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJcOpItmSrRqmtVwVOImpl extends ViewObjectImpl implements MnfJcOpItmSrRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfJcOpItmSrRqmtVwVOImpl() {
    }
     ...
     * @return
     */
    public Number getTotalIssueQtySrSF() {
        int totalCount = this.getRowCount();
        this.setRangeSize(totalCount);
        Row[] rr = this.getAllRowsInRange();
        Number totIssue = new Number(0);
        for (Row r : rr) {
            if (r.getAttribute("SelectSrNoStkTransSF") != null) {
                if ("Y".equalsIgnoreCase(r.getAttribute("SelectSrNoStkTransSF").toString())) {
