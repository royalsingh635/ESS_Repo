...
import mnfjobcardapp.model.views.common.MnfJcOpItmBinRqmtVwVO;
...
// ---    Wed Jan 07 17:41:34 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJcOpItmBinRqmtVwVOImpl extends ViewObjectImpl implements MnfJcOpItmBinRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfJcOpItmBinRqmtVwVOImpl() {
    }
    ...
    /**Method to calculate total issue quantity
         * @return
         */
        public Number getTotalIssueQtyBinSF() {
            ...
            for (Row r : rr) {
                if (r.getAttribute("TransIssueQtySF") != null) {
                    if (((Number) r.getAttribute("TransIssueQtySF")).compareTo(zero) > 0) {
                        totIssue = totIssue.add((Number) r.getAttribute("TransIssueQtySF"));
                    }
                }
            }
            return totIssue;
