...
import mnfjobcardapp.model.views.common.MnfJcOpItmLotRqmtVwVO;
...
// ---    Wed Jan 07 15:38:45 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJcOpItmLotRqmtVwVOImpl extends ViewObjectImpl implements MnfJcOpItmLotRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfJcOpItmLotRqmtVwVOImpl() {
    }
    ...
    /**
         ...
         */
        public Number getTotalIssueQtyLotSF() {
            ...
            for (Row r : rr) {
                if (r.getAttribute("TransIssuQtyValueSF") != null) {
                    if (((Number) r.getAttribute("TransIssuQtyValueSF")).compareTo(zero) > 0) {
                        totIssue = totIssue.add((Number) r.getAttribute("TransIssuQtyValueSF"));
                    }
                }
            }
            return totIssue;
