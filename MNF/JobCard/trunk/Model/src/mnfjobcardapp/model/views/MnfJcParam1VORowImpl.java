...
// ---    Thu Sep 25 14:39:31 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJcParam1VORowImpl extends ViewRowImpl {
    ...
    private static ADFLogger adfLog = (ADFLogger) ADFLogger.createADFLogger(MnfJcParam1VORowImpl.class);
    ...
    public void setParamId(String value) {
        System.out.println("Parameter Name : "+getTransParamNm());
        if(!getAm().duplicateParamEo1(getTransParamNm())){
    ...
    public String getTransParamNm() {
        if(this.getParamId() != null){
             ViewObjectImpl impl = getAm().getLOVMnfJcParamMDTFetch1();
    ...
    /**
     * Gets the attribute value for the calculated attribute TransNmParam.
     * @return the TransNmParam
     */
    public String getTransNmParam() {
        if(this.getParamId() != null){
             ViewObjectImpl impl = getAm().getLOVMnfJcParamMDTFetch1();
             Row[] r = impl.getFilteredRows("ParamId", this.getParamId());
                   if(r.length > 0){
        ...
        return (String) getAttributeInternal(TRANSNMPARAM);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransNmParam.
     * @param value value to set the  TransNmParam
     */
    public void setTransNmParam(String value) {
        setAttributeInternal(TRANSNMPARAM, value);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransOperNm.
     * @return the TransOperNm
     */
    public String getTransOperNm() {
        ...
        return (String) getAttributeInternal(TRANSOPERNM);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransOperNm.
     * @param value value to set the  TransOperNm
     */
    public void setTransOperNm(String value) {
        setAttributeInternal(TRANSOPERNM, value);
    }
