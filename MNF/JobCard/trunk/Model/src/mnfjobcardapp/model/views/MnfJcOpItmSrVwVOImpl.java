...
import mnfjobcardapp.model.views.common.MnfJcOpItmSrVwVO;
...
// ---    Wed Oct 08 17:31:33 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJcOpItmSrVwVOImpl extends ViewObjectImpl implements MnfJcOpItmSrVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfJcOpItmSrVwVOImpl() {
    }
    ...
    public Number getTotalIssueQtySr() {
        ...
        for (Row r : rr) {
            if (r.getAttribute("SelectSrNoStkTrans") != null) {
                if ("Y".equalsIgnoreCase(r.getAttribute("SelectSrNoStkTrans").toString())) {
