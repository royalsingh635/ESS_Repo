...
import mnfjobcardexecutionapp.model.views.common.MNFJeOpItmLotRqmtVwVO;
...
// ---    Tue Jan 06 12:19:04 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MNFJeOpItmLotRqmtVwVOImpl extends ViewObjectImpl implements MNFJeOpItmLotRqmtVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MNFJeOpItmLotRqmtVwVOImpl() {
    }
    ...
    /**
             ...
             */
            public Number getTotalManualIssueQtyLot() {
                ...
                for (Row r : rr) {
                    if (r.getAttribute("transManualIssuQtyValue") != null) {
                        if (((Number) r.getAttribute("transManualIssuQtyValue")).compareTo(zero) > 0) {
                            totIssue = totIssue.add((Number) r.getAttribute("transManualIssuQtyValue"));
                            System.out.println("Total Issue : "+totIssue);
                        }
                    }
                }
                return totIssue;
