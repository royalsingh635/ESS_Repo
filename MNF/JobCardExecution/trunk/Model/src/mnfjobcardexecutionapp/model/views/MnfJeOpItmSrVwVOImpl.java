...
import mnfjobcardexecutionapp.model.views.common.MnfJeOpItmSrVwVO;
...
// ---    Thu Dec 18 13:38:12 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJeOpItmSrVwVOImpl extends ViewObjectImpl implements MnfJeOpItmSrVwVO {
    /**
     * This is the default constructor (do not remove).
     */
    public MnfJeOpItmSrVwVOImpl() {
    }
    ...
    /**
        ...
        public Number getTotalIssueQtySr() {
            ...
            for (Row r : rr) {
                if (r.getAttribute("transSelectSrNoStk") != null) {
                    if ("Y".equalsIgnoreCase(r.getAttribute("transSelectSrNoStk").toString())) {
