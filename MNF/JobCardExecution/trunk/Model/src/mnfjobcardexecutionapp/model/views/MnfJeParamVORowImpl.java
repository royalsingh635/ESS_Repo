...
// ---    Sat Nov 29 10:03:03 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MnfJeParamVORowImpl extends ViewRowImpl {
    ...
    public static final int TRANSPARAMUOM = AttributesEnum.transParamUOM.index();
    ...
    public static final int TRANSOPNMDESC = AttributesEnum.transOpNmDesc.index();
    ...
    public void setParamId(String value) {
          if(!getAM().duplicateOverheadParam(gettransParamDesc())){
    ...
    /**
     * Gets the attribute value for the calculated attribute transParamUOM.
     * @return the transParamUOM
     */
    public String gettransParamUOM() {
        return (String) getAttributeInternal(TRANSPARAMUOM);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute transParamUOM.
     * @param value value to set the  transParamUOM
     */
    public void settransParamUOM(String value) {
        setAttributeInternal(TRANSPARAMUOM, value);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute transOpNmDesc.
     * @return the transOpNmDesc
     */
    public String gettransOpNmDesc() {
        if(getOpId()!=null){
        ...
        return (String) getAttributeInternal(TRANSOPNMDESC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute transOpNmDesc.
     * @param value value to set the  transOpNmDesc
     */
    public void settransOpNmDesc(String value) {
        setAttributeInternal(TRANSOPNMDESC, value);
    }
