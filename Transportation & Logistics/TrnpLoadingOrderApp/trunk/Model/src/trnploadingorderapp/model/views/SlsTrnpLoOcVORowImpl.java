...
import trnploadingorderapp.model.entities.SlsTrnpLoOcEOImpl;
import trnploadingorderapp.model.services.TrnpLoadingOrderAMImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Fri Jun 12 12:25:46 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SlsTrnpLoOcVORowImpl extends ViewRowImpl {
    public static final int ENTITY_SLSTRNPLOOCEO = 0;
     ...
     */
    public SlsTrnpLoOcVORowImpl() {
    }

    /**
     * Gets SlsTrnpLoOcEO entity object.
     * @return the SlsTrnpLoOcEO
     */
    public SlsTrnpLoOcEOImpl getSlsTrnpLoOcEO() {
        return (SlsTrnpLoOcEOImpl) getEntity(ENTITY_SLSTRNPLOOCEO);
    }
    ...
    public String getTransCoaNm() {
        if (this.getCoaId() != null) {
            return this.getAm().getCoaNameBasedOnId(this.getCoaId());
        }
    ...
    public String getTransOcCat() {
        if (this.getOcCat() != null) {
            Row[] fr = this.getAm().getLOVOcCatVO1().getFilteredRows("OcCatId", this.getOcCat());
            if (fr.length > 0)
