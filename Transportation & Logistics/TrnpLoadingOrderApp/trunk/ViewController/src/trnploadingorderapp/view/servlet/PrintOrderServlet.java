package trnploadingorderapp.view.servlet;
...
public class PrintOrderServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if((request.getParameter("LoId") != null) && (!request.getParameter("LoId").toString().equalsIgnoreCase(" ")))
                loId = request.getParameter("LoId");
            
            System.out.println("LoId is :: "+loId);
            ...
            response.setHeader("Content-Disposition", "attachement; filename=\"" + loId + ".pdf\"");
