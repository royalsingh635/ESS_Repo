...
// ---------------------------------------------------------------------
public class SlsTrnpRoutePrfVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public SlsTrnpRoutePrfVOImpl() {
    }
    ...
    /**
     * Returns the variable value for BindRoutePflName.
     * @return variable value for BindRoutePflName
     */
    public String getBindRoutePflName() {
        return (String) ensureVariableManager().getVariableValue("BindRoutePflName");
    }

    /**
     * Sets <code>value</code> for variable BindRoutePflName.
     * @param value value to bind as BindRoutePflName
     */
    public void setBindRoutePflName(String value) {
        ensureVariableManager().setVariableValue("BindRoutePflName", value);
    }
    ...
    /**
     * Returns the variable value for SearchPopup.
     * @return variable value for SearchPopup
     */
    public String getSearchPopup() {
        return (String) ensureVariableManager().getVariableValue("SearchPopup");
    }

    /**
     * Sets <code>value</code> for variable SearchPopup.
     * @param value value to bind as SearchPopup
     */
    public void setSearchPopup(String value) {
        ensureVariableManager().setVariableValue("SearchPopup", value);
    }
}
