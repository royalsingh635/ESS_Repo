...
// ---    Wed Jun 17 15:58:44 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SlsTrnpOlOcVORowImpl extends ViewRowImpl {
    private static ADFLogger _log = ADFLogger.createADFLogger(SlsTrnpOlOcVORowImpl.class);

    public static final int ENTITY_SLSTRNPOLOCEO = 0;
     ...
     */
    public SlsTrnpOlOcVORowImpl() {
    }

    /**
     * Gets SlsTrnpOlOcEO entity object.
     * @return the SlsTrnpOlOcEO
     */
    public EntityImpl getSlsTrnpOlOcEO() {
        return (EntityImpl) getEntity(ENTITY_SLSTRNPOLOCEO);
    }
    ...
    public String getTransOcNm() {
        if (getAttributeInternal(TRANSOCNM) != null)
    ...
    public String getTransOcCat() {
        if (getAttributeInternal(TRANSOCCAT) != null)
