...
// ---    Wed Jun 17 16:38:48 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SlsTrnpOcVwVORowImpl extends ViewRowImpl {
    /**
    ...
    public String getIsOcInUse() {
        ...
        Row fr[] = am.getSlsTrnpOlOc().getFilteredRows("OcId", this.getOcId());
        if (fr.length > 0)
            return "Y";
        else
            return "N";
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute IsOcInUse.
     * @param value value to set the  IsOcInUse
     */
