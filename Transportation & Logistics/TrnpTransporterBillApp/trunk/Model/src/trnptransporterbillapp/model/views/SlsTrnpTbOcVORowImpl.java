...
import trnptransporterbillapp.model.entities.SlsTrnpTbOcEOImpl;
import trnptransporterbillapp.model.services.TrnpTransporterBillAMImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Thu Jun 18 17:40:27 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SlsTrnpTbOcVORowImpl extends ViewRowImpl {
    public static final int ENTITY_SLSTRNPTBOCEO = 0;
    ...
    public static final int LOVOCCATVO1 = AttributesEnum.LOVOcCatVO1.index();

    /**
     * This is the default constructor (do not remove).
     */
    public SlsTrnpTbOcVORowImpl() {
    }

    /**
     * Gets SlsTrnpTbOcEO entity object.
     * @return the SlsTrnpTbOcEO
     */
    public SlsTrnpTbOcEOImpl getSlsTrnpTbOcEO() {
        return (SlsTrnpTbOcEOImpl) getEntity(ENTITY_SLSTRNPTBOCEO);
    }
    ...
    public String getTransCoaNm() {
        if (this.getCoaId() != null) {
            this.getAm().getLOVCoaIdVO1().setNamedWhereClauseParam("BindCldId", this.getCldId());
            this.getAm().getLOVCoaIdVO1().setNamedWhereClauseParam("BindSlocId", this.getSlocId());
            this.getAm().getLOVCoaIdVO1().setNamedWhereClauseParam("BindHoOrgId", this.getHoOrgId());
            this.getAm().getLOVCoaIdVO1().setNamedWhereClauseParam("BindOrgId", this.getOrgId());
            this.getAm().getLOVCoaIdVO1().setNamedWhereClauseParam("BindCoaId", this.getCoaId());
            this.getAm().getLOVCoaIdVO1().executeQuery();
            Row fr[] = this.getAm().getLOVCoaIdVO1().getFilteredRows("OrgCoaId", this.getCoaId());
            if (fr.length > 0)
    ...
    public String getTransCurrDesc() {
        if (this.getCurrId() != null) {
            ...
            currVO1.setNamedWhereClauseParam("BindCurrId", this.getCurrId());
    ...
    public String getTransOcNm() {
        if (this.getOcId() != null) {
            Row fr[] = this.getAm().getVwSlsTrnpOcVwVO1().getFilteredRows("OcId", this.getOcId());
            if (fr.length > 0)
    ...
    public String getTransOcCat() {
        if (this.getOcCat() != null) {
            Row[] fr = this.getLOVOcCatVO1().getFilteredRows("OcCatId", this.getOcCat());
            if (fr.length > 0)
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LOVOcCatVO1.
     */
    public RowSet getLOVOcCatVO1() {
        return (RowSet) getAttributeInternal(LOVOCCATVO1);
    }
