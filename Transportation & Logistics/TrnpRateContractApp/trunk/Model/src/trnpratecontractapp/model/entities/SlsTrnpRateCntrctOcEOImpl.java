...
// ---    Fri Jun 05 15:28:36 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SlsTrnpRateCntrctOcEOImpl extends EntityImpl {
    /**
     ...
     */
    public SlsTrnpRateCntrctOcEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("trnpratecontractapp.model.entities.SlsTrnpRateCntrctOcEO");
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        this.setAmtSp(new Number(0));
        this.setAmtBs(new Number(0));
        this.setAmtSpOc(new Number(0));
