...
public class ScrapSlsBean {
    ...
    public void editActionListner(ActionEvent actionEvent) {
        ...
        if (userId.compareTo(new Integer(-1)) == 0 || userId.compareTo(usr_Id) == 0) {
            ...
            // String msg1="This Scrap Sales is Pending at [";
            //String msg2="]. You can't Edit this Scrap Sales.";
            String msg1 = resolvElDCMsg("#{bundle['MSG.2034']}").toString();
            String msg2 = resolvElDCMsg("#{bundle['MSG.2036']}").toString();
    ...
    public void saveActionListner(ActionEvent actionEvent) {
        ...
        if ("Y".equalsIgnoreCase(result)) {
            ...
            if (WfNum != null) {
                ...
                //String msg="Workflow not Created for Scrap Sales";
                String msg = resolvElDCMsg("#{bundle['MSG.2038']}").toString();
                showFacesMessage(msg, "E", false, "F", null);
                //         return null;
            }
        }
    ...
    public void addItemActionListener(ActionEvent actionEvent) {
        ...
        if (flag.equalsIgnoreCase("Y")) {
            ...
            String msg = resolvElDCMsg("#{bundle['MSG.2039']}").toString();
            FacesMessage message = new FacesMessage(msg);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void itmQtyBsValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            if (i1.compareTo(zero) == 0 || i1.compareTo(zero) == -1) {
                ...
                String error = resolvElDCMsg("#{bundle['MSG.2040']}").toString();
            ...
            System.out.println("value ogf input valid" + inptvalid);
            inptvalid.getParamsMap().put("itmBsQty", i1);
            inptvalid.execute();
            String temp = null;
            if (inptvalid.getErrors() != null) {
                System.out.println("value of input valid" + inptvalid.getErrors());
            ...
            if ("Y".equalsIgnoreCase(temp)) {
                ...
                String error1 = resolvElDCMsg("#{bundle['MSG.2041']}").toString();
    ...
    public void lotQtyValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            if (i1.compareTo(zero) == -1) {
                ...
                String error = resolvElDCMsg("#{bundle['MSG.1063']}").toString();
            ...
            if (flag) {
                ...
                String msg = resolvElDCMsg("#{bundle['MSG.57']}").toString();
            ...
            if (i1.compareTo(avlStk) == 0 || i1.compareTo(avlStk) == -1) {
                ...
                //String msg = "Stock Not Available in selected lot";
                String msg = resolvElDCMsg("#{bundle['MSG.1213']}").toString();
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg, null));
    ...
    public void lotSrDialogListner(DialogEvent dialogEvent) {
        ...
        if (dialogEvent.getOutcome().name().equals("ok")) {
            ...
            if ("Y".equalsIgnoreCase(temp)) {
                ...
                //String msg = "Total Quantity must be less than given quantity";
                String msg = resolvElDCMsg("#{bundle['MSG.2043']}").toString();
                FacesMessage message = new FacesMessage(msg);
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message);
    ...
    public String saveNFwdAction() {
        ...
        if (userId.compareTo(new Integer(-1)) == 0 || userId.compareTo(usr_Id) == 0) {
            ...
            if (getusrname.getErrors().size() == 0 && getusrname.getResult() != null)
                name = (String) getusrname.getResult();
            //String msg1 = "This Scrap Sales is Pending at [";
            //String msg2 = "]. You can't forward this Scrap Sales.";
            String msg1 = resolvElDCMsg("#{bundle['MSG.2034']}").toString();
            String msg2 = resolvElDCMsg("#{bundle['MSG.2045']}").toString();
            String msg = msg1 + name + msg2;
            FacesMessage message = new FacesMessage(msg);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void ScrpPriceValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (new BigDecimal(object.toString()).compareTo(BigDecimal.ZERO) == -1) {
            //String msg = "Price Must be Greater than Zero";
            String msg = resolvElDCMsg("#{bundle['MSG.2046']}").toString();
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg + "", null));
        }
