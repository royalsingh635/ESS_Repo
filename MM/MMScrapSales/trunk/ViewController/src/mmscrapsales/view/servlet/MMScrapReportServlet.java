package mmscrapsales.view.servlet;
...
public class MMScrapReportServlet extends HttpServlet {
    ...
    private void openReportFun(HttpServletRequest request, HttpServletResponse response) throws ServletException,
            ...
            try{
                ...
                System.out.println(" orgId  "+orgId+" cldId  "+cldId+" slocId "+slocId+" DocId "+DocId);
                        ...
                        path =path+"MM/";
                                        ...
                                        JasperReport report =(JasperReport)JRLoader.loadObject(path+"Scrap_Sales.jasper");
                    //    am.openReportUpdate(paramDocId,usrId);
                        ...
                        parameters.put("ItmId",null);
                                      ...
                                      String fileName = "Scrap_Sales"+".pdf";
