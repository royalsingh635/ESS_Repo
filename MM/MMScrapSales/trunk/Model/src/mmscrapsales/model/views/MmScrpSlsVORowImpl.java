...
public class MmScrpSlsVORowImpl extends ViewRowImpl {
    ...
    public static final int LOVCSTMRNMVO1 = AttributesEnum.LovCstmrNmVO1.index();
    ...
    public String getTransCoaNm() {
        ...
        if (getCoaId() != null) {
            ...
            coavo.setNamedWhereClauseParam("bindCoaHoOrgId", this.getTransHoOrgId());
    ...
    public String getTransEoNm() {
        if (getEoId() != null) {
            ...
            cstmrvo.setNamedWhereClauseParam("bindEoHoOrgId", this.getTransHoOrgId());
    ...
    public String gettransVoucherId() {
        if (this.getAuthStat() != null && this.getAuthStat().equals("Y")) {
            String VouId = null;
            VouId = callStoredFunction(Types.VARCHAR, "MM.MM_GET_RCPT_PROV_GL (?,?,?,?,?,?)", new Object[] {
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LovCstmrNmVO1.
     */
    public RowSet getLovCstmrNmVO1() {
        return (RowSet) getAttributeInternal(LOVCSTMRNMVO1);
    }
