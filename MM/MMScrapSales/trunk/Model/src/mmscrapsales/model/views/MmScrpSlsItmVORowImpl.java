...
public class MmScrpSlsItmVORowImpl extends ViewRowImpl {
    ...
    public Number getTransAvlQty() {
        ...
        if (getItmId() != null) {
            MmScrapSalesAMImpl am = (MmScrapSalesAMImpl) this.getApplicationModule();
            am.getLovStkSummItm().setNamedWhereClauseParam("BindCldId", getCldId());
            am.getLovStkSummItm().setNamedWhereClauseParam("BindSlocId", getSlocId());
            am.getLovStkSummItm().setNamedWhereClauseParam("BindOrgId", getOrgId());
            am.getLovStkSummItm().setNamedWhereClauseParam("bindWhId", getWhId());
            am.getLovStkSummItm().executeQuery();
