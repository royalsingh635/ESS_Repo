...
public class TransferOrderAddBean {
    ...
    ADFLogger _log = (ADFLogger) ADFLogger.createADFLogger(TransferOrderAddBean.class);
    ...
    public void saveTransferOrderActionListener(ActionEvent actionEvent) {
        if (trfDateBind.getValue() != null) {
                ...
                if (trfTypeBind.getValue() != null) {
                    if (warehouseSrcBind.getValue() != null) {
                        if (warehouseDestBind.getValue() != null) {
                            ...
                            //
                            OperationBinding chkRmkr = getBindings().getOperationBinding("checkRemarksField");
                            chkRmkr.execute();

                            if (chkRmkr.getResult() != null && !chkRmkr.getResult().equals("")) {
                                if (chkRmkr.getResult().equals("H") || chkRmkr.getResult().equals("I"))
                                    return;
                            }
                            _log.info("-----------return from checkRemarksField  " + chkRmkr.getResult());
                            //
                            ...
                            String glblPrjAlw = resolvEl("#{pageFlowScope.GLBL_ORG_PROJ_ALW}");
                            if (glblPrjAlw.equalsIgnoreCase("N")) {
                                OperationBinding setPrjId = getBindings().getOperationBinding("setDfltProjectId");
                                setPrjId.execute();
                                System.out.println("inside pj alw N");
                            }
                            ...
                            if (WfNo != null) {
                                ...
                                //String msg = "Workflow for this Document is not Created.";
                            ...
                            String msg = resolvElDCMsg("#{bundle['MSG.2206']}").toString();
                            FacesMessage message2 = new FacesMessage(msg);
                            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext fc = FacesContext.getCurrentInstance();
                            fc.addMessage(warehouseDestBind.getClientId(), message2);
                        ...
                        String msg = resolvElDCMsg("#{bundle['MSG.2607']}").toString();
                        FacesMessage message2 = new FacesMessage(msg);
                        message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                    ...
                    String msg = resolvElDCMsg("#{bundle['MSG.2608']}").toString();
                    FacesMessage message2 = new FacesMessage(msg);
                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
            ...
            String msg = resolvElDCMsg("#{bundle['MSG.2609']}").toString();
            FacesMessage message2 = new FacesMessage(msg);
            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void editTransferOrderActionListener(ActionEvent actionEvent) {
        ...
        if (pending.compareTo(new Integer(-1)) == 0 || pending.compareTo(UsrId) == 0) {
            if (authCB.getValue().toString().equals("true")) {
                ...
                OperationBinding chkusr = getBindings().getOperationBinding("getTopWFUsr");
                chkusr.execute();
                String usrauth = "N";
                ...
                if (usrauth.equals("Y"))
                    ...
                    String msg = resolvElDCMsg("#{bundle['MSG.2610']}").toString();
                    FacesMessage message2 = new FacesMessage(msg);
                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message2);
            ...
            String msg2 = resolvElDCMsg("#{bundle['MSG.2611']}").toString();
    ...
    public void trfTypeValueChangeListener(ValueChangeEvent valueChangeEvent) {
        if (warhouseBind.getValue() != null && (!warhouseBind.getValue().toString().equals(""))) {
            ...
            String msg2 = resolvElDCMsg("#{bundle['MSG.800']}").toString();
            FacesMessage message2 = new FacesMessage(msg2);
            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(warhouseBind.getClientId(), message2);
    ...
    public void createSrcDocActionListener(ActionEvent actionEvent) throws SQLException {
        ...
        if (trfDateBind.getValue() != null) {
            if (warhouseBind.getValue() != "") {
                if (trfTypeBind.getValue() != null) {
                    if (trfFrmOrgBind.getValue() != null) {
                        if (trfToOrgBind.getValue() != null) {
                            if (warehouseSrcBind.getValue() != null) {
                                if (warehouseDestBind.getValue() != null) {
                                    if (transItmDescBind.getValue() != null &&
                                        ...
                                        if (reqQtyBind.getValue() != null &&
                                            ...
                                            if (qty.compareTo(new Number(0)) > 0) {
                                                ...
                                                if (dupli.booleanValue() == false) {
                                                    OperationBinding opfy =
                                                        getBindings().getOperationBinding("setFyId");
                                                    opfy.execute();
                                                    ...
                                                    String msg2 = resolvElDCMsg("#{bundle['MSG.2612']}").toString();
                                                    FacesMessage message2 = new FacesMessage(msg2);
                                                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                                    FacesContext fc = FacesContext.getCurrentInstance();
                                                ...
                                                String msg2 = resolvElDCMsg("#{bundle['MSG.314']}").toString();
                                                FacesMessage message2 = new FacesMessage(msg2);
                                                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                                FacesContext fc = FacesContext.getCurrentInstance();
                                            ...
                                            String msg2 = resolvElDCMsg("#{bundle['MSG.2613']}").toString();
                                            FacesMessage message2 = new FacesMessage(msg2);
                                            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                            FacesContext fc = FacesContext.getCurrentInstance();
                                            fc.addMessage(reqQtyBind.getClientId(), message2);
                                        ...
                                        String msg2 = resolvElDCMsg("#{bundle['MSG.430']}").toString();
                                        FacesMessage message2 = new FacesMessage(msg2);
                                        message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                        FacesContext fc = FacesContext.getCurrentInstance();
                                        fc.addMessage(transItmDescBind.getClientId(), message2);
                                    ...
                                    //  String msg2 = "Destination Warehouse Required.";
                                    String msg2 = resolvElDCMsg("#{bundle['MSG.2606']}").toString();
                                    FacesMessage message2 = new FacesMessage(msg2);
                                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                    FacesContext fc = FacesContext.getCurrentInstance();
                                    fc.addMessage(warehouseDestBind.getClientId(), message2);
                                ...
                                //   String msg2 = "Source Warehouse Required.";
                                String msg2 = resolvElDCMsg("#{bundle['MSG.2607']}").toString();
                                FacesMessage message2 = new FacesMessage(msg2);
                                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(warehouseSrcBind.getClientId(), message2);
                            ...
                            String msg2 = resolvElDCMsg("#{bundle['MSG.2804']}").toString();
                            FacesMessage message2 = new FacesMessage(msg2);
                            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext fc = FacesContext.getCurrentInstance();
                        ...
                        String msg2 = resolvElDCMsg("#{bundle['MSG.2805']}").toString();
                        FacesMessage message2 = new FacesMessage(msg2);
                        message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                    ...
                    // String msg2 = "Transfer Type Required.";
                    String msg2 = resolvElDCMsg("#{bundle['MSG.2608']}").toString();
                    FacesMessage message2 = new FacesMessage(msg2);
                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(trfTypeBind.getClientId(), message2);
                ...
                // String msg2 = "Warehouse Required.";
                String msg2 = resolvElDCMsg("#{bundle['MSG.713']}").toString();
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(warhouseBind.getClientId(), message2);
            ...
            String msg2 = resolvElDCMsg("#{bundle['MSG.2806']}").toString();
            FacesMessage message2 = new FacesMessage(msg2);
            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
        ...
        if (WfNo != null && (!WfNo.equals("0"))) {
            ...
            if (level >= 0) {
                ...
                if (pending.compareTo(new Integer(-1)) == 0 || pending.compareTo(UsrId) == 0) {
                    ...
                    String msg2 = resolvElDCMsg("#{bundle['MSG.2807']}").toString();
                    FacesMessage message2 = new FacesMessage(msg2);
                ...
                String msg2 = resolvElDCMsg("#{bundle['MSG.2400']}").toString();
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message2);
            ...
            String msg2 = resolvElDCMsg("#{bundle['MSG.2808']}").toString();
            FacesMessage message2 = new FacesMessage(msg2);
            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message2);
    ...
    public void reqQtyValidatorinTable(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            ...
            if (qty.compareTo(new Number(0)) <= 0) {
                ...
                String msg2 = resolvElDCMsg("#{bundle['MSG.730']}").toString();
                ...
                if (is.toString().equalsIgnoreCase("true")) {
                    ...
                    // String msg2="Invalid Precision(26,6).";
                    String msg2 = resolvElDCMsg("#{bundle['MSG.1107']}").toString();
                    throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
                }
            }
    ...
    public void warehouseSrcVCE(ValueChangeEvent valueChangeEvent) {
        if (valueChangeEvent.getNewValue() != null && warehouseSrcBind.getValue() != null &&
            (!warehouseSrcBind.getValue().toString().equals(""))) {
    ...
    public void warehouseDestVCE(ValueChangeEvent valueChangeEvent) {
        if (valueChangeEvent.getNewValue() != null && warehouseDestBind.getValue() != null &&
            (!warehouseDestBind.getValue().toString().equals(""))) {
            ...
            if (Auth.compareTo(0) >= 0) {
                ...
                if (is.toString().equalsIgnoreCase("true")) {
                    ...
                    if (value <= 0) {
                        ...
                        if (value == 1) {
                            // String msg2="Invalid Authorised Quantity.";
                            String msg2 = resolvElDCMsg("#{bundle['MSG.2809']}").toString();
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
                        } else if (value == 2) {
                            // String msg2="Authorised Quantity can not be given without Order Quantity.";
                            String msg2 = resolvElDCMsg("#{bundle['MSG.2810']}").toString();
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
                        }
                ...
                // String msg2="Quantity can not be less than Zero.";
                String msg2 = resolvElDCMsg("#{bundle['MSG.2520']}").toString();
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
            }
        } else {
            // String msg2="Quantity Required.";
            String msg2 = resolvElDCMsg("#{bundle['MSG.2510']}").toString();
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
        }
        /* OperationBinding op=getBindings().getOperationBinding("ExecuteItmVo");
        op.execute(); */
            ...
            if (Res.compareTo(0) >= 0) {
                ...
                if (is.toString().equalsIgnoreCase("true")) {
                    ...
                    if (value <= 0) {
                        ...
                        if (value == 1) {
                            // String msg2="Reserved Quantity can not be greater than Available Stock or Authorised Quantity.";
                            String msg2 = resolvElDCMsg("#{bundle['MSG.2811']}").toString();
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
                        } else if (value == 2) {
                            // String msg2="Reserve Quantity can not be given without Authorised Quantity";
                            String msg2 = resolvElDCMsg("#{bundle['MSG.2812']}").toString();
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg2, null));
                        }
                    }
                } else {
    ...
    public void raiseOrderAction(ActionEvent actionEvent) {
        // Add event code here...
        System.out.println("come00");
        Object ob = getBindings().getOperationBinding("raiseTransferOrder").execute();
        System.out.println("---> :: " + ob);
        if (ob != null && (!ob.equals("N"))) {
            System.out.println("come");
            //String msg1="raised Successfully !!"
            String msg1 = resolvElDCMsg("#{bundle['MSG.2813']}").toString();
            String msg2 = ob.toString() + msg1;
            FacesMessage message2 = new FacesMessage(msg2);
            ...
            //String msg1="There is some Error Contact ESS !!"
            String msg1 = resolvElDCMsg("#{bundle['MSG.2814']}").toString();
            String msg2 = msg1;
            FacesMessage message2 = new FacesMessage(msg2);
            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
