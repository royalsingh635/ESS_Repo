...
public class MmTrfOrdVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransAvailStkView {
            public Object get(MmTrfOrdVORowImpl obj) {
                return obj.getTransAvailStkView();
            }

            public void put(MmTrfOrdVORowImpl obj, Object value) {
                obj.setTransAvailStkView((String) value);
            }
        }
        ,
        MmTrfOrdItm {
        ...
        LovPrjDestTRFVO1 {
            public Object get(MmTrfOrdVORowImpl obj) {
                return obj.getLovPrjDestTRFVO1();
            }
    ...
    public static final int TRANSAVAILSTKVIEW = AttributesEnum.TransAvailStkView.index();
    ...
    public static final int LOVWHIDDESTVO = AttributesEnum.LovWhIdDestVO.index();
    public static final int LOVORGIDNEWVO = AttributesEnum.LovOrgIdNewVO.index();
    public static final int LOVPRJSRCTRFVO1 = AttributesEnum.LovPrjSrcTRFVO1.index();
    public static final int LOVPRJDESTTRFVO1 = AttributesEnum.LovPrjDestTRFVO1.index();
    ...
    //    return ((String) getAttributeInternal(PRJID)==null?resolvEl("#{pageFlowScope.GLBL_ORG_PROJ_ID}").toString():(String) getAttributeInternal(PRJID));
    }
    ...
    /**
     * Gets the attribute value for PRJ_ID_DEST using the alias name PrjIdDest.
     * @return the PRJ_ID_DEST
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for PRJ_ID_DEST using the alias name PrjIdDest.
     * @param value value to set the PRJ_ID_DEST
     */
    ...
    /**
     * Gets the attribute value for the calculated attribute TransAvailStkView.
     * @return the TransAvailStkView
     */
    public String getTransAvailStkView() {
        Object retrn = callStoredFunction(Types.VARCHAR, "MM.mm_chk_org_prf(?,?,?,?)",new Object[] { getCldId(), getSlocId(), getOrgId(),"DISP_ALL_WH_STK"});   
        return ((String) getAttributeInternal(TRANSAVAILSTKVIEW) == null ? retrn.toString() : (String) getAttributeInternal(TRANSAVAILSTKVIEW));
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransAvailStkView.
     * @param value value to set the  TransAvailStkView
     */
    public void setTransAvailStkView(String value) {
        setAttributeInternal(TRANSAVAILSTKVIEW, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LovWhIdDestVO.
     */
    public RowSet getLovWhIdDestVO() {
        return (RowSet) getAttributeInternal(LOVWHIDDESTVO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LovOrgIdNewVO.
     */
    public RowSet getLovOrgIdNewVO() {
        return (RowSet) getAttributeInternal(LOVORGIDNEWVO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LovPrjSrcTRFVO1.
     */
    public RowSet getLovPrjSrcTRFVO1() {
        return (RowSet) getAttributeInternal(LOVPRJSRCTRFVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LovPrjDestTRFVO1.
     */
    public RowSet getLovPrjDestTRFVO1() {
        return (RowSet) getAttributeInternal(LOVPRJDESTTRFVO1);
    }
