...
import mmappuom.model.entities.AppUomConvClsEOImpl;
...
public class AppUomConvClsVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransUomIdSrc {
            public Object get(AppUomConvClsVORowImpl obj) {
                return obj.getTransUomIdSrc();
            }

            public void put(AppUomConvClsVORowImpl obj, Object value) {
                obj.setTransUomIdSrc((String) value);
            }
        },
        LovUomIdVO1 {
            public Object get(AppUomConvClsVORowImpl obj) {
    ...
    public static final int TRANSUOMIDSRC = AttributesEnum.TransUomIdSrc.index();
    ...
    public static final int LOVUOMIDNEWVO = AttributesEnum.LovUomIdNewVO.index();
     ...
     */
    public AppUomConvClsEOImpl getAppUomConvClsEO() {
        return (AppUomConvClsEOImpl) getEntity(ENTITY_APPUOMCONVCLSEO);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransUomIdSrc.
     * @return the TransUomIdSrc
     */
    public String getTransUomIdSrc() {

        AppUOMAMImpl am = (AppUOMAMImpl) this.getApplicationModule();
        ViewObjectImpl conv = am.getAppUomConv1();
        conv.setNamedWhereClauseParam("bindcldId", getCldId());
        conv.setNamedWhereClauseParam("bindslocId", getSlocId());
        conv.executeQuery();
        Row[] rr = conv.getFilteredRows("UomId", getUomIdSrc());
        if (rr.length > 0) {
            System.out.println("length of arrtys::" + rr.length);
            String desc = (String) rr[0].getAttribute("UomDesc");
            System.out.println("desc:::" + desc);
            return desc;
        }
        return (String) getAttributeInternal(TRANSUOMIDSRC);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransUomIdSrc.
     * @param value value to set the  TransUomIdSrc
     */
    public void setTransUomIdSrc(String value) {
        setAttributeInternal(TRANSUOMIDSRC, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LovUomIdNewVO.
     */
    public RowSet getLovUomIdNewVO() {
        return (RowSet) getAttributeInternal(LOVUOMIDNEWVO);
    }
