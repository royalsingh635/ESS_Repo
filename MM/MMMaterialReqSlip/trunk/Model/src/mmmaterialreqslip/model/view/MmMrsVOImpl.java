...
public class MmMrsVOImpl extends ViewObjectImpl {
    ...
    /**
     * Returns the variable value for BindSrcType.
     * @return variable value for BindSrcType
     */
    public Integer getBindSrcType() {
        return (Integer) ensureVariableManager().getVariableValue("BindSrcType");
    }

    /**
     * Sets <code>value</code> for variable BindSrcType.
     * @param value value to bind as BindSrcType
     */
    public void setBindSrcType(Integer value) {
        ensureVariableManager().setVariableValue("BindSrcType", value);
    }
