...
public class MmInvcOcEOImpl extends EntityImpl {
     ...
     */
    public Long getCurrIdSpOc() {
        return (Long) getAttributeInternal(CURRIDSPOC);
    }
     ...
     */
    public void setCurrIdSpOc(Long value) {
    ...
    public static Key createPrimaryKey(String cldId, Integer slocId, String orgId, String docId, String docIdRcpt,
                                       String docIdPo, Integer dlvSchdlNo, Integer coaId, String ocId) {
        return new Key(new Object[] { cldId, slocId, orgId, docId, docIdRcpt, docIdPo, dlvSchdlNo, coaId, ocId });
    }
