...
public interface MMInvoiceAM extends ApplicationModule {
    ...
    String addinvcType(Integer invcType);
    ...
    Integer chkCancelInvc();

    Integer updateRcptAftrCancel();

    void afterCancelWF();

    String chkAttchRqd();

    String checkWFUsrLevel();

    String applyDefaultTDS();

    Integer checkSuppDoc();

    String ccFinalizedCheck();

    void deleteAttachRow();
