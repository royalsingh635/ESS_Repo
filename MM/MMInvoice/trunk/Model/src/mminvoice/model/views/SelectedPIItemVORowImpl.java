...
public class SelectedPIItemVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransFinlRcptQtyNew {
            public Object get(SelectedPIItemVORowImpl obj) {
                return obj.getTransFinlRcptQtyNew();
            }

            public void put(SelectedPIItemVORowImpl obj, Object value) {
                obj.setTransFinlRcptQtyNew((Number) value);
            }
        }
        ,
        LovItmIdVO1 {
    ...
    public static final int TRANSFINLRCPTQTYNEW = AttributesEnum.TransFinlRcptQtyNew.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute TransFinlRcptQtyNew.
     * @return the TransFinlRcptQtyNew
     */
    public Number getTransFinlRcptQtyNew() {
        if(getAttributeInternal(TRANSFINLRCPTQTYNEW)!=null && ((Number)getAttributeInternal(TRANSFINLRCPTQTYNEW)).compareTo(new Number(0))!=0){
          return (Number) getAttributeInternal(TRANSFINLRCPTQTYNEW);
        }
        else{
            return getFinalRcptQty();
        }
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransFinlRcptQtyNew.
     * @param value value to set the  TransFinlRcptQtyNew
     */
    public void setTransFinlRcptQtyNew(Number value) {
        if(value !=null){
            setAttributeInternal(TRANSFINLRCPTQTYNEW, value);
        }else{
            setAttributeInternal(TRANSFINLRCPTQTYNEW, new Number(0));
        }
    }
