...
public class MmInvcSrcVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransOcAmtPoWise {
            public Object get(MmInvcSrcVORowImpl obj) {
                return obj.getTransOcAmtPoWise();
            }

            public void put(MmInvcSrcVORowImpl obj, Object value) {
                obj.setTransOcAmtPoWise((Number) value);
            }
        },
        TransPoOcAmtSp {
            public Object get(MmInvcSrcVORowImpl obj) {
                return obj.getTransPoOcAmtSp();
            }

            public void put(MmInvcSrcVORowImpl obj, Object value) {
                obj.setTransPoOcAmtSp((Number) value);
            }
        },
        TransTotTaxAmt {
            public Object get(MmInvcSrcVORowImpl obj) {
    ...
    public static final int TRANSOCAMTPOWISE = AttributesEnum.TransOcAmtPoWise.index();
    public static final int TRANSPOOCAMTSP = AttributesEnum.TransPoOcAmtSp.index();
    ...
    public String getTransSrcDocNm() {
        ...
        if (type == 455 || type == 492 || type == 737 || type == 739 || type == 457) {
            ret = (Object) (callStoredFunction(Types.VARCHAR, "MM.MM_GET_PO_NO(?,?,?,?)", new Object[] {
                                               this.getCldId(), this.getSlocId(), this.getOrgId(), this.getDocIdPo()
            }));
        } else if (type == 456 || type == 716 || type == 738) {
            ret = (Object) (callStoredFunction(Types.VARCHAR, "MM.MM_GET_TO_NO(?,?,?,?)", new Object[] {
                                               this.getCldId(), this.getSlocId(), this.getOrgId(), this.getDocIdPo()
            }));
        }
        /*
  ...
  */
    ...
    /**
     * Gets the attribute value for the calculated attribute TransOcAmtPoWise.
     * @return the TransOcAmtPoWise
     */
    public Number getTransOcAmtPoWise() {

        MMInvoiceAMImpl am = (MMInvoiceAMImpl) this.getApplicationModule();
        ViewObjectImpl invcOc1 = am.getMmInvcOc1();
        ViewObjectImpl ocDoc = am.getLovOcDoc();
        RowQualifier rq1 = new RowQualifier(invcOc1);
        rq1.setWhereClause("DocId='" + getDocId() + "' and DocIdPo='" + getDocIdPo() + "' and DocIdRcpt='" +
                           getDocIdRcpt() + "'");
        Row[] rr = invcOc1.getFilteredRows(rq1);
        ...
        if (rr.length > 0) {
            ...
            //System.out.println("oc amount after filter is "+TtlocAmtCalc);
            return TtlocAmtCalc;
        }
        return (Number) getAttributeInternal(TRANSOCAMTPOWISE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransOcAmtPoWise.
     * @param value value to set the  TransOcAmtPoWise
     */
    public void setTransOcAmtPoWise(Number value) {
        setAttributeInternal(TRANSOCAMTPOWISE, value);
    }

    /**
     * Gets the attribute value for the calculated attribute TransPoOcAmtSp.
     * @return the TransPoOcAmtSp
     */
    public Number getTransPoOcAmtSp() {
        return (Number) getAttributeInternal(TRANSPOOCAMTSP);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransPoOcAmtSp.
     * @param value value to set the  TransPoOcAmtSp
     */
    public void setTransPoOcAmtSp(Number value) {
        setAttributeInternal(TRANSPOOCAMTSP, value);
    }
