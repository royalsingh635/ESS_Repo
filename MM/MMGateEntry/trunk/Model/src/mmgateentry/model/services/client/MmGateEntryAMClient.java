...
public class MmGateEntryAMClient extends ApplicationModuleImpl implements MmGateEntryAM {
    ...
    public void addItemToGe(String ItmName, String ItmUom, oracle.jbo.domain.Number ItmQty) {
        Object _ret = this.riInvokeExportedMethod(this, "addItemToGe", new String[] {
    ...
    public String callForValidateToleranceQty(String CldId, Integer SlocId, String OrgId, String p_itm_id,
        ...
        Object _ret = this.riInvokeExportedMethod(this, "callForValidateToleranceQty", new String[] {
                                                  "java.lang.String", "java.lang.Integer", "java.lang.String",
                                                  "java.lang.String", "oracle.jbo.domain.Number"
        }, new Object[] { CldId, SlocId, OrgId, p_itm_id, retn_qty });
        return (String) _ret;
    }

    public Integer cancelGateEntry() {
        Object _ret = this.riInvokeExportedMethod(this, "cancelGateEntry", null, null);
        return (Integer) _ret;
    }
    ...
    public String checkCurrCompatibilityCPO(String OrgId, String CldId, Integer SlocId, String PoDocId) {
        Object _ret = this.riInvokeExportedMethod(this, "checkCurrCompatibilityCPO", new String[] {
                                                  "java.lang.String", "java.lang.String", "java.lang.Integer",
                                                  "java.lang.String"
        }, new Object[] { OrgId, CldId, SlocId, PoDocId });
        return (String) _ret;
    ...
    public Integer checkItemAvlblOrNotPo() {
        Object _ret = this.riInvokeExportedMethod(this, "checkItemAvlblOrNotPo", null, null);
        return (Integer) _ret;
    }
    ...
    public Integer chkCurrencyConversion() {
        Object _ret = this.riInvokeExportedMethod(this, "chkCurrencyConversion", null, null);
        return (Integer) _ret;
    }
    ...
    public HashSet chkdlvryQtyForItem(String CldId, Integer slocId, String OrgId, String whId) {
        Object _ret = this.riInvokeExportedMethod(this, "chkdlvryQtyForItem", new String[] {
                                                  "java.lang.String", "java.lang.Integer", "java.lang.String",
                                                  "java.lang.String"
        }, new Object[] { CldId, slocId, OrgId, whId });
        return (HashSet) _ret;
    ...
    public String compTotRcptQty(oracle.jbo.domain.Number RetQty) {
        Object _ret = this.riInvokeExportedMethod(this, "compTotRcptQty", new String[] { "oracle.jbo.domain.Number" }, new Object[] {
                                                  RetQty });
        return (String) _ret;
    }
    ...
    public String getGeNo(Integer SlocId, String CldId, String OrgId, String WhId, Integer fyId) {
        Object _ret = this.riInvokeExportedMethod(this, "getGeNo", new String[] {
    ...
    public void getGeRecordForEdit(String CldId, Integer SlocId, String OrgId, String TxnId) {
        Object _ret = this.riInvokeExportedMethod(this, "getGeRecordForEdit", new String[] {
                                                  "java.lang.String", "java.lang.Integer", "java.lang.String",
                                                  "java.lang.String"
        }, new Object[] { CldId, SlocId, OrgId, TxnId });
        return;
    }

    public void getItemsForPopUp(Integer docType, Integer SlocId, String CldId, String OrgId, String HoOrgId,
                                 String sourceDocNo) {
        Object _ret = this.riInvokeExportedMethod(this, "getItemsForPopUp", new String[] {
                                                  "java.lang.Integer", "java.lang.Integer", "java.lang.String",
                                                  "java.lang.String", "java.lang.String", "java.lang.String"
        }, new Object[] { docType, SlocId, CldId, OrgId, HoOrgId, sourceDocNo });
        return;
    }
    ...
    public Integer poItmQtyGrtrZero() {
        Object _ret = this.riInvokeExportedMethod(this, "poItmQtyGrtrZero", null, null);
        return (Integer) _ret;
    }
    ...
    public Integer populateGeSrcItmToJITR() {
        Object _ret = this.riInvokeExportedMethod(this, "populateGeSrcItmToJITR", null, null);
        return (Integer) _ret;
    }
    ...
    public void returnGe(String Flg) {
        Object _ret = this.riInvokeExportedMethod(this, "returnGe", new String[] { "java.lang.String" }, new Object[] {
                                                  Flg });
        return;
    }
    ...
    public void setCurrIdSpInMtlGeWithoutPO() {
        Object _ret = this.riInvokeExportedMethod(this, "setCurrIdSpInMtlGeWithoutPO", null, null);
        return;
    }

    public void setCurrIdSpPoToMtlGe(Integer value) {
        Object _ret = this.riInvokeExportedMethod(this, "setCurrIdSpPoToMtlGe", new String[] { "java.lang.Integer" }, new Object[] {
                                                  value });
        return;
    }
    ...
    public void setStatusforGe(String stat) {
        Object _ret = this.riInvokeExportedMethod(this, "setStatusforGe", new String[] { "java.lang.String" }, new Object[] {
                                                  stat });
        return;
    }
    ...
    public void updateGeItmQty() {
        Object _ret = this.riInvokeExportedMethod(this, "updateGeItmQty", null, null);
        return;
    }
    ...
    public void updateTxnQty(oracle.jbo.domain.Number oldRcptQty, oracle.jbo.domain.Number newRcptQty) {
        Object _ret = this.riInvokeExportedMethod(this, "updateTxnQty", new String[] {
    ...
    public void updtRcptQty(oracle.jbo.domain.Number TotRcpt) {
        Object _ret = this.riInvokeExportedMethod(this, "updtRcptQty", new String[] { "oracle.jbo.domain.Number" }, new Object[] {
                                                  TotRcpt });
        return;
    }

    public void updtRcptRetnTmpRcptQty(oracle.jbo.domain.Number TotRcpt) {
        Object _ret = this.riInvokeExportedMethod(this, "updtRcptRetnTmpRcptQty", new String[] {
                                                  "oracle.jbo.domain.Number" }, new Object[] { TotRcpt });
        return;
    }

    public void updtRcptTmpRcptQty(oracle.jbo.domain.Number RetnQty) {
        Object _ret = this.riInvokeExportedMethod(this, "updtRcptTmpRcptQty", new String[] {
                                                  "oracle.jbo.domain.Number" }, new Object[] { RetnQty });
        return;
    }
