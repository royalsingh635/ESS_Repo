...
public interface MmGateEntryAM extends ApplicationModule {
    ...
    String checkCurrCompatibilityCPO(String OrgId, String CldId, Integer SlocId, String PoDocId);

    Integer checkItemAvlblOrNotPo();

    Integer poItmQtyGrtrZero();
    ...
    void setCurrIdSpInMtlGeWithoutPO();

    Integer cancelGateEntry();

    Integer chkSupplierInvcCopyReceipt();

    Integer chkCurrencyConversion();

    void resetOrgWh(Integer rcptType);

    Integer populateGeSrcItmToJITR();
}
