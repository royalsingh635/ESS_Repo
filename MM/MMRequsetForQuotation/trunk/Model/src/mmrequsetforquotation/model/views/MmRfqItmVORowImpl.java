...
public class MmRfqItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ItmLongDescTrans {
            public Object get(MmRfqItmVORowImpl obj) {
                return obj.getItmLongDescTrans();
            }

            public void put(MmRfqItmVORowImpl obj, Object value) {
                obj.setItmLongDescTrans((String) value);
            }
        },
        ItmAttributeTrans {
            public Object get(MmRfqItmVORowImpl obj) {
                return obj.getItmAttributeTrans();
            }

            public void put(MmRfqItmVORowImpl obj, Object value) {
                obj.setItmAttributeTrans((String) value);
            }
        },
        MMPendOrdVw {
            public Object get(MmRfqItmVORowImpl obj) {
    ...
    public static final int ITMLONGDESCTRANS = AttributesEnum.ItmLongDescTrans.index();
    public static final int ITMATTRIBUTETRANS = AttributesEnum.ItmAttributeTrans.index();
    ...
    public BigDecimal getTransLatestPrice() {
        System.out.println("GET_LATEST_PRICE : " + getSlocId() + " " + getCldId() + " " + getOrgId() + " " +
                           getItmId());
        BigDecimal bg = callStoredFunctionLatest("PKG_MM_RFQ.GET_LATEST_PRICE(?,?,?,?,?,?,?)", new Object[] {
                                                 getSlocId(), getCldId(), getOrgId(), getItmId()
        });
        return bg;
    ...
    public BigDecimal getTransBestPrice() {
        System.out.println("GET_BEST_PRICE : " + getSlocId() + " " + getCldId() + " " + getOrgId() + " " + getItmId());
        BigDecimal bg = callStoredFunction("PKG_MM_RFQ.GET_BEST_PRICE(?,?,?,?,?,?,?)", new Object[] {
                                           getSlocId(), getCldId(), getOrgId(), getItmId()
        });
        return bg;
    ...
    public String getTransDate() {
        ...
        if (this.getItmId() != null) {
            BigDecimal d =
                (BigDecimal) ((mmRfqAMImpl) this.getApplicationModule()).callStoredFunction(Types.NUMERIC,
                                                                                            "mm.MM_GET_PRICE_MOV(?,?,?,?)", new Object[] {
                                                                                            this.getCldId(),
                                                                                            this.getSlocId(),
                                                                                            this.getOrgId(),
                                                                                            this.getItmId()
            ...
            res = new Integer(d.intValue()) + "Days";
        }
        return res;
    }

    /**
     * Gets the attribute value for the calculated attribute ItmLongDescTrans.
     * @return the ItmLongDescTrans
     */
    public String getItmLongDescTrans() {
        if (getItmId() != null) {
            mmRfqAMImpl am = (mmRfqAMImpl) this.getApplicationModule();
            ViewObjectImpl itmVo = am.getItemLOV1();
            itmVo.setNamedWhereClauseParam("cldIdBind", getCldId());
            itmVo.setNamedWhereClauseParam("SlocIdBind", getSlocId());
            itmVo.setNamedWhereClauseParam("orgIdBind", getOrgId());
            itmVo.setNamedWhereClauseParam("bindHoOrgId", getTransHoOrgId());
            itmVo.executeQuery();
            System.out.println("-------itmvo length-- " + itmVo.getRowCount());
            Row[] rr = itmVo.getFilteredRows("ItmId", getItmId());
            System.out.println("--------length------ " + rr.length);
            if (rr.length > 0) {
                return (String) rr[0].getAttribute("ItmLongDesc");
            } else
                return "NA";
            // return (String) getAttributeInternal(ITMLONGDESCTRANS);
        } else
            return (String) getAttributeInternal(ITMLONGDESCTRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ItmLongDescTrans.
     * @param value value to set the  ItmLongDescTrans
     */
    public void setItmLongDescTrans(String value) {
        setAttributeInternal(ITMLONGDESCTRANS, value);
    }

    /**
     * Gets the attribute value for the calculated attribute ItmAttributeTrans.
     * @return the ItmAttributeTrans
     */
    public String getItmAttributeTrans() {
        if (getItmId() != null) {
            mmRfqAMImpl am = (mmRfqAMImpl) this.getApplicationModule();
            Object attdetail = am.callStoredFunction(Types.VARCHAR, "APP.FN_GET_ITM_ATT(?,?,?,?,?,?)", new Object[] {
        ...
        // return (String) getAttributeInternal(ITMATTRIBUTETRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute ItmAttributeTrans.
     * @param value value to set the  ItmAttributeTrans
     */
    public void setItmAttributeTrans(String value) {
        setAttributeInternal(ITMATTRIBUTETRANS, value);
    }
