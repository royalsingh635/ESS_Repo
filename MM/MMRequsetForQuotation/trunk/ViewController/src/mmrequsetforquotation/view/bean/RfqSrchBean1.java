...
public class RfqSrchBean1 {
    ...
    private RichSelectOneChoice rfqSourceTypeBind;
    ...
    public void searchActionListner(ActionEvent actionEvent) {
        ...
        //System.out.println("Rfq value is "+this.getRfqSourceTypeBind().getValue());
        if(this.getRfqSourceTypeBind().getValue() != null && this.getRfqSourceTypeBind().getValue().toString().trim().length()!= 0){
           
            rfqSource=(Integer)this.getRfqSourceTypeBind().getValue();
            System.out.println("RFQ source is "+rfqSource);
        }
        
       // System.out.println("Source value is "+rfqSource);
        ...
        obind.getParamsMap().put("sourceType", rfqSource);
        obind.execute(); 
    }
    ...
    public void ResetActionListner(ActionEvent actionEvent) {
        ...
        this.getRfqSourceTypeBind().setValue(null);
    ...
    public void setRfqSourceTypeBind(RichSelectOneChoice rfqSourceTypeBind) {
        this.rfqSourceTypeBind = rfqSourceTypeBind;
    }

    public RichSelectOneChoice getRfqSourceTypeBind() {
        return rfqSourceTypeBind;
    }
}
