...
/* public class RequestForQuotPageBundle extends ListResourceBundle {
...
public class RequestForQuotPageBundle extends ListResourceBundle {
    private static ADFLogger adflog = ADFLogger.createADFLogger(RequestForQuotPageBundle.class);
    private static int STRING = Types.VARCHAR;
   
    public  RequestForQuotPageBundle(){
