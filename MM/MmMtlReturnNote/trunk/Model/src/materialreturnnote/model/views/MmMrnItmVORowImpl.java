...
public class MmMrnItmVORowImpl extends ViewRowImpl {
    ...
    public String getTransItemName() {
        if (getItmId() != null) {
            MaterialReturnNoteAMImpl am1 = (MaterialReturnNoteAMImpl) this.getApplicationModule();
            ViewObjectImpl itmVO = am1.getMMItmVo1();
     ...
     //  System.out.println("--------itmid -------------"+"  "+getTransHoOrgId()+"  "+getOrgId()+"  "+getItmId()+"----"+rr[0].getAttribute("ItmDesc"));
