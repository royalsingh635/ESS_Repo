...
public class MaterialReturnNoteAMImpl extends ApplicationModuleImpl implements MaterialReturnNoteAM {
    ...
    public void setTxnIdForCurrentRow(Integer UsrId, String CldId, Integer SlocId, String OrgId) {
        ...
        if (getProjAlw().equalsIgnoreCase("N")) {
    ...
    public String generateMRNNo(Integer SlocId, String CldId, String OrgId, String TableName, Integer fyId) {
        ...
        if (mrnRw.getAttribute("MrnNo") == null) {
            ...
            mrnNo = (String) callStoredFunction(Types.VARCHAR, "FN_MM_GEN_ID(?,?,?,?,?,?)", new Object[] {
    ...
    public Integer getFYid(String CldId, String OrgId, Timestamp geDate, String Mode) {
        ...
        if (mrn.getCurrentRow().getAttribute("DocDt") != null) {
            if (geDate != null) {
                ...
                fyId = (Integer) (callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID (?,?,?)", new Object[] {
                                                     CldId, OrgId, mrn.getCurrentRow().getAttribute("DocDt")
                }));
            }
    ...
    public void addItmFormMrNTable() {
        ...
        if (currMrn.getAttribute("TransItemId") != null) {
            ...
            adflog.info("inside + -----" + itmDesc + "    " + ItemId);
            ...
            if (rr1.length > 0) {
                for (Row r111 : rr1) {
                    ...
                    if (mrnDoc != null) {
                        ...
                        adflog.info("rr2 length------ " + rr2.length + " doc id is " + mrnDoc + " item id is " +
                                    ItemId);
                ...
                adflog.info("issu item string " + rowQualifier.getExprStr() + "---- length ---- issu qty " +
                            issueItmR[0].getAttribute("IssuQty") + "  " + issueItmR.length + " " +
                ...
                if (issueItmR.length > 0) {
                    if (((Number) issueItmR[0].getAttribute("IssuQty")).compareTo(totQty) > 0) {
                        ...
                        //String msg = "Issue quantity not available for this item";
                        String msg = resolvElDCMsg("#{bundle['MSG.2588']}").toString();
                ...
                if (issueItmR.length > 0) {
                    ...
                    for (Row r : issueItmR) {
                        ...
                        newMrnItm.setAttribute("ItmUom", r.getAttribute("ItmUom"));
                        mrnItmVo.insertRow(newMrnItm);
                        adflog.info(" else part issueItmr>>>>>-----" + mrnItmVo.getCurrentRow().getAttribute("ItmId"));
                    }
    ...
    public void filterSrNo() {
        ...
        adflog.info("---cld " + currRow.getAttribute("CldId") + "-------" + currRow.getAttribute("SlocId") +
                    "------------" + currRow.getAttribute("OrgId") + "------" + currRow.getAttribute("DocIdIssu") +
    ...
    public String isItmNameDuplicate(String value) {
        ...
        if (value != null) {
            adflog.info("value--------------------21213");
            String itmId = null;
            //  Row[] itmrow = this.getLovItmId().getFilteredRows("ItmDesc", value);
            this.getLovItmNmView().setNamedWhereClauseParam("BindCldId", EbizParams.GLBL_APP_CLD_ID());
            this.getLovItmNmView().setNamedWhereClauseParam("BindSlocId", EbizParams.GLBL_APP_SERV_LOC());
            this.getLovItmNmView().setNamedWhereClauseParam("BindHoOrgId", EbizParams.GLBL_HO_ORG_ID());
            this.getLovItmNmView().setNamedWhereClauseParam("BindOrgId", EbizParams.GLBL_APP_USR_ORG());
            this.getLovItmNmView().setNamedWhereClauseParam("BindItmId", null);
            this.getLovItmNmView().setNamedWhereClauseParam("BindItmDesc", value);
            this.getLovItmNmView().executeQuery();
            adflog.info("itmId-------------------yz");
            Row[] itmrow = this.getLovItmNmView().getFilteredRows("ItmDesc", value);
            adflog.info("itmId-------------------abc");
            if (itmrow.length > 0 && itmrow[0].getAttribute("ItmId") != null) {
                adflog.info("itmId-------------------xyz");
                itmId = itmrow[0].getAttribute("ItmId").toString();
            }
            adflog.info("itmId--------------------21213" + itmId);
            if (itmId != null) {
                adflog.info("value--------------------212545454");
                RowQualifier rowQualifier = new RowQualifier(mrnItmVo);
                rowQualifier.setWhereClause("CldId = '" + cld_id + "' and SlocId = " + sloc_id + " and OrgId = '" +
                                            org_id + "' and DocId = '" + doc_id + "' and ItmId = '" + itmId + "'");
        ...
        adflog.info("return value-------------  " + retvalue);
        return retvalue;
    }
    ...
    public String isSrNoDuplicate(String value) {
        ...
        if (value != null && itmId != null) {
            ...
            rowQualifier.setWhereClause("CldId = '" + cld_id + "' and SlocId = " + sloc_id + " and OrgId = '" + org_id +
                                        "' and DocId = '" + doc_id + "' and ItmId = '" + itmId + "' and SrNo = '" +
                                        value + "'");
    ...
    public void mrnViewQuery(String docid) {
        String p_org_id = resolvEl("#{pageFlowScope.GLBL_APP_USR_ORG}").toString();
        String p_cld_id = resolvEl("#{pageFlowScope.GLBL_APP_CLD_ID}").toString();
        String p_sloc_id = resolvEl("#{pageFlowScope.GLBL_APP_SERV_LOC}").toString();
        ...
        if (docid != null) {
            ...
            vo.setNamedWhereClauseParam("CldIdBindVar", p_cld_id);
            vo.setNamedWhereClauseParam("SlocIdBindVar", p_sloc_id);
            vo.setNamedWhereClauseParam("OrgIdBindVar", p_org_id);
    ...
    public void searchMrnAction() {
        ...
        adflog.info("BindOrgId--" + p_org_id + "TransMrnNo---" + currTransSrch.getAttribute("TransMrnNo") +
                    "TransRqmtAreaId---" + currTransSrch.getAttribute("TransRqmtAreaId") + "TransWhIdRetTo" +
                    currTransSrch.getAttribute("TransWhIdRetTo") + "TransOrgIdRetTo---" +
                    currTransSrch.getAttribute("TransOrgIdRetTo"));
        adflog.info("TransMrnStat---" + currTransSrch.getAttribute("TransMrnStat") + "TransMrsDtFrom----" +
                    currTransSrch.getAttribute("TransMrsDtFrom") + "TransMrsDtTo----" +
                    currTransSrch.getAttribute("TransMrsDtTo") + "TransSrNo-----" +
                    currTransSrch.getAttribute("TransSrNo") + "itmId---" + itmId);
    ...
    */
    ...
    public void setoutcome(String wfvalue) {
        ...
        if (wfvalue.equalsIgnoreCase("A")) {
            ...
            String output = callStoredFunction(NUMBER, "mm.mm_updt_mrn_scrp(?,?,?,?,?)", new Object[] {
                                               cldId, slocId, orgId, docId, fyId
            }).toString();
    ...
    /**
     * Container's getter for MMItmVo1.
     * @return MMItmVo1
     */
    public ViewObjectImpl getMMItmVo1() {
        return (ViewObjectImpl) findViewObject("MMItmVo1");
    }

    public String getProjAlw() {
        return (String) resolvEl("#{pageFlowScope.GLBL_ORG_PROJ_ALW}");
    }
    ...
    public void settingRtnQty(String srFlg){
        ViewObjectImpl vo = this.getMmMrnItmStk();
        Row r = vo.getCurrentRow();
        r.setAttribute("TotRetQty", new Number(1));   
        r.setAttribute("OkQty", new Number(1));   
        adflog.info("----calling inside seeting rtn qty---"+r.getAttribute("TotRetQty")+" -  "+srFlg);
