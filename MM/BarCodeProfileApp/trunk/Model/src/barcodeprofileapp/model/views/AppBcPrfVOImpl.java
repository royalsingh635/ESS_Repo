...
// ---------------------------------------------------------------------
public class AppBcPrfVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public AppBcPrfVOImpl() {
    }
    ...
    /**
     * Returns the variable value for PrcsIdBind.
     * @return variable value for PrcsIdBind
     */
    public Integer getPrcsIdBind() {
        return (Integer) ensureVariableManager().getVariableValue("PrcsIdBind");
    }

    /**
     * Sets <code>value</code> for variable PrcsIdBind.
     * @param value value to bind as PrcsIdBind
     */
    public void setPrcsIdBind(Integer value) {
        ensureVariableManager().setVariableValue("PrcsIdBind", value);
    }
}
