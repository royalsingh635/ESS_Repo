...
import mmissuematerial.model.entities.MmMtlIssuItmEOImpl;
...
public class MmMtlIssuItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        SerialNoteTrans {
            public Object get(MmMtlIssuItmVORowImpl obj) {
                return obj.getSerialNoteTrans();
            }

            public void put(MmMtlIssuItmVORowImpl obj, Object value) {
                obj.setSerialNoteTrans((String) value);
            }
        }
        ,
        MmMtlIssuLot {
    ...
    public static final int TRANSISFUEL = AttributesEnum.TransIsFuel.index();
    public static final int SERIALNOTETRANS = AttributesEnum.SerialNoteTrans.index();
    ...
    public static final int STOCKDETAL = AttributesEnum.StockDetal.index();
     ...
     */
    public MmMtlIssuItmEOImpl getMmMtlIssuItmEO() {
        return (MmMtlIssuItmEOImpl) getEntity(ENTITY_MMMTLISSUITMEO);
    }
    ...
    /**
     * Gets the attribute value for METR_REDNG using the alias name MetrRedng.
     * @return the METR_REDNG
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for METR_REDNG using the alias name MetrRedng.
     * @param value value to set the METR_REDNG
     */
    ...
    /**
     * Gets the attribute value for the calculated attribute TransIsFuel.
     * @return the TransIsFuel
     */
    public String getTransIsFuel() {
        String flag="N";
        ...
        Row [] rr1=tunevo.getFilteredRows("ItmId",getItmId());
        if(rr1.length>0){
            flag=rr1[0].getAttribute("FuelFlg").toString();
            return flag;
        }
        return flag;
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute SerialNoteTrans.
     * @return the SerialNoteTrans
     */
    public String getSerialNoteTrans() {
        return (String) getAttributeInternal(SERIALNOTETRANS);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute SerialNoteTrans.
     * @param value value to set the  SerialNoteTrans
     */
    public void setSerialNoteTrans(String value) {
        setAttributeInternal(SERIALNOTETRANS, value);
    }
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link MmMtlIssuSrNote.
     */
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link StockDetal.
     */
    public RowIterator getStockDetal() {
        return (RowIterator) getAttributeInternal(STOCKDETAL);
    }
