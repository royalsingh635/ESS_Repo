...
import mmqcsetupapp.model.entities.MmQcParamGrpEOImpl;
...
// ---------------------------------------------------------------------
public class MmQcParamGrpVORowImpl extends ViewRowImpl {


    public static final int ENTITY_MMQCPARAMGRPEO = 0;
    ...
    public enum AttributesEnum {
        CldId {
            public Object get(MmQcParamGrpVORowImpl obj) {
                return obj.getCldId();
            }

            public void put(MmQcParamGrpVORowImpl obj, Object value) {
        ...
        TransParanTyp {
            public Object get(MmQcParamGrpVORowImpl obj) {
                return obj.getTransParanTyp();
            }

            public void put(MmQcParamGrpVORowImpl obj, Object value) {
                obj.setTransParanTyp((Integer)value);
            }
        }
        ,
        LovGrpIdVO {
            public Object get(MmQcParamGrpVORowImpl obj) {
                return obj.getLovGrpIdVO();
            }
        ...
        public abstract Object get(MmQcParamGrpVORowImpl object);

        public abstract void put(MmQcParamGrpVORowImpl object, Object value);
    ...
    public static final int TRANSPARANTYP = AttributesEnum.TransParanTyp.index();
     ...
     */
    public MmQcParamGrpVORowImpl() {
    }

    /**
     * Gets MmQcParamGrpEO entity object.
     * @return the MmQcParamGrpEO
     */
    public MmQcParamGrpEOImpl getMmQcParamGrpEO() {
        return (MmQcParamGrpEOImpl)getEntity(ENTITY_MMQCPARAMGRPEO);
    }
    ...
    public void setStdVal(Number value) {
        ...
        if(value != null && getTlrncType() != null && getTlrncLower()!=null && getTlrncUpper()!=null){
            ...
            {
                            try{
                              Number  upprLimit = (Number)value.plus(getTlrncUpper().multiply(value).divide(new Number(100))).round(6);
                                Number  lowerLimit =(Number)( (Number)value.minus(getTlrncLower().multiply(value).divide(new Number(100)))).round(6);
                            setUpperLimit(upprLimit);
                                setLowerLimit(lowerLimit);
                            }catch (NullPointerException e) {
                                    }
    ...
    public void setTlrncLower(Number value) {
        ...
        if(value != null && getTlrncType() != null){
            ...
            {
                            try{
                              Number  lwrLimit = (Number)((Number)getStdVal().minus((value.multiply(getStdVal()).divide(new Number(100))).abs())).round(6);  // change value to abs Value     
                            setLowerLimit(lwrLimit);
        ...
        if(value != null && getTlrncType() != null){
            ...
            }else if(getTlrncType().equalsIgnoreCase("P") && getStdVal() != null)
            {
                Number stdVal = (Number)getStdVal().abs();
                            try{
                              Number  upprLimit = (Number)getStdVal().plus(value.multiply(stdVal).divide(new Number(100))).round(6);
                            setUpperLimit(upprLimit);
                            }catch (NullPointerException e) {
                                    }
                        }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransParanTyp.
     * @return the TransParanTyp
     */
    public Integer getTransParanTyp() {
       ...
       // Row[] xx=am.getLovParamId().getFilteredRows("ParamId", inputParmId);
        ...
        return (Integer) getAttributeInternal(TRANSPARANTYP);
        }
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransParanTyp.
     * @param value value to set the  TransParanTyp
     */
    public void setTransParanTyp(Integer value) {
        if(value ==275){
        ...
        setAttributeInternal(TRANSPARANTYP, value);
    }
