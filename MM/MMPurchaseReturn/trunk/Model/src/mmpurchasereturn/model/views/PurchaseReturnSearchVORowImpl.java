...
public class PurchaseReturnSearchVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransPurRtnType {
            public Object get(PurchaseReturnSearchVORowImpl obj) {
                return obj.getTransPurRtnType();
            }

            public void put(PurchaseReturnSearchVORowImpl obj, Object value) {
                obj.setTransPurRtnType((Integer) value);
            }
        }
        ,
        LovWhIdVO1 {
    ...
    public static final int TRANSPURRTNTYPE = AttributesEnum.TransPurRtnType.index();
    ...
    /**
     * Gets the attribute value for the calculated attribute TransPurRtnType.
     * @return the TransPurRtnType
     */
    public Integer getTransPurRtnType() {
        return (Integer) getAttributeInternal(TRANSPURRTNTYPE);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransPurRtnType.
     * @param value value to set the  TransPurRtnType
     */
    public void setTransPurRtnType(Integer value) {
        setAttributeInternal(TRANSPURRTNTYPE, value);
    }
