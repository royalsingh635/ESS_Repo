...
public class MmEoItmEOImpl extends EntityImpl {
    ...
    public void setItmId(String value) {
        System.out.println("Setting itm id "+value);
        setAttributeInternal(ITMID, value);
        System.out.println("getting itm id "+this.getItmId());
    }
    ...
    /**
     * Gets the attribute value for DfltSuppFlg, using the alias name DfltSuppFlg.
     * @return the value of DfltSuppFlg
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for DfltSuppFlg.
     * @param value value to set the DfltSuppFlg
     */
