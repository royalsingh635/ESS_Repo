...
public class MmEoItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        DfltSuppFlg {
            public Object get(MmEoItmVORowImpl obj) {
                return obj.getDfltSuppFlg();
            }

            public void put(MmEoItmVORowImpl obj, Object value) {
                obj.setDfltSuppFlg((String) value);
            }
        }
        ,
        EoPartNo {
    ...
    public static final int DFLTSUPPFLG = AttributesEnum.DfltSuppFlg.index();
    ...
    public void setItmPrice(Number value) {
      ...
      //  setItmPriceUomBs(price.multiply(uomconv));
      setItmPriceUomBs(price.divide(uomconv));
        System.out.println(" value "+value+"  uomconv  "+uomconv+" price.multiply(uomconv)   "+price.multiply(uomconv)+" actual "+price.divide(uomconv) );
    ...
    System.out.println(" inside get Trans price bs unit "+uomConvFctr+" price "+price +" curr "+currconv+ " amnt "+(price.multiply(uomConvFctr)).multiply(currconv)+" actual--"+(price.divide(uomConvFctr)).multiply(currconv));
    ...
    public void setTransItmDesc(String value) {
        System.out.println("Setting trns desc "+value);
        setAttributeInternal(TRANSITMDESC, value);
        System.out.println("getting trns desc "+this.getTransItmDesc());
    }
    ...
    /**
     * Gets the attribute value for DFLT_SUPP_FLG using the alias name DfltSuppFlg.
     * @return the DFLT_SUPP_FLG
     */
    public String getDfltSuppFlg() {
        return (String) getAttributeInternal(DFLTSUPPFLG);
    }

    /**
     * Sets <code>value</code> as attribute value for DFLT_SUPP_FLG using the alias name DfltSuppFlg.
     * @param value value to set the DFLT_SUPP_FLG
     */
    public void setDfltSuppFlg(String value) {
        setAttributeInternal(DFLTSUPPFLG, value);
    }
