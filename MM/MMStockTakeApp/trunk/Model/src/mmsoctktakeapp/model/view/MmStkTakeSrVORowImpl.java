...
public class MmStkTakeSrVORowImpl extends ViewRowImpl {
  ...
  private static ADFLogger adfLog =(ADFLogger)ADFLogger.createADFLogger(MmStkTakeSrVORowImpl.class);
    ...
    public String getTransItemDesc() {
        System.out.println("in the transitemdesc sr");
        String name = null;
    ...
    public String getTransUomDesc() {
        System.out.println("in the transuomdesc sr");
        String name = null;
    ...
    /**
     * Gets the attribute value for SR_REMARKS using the alias name SrRemarks.
     * @return the SR_REMARKS
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for SR_REMARKS using the alias name SrRemarks.
     * @param value value to set the SR_REMARKS
     */
