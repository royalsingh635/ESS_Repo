...
public class PerfevalBean {
    ...
    public void saveButton(ActionEvent actionEvent) {
        ...
        if (SetparamMode.equalsIgnoreCase("A")) {
            ...
            String id = (String) (callStoredFunction(VARCHAR, "MM.FN_MM_GEN_ID(?,?,?,?)", new Object[] {
    ...
    public void addparameterButton(ActionEvent actionEvent) {
        ...
        if (count > 0) {
            FacesMessage msg = new FacesMessage(resolvElDCMsg("#{bundle['MSG.108']}").toString());
    ...
    public void weightagesValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (wtg.intValue() == 0) {
            ...
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Weightage will not be zero",
                                                          null));
        }
        if (wtg.intValue() < 0 || wtg.intValue() > 100) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                          resolvElDCMsg("#{bundle['MSG.284']}").toString(), null));
        }
    }
    ...
    public void saveWeithage(ActionEvent actionEvent) {
        ...
        if (wtag.compareTo(hund) != 0) {
            FacesMessage msg =
                new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.284']}").toString(), null);
            fc.addMessage(null, msg);
        } else {
            BindingContainer bindings = getBindings();
            OperationBinding operationBinding = bindings.getOperationBinding("Commit");
    ...
    public void actvValueChangeListener(ValueChangeEvent vce) {
        ...
        if (vce.getNewValue() != null) {
            ...
            if (newVal.equalsIgnoreCase("true")) {
                ...
                row.setAttribute("InactvDt", "");
                row.setAttribute("InactvResn", "");
