...
public class quotationAnaAMImpl extends ApplicationModuleImpl implements quotationAnaAM {
     ...
     * @return MmQuot2
     */
    public MmQuotVOImpl getMmQuot2() {
        return (MmQuotVOImpl) findViewObject("MmQuot2");
    }
    ...
    /**
     * Container's getter for MMQuotationView1.
     * @return MMQuotationView1
     */
    public ViewObjectImpl getMMQuotationView() {
        return (ViewObjectImpl) findViewObject("MMQuotationView");
    }

    /**
     * Container's getter for RfqtoViewQuotationVL1.
     * @return RfqtoViewQuotationVL1
     */
    public ViewLinkImpl getRfqtoViewQuotationVL1() {
        return (ViewLinkImpl) findViewLink("RfqtoViewQuotationVL1");
    }
    
    public void resetQuot(){
        /*    ViewObjectImpl quotvo=this.getMmQuot1();
        quotvo.setNamedWhereClauseParam("bindQuotStatus", null);
        quotvo.executeQuery(); */
    }
    ...
    public void executeQuotAnaWithRFQId(String cldId,Integer slocId,String orgId, String rfqDocId)
    {
        ViewCriteria vc=this.getQuotAnaRsltRFQID1().getViewCriteria("QuotAnaRsltRFQIDVOCriteria");
            ...
            this.getQuotAnaRsltRFQID1().setNamedWhereClauseParam("SlocIdBindVar", slocId);
            this.getQuotAnaRsltRFQID1().setNamedWhereClauseParam("OrgIdBindVar", orgId);
            this.getQuotAnaRsltRFQID1().setNamedWhereClauseParam("BindRfqDocId", rfqDocId);
            this.getQuotAnaRsltRFQID1().applyViewCriteria(vc);
            this.getQuotAnaRsltRFQID1().executeQuery();
    ...
    {
        System.out.println("-----calling method from Dasboard--->>>>>>>>>>>>>>>>>");
        System.out.println("--passing value from dashboard -----  "+cldId +" "+slocId+" "+orgId+" "+rfqDocId);
            ViewCriteria vc=this.getQuotAnaRsltRFQID1().getViewCriteria("QuotAnaRsltRFQIDVOCriteria");
            this.getQuotAnaRsltRFQID1().setNamedWhereClauseParam("CldIdBindVar", cldId);
            this.getQuotAnaRsltRFQID1().setNamedWhereClauseParam("SlocIdBindVar", slocId);
            this.getQuotAnaRsltRFQID1().setNamedWhereClauseParam("OrgIdBindVar", orgId);
