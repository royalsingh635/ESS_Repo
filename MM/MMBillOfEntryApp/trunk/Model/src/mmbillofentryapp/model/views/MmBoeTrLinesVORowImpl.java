...
import mmbillofentryapp.model.entities.MmBoeTrLinesEOImpl;
...
// ---    Sat Apr 04 16:23:54 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MmBoeTrLinesVORowImpl extends ViewRowImpl {


    public static final int ENTITY_MMBOETRLINESEO = 0;
    ...
    public static final int TRANSTAXCOANM = AttributesEnum.TransTaxCoaNm.index();
    public static final int TRANSHOORGID = AttributesEnum.TransHoOrgId.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MmBoeTrLinesVORowImpl() {
    }

    /**
     * Gets MmBoeTrLinesEO entity object.
     * @return the MmBoeTrLinesEO
     */
    public MmBoeTrLinesEOImpl getMmBoeTrLinesEO() {
        return (MmBoeTrLinesEOImpl) getEntity(ENTITY_MMBOETRLINESEO);
    }
    ...
    public String getTransTaxTypeNm() {
        if (getTaxType() != null) {
            ...
            am.getLovTaxType().setNamedWhereClauseParam("HoOrgIdBind", getTransHoOrgId());
            am.getLovTaxType().setNamedWhereClauseParam("CldIdBind", getCldId());
            am.getLovTaxType().setNamedWhereClauseParam("SlocIdBind", getSlocId());
            am.getLovTaxType().setNamedWhereClauseParam("TaxTypeIdBind", getTaxType());
            am.getLovTaxType().executeQuery();
            Row[] rr = am.getLovTaxType().getFilteredRows("TaxTypeId", getTaxType());
    ...
    /**
     * Gets the attribute value for the calculated attribute TransTaxCoaNm.
     * @return the TransTaxCoaNm
     */
    public String getTransTaxCoaNm() {
        if (getTaxCoaId() != null) {
            BillOfEntryAMImpl am = (BillOfEntryAMImpl) this.getApplicationModule();
            am.getLovTaxCoaId().setNamedWhereClauseParam("HoOrgIdBind", getTransHoOrgId());
            am.getLovTaxCoaId().setNamedWhereClauseParam("CldIdBind", getCldId());
            am.getLovTaxCoaId().setNamedWhereClauseParam("SlocIdBind", getSlocId());
            am.getLovTaxCoaId().setNamedWhereClauseParam("CoaIdBind", getTaxCoaId());
            ...
            if (rr.length > 0 && rr[0].getAttribute("CoaNm") != null) {
                ...
                return (String) getAttributeInternal(TRANSTAXCOANM);
            }
        } else {
            return (String) getAttributeInternal(TRANSTAXCOANM);
        }
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransTaxCoaNm.
     * @param value value to set the  TransTaxCoaNm
     */
    public void setTransTaxCoaNm(String value) {
        setAttributeInternal(TRANSTAXCOANM, value);
    }
