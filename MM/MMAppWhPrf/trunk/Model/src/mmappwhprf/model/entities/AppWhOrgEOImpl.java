...
public class AppWhOrgEOImpl extends EntityImpl {
    ...
    public static final int APPBINLOCT = AttributesEnum.APPBinLoct.index();
    ...
    private void setUsrIdModDt(Timestamp value) {
     ...
     */
    public RowIterator getAPPBinLoct() {
        return (RowIterator) getAttributeInternal(APPBINLOCT);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        String whid = (String) (callStoredFunction(Types.VARCHAR, "APP.FN_APP_GEN_ID (?,?,?,?,?)", new Object[] {
                                                   slocId, cldId, ho, org, "APP$WH$ORG"
        }));
        System.out.println("Wh id is-->" + whid);
        setWhId(whid);
        Object prj = resolvEl("#{pageFlowScope.GLBL_ORG_PROJ_ID}");
        if (prj != null) {
            this.setPrjId(prj.toString());
        }
