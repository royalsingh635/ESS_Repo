...
public class AppKitVORowImpl extends ViewRowImpl {
    ...
    public String getInputItemId_Trans() {
        if (getInputItmId() != null) {
            ...
            impl.setNamedWhereClauseParam("BindHoOrgId", getTrnasHoOrgId());
            impl.setNamedWhereClauseParam("BindItemId", getInputItmId());
            impl.executeQuery();
            Row[] rr = impl.getFilteredRows("ItmId", getInputItmId());
    ...
    public Integer getUomClass_Trans() {
        if (getInputItmUom() != null) {
            KitDefAppAMImpl am = (KitDefAppAMImpl) this.getApplicationModule();
            Row[] xx = am.getLovUomID1().getFilteredRows("UomId", getInputItmUom());
            if (xx.length > 0 && xx[0].getAttribute("UomClass") != null) {
                return (Integer) xx[0].getAttribute("UomClass");
            } else {
