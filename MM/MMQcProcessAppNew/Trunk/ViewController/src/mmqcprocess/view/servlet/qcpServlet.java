package mmqcprocess.view.servlet;
...
public class qcpServlet extends HttpServlet {
    ...
    private void openReportFun(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            String qcpNo = (String)request.getParameter("qcpNo");
            String orgId = (String)request.getParameter("orgId");
            String cldId = (String)request.getParameter("cldId");
            Integer slocId = Integer.parseInt(request.getParameter("slocId"));
            String qcTxnId = (String)request.getParameter("qcTxnId");
           
          

            InputStream input = new FileInputStream(new File(path + "QcProcess.jrxml"));
