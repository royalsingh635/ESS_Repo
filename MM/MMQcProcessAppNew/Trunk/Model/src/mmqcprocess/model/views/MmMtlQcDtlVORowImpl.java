...
public class MmMtlQcDtlVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransQcCompleteChk {
            public Object get(MmMtlQcDtlVORowImpl obj) {
                return obj.getTransQcCompleteChk();
            }

            public void put(MmMtlQcDtlVORowImpl obj, Object value) {
                obj.setTransQcCompleteChk((String) value);
            }
        },
        LovParamIdVO {
            public Object get(MmMtlQcDtlVORowImpl obj) {
    ...
    public static final int TRANSQCCOMPLETECHK = AttributesEnum.TransQcCompleteChk.index();
    ...
    public Integer getTransParamType() {
        ...
        if (inputParmId != null) {
            ...
            if (xx.length > 0 && xx[0].getAttribute("ParamType") != null) {
    ...
    public void setTransActualValNo(Number value) {
        ...
        if (getTransParamType() != null && getLowerLimit() != null && getUpperLimit() != null &&
            getTransFailAction() != null) {
            if (getTransParamType() == 274) {
                setActualVal(value);
    ...
    /**
     * Gets the attribute value for the calculated attribute TransQcCompleteChk.
     * @return the TransQcCompleteChk
     */
    public String getTransQcCompleteChk() {
        if (getChkSrlNo() != null) {
            QcProcessAMImpl am = (QcProcessAMImpl) this.getApplicationModule();
            ViewObjectImpl qcCsn = am.getMmMtlQcCsn();
            RowQualifier rq = new RowQualifier(qcCsn);
            rq.setWhereClause("CldId ='" + getCldId() + "' and SlocId =" + getSlocId() + " and OrgId ='" + getOrgId() +
                              "' and QcTxnId ='" + getQcTxnId() + "' and DocIdSrc='" + getDocIdSrc() +
                              "' and DlvSchdlNo=" + getDlvSchdlNo() + " and ItmId ='" + getItmId() + "' and ItmUom ='" +
                              getItmUom() + "' and ChkSrlNo=" + getChkSrlNo() + " ");
            Row[] rr = qcCsn.getFilteredRows(rq);
          //  System.out.println(rr.length + " getTransQcCompleteChk " + rq.getExprStr());
            if (rr.length > 0) {
                if (rr[0].getAttribute("QcCsnComplete") != null)
                    return rr[0].getAttribute("QcCsnComplete").toString();
                else
                    return "N";
            } else {
                return "N";
            ...
            return (String) getAttributeInternal(TRANSQCCOMPLETECHK);
        }
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransQcCompleteChk.
     * @param value value to set the  TransQcCompleteChk
     */
    public void setTransQcCompleteChk(String value) {
        setAttributeInternal(TRANSQCCOMPLETECHK, value);
    }
