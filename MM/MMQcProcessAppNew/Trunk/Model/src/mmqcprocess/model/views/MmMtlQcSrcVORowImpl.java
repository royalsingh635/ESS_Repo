...
import mmqcprocess.model.entities.MmMtlQcSrcEOImpl;
...
public class MmMtlQcSrcVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        LovPoNoForViewVO1 {
            public Object get(MmMtlQcSrcVORowImpl obj) {
                return obj.getLovPoNoForViewVO1();
            }
    ...
    public static final int LOVPONOFORVIEWVO1 = AttributesEnum.LovPoNoForViewVO1.index();
    public static final int LOVMNFOPNOVO1 = AttributesEnum.LovMnfOpNoVO1.index();
    public static final int LOVSCONOVO1 = AttributesEnum.LovScoNoVO1.index();
     ...
     */
    public MmMtlQcSrcEOImpl getMmMtlQcSrcEO() {
        return (MmMtlQcSrcEOImpl) getEntity(ENTITY_MMMTLQCSRCEO);
    }
    ...
    public String getDocIdSrcDisp() {
        ...
        if (type.equals(266) || type.equals(819)) {
            if(this.getLovPoNoForViewVO1().getRowCount()==1)
                return this.getLovPoNoForViewVO1().first().getAttribute("AuthPoNo").toString();
        } else if (type.equals(999)) {
            if(this.getLovMnfOpNoVO1().getRowCount()==1)
            return this.getLovMnfOpNoVO1().first().getAttribute("OpId").toString();
        } else if (type.equals(888)) {
            if(this.getLovMnfOpNoVO1().getRowCount()==1)
            return this.getLovMnfOpNoVO1().first().getAttribute("OpId").toString();
        } else if (type.equals(777)) {
            if(this.getLovMnfOpNoVO1().getRowCount()==1)
            return this.getLovMnfOpNoVO1().first().getAttribute("OpId").toString();
        }  else if (type.equals(839)) {
          //  System.out.println("In Subcontratcing"+ " row coutn is "+this.getLovMnfOpNoVO1().getRowCount());
            if(this.getLovScoNoVO1().getRowCount()==1){
            return this.getLovScoNoVO1().first().getAttribute("ScoId").toString();
            }
        } else {
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LovPoNoForViewVO1.
     */
    public RowSet getLovPoNoForViewVO1() {
        return (RowSet) getAttributeInternal(LOVPONOFORVIEWVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LovMnfOpNoVO1.
     */
    public RowSet getLovMnfOpNoVO1() {
        return (RowSet) getAttributeInternal(LOVMNFOPNOVO1);
    }

    /**
     * Gets the view accessor <code>RowSet</code> LovScoNoVO1.
     */
    public RowSet getLovScoNoVO1() {
        return (RowSet) getAttributeInternal(LOVSCONOVO1);
    }
