...
public class SuggestedOrderView {
    ...
    public String createPurchaseOrd() {
        ...
        if (i == 0) {
            System.out.println("First Faces Msg..............................");
            ...
            if (returnVal != null || returnVal != -1) {
                ...
                draftPoVO.setWhereClause("so_grp_id = '" + resolveElExp("#{pageFlowScope.APP_GRP_ID}") +
                                         "'  and FY_ID=" + (Integer) getfy.getResult());
                draftPoVO.executeQuery();
                ...
                System.out.println("Else Faces Msg===================================");
                FacesContext.getCurrentInstance().addMessage(null,
                                                             new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                              resolveElExp("#{bundle['MSG.467']}").toString(),
                                                                              null));
            }
        }
    ...
    public void viewSO(ActionEvent actionEvent) {
        ...
        clause.setWhereClause("SO_ID ='" + soId + "' AND SLOC_ID = " + p_SLOCID + " AND ORG_ID = '" + p_ORGID +
                              "' AND CLD_ID = '" + p_CLDID + "'");
        clause.executeQuery();
        FacesContext context = FacesContext.getCurrentInstance();
    ...
    public String createRFQ() {
        ...
        */
        ...
        rfqVo.executeQuery();
        rfqVo.setWhereClause("DOC_ID_SRC = '" + resolveElExp("#{pageFlowScope.APP_GRP_ID}") + "' and FY_ID=" +
                             (Integer) getfy.getResult());
        rfqVo.executeQuery();
    ...
    public String createRFQAction() {
       ...
       */
                        ...
                        set.add(new SoBean(slocId, cldId, orgId, itmId, itmUom, String.valueOf(grpId), usrId,
                                           soQty)); //add Item into HashSet<SoBean>
