...
public class ItemProfileAMClient extends ApplicationModuleImpl implements ItemProfileAM {
    ...
    public void addItemAttribute(String itmAttType, String itmAttValue) {
        Object _ret = this.riInvokeExportedMethod(this, "addItemAttribute", new String[] {
                                                  "java.lang.String", "java.lang.String" }, new Object[] {
                                                  itmAttType, itmAttValue });
        return;
    }
    ...
    public String filterImage() {
        Object _ret = this.riInvokeExportedMethod(this, "filterImage", null, null);
        return (String) _ret;
    }

    public String getAttributePath(Integer SlocId, String CldId, String hoOrgId, String itmId) {
        Object _ret = this.riInvokeExportedMethod(this, "getAttributePath", new String[] {
                                                  "java.lang.Integer", "java.lang.String", "java.lang.String",
                                                  "java.lang.String"
        }, new Object[] { SlocId, CldId, hoOrgId, itmId });
        return (String) _ret;
    }
    ...
    public String isAttributeValid(String itmAttType, String itmAttValue) {
        Object _ret = this.riInvokeExportedMethod(this, "isAttributeValid", new String[] {
                                                  "java.lang.String", "java.lang.String" }, new Object[] {
                                                  itmAttType, itmAttValue });
        return (String) _ret;
    }
    ...
    public boolean isDuplicateItmId(String name) {
        Object _ret = this.riInvokeExportedMethod(this, "isDuplicateItmId", new String[] { "java.lang.String" }, new Object[] {
                                                  name });
        return ((Boolean) _ret).booleanValue();
    }

    public Boolean isItemNameDuplicate(String itemName, String previousVal) {
        Object _ret = this.riInvokeExportedMethod(this, "isItemNameDuplicate", new String[] {
                                                  "java.lang.String", "java.lang.String" }, new Object[] {
                                                  itemName, previousVal });
        return (Boolean) _ret;
    }
    ...
    public void populateItmPropertyFrmSampleItem(String value) {
        Object _ret = this.riInvokeExportedMethod(this, "populateItmPropertyFrmSampleItem", new String[] {
                                                  "java.lang.String" }, new Object[] { value });
        return;
    }

    public Integer replicateAllOrgFoItm() {
        Object _ret = this.riInvokeExportedMethod(this, "replicateAllOrgFoItm", null, null);
        return (Integer) _ret;
    }

    public String resetItmAttVal() {
        Object _ret = this.riInvokeExportedMethod(this, "resetItmAttVal", null, null);
        return (String) _ret;
    }
    ...
    public void updateItemIdAfterApproved(String retValue) {
        Object _ret = this.riInvokeExportedMethod(this, "updateItemIdAfterApproved", new String[] {
                                                  "java.lang.String" }, new Object[] { retValue });
        return;
    }
}
