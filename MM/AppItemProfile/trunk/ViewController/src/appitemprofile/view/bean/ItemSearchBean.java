...
public class ItemSearchBean {
    private RichInputRangeSlider amountSlider=new RichInputRangeSlider();
   ...
   private Integer count=-1;
    ...
    private NumberRange sliderValue;

    public ItemSearchBean() {
        BigDecimal bigDecimal = getMaxNo();
              Number n = new Number(0);
              try {
                  n = new Number(bigDecimal);
              } catch (SQLException e) {
              }
              sliderValue = new NumberRange(0, Integer.valueOf(bigDecimal.intValue()));
