...
import TickerApp.model.views.MmGlBlTkrVOImpl;
...
public class TickerAppAMImpl extends ApplicationModuleImpl implements TickerAppAM {
        ...
        if(currentRow.getAttribute("TickerId")!=null){
            ...
            if(filteredRows.length>0){
               ...
               Actve= filteredRows[0].getAttribute("Actv").toString();
                ...
                if(filteredRows[0].getAttribute("GlblAppliStructId")!=null){
                AppliStruct= filteredRows[0].getAttribute("GlblAppliStructId").toString();
                }
              // Row createRow = mmtkr.createRow();
               ...
               // System.out.println("current ro----"+createRow.getKey());
                ...
                mmtkr.getCurrentRow().setAttribute("GlblAppliStructId", AppliStruct);
                //mmtkr.executeQuery();
    ...
    /**
     * Container's getter for AppStruct1.
     * @return AppStruct1
     */
    public ViewObjectImpl getAppStruct1() {
        return (ViewObjectImpl) findViewObject("AppStruct1");
    }
    public Integer chkTkrId(){
        ViewObjectImpl vo= this.getMmTkr1();
        if(vo.getCurrentRow().getAttribute("TkrId")!=null){
    return 1;
    }else 
    return 0;
    }
