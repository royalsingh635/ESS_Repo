...
// ---    Tue Sep 17 18:55:47 IST 2013
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SrchBinVoRowImpl extends ViewRowImpl {
    /**
     * AttributesEnum: generated enum for identifying attributes and accessors. Do not modify.
     */
    public enum AttributesEnum {
        BinId {
            public Object get(SrchBinVoRowImpl obj) {
                return obj.getBinId();
            }

            public void put(SrchBinVoRowImpl obj, Object value) {
        ...
        public abstract Object get(SrchBinVoRowImpl object);

        public abstract void put(SrchBinVoRowImpl object, Object value);
    ...
    public BigDecimal getAdjtQty() {
        ...
        MMStockAdjustmentAMImpl am = (MMStockAdjustmentAMImpl)resolvElDC("MMStockAdjustmentAMDataControl");
         ViewObjectImpl vo = am.getSTKADJTBIN1();
         
         RowQualifier rq = new RowQualifier(vo);
         rq.setWhereClause("BinId ='"+getBinId()+"' AND LotId ='"+getLotId()+"' AND ItmId = '"+getItmId()+"' AND OrgId = '"+getOrgId()+"' AND CldId = '"+getCldId()+"' AND SlocId = "+getSlocId()+"");
