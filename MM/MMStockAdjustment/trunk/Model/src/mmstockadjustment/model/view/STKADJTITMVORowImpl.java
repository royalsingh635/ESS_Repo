...
public class STKADJTITMVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        LovStaticRemarkVO1 {
            public Object get(STKADJTITMVORowImpl obj) {
                return obj.getLovStaticRemarkVO1();
            }
    ...
    public static final int LOVSTATICREMARKVO1 = AttributesEnum.LovStaticRemarkVO1.index();
    ...
    /**
     * Gets the attribute value for ADJT_REM_STATIC using the alias name AdjtRemStatic.
     * @return the ADJT_REM_STATIC
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for ADJT_REM_STATIC using the alias name AdjtRemStatic.
     * @param value value to set the ADJT_REM_STATIC
     */
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LovStaticRemarkVO1.
     */
    public RowSet getLovStaticRemarkVO1() {
        return (RowSet) getAttributeInternal(LOVSTATICREMARKVO1);
    }
