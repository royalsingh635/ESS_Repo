...
public class MmDrftPoDlvSchdlVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransDlvAddress {
            public Object get(MmDrftPoDlvSchdlVORowImpl obj) {
                return obj.getTransDlvAddress();
            }

            public void put(MmDrftPoDlvSchdlVORowImpl obj, Object value) {
                obj.setTransDlvAddress((String) value);
            }
        }
        ,
        LovItmId {
    ...
    public String getTransDlvAddress() {
        if(getDlvAddsId()!=null){
            ...
            am.getLovAddressView().setNamedWhereClauseParam("AddsIdBind", getDlvAddsId());
            am.getLovAddressView().executeQuery();
            Row []rr = am.getLovAddressView().getFilteredRows("AddsId", getDlvAddsId());
