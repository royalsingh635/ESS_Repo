...
// ---------------------------------------------------------------------
public class MmPrFlxVORowImpl extends ViewRowImpl {


    public static final int ENTITY_MMPRFLXEO = 0;
    ...
    public enum AttributesEnum {
        CldId {
            public Object get(MmPrFlxVORowImpl obj) {
                return obj.getCldId();
            }

            public void put(MmPrFlxVORowImpl obj, Object value) {
        ...
        public abstract Object get(MmPrFlxVORowImpl object);

        public abstract void put(MmPrFlxVORowImpl object, Object value);
    ...
    public static final int LOVFLXFLDVAL = AttributesEnum.LovFlxFldVal.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MmPrFlxVORowImpl() {
    }

    /**
     * Gets MmPrFlxEO entity object.
     * @return the MmPrFlxEO
     */
    public EntityImpl getMmPrFlxEO() {
        return (EntityImpl) getEntity(ENTITY_MMPRFLXEO);
    }
    ...
    public Timestamp getFldValDate() {
        if (getFldVal() != null && getTransFldtype() != null && getTransFldtype().compareTo(756) == 0) {
            ...
            try {
                ...
                Timestamp ts = new Timestamp(newDateString);
    ...
    public Integer getTransFldtype() {
        ...
        if (getFldId() != null) {
            ...
            ViewObjectImpl fld = am.getAppFlexFld();
            fld.setNamedWhereClauseParam("bindCldId", getCldId());
            fld.setNamedWhereClauseParam("bindDocId", new Integer(18514));
            fld.executeQuery();
    ...
    public String getTransFldReq() {
        ...
        if (getFldId() != null) {
            Integer prCatg = 0;
            if(am.getMmPr2().getCurrentRow().getAttribute("PrCatg")!= null){
                prCatg = (Integer)am.getMmPr2().getCurrentRow().getAttribute("PrCatg");
            }  
            //System.out.println("Value of fldid id:::" + getFldId());
            ViewObjectImpl fld = am.getAppFlxFldInsrt();
            fld.setNamedWhereClauseParam("bindCldId", getCldId());
            fld.setNamedWhereClauseParam("bindDocId", new Integer(18514));
            fld.setNamedWhereClauseParam("bindTypeId", prCatg);
            fld.executeQuery();
            Row rr[] = fld.getFilteredRows("FldId", getFldId());
            if (rr.length > 0) {
                String req = (String) rr[0].getAttribute("Reqd");
                 System.out.println("value of type::---------------" + req);
                return req;
            }
        }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LovFlxFldVal.
     */
    public RowSet getLovFlxFldVal() {
        return (RowSet) getAttributeInternal(LOVFLXFLDVAL);
    }
