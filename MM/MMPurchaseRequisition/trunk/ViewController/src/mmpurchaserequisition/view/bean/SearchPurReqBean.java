...
public class SearchPurReqBean {
    ...
    private RichSelectOneChoice prCatgBind;
    ...
    public String AddPrAction() {
        // Add event code here...
        Object ob = this.getBindings().getOperationBinding("isValidDocument").execute();
        System.out.println("ob " + ob);
        if (ob != null && ob.equals("N")) {
            FacesMessage msg = new FacesMessage("Document is not Properly setup for PR !!");
    ...
    public void setPrCatgBind(RichSelectOneChoice prCatgBind) {
        this.prCatgBind = prCatgBind;
    }

    public RichSelectOneChoice getPrCatgBind() {
        return prCatgBind;
    }
}
