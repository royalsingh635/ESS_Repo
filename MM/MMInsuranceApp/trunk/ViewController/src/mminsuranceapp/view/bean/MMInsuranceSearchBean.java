...
public class MMInsuranceSearchBean {
    private RichPanelGroupLayout panelGrpBind;

    public MMInsuranceSearchBean() {
    }
    ...
    public String SearchAction() {
        // Add event code here...
        OperationBinding srchsvc = getBindings().getOperationBinding("searchINS");
        srchsvc.execute();
        return null;
    ...
    public String ResetAction() {
        ...
        OperationBinding rstObind = getBindings().getOperationBinding("resetINS");
        rstObind.execute();
        return null;
