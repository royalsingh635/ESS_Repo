...
public class BdgEoBudgetProdPrdDtlVORowImpl extends ViewRowImpl {
     ...
     */
    public EntityImpl getBdgEoBudgetProdPrdDtlEO() {
        return (EntityImpl) getEntity(ENTITY_BDGEOBUDGETPRODPRDDTLEO);
    }
    ...
    public Number getTransItmAmtSpDisp() {
        if (getAttributeInternal(TRANSITMAMTSPDISP) != null)
