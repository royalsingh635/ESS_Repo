...
// ---    Mon May 04 12:22:16 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class BdgExpenseSummVORowImpl extends ViewRowImpl {
    /**
    ...
    public static final int TOTBALNOTATRANS = AttributesEnum.TotbalNotaTrans.index();

    /**
     * This is the default constructor (do not remove).
     */
    public BdgExpenseSummVORowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TotbalNotaTrans.
     * @return the TotbalNotaTrans
     */
    public Number getTotbalNotaTrans() {
        if (getAttributeInternal(TOTBALNOTATRANS) == null && this.getTotbal() != null) {
            return this.getAm().convertNumberToNotation(getTotbal());
        }
        return (Number) getAttributeInternal(TOTBALNOTATRANS);
    }
