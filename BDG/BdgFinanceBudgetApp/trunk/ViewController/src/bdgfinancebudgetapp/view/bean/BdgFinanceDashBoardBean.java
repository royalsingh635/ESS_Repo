...
public class BdgFinanceDashBoardBean {
    ...
    private SideBarItem _EMPLOYEE = new SideBarItem("Employee Details", "");
    private SideBarItem _MONTHLY = new SideBarItem("Monthly Budget", "");
    private SideBarItem _BUDGETVSACTUAL = new SideBarItem("Budget Vs Actual Variance", "");
    private SideBarItem _COMPARISION = new SideBarItem("Comparision", "");
    ...
    public BdgFinanceDashBoardBean() {

        _sideBarItems = new ArrayList<SideBarItem>(4);
        _sideBarItems.add(_EMPLOYEE);
        _sideBarItems.add(_MONTHLY);
        _sideBarItems.add(_BUDGETVSACTUAL);
        _sideBarItems.add(_COMPARISION);
    }
