...
public class TagDC {
    ...
    public TagDC(StringBuffer idFirst, StringBuffer valueFirst, StringBuffer descFirst, StringBuffer idSecond,
                 StringBuffer valueSecond, StringBuffer descSecond) {
        this.idFirst = idFirst;
        this.valueFirst = valueFirst;
        this.descFirst = descFirst;
