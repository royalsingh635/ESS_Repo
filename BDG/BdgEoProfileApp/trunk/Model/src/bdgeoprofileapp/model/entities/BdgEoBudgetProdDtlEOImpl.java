...
// ---    Tue Dec 16 17:26:35 IST 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class BdgEoBudgetProdDtlEOImpl extends EntityImpl {
    /**
     ...
     */
    public BdgEoBudgetProdDtlEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("bdgeoprofileapp.model.entities.BdgEoBudgetProdDtlEO");
    }
    ...
    public static Key createPrimaryKey(String cldId, Integer slocId, String orgId, String hoOrgId, String docId,
                                       Integer custEoId, String itmGrpId, String itmId, Integer bdgFyId, Integer eoId,
                                       String region) {
        return new Key(new Object[] {
                       cldId, slocId, orgId, hoOrgId, docId, custEoId, itmGrpId, itmId, bdgFyId, eoId, region });
    }
    ...
    protected void create(AttributeList attributeList) {
        System.out.println("DocId in rowImpl is " + this.getDocId());
        ...
        this.setPrdStartDt(this.getBdgEoBudget().getPrdStartDt());
        this.setPrdEndDt(this.getBdgEoBudget().getPrdEndDt());
        //this.setBdgGrpId(this.getBdgEoBudget().getBdgGrpId());
        this.setCurrIdSp(this.getBdgEoBudget().getCurrIdSp());
        this.setCurrConvRate(this.getBdgEoBudget().getCurrConvRate());
        this.setEoId(this.getBdgEoBudget().getEoId());
        this.setItmSelType("I");
        this.setRegion(this.getBdgEoBudget().getRegion());
        ...
        this.setDistbMethd(this.getBdgEoBudget().getDistbMethd());
        this.setDistbPrdBasis(this.getBdgEoBudget().getDistbPrdBasis());
    ...
    /* public String getHexDocNoFromFun() {
        ...
        try {
            hexDocIdFromFun = this.callStoredFunction(Types.VARCHAR, "APP.GET_TXN_ID_CC(?,?,?,?,?,?,?)", new Object[] {
                                                      ...
                                                      this.getUsrIdCreate(), 34002, 84901, 0
            }).toString();
