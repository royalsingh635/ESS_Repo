...
// ---    Tue Aug 11 13:59:26 IST 2015
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class HcmJobAdvtDtlEOImpl extends EntityImpl {
    /**
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("hrjobadapp.model.entities.HcmJobAdvtDtlEO");
    }
    ...
    /**
     * Gets the attribute value for NoVacancies, using the alias name NoVacancies.
     * @return the value of NoVacancies
     */
    public oracle.jbo.domain.Number getNoVacancies() {
        return (oracle.jbo.domain.Number) getAttributeInternal(NOVACANCIES);
    }

    /**
     * Sets <code>value</code> as the attribute value for NoVacancies.
     * @param value value to set the NoVacancies
     */
    public void setNoVacancies(oracle.jbo.domain.Number value) {
    ...
    public static Key createPrimaryKey(String cldId, Integer slocId, String hoOrgId, String orgId, Timestamp docDt,
                                       String jobId, String deptId, String desigId, String docId) {
        return new Key(new Object[] { cldId, slocId, hoOrgId, orgId, docDt, jobId, deptId, desigId, docId });
    }
