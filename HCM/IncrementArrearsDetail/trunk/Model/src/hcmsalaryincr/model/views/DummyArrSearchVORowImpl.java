...
// ---    Tue Sep 23 19:28:55 PDT 2014
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class DummyArrSearchVORowImpl extends ViewRowImpl
{
    /**
    ...
    public enum AttributesEnum {
        ...
        public int index() {
            return DummyArrSearchVORowImpl.AttributesEnum.firstIndex() + ordinal();
        }
        ...
        public static int count() {
            return DummyArrSearchVORowImpl.AttributesEnum.firstIndex() +
                   DummyArrSearchVORowImpl.AttributesEnum.staticValues().length;
        }

        public static final AttributesEnum[] staticValues() {
            if (vals == null) {
                vals = DummyArrSearchVORowImpl.AttributesEnum.values();
            }
            return vals;
        }
    }
    ...
    public static final int INCRMNTDTNEW = AttributesEnum.incrmntDtNew.index();
    public static final int APPLICBLEDTNEW = AttributesEnum.applicbleDtNew.index();
    public static final int TRANSWRKSTAT = AttributesEnum.transWrkStat.index();
    public static final int TRANSINCRCRITERIA = AttributesEnum.transIncrCriteria.index();
     ...
     */
    public DummyArrSearchVORowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute incrmntDtNew.
     * @return the incrmntDtNew
     */
    public Timestamp getincrmntDtNew() {
        return (Timestamp) getAttributeInternal(INCRMNTDTNEW);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute incrmntDtNew.
     * @param value value to set the  incrmntDtNew
     */
    public void setincrmntDtNew(Timestamp value) {
        setAttributeInternal(INCRMNTDTNEW, value);
    }

    /**
     * Gets the attribute value for the calculated attribute applicbleDtNew.
     * @return the applicbleDtNew
     */
    public Timestamp getapplicbleDtNew() {
        return (Timestamp) getAttributeInternal(APPLICBLEDTNEW);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute applicbleDtNew.
     * @param value value to set the  applicbleDtNew
     */
    public void setapplicbleDtNew(Timestamp value) {
        setAttributeInternal(APPLICBLEDTNEW, value);
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute transIncrCriteria.
     * @return the transIncrCriteria
     */
    public String gettransIncrCriteria()
    {
        return (String) getAttributeInternal(TRANSINCRCRITERIA);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute transIncrCriteria.
     * @param value value to set the  transIncrCriteria
     */
    public void settransIncrCriteria(String value)
    {
        setAttributeInternal(TRANSINCRCRITERIA, value);
    }
