...
// ---------------------------------------------------------------------
public class MmSchmFreeItmVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public MmSchmFreeItmVOImpl() {
    }
    ...
    public void deleteFromScheme_FreeItem(Integer SlocId, String OrgId, String SchemeId, String CldId) {
        this.setWhereClause("SLOC_ID=" + SlocId + " AND ORG_ID='" + OrgId + "' AND SCHM_ID='" + SchemeId +
                            "'AND CLD_ID='" + CldId + "'");
        ...
        this.executeQuery();  
        System.out.println("tottal no of rowa ias==" + this.getRowCount());
        System.out.println(this.getEstimatedRowCount());

        RowSetIterator createRowSetIterator = this.createRowSetIterator(null);

        while (createRowSetIterator.hasNext()) {
            System.out.println("MMSchemeFreeItem");
