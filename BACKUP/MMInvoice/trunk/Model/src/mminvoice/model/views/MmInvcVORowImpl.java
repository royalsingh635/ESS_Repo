...
public class MmInvcVORowImpl extends ViewRowImpl {
    ...
    public void setTransInvcAmtSp(Number value) {
        ...
        else{setAttributeInternal(TRANSINVCAMTSP, value);}
    }
    ...
    public void setTransPmtAmtSp(Number value) {
        ...
        else{setAttributeInternal(TRANSPMTAMTSP, value);}
    }
    ...
    public void setTotAmtBs(Number value) {
        ...
        else {setAttributeInternal(TOTAMTBS, value);}
    }
    ...
    public String getTransVouId() {
        if(getGlVouId() != null)
        {
         Object dispId =(Object)(callStoredFunction(Types.VARCHAR, "MM.MM_GET_VOU_NO(?,?,?,?)", new Object[] {this.getCldId(),this.getSlocId(),this.getOrgId(),this.getGlVouId()}));
             if(dispId != null)
