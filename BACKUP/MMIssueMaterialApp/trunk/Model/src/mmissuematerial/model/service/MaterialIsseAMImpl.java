...
public class MaterialIsseAMImpl extends ApplicationModuleImpl implements MaterialIsseAM {
    ...
    // String txnId = (String)callStoredFunction(Types.VARCHAR, "FN_MM_GEN_ID(?,?,?,?)", new Object[]{SlocId,CldId,OrgId,tableName}); 
     String docId =(String)(callStoredFunction(Types.VARCHAR, "app.get_txn_id (?,?,?,?,?,?)", new Object[] {CldId,SlocId, OrgId,UsrId, new Integer(18516),new Integer(0)})); // app.pkg_app.get_txn_id(p_usr_id,p_org_id,p_sloc_id,18505)
    ...
    public String generateIssueNo (Integer SlocId ,String CldId, String OrgId, String TableName){
        String issueId = (String)callStoredFunction(Types.VARCHAR, "FN_MM_GEN_ID(?,?,?,?)", new Object[]{SlocId,CldId,OrgId,TableName});
    ...
    public String genIssueNo (Integer SlocId ,String CldId, String OrgId, String TableName,String WhId,Integer fyId){
       ...
       if(issuRow.getAttribute("IssuNo")==null){
         issueNo = (String)callStoredFunction(Types.VARCHAR, "FN_MM_GEN_ID(?,?,?,?,?,?)", new Object[]{SlocId,CldId,OrgId,TableName,WhId,fyId});
        ...
        ViewObjectImpl mtlIssu = this.getMmMtlIssu();
         ...
         if(issuType!=null && issuto!=null){
             if(issuType==323 && curr.getAttribute("RqmtAreaIdSrc")==null){
                 ...
                 curr.setAttribute("TransDocumentNo", null);
                 adflog.info("O------------------------");
             }else if(issuType==325 && issuto ==366 && curr.getAttribute("OrgIdSrc")!=null && curr.getAttribute("WhIdSrc")==null){
                 ret="S";
                 curr.setAttribute("TransDocumentNo", null);
                 adflog.info("S------------------------");
             }else if(issuType==323 && curr.getAttribute("RqmtAreaIdSrc")!=null && curr.getAttribute("RetnblIssu")!=null && "Y".equalsIgnoreCase(curr.getAttribute("RetnblIssu").toString())){
         ...
         if(curr.getAttribute("RetnblIssu")!=null && "N".equalsIgnoreCase(curr.getAttribute("RetnblIssu").toString())){
        ...
        Row srcInsrt = issuSrc.createRow();
           ...
           adflog.info("length--------"+itmRow.length);
            ...
            for(Row r :itmRow){
                ...
                if(r.getAttribute("ItmId")!=null && r.getAttribute("ItmUomBs")==null && r.getAttribute("UomConvFctr")==null){
                if(uomBs!=null && r.getAttribute("ItmUom")!=null){
                    adflog.info("----"+SlocId+"------------"+CldId+"--------"+OrgId+"----------"+r.getAttribute("ItmId")+"-------"+r.getAttribute("ItmUom")+"----------"+uomBs);
                    BigDecimal uomConv =(BigDecimal)(callStoredFunction(Types.NUMERIC, "APP.FN_GET_UOM_CONV_FCTR (?,?,?,?,?,?)", new Object[] {SlocId,CldId,OrgId,r.getAttribute("ItmId").toString(),r.getAttribute("ItmUom").toString(),uomBs}));  
        ...
        Row srcInsrt = issuSrc.createRow();
           ...
           adflog.info("22222length--------"+itmRow.length);
            ...
            for(Row r :itmRow){
                ...
                if(r.getAttribute("ItmId")!=null && r.getAttribute("ItmUomBs")==null && r.getAttribute("UomConvFctr")==null){
                if(uomBs!=null && r.getAttribute("ItmUom")!=null){
                    adflog.info("22222----"+SlocId+"------------"+CldId+"--------"+OrgId+"----------"+r.getAttribute("ItmId")+"-------"+r.getAttribute("ItmUom")+"----------"+uomBs);
                    BigDecimal uomConv =(BigDecimal)(callStoredFunction(Types.NUMERIC, "APP.FN_GET_UOM_CONV_FCTR (?,?,?,?,?,?)", new Object[] {SlocId,CldId,OrgId,r.getAttribute("ItmId").toString(),r.getAttribute("ItmUom").toString(),uomBs}));  
        ...
        while(i.hasNext()){
            ...
            for(Row r2 : srRow){
                if(r2.getAttribute("TransSelectSrCB")!=null){                
                    if("Y".equalsIgnoreCase(r2.getAttribute("TransSelectSrCB").toString()) && r2.getAttribute("LotId").toString().equals(lot)){   
    ...
    public String deleteSerialNo(){
        ...
        if(srNo!=null){
            if("Y".equalsIgnoreCase(binChkFlg)){
            RowQualifier rowQualifier =new RowQualifier(mtlBin);
            rowQualifier.setWhereClause("DocId = '"+currSr.getAttribute("DocId")+"' and DocIdSrc ='"+currSr.getAttribute("DocIdSrc")+"' and WhId = '"+currSr.getAttribute("WhId")+"' and ItmId = '"+currSr.getAttribute("ItmId")+"' and LotId = '"+currSr.getAttribute("LotId")+"' and BinId ='"+currSr.getAttribute("BinId")+"'");
            Row[] rows=mtlBin.getFilteredRows(rowQualifier);
            adflog.info(""+rowQualifier.getExprStr());
            ...
            rowQualifier1.setWhereClause("DocId = '"+currSr.getAttribute("DocId")+"' and  DocIdSrc ='"+currSr.getAttribute("DocIdSrc")+"' and WhId = '"+currSr.getAttribute("WhId")+"' and ItmId = '"+currSr.getAttribute("ItmId")+"' and LotId = '"+currSr.getAttribute("LotId")+"'");
            ...
            if(rowsLot.length>0){  // update lot quantity if lot already exist......:
              ...
              //  Number prLotValBs = (Number)r.getAttribute("IssuQtyBs");
                ...
                adflog.info(prLotVal+"---------new vale FOR LOT----------  "+newQty);
                r.setAttribute("IssuQty", newQty);
                r.setAttribute("IssuQtyBs", newQty);
                if(newQty.compareTo(zero)==0){
    ...
    // Method for Insert Update and Remove Bin and Lotwhen Organization  used bin and itm serialazed flag "N" and issue Manual entry itm Pick Order type "ANY" 
    ...
    public void insrtSelectedBinForView(){
       ...
       // for(String kay : lotset){
        ...
        while(itr.hasNext()){
            ...
            for(Row r1 : binRow){
                if(r1.getAttribute("TransIssueQty")!=null){
                if(((Number)r1.getAttribute("TransIssueQty")).compareTo(zero) > 0 && r1.getAttribute("LotId").toString().equals(lotId)){
           ...
           // Check lot already created or not 
            RowQualifier rowQualifier =new RowQualifier(mtlLot);
            rowQualifier.setWhereClause(" DocIdSrc ='"+currItm.getAttribute("DocIdSrc")+"' and ItmId = '"+currItm.getAttribute("ItmId")+"' and LotId = '"+lotId+"'");
            Row[] rows=mtlLot.getFilteredRows(rowQualifier);
            adflog.info(""+rowQualifier.getExprStr());
            if(rows.length>0){
                for(Row r : rows){
           ...
           for(Row rr : binRow){
               ...
               if(((Number)rr.getAttribute("TransIssueQty")).compareTo(zero) >= 0){
                  ...
                  // check bin already created or not 
                   RowQualifier rowQualifier =new RowQualifier(mtlBin);
                   rowQualifier.setWhereClause(" DocIdSrc ='"+currItm.getAttribute("DocIdSrc")+"' and ItmId = '"+currItm.getAttribute("ItmId")+"' and LotId = '"+rr.getAttribute("LotId").toString()+"' and BinId = '"+rr.getAttribute("BinId").toString()+"'");
                   Row[] rows=mtlBin.getFilteredRows(rowQualifier);
                   adflog.info(""+rowQualifier.getExprStr());
 ...
 // Method for Insert Update and Remove Lot when Organization not used bin and itm serialazed flag "N" and issue Manual entry itm Pick Order type "ANY" 
       ...
       Row [] lotRow = this.getMmMtlIssuLot().getFilteredRows("ItmId", currItm.getAttribute("ItmId"));
        ...
        if(lotRow.length>0){
            ...
            if(((Number)rr1.getAttribute("IssuQtyBs")).compareTo(zero) >= 0){
                ...
                rq.setWhereClause("OrgId = '"+issR.getAttribute("OrgId").toString()+"' and ItmId= '"+rr1.getAttribute("ItmId").toString()+"' and LotId ='"+rr1.getAttribute("LotId").toString()+"'");
   ...
   public String isSrcDocIdDuplicate(String value){
      ...
      String srcDocId = null;
       if(value !=null){
           Row[] rr = getLovMRSDocNo().getFilteredRows("MrsNo", value);
          // Row[] rrTr= this.getTransferOrderDocNo().getFilteredRows("TrfNo", value);
          RowQualifier rowQualifier1 = new RowQualifier(trfOdr);
          rowQualifier1.setWhereClause("TrfNo = '"+value+"' and FyId = "+Integer.parseInt(currRow.getAttribute("FyId").toString())+"");
       ...
       // check for Internal Issue 323 MRS 
        if(issType==323){
           ...
           if(srcDocId!=null && currRow.getAttribute("WhId") != null){
               ...
               rowQualifier.setWhereClause("CldId = '"+currRow.getAttribute("CldId")+"' and DocId = '"+currRow.getAttribute("DocId")+"' and SlocId = "+Integer.parseInt(currRow.getAttribute("SlocId").toString())+" and DocIdSrc ='"+srcDocId+"' and OrgId = '"+currRow.getAttribute("OrgId")+"' and WhId = '"+currRow.getAttribute("WhId").toString()+"'");
    ...
    public Integer autoIssueItemfromSystem(){
        ...
        adflog.info("binChkFlg-----"+binChkFlg+"wh ---"+currIssu.getAttribute("WhId")+"itm   "+currItm.getAttribute("ItmId")+"pic or  "+currItm.getAttribute("TransItmPickOrder")+"serial  "+currItm.getAttribute("TransItmSerializedFlg")+"fact  "+uomCovrFctr+" doc id Src "+currItm.getAttribute("DocIdSrc")+" doc id  "+currIssu.getAttribute("DocId"));
        if(uomCovrFctr !=null){
         this.getDBTransaction().postChanges();
        retVal = Integer.parseInt(callStoredFunction(Types.NUMERIC, "MM_ISSU_AUTO (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {currIssu.getAttribute("CldId").toString(),Integer.parseInt(currIssu.getAttribute("SlocId").toString()), currIssu.getAttribute("OrgId").toString()
                                                                                                                                         ,currIssu.getAttribute("WhId").toString(), currItm.getAttribute("ItmId").toString(),issQty,
                                                                                                                                                Integer.parseInt(currItm.getAttribute("TransItmPickOrder").toString()),currItm.getAttribute("TransItmSerializedFlg").toString(),binChkFlg,currIssu.getAttribute("DocId").toString(),
                                                                                                                                              currItm.getAttribute("DocIdSrc").toString(),currItm.getAttribute("DocDtSrc"),currItm.getAttribute("ItmUomBs").toString(),
                                                                                                                                                currItm.getAttribute("ItmUom").toString(),uomCovrFctr}).toString());
        }
       if(retVal==1){
        ...
        if(rows.length>0){
            ...
            adflog.info("count---------: "+count);
                if(count==0){
                    ...
                    RowQualifier rowQualifier1 = new RowQualifier(trfOdr);
                    rowQualifier1.setWhereClause("DocId = '"+docIdSrc+"' and FyId = "+Integer.parseInt(currIss.getAttribute("FyId").toString())+"");
                    Row[] rows1 = trfOdr.getFilteredRows(rowQualifier1);
                    adflog.info(rowQualifier1.getExprStr());
                    ...
                    if(docNoTrf!=null){
                        ...
                        rowQualifier1.setWhereClause("MrsTxnId = '"+docIdSrc+"' and FyId = "+Integer.parseInt(currIss.getAttribute("FyId").toString())+"");
      ...
      //  this.getDBTransaction().postChanges();
        ...
        if(rows.length>0){
            ...
            if(rr1.getAttribute("ItmId")!=null){
                ...
                if(issuQty.compareTo(zero)>0){
                    RowQualifier rowQualifier = new RowQualifier(mtlLot);
                    rowQualifier.setWhereClause("DocId ='"+docId+"' and DocIdSrc = '"+docIdSrc+"' and ItmId = '"+rr1.getAttribute("ItmId").toString()+"'");
    ...
    public void srNoFilterRow(){
        ...
        this.getMmMtlIssuSr().executeQuery();
        this.getViewMmStkSummSr().setWhereClause("SR_NO NOT IN (SELECT SR_NO from MM$MTL$ISSU$SR where itm_id = '"+curRow.getAttribute("ItmId").toString()+"' and doc_id = '"+issR.getAttribute("DocId").toString()+"' )");
    ...
    public void searchIssueAction(){
        ...
        adflog.info("BindOrgId--"+p_org_id+"BindRqmtAreaId---"+currTransSrch.getAttribute("TransRqmtAreaIdSrc")+"BindWhIdSrc---"+currTransSrch.getAttribute("TransWhIdSrc")+"BindOrgIdSrc"+currTransSrch.getAttribute("TransOrgIdSrc")+"BindWhId---"+currTransSrch.getAttribute("TransWhId"));
    ...
    public String updateStockFromIssue(){
        ...
        Integer issDocType = Integer.parseInt(currSrc.getAttribute("IssuDocType").toString());
         String updateType = "I";
         if(currIssu.getAttribute("CldId")!=null && currIssu.getAttribute("SlocId")!=null && currIssu.getAttribute("OrgId")!=null && currIssu.getAttribute("WhId")!=null && currIssu.getAttribute("FyId")!=null && currIssu.getAttribute("DocId")!=null){
      Integer  retVal = Integer.parseInt(callStoredFunction(Types.NUMERIC, "MM.MM_UPDT_STK (?,?,?,?,?,?)", new Object[] {currIssu.getAttribute("CldId").toString(),Integer.parseInt(currIssu.getAttribute("SlocId").toString()), currIssu.getAttribute("OrgId").toString()
                                                                                                                                         ,currIssu.getAttribute("WhId").toString(),currIssu.getAttribute("DocId").toString(),updateType}).toString());
        
      adflog.info("function return------------   "+retVal);  
      if(retVal==1){
    Integer  retRelVal = Integer.parseInt(callStoredFunction(Types.NUMERIC, "MM.mm_updt_stk_rels (?,?,?,?,?,?,?)", new Object[] {currIssu.getAttribute("CldId").toString(),Integer.parseInt(currIssu.getAttribute("SlocId").toString()), currIssu.getAttribute("OrgId").toString()
                                                                                                                                             ,currIssu.getAttribute("WhId").toString(),Integer.parseInt(currIssu.getAttribute("FyId").toString()),issDocType,currIssu.getAttribute("DocId").toString()}).toString());
               ...
               // Integer retRelVal = 1;
                ...
                if(currIssu.getAttribute("RetnblIssu")!=null){
                   ...
                   if("Y".equalsIgnoreCase(retrnIssFlg)){
                       ...
                       Integer  retGLVou = Integer.parseInt(callStoredFunction(Types.NUMERIC, "MM.MM_INS_GL_CONSM (?,?,?,?,?,?,?,?)", new Object[] {Integer.parseInt(currIssu.getAttribute("SlocId").toString()),currIssu.getAttribute("CldId").toString(), hoOrgId, currIssu.getAttribute("OrgId").toString()
                                                                                                                                                    ,Integer.parseInt(currIssu.getAttribute("FyId").toString()),currIssu.getAttribute("DocId").toString() ,currIssu.getAttribute("DocDt"),Integer.parseInt(currIssu.getAttribute("UsrIdCreate").toString())}).toString());
    ...
    public void deleteDocumentNo(){
        ...
        adflog.info("curr row disp --"+currRowSrc.getAttribute("DocIdSrcDisp")+"   docidsrc"+currRowSrc.getAttribute("DocIdSrc"));
   
        if(docIdSrc!=null){
            RowQualifier itmRowQualifier = new RowQualifier(mtlItm);
            itmRowQualifier.setWhereClause("CldId = '"+cldId+"' and SlocId = "+slocId+" and OrgId = '"+orgId+"' and WhId = '"+whId+"' and DocId = '"+docId+"' and DocIdSrc = '"+docIdSrc+"'");
         ...
         srRowQualifier.setWhereClause("CldId = '"+cldId+"' and SlocId = "+slocId+" and OrgId = '"+orgId+"' and WhId = '"+whId+"' and DocId = '"+docId+"' and DocIdSrc = '"+docIdSrc+"'  and ItmId = '"+r.getAttribute("ItmId")+"'");
        ...
        binRowQualifier.setWhereClause("CldId = '"+cldId+"' and SlocId = "+slocId+" and OrgId = '"+orgId+"' and WhId = '"+whId+"' and DocId = '"+docId+"' and DocIdSrc = '"+docIdSrc+"' and ItmId = '"+r.getAttribute("ItmId")+"'");
        ...
        lotRowQualifier.setWhereClause("CldId = '"+cldId+"' and SlocId = "+slocId+" and OrgId = '"+orgId+"' and WhId = '"+whId+"' and DocId = '"+docId+"' and DocIdSrc = '"+docIdSrc+"'  and ItmId = '"+r.getAttribute("ItmId")+"'");
