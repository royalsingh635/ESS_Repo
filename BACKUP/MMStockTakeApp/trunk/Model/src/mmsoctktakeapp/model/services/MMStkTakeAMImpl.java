...
public class MMStkTakeAMImpl extends ApplicationModuleImpl implements MMStkTakeAM {
    ...
    public String genStkTkNo() {
        ...
        if (getMmStkTake1().getCurrentRow().getAttribute("StkTakeNo") != null) {
            ...
            String stkno =
                (String)(callStoredFunction(Types.VARCHAR, "MM.fn_mm_gen_id(?,?,?,?,?,?)", new Object[] { SlocId,
                                                                                                          CldId, OrgId,
                                                                                                          tableName,
                                                                                                          null,
                                                                                                          fyid }));
    ...
    public void setItmAcctoWhouse(String WhId){
        ...
        Integer stknum=(Integer)callStoredFunction(Types.INTEGER, "MM_STK_TAKE_INIT(?,?,?,?,?,?,?,?)", new Object[] { CldId,SlocId,HoOrg,OrgId,Wh,
                                                                                     null,"N",DocId });
    ...
    public void setItemAcctoWh(String WhId) {
        ...
        String HoOrg = resolvEl("#{pageFlowScope.GLBL_HO_ORG_ID}").toString();
        String DocId = getMmStkTake1().getCurrentRow().getAttribute("DocId").toString();
        Integer stknum=(Integer)callStoredFunction(Types.INTEGER, "MM_STK_TAKE_INIT(?,?,?,?,?,?,?,?)", new Object[] { CldId,SlocId,HoOrg,OrgId,WhId,
                                                                                     null,"N",DocId });
...
//        }
    ...
    public void setBinAcctoLot(String whbin) {
        ...
        while (i >= 0) {
            ...
            RowQualifier rqlot = new RowQualifier(getMmStkSummLot1());
            rqlot.setWhereClause("CldId='" + Cld + "' and SlocId=" + Sloc + " and OrgId='" + Org + "' and WhId='" +
                                 Wh + "' and ItmId='" + Itm + "'");
            Row rlot[] = getMmStkSummLot1().getFilteredRows(rqlot);
            if (rlot.length > 0)
                ilot = rlot.length - 1;
     ...
     */
    public ViewObjectImpl getTransDistinctItem1() {
        return (ViewObjectImpl)findViewObject("TransDistinctItem1");
    }
            ...
            while (ibin >= 0) {
                ...
                while (isr >= 0) {
                    ...
                    rqd.setWhereClause("CldId='" + rsr[isr].getAttribute("CldId") + "' and SlocId=" +
                                       rsr[isr].getAttribute("SlocId") + " and OrgId='" +
                                       rsr[isr].getAttribute("OrgId") + "' and WhId='" +
                                       rsr[isr].getAttribute("WhId") + "' and ItmId='" +
                                       rsr[isr].getAttribute("ItmId") + "' and LotId='" +
                                       rsr[isr].getAttribute("LotId") + "' and BinId='" +
        ...
        while (i >= 0) {
            ...
            while (ilot >= 0) {
                ...
                rqd.setWhereClause("CldId='" + rlot[ilot].getAttribute("CldId") + "' and SlocId=" +
                                   ...
                                   rlot[ilot].getAttribute("ItmId") + "' and WhId='" +
                                   rlot[ilot].getAttribute("WhId") + "' and LotId='" +
                                   rlot[ilot].getAttribute("LotId") + "' and DocId='" + DocId + "'");
    ...
    public String checkItmidSerialize(String ItmId) {
        ...
        if(ItmId!=null) {
           ...
           this.getItmPrf1().setNamedWhereClauseParam("bindCldId",resolvEl("#{pageFlowScope.GLBL_APP_CLD_ID}").toString());
           this.getItmPrf1().setNamedWhereClauseParam("bindSlocId",Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_APP_SERV_LOC}").toString()));
           this.getItmPrf1().setNamedWhereClauseParam("bindHoOrgId",resolvEl("#{pageFlowScope.GLBL_HO_ORG_ID}").toString());
        ...
        rq.setWhereClause("CldId='" + CldId + "' AND ItmId='" + ItmId + "' and SlocId=" + SlocId );//+"and HoOrgId='"+hoOrgId+"'");
     ...
     * @return MmStkTakeSr4
     */
    public ViewObjectImpl getMmStkTakeSr4() {
        return (ViewObjectImpl)findViewObject("MmStkTakeSr4");
    }
    ...
    public Integer getUsrLvl(Integer SlocId, String CldId, String OrgId, Integer UsrId, String WfNo, String DocNo) {
        Object obj =
            callStoredFunction(NUMBER, "APP.WF_GET_USR_LEVEL (?,?,?,?,?,?,?)", new Object[] { SlocId, CldId, OrgId,
                                                                                              UsrId, WfNo, DocNo, 0 });
        if (obj != null) {
    ...
    public Integer pendingCheck(Integer SlocId, String CldId, String OrgId, Integer DocNo) {
        ...
        Object obj =
            Integer.parseInt(callStoredFunction(NUMBER, "APP.WF_GET_CUR_USR(?,?,?,?,?,?)", new Object[] { SlocId,
                                                                                                          CldId, OrgId,
                                                                                                          DocNo, DocId,
                                                                                                          0 }).toString());
        Integer UsrId = null;
    ...
    public void updateAuth() {
        ...
        if ("A".equals(retVal)) {
            ...
            //Update stock
            BigDecimal obj =
                (BigDecimal)callStoredFunction(Types.NUMERIC, "MM.mm_updt_stk_take(?,?,?,?,?,?)", new Object[] { CldId,
                                                                                                                 SlocId,
                                                                                                                 OrgId,
                                                                                                                 DocId,
                                                                                                                 FyId,
            ...
            VoucherId =(String)callStoredFunction(Types.VARCHAR, "MM.MM_GET_RCPT_PROV_GL(?,?,?,?,?,?)", new Object[] { CldId,
                                                                                                SlocId,
                                                                                                OrgId,
                                                                                                DocId,
                                                                                                "T",
    ...
    public void updateQuantity() {
        ...
        String DocId = (String)getMmStkTake1().getCurrentRow().getAttribute("DocId");
        BigDecimal cnt =
            (BigDecimal)(callStoredFunction(Types.NUMERIC, "MM.mm_ins_stk_take(?,?,?,?)", new Object[] { CldId, SlocId,
                                                                                                         OrgId,
                                                                                                         DocId }));
