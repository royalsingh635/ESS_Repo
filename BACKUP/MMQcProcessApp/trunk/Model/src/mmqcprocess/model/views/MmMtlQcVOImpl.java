...
// ---------------------------------------------------------------------
public class MmMtlQcVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public MmMtlQcVOImpl() {
    }
    ...
    /**
     * Returns the variable value for QcTxnIdBind.
     * @return variable value for QcTxnIdBind
     */
    public String getQcTxnIdBind() {
        return (String)ensureVariableManager().getVariableValue("QcTxnIdBind");
    }

    /**
     * Sets <code>value</code> for variable QcTxnIdBind.
     * @param value value to bind as QcTxnIdBind
     */
    public void setQcTxnIdBind(String value) {
        ensureVariableManager().setVariableValue("QcTxnIdBind", value);
    }
}
