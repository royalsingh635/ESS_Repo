...
private static ADFLogger adfLog = (ADFLogger)ADFLogger.createADFLogger(QuotationBean.class);
    ...
    public QuotationAMImpl getAm() {        return (QuotationAMImpl)resolvElDC("QuotationAMDataControl");
    }
    public String getWfId() {
        try {
            ...
            return callStoredFunction(VARCHAR, "APP.WF_GET_ID(?,?,?,?,?)",
                                      new Object[] { p_sloc_id, CldID, p_org_id, Docid,DocTypeId }).toString();
        } catch (Exception e) {
            return "0";
        }
    }
    ...
    public void editQuotation(ActionEvent actionEvent) {
        ...
        Integer pending =
            Integer.parseInt(callStoredFunction(NUMBER, "APP.WF_GET_CUR_USR(?,?,?,?,?,?)", new Object[] { P_SLOCID,
                                                                                                                       CldID,
                                                                                                                       P_ORGID,
                                                                                                                       Docid,
                                                                                                                       P_DOCID , DocTypeId }).toString());
        ...
        String name="Anonymous";
           ...
           if(r.length>0)
            ...
            FacesMessage message = new FacesMessage("This document is pending at ["+name+"] .You can not edit this.");
        ...
        {
        String flag=(String)callStoredFunction(Types.VARCHAR, "MM.PKG_MM_QUOT.IS_QUOT_DELETABLE(?,?,?,?)", new Object[]{P_SLOCID, CldID, P_ORGID,P_DOCID});
        ...
        if(vce.getNewValue() != null){
         ...
         System.out.println("RowCount="+am.getLovrfqId().getEstimatedRowCount());
          ...
          //  RowQualifier rfqf=new RowQualifier( getAm().getLovRfqItm1());
           ...
           rfq.setWhereClause("RfqId='"+rfqIdnew+"' and CldId='"+CldID+"' and SlocId="+P_SLOCID+" and OrgId='"+P_ORGID+"'");
          ...
          //  String P_ORGID = (String)getAm().getMmQuot1().getCurrentRow().getAttribute("OrgId");
           ...
           getAm().getLovItmIdForCode().executeQuery();
              RowQualifier rq=new RowQualifier(getAm().getLovItmIdForCode());
               rq.setWhereClause("CldId='"+CldID+"' and SlocId="+P_SLOCID+" and OrgId='"+P_ORGID+"' and HoOrgId='"+hoOrg+"' and ItmId='"+r.getAttribute("ItmId")+"'");
           ...
           rquom.setWhereClause("CldId='"+CldID+"' and SlocId="+P_SLOCID+" and OrgId='"+P_ORGID+"' and HoOrgId='"+hoOrg+"' and ItmId='"+r.getAttribute("ItmId")+"' and UomIdSrc='"+uombs+"' and UomIdDest='"+r.getAttribute("ItmUom")+"'");
           ...
           row1.setAttribute("UomConvFctr",convFctr);
            ...
            rfqtnc.setWhereClause("DocId='"+docIdNew+"' and CldId='"+CldID+"' and SlocId="+P_SLOCID+" and OrgId='"+P_ORGID+"'");
       ...
       if (quotItm.getAllRowsInRange().length > 0) {
           /*  if ("Q".equalsIgnoreCase(taxruleFlg) && taxableAmt.compareTo(taxOnAmount) != 0 && filterdRw.length > 0) {
                    ...
                    fc.addMessage(null, message);
                        ...
                        FacesMessage message =
                            new FacesMessage(resolvElDCMsg("#{bundle['MSG.292']}").toString()+" ( "+itmNameConcat.substring(0, itmNameConcat.length()-1)+ resolvElDCMsg("#{bundle['MSG.293']}").toString());
                        message.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                        fc.addMessage(null, message);
                ...
                fc.addMessage(null, message);
                        ...
                        FacesMessage message =
                            new FacesMessage(" ( "+itmName.substring(0, itmName.length()-1)+" )"+ resolvElDCMsg("#{bundle['MSG.315']}").toString());
                        message.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                        fc.addMessage(null, message);
        ...
        //QuotAmtSp_Trans
                ...
                if(amtSp.compareTo(new Number(0))<=0 || cstBfrTax.compareTo(new Number(0))<=0)
                {
                    FacesMessage message = new FacesMessage("Amount for Quotation must be Greater than Zero.");
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message);
                }
                   ...
                   // System.out.println("value of sup----"+dup);
                      ...
                      currRow.setAttribute("QuotAmtSp", amtSp);
                          ...
                          if(currRow.getAttribute("QuotDt")!=null){
                           Integer fyId =(Integer)(callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID (?,?,?)", new Object[] {CldID,p_org_id,currRow.getAttribute("QuotDt")}));
                   ...
                   // refDOcIdBind.setDisabled(true);
                      ...
                      level =
                          Integer.parseInt(callStoredFunction(NUMBER, "APP.WF_GET_USR_LEVEL(?,?,?,?,?,?,?)", new Object[] { p_sloc_id,
                                                                                                                                  CldID,
                                                                                                                                  p_org_id,
                                                                                                                                  p_user_id,
                                                                                                                                  wf_no,
                                                                                                                                  Docid ,DocTypeId}).toString());

                      if(level>-1){
                      Integer res =
                          Integer.parseInt(callStoredFunction(NUMBER, "APP.WF_INS_TXN(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                              new Object[] { p_sloc_id, CldID, p_org_id, Docid, DocTypeId,wf_no, doc_txn_id,
                                                                             p_user_id, p_user_id, level, level, action, remark,
                                                                             amtBs }).toString());
                      ...
                      operationBindingS.execute();
                          ...
                          if(operationBindingS.getErrors().size()!=0)
                              System.out.println("Error on save="+operationBindingS.getErrors());
                    ...
                    setMode("V");
                      ...
                      {
                              FacesMessage message = new FacesMessage("Something went wrong(User Level in Workflow).Contact to ESS!");
                              message.setSeverity(FacesMessage.SEVERITY_ERROR);
                              FacesContext fc = FacesContext.getCurrentInstance();
                              fc.addMessage(null, message);
                          }
                          ...
                          {
                                  FacesMessage message = new FacesMessage("Workflow for Quotation has not been Defined for current Organisation.");
                                  message.setSeverity(FacesMessage.SEVERITY_ERROR);
                                  FacesContext fc = FacesContext.getCurrentInstance();
                                  fc.addMessage(null, message);
                              }
    ...
    if(currOcSp!=null){
      ...
      Number totSp=AmSp.multiply(currency);
    ...
    public String addOCAction() {
       ...
       System.out.println("Coa Id="+getAm().getMmQuot1().getCurrentRow().getAttribute("TransCoaId"));
        ...
        {
            if(((Number)getAm().getMmQuot1().getCurrentRow().getAttribute("TransOcAmtSp")).compareTo(new Number(0))>0)
            { 
        ...
        //Check for duplicate
           ...
           rq.setWhereClause("CldId='"+getAm().getMmQuot1().getCurrentRow().getAttribute("CldId")+"' and SlocId="+getAm().getMmQuot1().getCurrentRow().getAttribute("SlocId")+" and OrgId='"+getAm().getMmQuot1().getCurrentRow().getAttribute("OrgId")+"' and DocId='"+getAm().getMmQuot1().getCurrentRow().getAttribute("DocId")+"' and CoaId="+coaId+"");
...
adfLog.info(taxAftrDiscChk.getValue()+" current tax exempted flag is ");
          ...
          if (itmCurr.getAttribute("ItmPrice") != null || itmCurr.getAttribute("ItmPrice") != new Number(0) ||
           ...
           // System.out.println("Flag is="+tflg);
              ...
              ViewObjectImpl voline = getAm().getMmQuotTrLines2();
                  ...
                  {
                        Row frline=rql.next();
                        if(frline.getAttribute("DocId").toString().equalsIgnoreCase(docId) && frline.getAttribute("ItmId").toString().equalsIgnoreCase(itmId))
                        {
     ...
     * */
         ...
         //  System.out.println("No of row in TR for this item and doc="+r2.length);
          ...
          // System.out.println("row in TR for this item and docid is avaliabale");
                   ...
                   while(rs1in.hasNext())
                   {
                       ...
                       {
                           if(row.getAttribute("DocId").toString().equalsIgnoreCase(docId2) && row.getAttribute("ItmId").toString().equalsIgnoreCase(itmId2)
                               && row.getAttribute("ItmUom").toString().equalsIgnoreCase(itmuom2))
                              System.out.println("Row in trline for this doc is removed for this doc and item id="+row.getKey());
                            //  row.remove();
                           }
                       }
     ...
     BigDecimal ret1=(BigDecimal)callStoredFunction(NUMBER, "MM.PKG_MM_QUOT.ins_quot_tr_lines(?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[]{p_sloc_id1, p_cldId1 , p_hoOrgId1 , p_org_id1,p_doc_id1,p_po_item_id1,p_po_item_uom1,taxid1,p_user_id1, p_taxable_amount1, p_tax_rule_flg1,p_curr_fctr1,taxexmpt});
      ...
      else
      {
           ...
           if (p_tax_rule_flg1.equalsIgnoreCase("I")) {
               getAm().getMmQuotItm().getCurrentRow().setAttribute("TaxAmtItm_Trans", new Number(retVal1.round(6)));
           } else if (p_tax_rule_flg1.equalsIgnoreCase("Q")) {
               getAm().getMmQuot1().getCurrentRow().setAttribute("SumTaxAmtItm_Trans", new Number(retVal1.round(6)));
           } 
       }
        ...
        if(r.length>0)
        {
          ...
          {   
              ...
              RowSetIterator rsi = trVo.createRowSetIterator(null);
                        while (rsi.hasNext()) {
                          Row rw = rsi.next();
                          if (rw.getAttribute("DocId").toString().equalsIgnoreCase(docId) && rw.getAttribute("TaxRuleFlg").toString().equalsIgnoreCase("Q") )
                          {
                          }
                        }
              rsi.closeRowSetIterator();
    ...
    public void taxRuleIdNewVCL(ValueChangeEvent vce) {
        ...
        if (vce.getNewValue() != null) {
            ...
            rqtax.setWhereClause("TaxHoOrgId ='"+p_hoOrgId+"' and TaxRuleSlocId = "+p_sloc_id+" and TaxCldId ='"+p_cldId+"' and TaxRuleDesc = '"+taxid1+"' ");
    ...
    public void taxDialogListener(DialogEvent dialogEvent) {
        if(dialogEvent.getOutcome().name().equals("ok")){
           if(getAm().getMmQuotTrLines2().getCurrentRow()!=null)
           {
              ...
              {
                      getAm().getMmQuotTr1().getCurrentRow().setAttribute("TaxRuleId", getAm().getMmQuotTrLines2().getCurrentRow().getAttribute("TaxRuleId"));
                  }
               }
    ...
    public void discountDialogListener(DialogEvent dialogEvent) {
        if(dialogEvent.getOutcome().name().equals("ok")){
            ...
            RowSetIterator rsiItm = getAm().getMmQuotItm().createRowSetIterator(null);
            ...
            RowSetIterator rsiItmPer = getAm().getMmQuotItm().createRowSetIterator(null);
      ...
      System.out.println("Count to del="+count);
        if (count > 0) {
          ...
          while (rsi1.hasNext()) {
              ...
              {  
                  if(nxt.getAttribute("MarkedForDeleteItm").toString().equalsIgnoreCase("Y") ||  nxt.getAttribute("MarkedForDeleteItm").toString().equalsIgnoreCase("true")){
                        if(nxt.getAttribute("ItmId")!=null && nxt.getAttribute("ItmUom")!=null){
                            rqTax.setWhereClause("DocId= '"+nxt.getAttribute("DocId").toString()+"' and ItmId= '"+nxt.getAttribute("ItmId").toString()+"' and ItmUom='"+nxt.getAttribute("ItmUom").toString()+"'");
        ...
        //  getAm().getMmQuotItm().setWhereClause(null);
          getAm().getMmQuotItm().executeQuery();
            ...
            FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_WARN, resolvElDCMsg("#{bundle['MSG.270']}").toString(), null);
    ...
    public void dltDiscValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        Number totol=((Number)itmPrice.getValue()).multiply((Number)quotQty.getValue());
        Number zero=new Number(0);
        Number hundrd=new Number(100);
        if (discType.getValue().equals("A") && n.compareTo(totol) == 1) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.401']}").toString()+""+totol, null));
        } else if (n.compareTo(zero) == -1) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.305']}").toString(),
                                                          null));
        } 
        if(discType.getValue().equals("P") && n.compareTo(hundrd) == 1){
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.303']}").toString(),
                                                          null));
        }
        }
    ...
    public void quotDiscValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        Number n = (Number)object;
       Number totol=(Number)((Number)totalOnDiscQuotVal.getValue()).minus((Number)sumItmTaxTotAmt.getValue());
        Number zero=new Number(0);
        Number hundrd=new Number(100);
        if (quotDiscType.getValue().equals("A") && n.compareTo(totol) == 1) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.401']}").toString()+""+totol, null));
        } else if (n.compareTo(zero) == -1) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.305']}").toString(),
                                                          null));
        } 
        if(quotDiscType.getValue().equals("P") && n.compareTo(hundrd) == 1){
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.303']}").toString(),
                                                          null));
        }
        }
    ...
    public void unitRateValidate(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        System.out.println("n is either 0 or -ve");
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Rate must be Greater than Zero.",
                                                          null));
        }
        ...
        Number tot = n.multiply((Number)quotQty.getValue()).multiply(currFact);
        Number zero=new Number(0); 
        Boolean totFlag = isPrecisionValid(26, 6, tot);
         if(n.compareTo(zero) < 0) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Price can not be less than Zero.",
                                                          null));
        } 
            if(getAm().getMmQuotItm().getCurrentRow().getAttribute("ItmId")!=null && n.compareTo(zero) == 0)
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Price should be greater than Zero.",
                                                              null));
    ...
    public void qtyVatidate(FacesContext facesContext, UIComponent uIComponent, Object object) {
       ...
       String flag = "Y";
        ...
        Number tot = n.multiply((Number)itmPrice.getValue()).multiply(currFact);
        Boolean totFlag = isPrecisionValid(26, 6, tot); 
   ...
   /*      String inputItm=(String)object;
    ...
    public void itmNameVCE(ValueChangeEvent vce) {
        if(vce.getNewValue()!=null){
            ...
            rqitm.setWhereClause("CldId='"+p_cldId+"' and SlocId="+pslocId+" and HoOrgId='"+p_hoOrgId+"' and ItmDesc='"+vce.getNewValue()+"'");
            System.out.println("Query is="+rqitm.getExprStr());
            Row ritm[]=getAm().getLovItmIdForCode().getFilteredRows(rqitm);
            String itm=null;String uomBs=null;String uomPur=null;
            if(ritm.length>0)
            { 
          ...
          //  ViewObjectImpl voUomVw=getAm().getLovUomVw1();
            RowQualifier rquom=new RowQualifier(getAm().getLovUomVw1());
            rquom.setWhereClause("CldId='"+p_cldId+"' and SlocId="+pslocId+" and OrgId='"+pOrgId+"' and HoOrgId='"+p_hoOrgId+"' and ItmId='"+itm+"' and UomIdSrc='"+uomBs+"' and UomIdDest='"+uomPur+"'");
          ...
          /*   System.out.println("--" + pslocId + "---" + pOrgId + "--" + pEoId + "-----" + pItmId + "-----" + pItmUom +
            ...
            Integer retval =
                Integer.parseInt(callStoredFunction(INTEGER, "MM.MM_INS_EO_ITM_AUTO(?,?,?,?,?,?,?,?,?,?,?)",
                                                    new Object[] { CldID ,pslocId,  pHoOrgId, pOrgId , pEoId,currIsSp, pItmId, pItmUom, 
                                                                   pUsrId, 18503,docId }).toString());
 ...
 public Boolean isPrecisionValid(Integer precision,Integer scale,Number total){
    ...
    public void ocSpValuevalidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
       ...
       // Row quotOcrow = quotOc.getCurrentRow();
        ...
        if(row.getAttribute("CurrConvFctr")!=null){
         ...
         Number tot = orderQtyVal.multiply(currFact);
         Boolean qtyFlag = isPrecisionValid(26, 6, orderQtyVal);
         Boolean totFlag = isPrecisionValid(26, 6, tot);
         if(tranType.equalsIgnoreCase("S") && orderQtyVal.compareTo(totalquotSpAmt) == 1){
             throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,resolvElDCMsg("#{bundle['MSG.302']}").toString(), null)); 
         }
        if(orderQtyVal.compareTo(zero) <= 0)
        {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.412']}").toString(), null)); 
    ...
    public void eoIdValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
           String eoName = (String)object;
            ...
            String flag = "Y";
                   if(p_eoId != null){
                       flag=(String)callStoredFunction(Types.VARCHAR, "APP.PKG_APP_EO.IS_SUPP_VALID(?,?,?,?,?)", new Object[]{p_sloc_id, CldID ,null , p_org_id, p_eoId});   
                   }
                   if(flag.equalsIgnoreCase("B")){
                       throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.340']}").toString(), null));                    
                   }else if(flag.equalsIgnoreCase("H")){
                       throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.341']}").toString(), null)); 
                   }
   ...
   Row quotRow = quot.getCurrentRow();
    ...
    Integer p_sloc_id = Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_APP_SERV_LOC1}")); 
     ...
     System.out.println("adds value---:"+quotRow.getAttribute("BillAddsId"));
        ...
        System.out.println("p_UsrId---"+p_UsrId+"p_sloc_id---"+p_sloc_id+"p_adds_id---"+p_adds_id+"eo----"+p_eo_id+"CldID     "+CldID);
        if(p_eo_id != null && p_adds_id != null){
         BigDecimal   addsRetVal=(BigDecimal)callStoredFunction(NUMBER, "APP.PKG_APP_EO.INS_EO_ADDS(?,?,?,?,?,?,?)", new Object[]{p_sloc_id, CldID ,p_hoOrgId, p_eo_id,p_adds_id,"B",p_UsrId});
  ...
  public void quotDateValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
    Date currDt = (Date)Date.getCurrentDate();
      ...
      Integer fyId =(Integer)(callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID (?,?,?)", new Object[] {CldID,pOrgId,formDate}));
    ...
    public void retrieveDeleteRfqItem(ActionEvent actionEvent) {
     ...
     // Row quotItmRow =vo.getCurrentRow();
       ...
       if(rfqId == null){
           FacesMessage message =
               new FacesMessage(resolvElDCMsg("#{bundle['MSG.418']}").toString());
           message.setSeverity(FacesMessage.SEVERITY_INFO);
           FacesContext fc = FacesContext.getCurrentInstance();
           fc.addMessage(null, message);
       }else{
       ...
       // if(strToProc.length()>1){
        ...
        if(aMImpl.getLovRfqItm1().getRowCount()>0){
            ...
            FacesMessage message =
                new FacesMessage(resolvElDCMsg("#{bundle['MSG.419']}").toString());
            message.setSeverity(FacesMessage.SEVERITY_INFO);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        }
                    ...
                    if (rows.length == 0) {
                        ...
                        Integer retval =
                            Integer.parseInt(callStoredFunction(INTEGER, "MM.PKG_MM_EOITM.INS_EO_ITM(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                                new Object[] { pslocId, CldID , pOrgId, pEoId, pItmId, pItmUom,
                                                                               pPrice, pQty, pDiscType, pDiscVal,
    ...
    public String saveandforward() {
       QuotationAMImpl am = (QuotationAMImpl)resolvElDC("QuotationAMDataControl");
        ...
        if(dt!=null)
        {
                 ...
                 fyId =(Integer)(callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID (?,?,?)", new Object[] {currRow.getAttribute("CldId"),currRow.getAttribute("OrgId"),dt}));
                if(fyId>0){
                    currRow.setAttribute("FyId", fyId);
                }
          ...
          /*   if ("Q".equalsIgnoreCase(taxruleFlg) && taxableAmt.compareTo(taxOnAmount) != 0 && filterdRw.length > 0) {
                ...
                if(amtSpFlag.equals(false)){
                   ...
                   // refDOcIdBind.setDisabled(true);
                      ...
                      Integer level =-1;
                         level= Integer.parseInt(callStoredFunction(NUMBER, "APP.WF_GET_USR_LEVEL(?,?,?,?,?,?,?)", new Object[] { p_sloc_id,
                                                                                                                                  CldID,
                                                                                                                                  p_org_id,
                                                                                                                                  p_user_id,
                                                                                                                                  wf_no,
                      ...
                      if(level>-1)
                      {
                      System.out.println(p_sloc_id+" "+CldID+" "+p_org_id+ " "+Docid+" "+wf_no+" "+doc_txn_id+" "+
                                                                                       p_user_id+ " "+p_user_id+" "+ level+" "+level+" "+action+ " "+remark+" "+
                                                                                       amtBs );
                        ...
                        //       System.out.println("new row created in tr");
                               ...
                               Number p_curr_fctr=new Number(1);
                                  ...
                                  System.out.println("Tax rule flg="+taxruleflg);
                                   //create trlines
                                   BigDecimal ret =
                                  (BigDecimal)callStoredFunction(NUMBER, "MM.PKG_MM_QUOT.ins_quot_tr_lines(?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                  ...
                                  getAm().getMmQuot1().getCurrentRow().setAttribute("SumTaxAmtItm_Trans",new Number(temp.round(6)));    
                                  ...
                                  if (rw.getAttribute("DocId").toString().equalsIgnoreCase(docId))
                                  {
                                      ...
                                      RowSetIterator rsitr = trVo.createRowSetIterator(null);
                                                while (rsitr.hasNext()) {
                                                  ...
                                                  if (trrw.getAttribute("DocId").toString().equalsIgnoreCase(docId))
                                                  {
                                                      if(trrw.getAttribute("ItmId").toString().equalsIgnoreCase(itmId) && trrw.getAttribute("ItmUom").toString().equalsIgnoreCase(itmUom) && trrw.getAttribute("TaxRuleFlg").toString().equalsIgnoreCase("Q"))
                                                      {
                                                      removedItmid=trrw.getAttribute("ItmId").toString();
                                                      removedItmUom=trrw.getAttribute("ItmUom").toString();
                                                      removedExmptflg=trrw.getAttribute("TaxExmptFlg").toString();
...
System.out.println("tax after discount flag "+am.getMmQuot1().getCurrentRow().getAttribute("TaxAfterDiscFlg"));
        } 
...
adfLog.info("new disc amt=" + newDiscVal);
      ...
      // poItmRow.setAttribute("Discout_trans", newDiscVal);//TransDiscAmt
        ...
        RowSetIterator rowsetitr = getAm().getMmQuotItm().createRowSetIterator(null);
        ...
        while (rsiItmPer.hasNext()) {
            ...
            if (discTypePo.equals("A") && sumItmAmt.compareTo(zero) != 0) {
                ...
                discAmt =new Number( (discValPo.multiply(itmAmtInPer)).divide(new Number(100)).round(6)); //discount amount for an item
            } else {
                discAmt =
