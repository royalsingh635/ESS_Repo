package mmstockadjustment.view.servlets;
...
public class MMAdjustmentServlet extends HttpServlet {
    private static final String CONTENT_TYPE = "text/html; charset=UTF-8";
    @SuppressWarnings("compatibility:-5361571114210430765")
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("slocId", request.getParameter("slocId"));
        request.setAttribute("docId", request.getParameter("docId"));
        request.setAttribute("fyId", request.getParameter("fyId"));
        request.setAttribute("stkNo", request.getParameter("stkNo"));
    ...
    private void performTask(HttpServletRequest request, HttpServletResponse response) throws ServletException,
            ...
            try{
                     ...
                     String stkNo =(String)request.getAttribute("stkNo");
                     ...
                     String amDef = "mmstockadjustment.model.service.MMStockAdjustmentAMImpl";
                     String config = "MMStockAdjustmentAMLocal";
                     MMStockAdjustmentAMImpl am = (MMStockAdjustmentAMImpl)Configuration.createRootApplicationModule(amDef,config);
              ...
              //  System.out.println("Connection : "+conn);
                     ...
                     ResultSet res=null;
                                        ...
                                        InputStream input = new FileInputStream(new File(path+"StockAdjustmentReport.jrxml"));
