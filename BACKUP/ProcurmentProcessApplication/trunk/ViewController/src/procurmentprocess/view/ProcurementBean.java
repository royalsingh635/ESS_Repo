...
public class ProcurementBean {
    ...
    public String SearchAction() {
        ...
        drftPoVo.setNamedWhereClauseParam("bindOrgId", am.getDual1().getCurrentRow().getAttribute("OrgId"));
    ...
    public void searchRFQAction(ActionEvent actionEvent) {
        ...
        rfqSrchVo.setNamedWhereClauseParam("bindOrgId", am.getDual1().getCurrentRow().getAttribute("OrgId"));
        BindingContainer bindings = getBindings();
    ...
    public void searchQuotionAction(ActionEvent actionEvent) {
        ...
        srchVo.setNamedWhereClauseParam("bindOrgId", am.getDual1().getCurrentRow().getAttribute("OrgId"));
        BindingContainer bindings = getBindings();
