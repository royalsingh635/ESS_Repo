...
public class ItemProfileAMImpl extends ApplicationModuleImpl implements ItemProfileAM {
     ...
     * @return AppItmPrf
     */
    public ViewObjectImpl getAppItmPrf() {
        return (ViewObjectImpl)findViewObject("AppItmPrf");
    }
    ...
    public String getGroupPath(Integer SlocId,String CldId,String hoOrgId,String groupId) {
        ...
        String path =
            (String)callStoredFunction(Types.VARCHAR, "GET_ITM_GRP_PATH(?,?,?,?)", new Object[] {SlocId,CldId,hoOrgId,groupId });
        return path;
    }
    ...
    public String getAttributePath(Integer SlocId,String CldId,String hoOrgId,String itmId) {
        ...
        String path =
            (String)callStoredFunction(Types.VARCHAR, "APP.FN_GET_ITM_ATT(?,?,?,?,?,?)", new Object[] {CldId ,SlocId,hoOrgId,itmId ,"R","," });
    ...
    public String isItemDeletable(Integer SlocId,String CldId,String hoOrgId,String OrgId,String itemId) {
        ...
        try{
         isDeletable =(String)callStoredFunction(Types.VARCHAR, "FN_IS_ITM_DELETABLE(?,?,?,?,?)", new Object[] {SlocId,CldId,hoOrgId,OrgId,itemId });
    ...
    public String deleteItem(Integer SlocId,String CldId,String hoOrgId,String itemId) {
      ...
      //  System.out.println("delete Item : " +SlocId +" , "+CldId+" , "+hoOrgId+" , "+itemId);
        ...
        String delete =
            (String)callStoredFunction(Types.VARCHAR, "PKG_APP_ITM.DELETE_ITM(?,?,?,?)", new Object[] {SlocId,CldId,hoOrgId,itemId });
    ...
    public void setBindVarSearch(String CldId,String HoOrgId,Integer SlocId){
        this.getItemSearch().setWhereClause("CLD_ID= '"+CldId+"' and HO_ORG_ID='"+HoOrgId+"' and SLOC_ID="+SlocId);
   ...
   //   String ItemCode =(String)callStoredFunction(Types.VARCHAR, "  APP.FN_GEN_ITM_ID(?,?,?,?,?,?,?,?,?)", new Object[] {cld_id,  sloc_id,hoOrgId,null ,null,null,null, "T" ,"C"});
    ...
    public boolean isPropertyCombinationValid()
    {
        ...
        if(slsFlg == null){slsFlg="N";}
        if(serFlg == null){serFlg="N";}
        if(purFlg == null){purFlg="N";}
        if(cpFlg == null){cpFlg="N";}
        if(wipFlg == null){wipFlg="N";}
        if(cptFlg == null){cptFlg="N";}
        
        
        RowQualifier rq = new RowQualifier(voItmMat);
        rq.setWhereClause("Pur = '"+purFlg+"' AND Sls = '"+slsFlg+"' AND Wip = '"+wipFlg+"' AND Capital = '"+cptFlg+"' AND Service = '"+serFlg+"' AND CashPur = '"+cpFlg+"'");
    ...
    public void addItemAttribute(String itmAttType, String itmAttValue){
        ...
        if(itmAttType !=null && itmAttValue !=null){
           ...
           newRow.setAttribute("AttId", itmAttValue);
            newRow.setAttribute("AttTypeId", itmAttType);
    ...
    public String isAttributeValid(String itmAttType, String itmAttValue){
       ...
       String retVal="N";
        ...
        rq.setWhereClause("CldId = '"+cld_id+"' AND SlocId = "+sloc_id+" AND HoOrgId = '"+hoOrgId+"' AND ItmId = '"+itmId+"' And AttTypeId = '"+itmAttType+"' ");
    ...
    public void updateItemIdAfterApproved(String retValue)
    {
        ...
        {
            String ItemCode =(String)callStoredFunction(Types.VARCHAR, " APP.FN_GEN_ITM_ID(?,?,?,?,?,?,?,?,?)", new Object[] {cld_id ,sloc_id, hoOrgId, grpId, tempItmId ,docId ,UsrId ,"P" ,"A"});
            adfLog.info("APP.FN_GEN_ITM_ID   "+ItemCode);
             if(ItemCode!=null){
                adfLog.info(currR.getAttribute("Actv")+" item id before set  ---->"+currR.getAttribute("ItmId"));
                if(ItemCode.equalsIgnoreCase("-1")||ItemCode.equalsIgnoreCase("-3")||ItemCode.equalsIgnoreCase("-4"))
                {
    ...
    public Boolean isItemNameDuplicate(String itemName,String previousVal)
    {
        ...
        rq.setWhereClause("SlocId = "+sloc_id+" AND CldId = '"+cld_id+"' AND HoOrgId = '"+hoOrgId+"' AND UPPER(ItmDesc)=UPPER('"+itemName.trim()+"')");
    ...
    public Integer getRowCount()
    {
        ...
        String retVal="N";
        RowQualifier rq = new RowQualifier(itmAtt);
        rq.setWhereClause("CldId = '"+cld_id+"' AND SlocId = "+sloc_id+" AND HoOrgId = '"+hoOrgId+"' AND ItmId = '"+itmId+"'");
        Row []rr = itmAtt.getFilteredRows(rq);
      return rr.length;
    }
    ...
    public void populateItmPropertyFrmSampleItem(String value){
        ...
        if(currR.getAttribute("TransSampleItemForPopulate")!=null || value!=null){
            ...
            rq.setWhereClause("CldId = '"+currR.getAttribute("CldId")+"' and HoOrgId = '"+currR.getAttribute("HoOrgId")+"' and SlocId = "+Integer.parseInt(currR.getAttribute("SlocId").toString())+" and ItmDesc ='"+value+"' ");
            ...
            if(itmId!=null){
              ...
              rq2.setWhereClause("CldId = '"+currR.getAttribute("CldId")+"' and HoOrgId = '"+currR.getAttribute("HoOrgId")+"' and SlocId = "+Integer.parseInt(currR.getAttribute("SlocId").toString())+" and ItmId ='"+currR.getAttribute("ItmId")+"' ");
              Row [] rr3 = attvo.getFilteredRows(rq2);
                ...
                rq1.setWhereClause("CldId = '"+currR.getAttribute("CldId")+"' and HoOrgId = '"+currR.getAttribute("HoOrgId")+"' and SlocId = "+Integer.parseInt(currR.getAttribute("SlocId").toString())+" and ItmId ='"+itmId+"' ");
    ...
    public Integer replicateAllOrgFoItm(){
      ...
      // Row trOrgvo=this.gettransOrg1().getCurrentRow();
        ...
        ret= Integer.parseInt(callStoredFunction(NUMBER, "APP.FN_REPLI_ITM_ORG(?,?,?,?,?)",
                                                   new Object[] { cld_id, sloc_id, hoOrgId, itmId,this.gettransOrg1().getCurrentRow().getAttribute("TransTaxRule")}).toString());
