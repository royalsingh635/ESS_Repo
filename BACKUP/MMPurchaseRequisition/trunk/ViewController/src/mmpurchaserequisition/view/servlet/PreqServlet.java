package mmpurchaserequisition.view.servlet;
...
public class PreqServlet extends HttpServlet {
    ...
    private void openReportFun(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            String preq =(String)request.getParameter("preqNo");
            ...
            String docId = (String)request.getParameter("prTxnId");
           
          

            InputStream input = new FileInputStream(new File(path + "PurchaseRequistion.jrxml"));
