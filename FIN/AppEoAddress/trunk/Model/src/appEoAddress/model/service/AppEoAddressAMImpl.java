...
public class AppEoAddressAMImpl extends ApplicationModuleImpl implements AppEoAddressAM {
    ...
    public String checkDupicate(String referValue,String referCol){
        System.out.println("referValue = "+referValue+" referCol = "+referCol);
        AppEoAddsVOImpl adds = getAppEoAdds();
        Row currentRow = adds.getCurrentRow();
        RowSetIterator rsi = adds.createRowSetIterator(null);
        while(rsi.hasNext()){
            Row next = rsi.next();
            if (next!=currentRow) {
                Object val = next.getAttribute(referCol);
                System.out.println("val = "+val);
                if(val!=null){
                    if(referValue.equals(val.toString())){
