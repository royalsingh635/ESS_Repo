...
public class AppEoAddressAMClient extends ApplicationModuleImpl implements AppEoAddressAM {
    ...
    public String checkDupicate(String referValue, String referCol) {
        Object _ret = this.riInvokeExportedMethod(this, "checkDupicate", new String[] {
    ...
    public void setBindVar(String cldid, Integer slocid, String hoorgid, Integer eoid) {
        Object _ret = this.riInvokeExportedMethod(this, "setBindVar", new String[] {
                                                  ...
                                                  "java.lang.Integer"
        }, new Object[] { cldid, slocid, hoorgid, eoid });
        return;
    }

    public void setModeToEntity(String modeToEntity) {
        Object _ret = this.riInvokeExportedMethod(this, "setModeToEntity", new String[] { "java.lang.String" }, new Object[] {
                                                  modeToEntity });
        return;
    }
