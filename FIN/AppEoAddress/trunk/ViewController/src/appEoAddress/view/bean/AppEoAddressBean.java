...
public class AppEoAddressBean implements Serializable {
    ...
    public void referenceIdValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        // Add event code here...
        validateDuplicate(object, "LocRefId");
    }
    public String validateDuplicate(Object value,String ColName){
        System.out.println("value = "+value+" ColName = "+ColName);
        if(value!=null){
            BindingContainer bc = getBindings();
            OperationBinding binding = bc.getOperationBinding("checkDupicate");
            binding.getParamsMap().put("referValue", value);
            binding.getParamsMap().put("referCol", ColName);
            binding.execute();
            ...
            if(res!=null){
                if(res.equals("Y")){
                    ...
                    throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,"Duplicate Record Found",null));
                }
            }
    ...
    public void ReferenceNameValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        // Add event code here...
        validateDuplicate(object, "LocRefNm");
