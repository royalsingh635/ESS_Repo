...
public class OpBalCoasAMImpl extends ApplicationModuleImpl implements OpBalCoasAM {
     ...
     * @return LovCoaId1
     */
    public LovCoaIdVOImpl getLovCoaId1() {
        return (LovCoaIdVOImpl) findViewObject("LovCoaId1");
    }
    ...
    public void initViewExecution() {
        ...
        if (resolvEl("#{pageFlowScope.PARAM_PG_CALLED}") != null) {
            ...
            }else if (resolvEl("#{pageFlowScope.PARAM_PG_CALLED}").toString().equalsIgnoreCase("M")){
    ...
    public void updateDataFromExcel() {
        ...
        System.out.println("Come hello  java");
        Object updatedRows = resolvEl("#{pageFlowScope.UPDATED_ROWS}");
        ...
        if (updatedRows != null) {
            ...
            while (iterator.hasNext()) {
                ...
                ViewObjectImpl coaFy1 = this.getOrgCoaFy1();
                System.out.println("Row count is: " + coaFy1.getRowCount());
                System.out.println("Value for function are: " + cld_id + "  " + sloc_id + " " + org_id + " " +
                                   Pkeys.get("OrgCoaId") + " " + Pkeys.get("OrgFyId") + " " +
                                   column.get("OrgCoaOpBal") + " " + column.get("OrgCoaOpBalTyp"));
                if (column.get("OrgCoaOpBalTyp") != null && column.get("OrgCoaOpBal") != null) {
                    Object callStoredFunction =
                        this.callStoredFunction1(Types.NUMERIC, "FIN.fn_upd_opening_bal(?,?,?,?,?,?,?)", new Object[] {
                                                 cld_id, sloc_id, org_id, Pkeys.get("OrgCoaId"), Pkeys.get("OrgFyId"),
                                                 column.get("OrgCoaOpBal"), column.get("OrgCoaOpBalTyp")
                                                 //   "0000", 1, "01", 11, 1, 200, "Dr"

                    });
                    System.out.println("Result from function: " + callStoredFunction);
                }

                //  RowQualifier rq = new RowQualifier(coaFy1);
                //  rq.setWhereClause("OrgCoaCldId = '" + cld_id + "' and OrgSlocId = " + sloc_id + " and OrgId = '" +
                //                    org_id + "' and OrgFyId= " + 5 + " and OrgCoaId = " + 7);
                //Integer.parseInt(Pkeys.get("OrgFyId").toString())
                //Integer.parseInt(Pkeys.get("OrgCoaId").toString())
                //    String exprStr = rq.getExprStr();
                //     System.out.println("Expression is: " + exprStr);
                // Row[] filteredRows = coaFy1.getFilteredRows(rq);
...
*/
            ...
            this.getOrgCoaFy1().executeQuery();
        }
    }
