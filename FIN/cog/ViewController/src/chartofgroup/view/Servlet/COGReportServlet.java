package chartofgroup.view.Servlet;
...
public class COGReportServlet extends HttpServlet {
    ...
    String amDef = "chartofgroup.model.service.ChartOfGroupAMImpl";
            String config = "ChartOfGroupAMLocal";
           ChartOfGroupAMImpl am =
                (ChartOfGroupAMImpl)Configuration.createRootApplicationModule(amDef,
                                                                                  config);
    ...
    Connection conn = st.getConnection(); */
            ...
            Integer slocid = Integer.parseInt(request.getParameter("sloc_id").toString());
        ...
        InputStream input = new FileInputStream(new File(path + "COGReport.jrxml"));
        JasperDesign design = JRXmlLoader.load(input);
        JasperReport report = JasperCompileManager.compileReport(design);  */

            JasperReport report = (JasperReport) JRLoader.loadObject(path + "COGReport.jasper");
