...
public class TmplSearchBean {
    ...
    private RichSelectOneChoice transProjectNmBind;
    ...
    public void searchEvent(ActionEvent actionEvent) {
        ...
        v.setNamedWhereClauseParam("BindPrjId", transProjectNmBind.getValue());
        System.out.println();
    ...
    public void setTransProjectNmBind(RichSelectOneChoice transProjectNmBind) {
        this.transProjectNmBind = transProjectNmBind;
    }

    public RichSelectOneChoice getTransProjectNmBind() {
        return transProjectNmBind;
    }
}
