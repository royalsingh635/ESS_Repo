    ...
    * **/
    ...
    public String refreshSupplierAction() {
        ...
        if(binding.getErrors().isEmpty()){
            topSuppPie.setRendered(true);
            currDescBinding.setRendered(true);
           // refreshButton.setRendered(false);
            AdfFacesContext.getCurrentInstance().addPartialTarget(topSuppPie);
            AdfFacesContext.getCurrentInstance().addPartialTarget(currDescBinding);
    ...
    public String RefreshCutomer() {
        ...
        binding.execute();
        if(binding.getErrors().isEmpty()){
            cutomerGraphBinding.setRendered(true);
            currDescBinding1.setRendered(true);
         //   refresh1.setRendered(false);
            AdfFacesContext.getCurrentInstance().addPartialTarget(cutomerGraphBinding);
            AdfFacesContext.getCurrentInstance().addPartialTarget(currDescBinding1);
          //  AdfFacesContext.getCurrentInstance().addPartialTarget(refresh1);
    ...
    public String refreshBank() {
        ...
        binding.execute();
        if(binding.getErrors().isEmpty()){
            bankGraph.setRendered(true);
           // currDescBinding1.setRendered(true);
            //refresh2.setRendered(false);
            AdfFacesContext.getCurrentInstance().addPartialTarget(bankGraph);
         //   AdfFacesContext.getCurrentInstance().addPartialTarget(currDescBinding1);
            //AdfFacesContext.getCurrentInstance().addPartialTarget(refresh2);
    ...
    public String refreshCash() {
        ...
        binding.execute();
        if(binding.getErrors().isEmpty()){
            cashGraph.setRendered(true);
           // currDescBinding1.setRendered(true);
          //  refresh3.setRendered(false);
            AdfFacesContext.getCurrentInstance().addPartialTarget(cashGraph);
         //   AdfFacesContext.getCurrentInstance().addPartialTarget(currDescBinding1);
