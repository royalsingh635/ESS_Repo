...
public class Coa {
    ...
    private RichSelectOneChoice projectBind;
    private String ccMode = "V";
    private RichSelectBooleanCheckbox ccFlagBinding;
    private RichSelectBooleanCheckbox ccFlagBind;
    private String ccFlagMode="V";

    public void setCcFlagMode(String ccFlagMode) {
        this.ccFlagMode = ccFlagMode;
    }

    public String getCcFlagMode() {
        return ccFlagMode;
    }
    ...
    public void addDialogListner(DialogEvent dialogEvent) {
        ...
        if (coaNm == null) {
            ...
            FacesMessage message = new FacesMessage(":", resolvElDCMsg("#{bundle['MSG.153']}").toString());  //Field is Mandatory to fill
            ...
            if (a.equalsIgnoreCase("true") && pnl.equalsIgnoreCase("true")) {
                ...
                if (dialogEvent.getOutcome().name().equals("ok")) {
                    ...
                    if (prtBudgt.getValue().toString().equalsIgnoreCase("false") &&
                        ...
                        String msg = (String) resolvElDCMsg("#{bundle['MSG.2495']}");
                        FacesMessage message = new FacesMessage(msg);  //Part of Budgeting must be selected.
                        message.setSeverity(FacesMessage.SEVERITY_ERROR);
                        FacesContext fc = FacesContext.getCurrentInstance();
                        fc.addMessage(null, message);
                    } else {
                        ...
                        if ((("L".equalsIgnoreCase(coaGrpTypBind.getValue().toString())) ||
                            ...
                            saveData = "N";
                            _adfLog.info("ERROR = 1087 = Balance type for Income/Liabilities should be Cr!!");  //Balance type for Income/Liabilities should be Cr!!
                        ...
                        if (("I".equalsIgnoreCase(coaGrpTypBind.getValue().toString())) ||
                            ...
                            if (pnlItemPopup.getValue().equals(false) ||
                                ...
                                String msg1 = resolvEl("#{bundle['MSG.1089']}").toString();  //COA should be a part of Profit And loss for Income/Expenses!!
                                FacesMessage message = new FacesMessage(msg1);
                                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(null, message);
                                ...
                                String msg1 = resolvEl("#{bundle['MSG.1090']}").toString();  //Income/Expenses COA can not be a part of Cash Flow!!
                                FacesMessage message = new FacesMessage(msg1);
                                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(null, message);
                                ...
                                String msg1 = resolvEl("#{bundle['MSG.1091']}").toString();  //Income/Expenses COA can not be a Transfer Balance Account!!
                                FacesMessage message = new FacesMessage(msg1);
                                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(null, message);
                        ...
                        if ("Y".equalsIgnoreCase(saveData)) {
                            ...
                            if ((u.equals("Y"))) {
                                System.out.println("before insertinf data in madatory table");
                                BindingContainer bindingss = getBindings();
                                OperationBinding operationBindings =
                                    bindingss.getOperationBinding("insertDataInAppCCStruct");
                     ...
                     operationBindin1.execute();    */
                                String msg = (String) resolvEl("#{bundle['MSG.2496']}");
                                FacesMessage message = new FacesMessage(msg);  //Error in Post COA operations
                                message.setSeverity(FacesMessage.SEVERITY_INFO);
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(null, message);
                            }
    ...
    public String edit() {
       ...
       */
        ...
        if (check.equalsIgnoreCase("Y")) {
            ...
            this.projectBind.setDisabled(true);
            this.ccMode = "V";
            ...
            this.projectBind.setDisabled(false);
    ...
    public void save(ActionEvent actionEvent) {
        ...
        if (prtBudgt.getValue().toString().equalsIgnoreCase("true") &&
           ...
           String msg = (String) resolvEl("#{bundle['MSG.2497']}");
            FacesMessage message = new FacesMessage(msg);  //Budget Calc Logic required when part of budgeting is selected
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
                   ...
                   budjetCalcLogic.getValue().toString().length() > 0) {
            String msg = (String) resolvEl("#{bundle['MSG.2497']}");
            FacesMessage message = new FacesMessage(msg);  //Please select part of budgeting.
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        } else {
            if ((a.equalsIgnoreCase("true") && pnl1.equalsIgnoreCase("true"))) {
                ...
                if (saveData.equals("Y")) {
                    ...
                    if ((u.equals("Y") && "Y".equalsIgnoreCase(saveData))) {
                        ...
                        OperationBinding operationBinding = bindings.getOperationBinding("insertDataInAppCCStruct");
                        operationBinding.execute();
                        ...
                        if (operationBinding.getErrors().isEmpty()) {
                            ...
                            String msg =
                                resolvElDCMsg("#{bundle['MSG.226']}").toString() + " " + coaNm + " " +   //Chart of Account for
                                resolvElDCMsg("#{bundle['MSG.227']}").toString();   //Saved Successfully.
    ...
    public void saveAdd(ActionEvent actionEvent) {
        ...
        if ((this.prtBudgt.isSelected() && this.budjetCalcLogic.getValue() != null) ||
            ...
            String msg1 = resolvEl("#{bundle['MSG.240']}").toString();  //Budget Calc. Logic is Required.
            FacesMessage message = new FacesMessage(msg1);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void coaNameValidatorForm(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null && object.toString().trim().length() > 0) {
            ...
            if (openB != closeB || closeFg == true || (coaNm.lastIndexOf("(") > coaNm.lastIndexOf(")")) ||
                ...
                String msg2 = resolvElDCMsg("#{bundle['MSG.7']}").toString();   //Brackets not closed properly.
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message2);
            }
            ...
            if (coaNm.contains("()")) {
                ...
                String msg2 = resolvElDCMsg("#{bundle['MSG.49']}").toString();  //Empty Brackets are not allowed
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message2);
            }
            ...
            if (coaNm.contains("..")) {
                ...
                String msg2 = resolvElDCMsg("#{bundle['MSG.109']}").toString();  //Two dots (..)  together not allowed.
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message2);
            }
            ...
            if (coaNm.contains("(.") || coaNm.contains("(-") || coaNm.contains("-)")) {
                String msg2 = resolvElDCMsg("#{bundle['MSG.59']}").toString();  //Invalid content. Check content inside brackets.
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message2);
            }
    ...
    public void coaNameValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null && object.toString().trim().length() > 0) {
            ...
            if (res.equalsIgnoreCase("N")) {
                String msg =(String) resolvEl("#{bundle['MSG.46']}");  //Duplicate record found
    ...
    public void deleteAction(ActionEvent actionEvent) {
        ...
        if (check.intValue() == 0) {
            ...
            String msg =
                resolvElDCMsg("#{bundle['MSG.226']}").toString() + coaNm +  //Chart of Account for
                resolvElDCMsg("#{bundle['MSG.229']}").toString();       //is already in use. So it cannot be deleted.
            FacesMessage message = new FacesMessage(msg);
    ...
    public void exchangeFluctuationValidation(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (val == true) {
            ...
            if (validate.equalsIgnoreCase("Y")) {
                ...
                msg4 =
                    resolvEl("#{bundle['MSG.2504']}") + this.coaNameRound_exchng + " " +        //another account named
                    resolvEl("#{bundle['MSG.232']}").toString();        // is already selected for Exchange Fluctuation.

                String msg2 = resolvEl("#{bundle['MSG.233']}").toString();      //Only one COA can be selected for Exchange Fluctuation.
            ...
            if (!COGID.equals("")) {
                ...
                if (!((cogIdFirstDigit == '2') || (cogIdFirstDigit == '1'))) {
                    ...
                    throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                  ...
                                                                  resolvEl("#{bundle['MSG.235']}").toString(), null));      //Or child of Asset or Liability
            ...
            if (row.length > 0) {
                for (Row r : row) {
                    if (r.getAttribute("CoaId").toString().equals(v.getCurrentRow().getAttribute("CoaId").toString()) &&
                        ...
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      resolvEl("#{bundle['LBL.159']}") + r.getAttribute("CoaNm").toString() +       //coa
                                                                      resolvEl("#{bundle['MSG.2502']}"),    //is already selected Reserved Revenue Account.
                                                                      null));
    ...
    public void coaRoundVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (val == true) {
            ...
            if (validate.equalsIgnoreCase("Y")) {
                msg4 =
                    resolvEl("#{bundle['MSG.2501']}") + this.getCoaNameRound_exchng() + " " +  //Another Coa named
                    resolvEl("#{bundle['MSG.244']}").toString();        //is already selected for Round account.
                String msg2 = resolvEl("#{bundle['MSG.243']}").toString();      //Only one COA can be selected for Round account.
    ...
    public void coaGrpIdVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null && this.coaAccIdBindPopup.getValue() != null && currRow.getAttribute("CoaAccId") != null) {
            ...
            if (!CogId.equals("")) {
                ...
                if (rowI.length >
                    1) {
                   String msg = (String) resolvEl("#{bundle['MSG.2498']}");     //COA with this NATURAL ACCOUNT and ACCOUNT GROUP combination already exist.
                   String mesg = (String) resolvEl("#{bundle['MSG.2499']}");    //Only one COA can be created for one NATURAL ACCOUNT and ACCOUNT GROUP combination.
          ...
          new FacesMessage(msg,
            ...
            String msg = ("#{bundle['MSG.2624']}");  //Account type cannot be null.
    ...
    public void naValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (res != null && res == 1) {
                String msg = (String) resolvEl("#{bundle['MSG.12']}");
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,msg,null));
                                                              // Can not create COA, COA already exists for the selected NA or Group
            }
        }
    }
        ...
        if (valueChangeEvent.getNewValue().toString().equalsIgnoreCase("false")) {
            ...
            if (valueChangeEvent.getNewValue().toString().equalsIgnoreCase("true")) {
                FacesContext.getCurrentInstance().addMessage(valueChangeEvent.getComponent().getClientId(),
                                                             new FacesMessage(FacesMessage.SEVERITY_INFO,resolvElDCMsg("#{bundle['LBL.5197']}").toString(),  //Important Information
                                                                              resolvElDCMsg("#{bundle['MSG.1331']}").toString()));  //  Make Organizations Active for this Coal after saving the record
            }
        }
                            ...
                            if (number != null) {
                                ...
                                if (coaId != null) {
                                    ...
                                    if (result.equalsIgnoreCase("N")) {
                                        FacesMessage message =
                                            new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvEl("#{bundle['MSG.2625']}").toString(), //Please Check the box
                                                            resolvEl("#{bundle['MSG.2626']}").toString()); // Coa Can't be made Inactive for all Organization.
...
//            if (((String) object).equalsIgnoreCase("Y") || ((String) object).equalsIgnoreCase("True")) {
//                b = true;
//            } else {
//                b = false;
//            }
//            System.out.println("jvS b value" +b);
//
//        } else {
//            System.out.println("ELse java.lang.String");
//            b = (Boolean) object;
//            System.out.println("value of b"+b);
//        }
     if(object!=null){
        if (object.toString().equalsIgnoreCase("N")||object.toString().equalsIgnoreCase("False")) {
            ...
            if (result.equalsIgnoreCase("Y")) {
                ...
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvEl("#{bundle['MSG.2628']}").toString()
                                                              , null));  //Can not set this organization as Inactive for current COA
                ...
                AdfFacesContext.getCurrentInstance().addPartialTarget(uIComponent);
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvEl("#{bundle['MSG.2629']}").toString(), null));  //Exception
    ...
    public void setProjectBind(RichSelectOneChoice projectBind) {
        this.projectBind = projectBind;
    }

    public RichSelectOneChoice getProjectBind() {
        return projectBind;
    }

    public void setCcFlagBind(RichSelectBooleanCheckbox ccFlagBind) {
        this.ccFlagBind = ccFlagBind;
    }

    public RichSelectBooleanCheckbox getCcFlagBind() {
        return ccFlagBind;
    }
}
