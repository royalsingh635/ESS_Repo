        ...
        if (object.equals(true) && coaCogId.getValue()!=null) {
            ...
            Row[] row = coa1.getFilteredRows("CoaRr", "Y");
                ...
                for(Row r : row)
                {
                    ...
                    {
                            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,"COA- " +r.getAttribute("CoaNm").toString()+ " is already selected for Reserved Revenue account !", null));
