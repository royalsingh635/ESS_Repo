...
// ---------------------------------------------------------------------
public class GlAppAMImpl extends ApplicationModuleImpl implements GlAppAM {
    ...
    public Integer on_load_page() {
        ...
        callStoredFunctionamParam(VARCHAR, "app.fn_get_usr_doc_access_param(?,?,?,?,?,?,?,?,?)", new Object[] {
    ...
    public String processTaxForHdr() {
        ...
        Integer slNo = 0;
        Integer appInst = 1;
        System.out.println("Sloc id---" + slocId + "---Org---" + orgId + "--Vou----" + vouId + "---Vou Dt---" + tvouDt +
                           "---SLNO---" + slNo + "---TaxRule---" + taxRuleId + "---FinAmt---" + finAmt +
                           "---CurrId---" + currIdsp + "--ParamOp----" + op + "----UsrId--" + userId + "---VouDt---" +
                           tvouDt + "---Inst---" + appInst + "hoOrgId---->" + hoOrgId + "cld id is-->" + cldId);
        try {
            callStoredProcedure("FIN.PKG_FIN_GL.INS_GL_TAX_LINE(?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                                slocId, orgId, vouId, tvouDt, slNo, taxRuleId, finAmt, currIdsp, op, userId, tvouDt,
                                appInst, hoOrgId, cldId
            });
        } catch (Exception e1) {
    ...
    //  Number amtSp = (Number)glCurRow.getAttribute("GlAmtSp");
        ...
        try {
            ...
            callStoredProcedure("FIN.PKG_FIN_GL.INS_GL_TDS_LINE(?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                                slocId, orgId, vouId, tvouDt, slNo, tdsRuleId, finAmt, currIdsp, op, userId, tvouDt,
                                appInst, hoOrgId, cldId
            });
 ...
 //  Number amtSp = (Number)glCurRow.getAttribute("GlAmtSp");
    ...
    public void taxConsolidation() {
        ...
        callStoredFunction(NUMBER, "FIN.PKG_FIN_GL.FN_GL_TAX(?,?,?,?,?,?,?,?,?)", new Object[] {
                           vouId, vouTyp, vouSubTyp, vouInsId, tvouSpId, orgId, slocid, cldId, hoOrgId
        });
    ...
    public void tdsConsolidation() {
        ...
        callStoredFunction(NUMBER, "FIN.PKG_FIN_GL.FN_GL_TDS(?,?,?,?,?,?,?,?,?)", new Object[] {
                           vouId, vouTyp, vouSubTyp, vouInsId, tvouSpId, orgId, slocid, cldId, hoOrgId
        });
    ...
    public void tvouOtherCharges() {
        ...
        callStoredFunction(NUMBER, "FIN.PKG_FIN_GL.FN_GL_OC (?,?,?,?,?)", new Object[] {
                           vouId, orgId, slocid, cldId, hoOrgId });
    ...
    public void refreshAdvanceValues(String eoOrCoa) {
        ...
        if (tVou.getEstimatedRowCount() != 0) {
            ...
            if (eoOrCoa.equals("eo")) {
                getEoFronCoa("pkg_fin.get_coa_msteo(?,?,?,?,?,?)", new Object[] {
                             tVou.getCurrentRow().getAttribute("AdjSlocId"),
    ...
    public String validateChqNo(Integer p_sloc_id, Integer p_bnk_id, Integer p_chq_buk_id, Number p_chq_no) {
        ...
        return (String) callStoredFunction(VARCHAR, "pkg_fin.fn_validate_chq_no (?,?,?,?)", new Object[] {
    ...
    public String updateChqNo(Integer p_sloc_id, Integer p_bnk_id, Integer p_chq_buk_id, Number p_chq_no,
        ...
        return (String) callStoredFunction(VARCHAR, "pkg_fin.fn_upd_chq_no_data (?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
    ...
    public String getLastChqNo(Integer p_sloc_id, Integer p_bnk_id, String p_search_mode, Integer p_chq_buk_id) {
        ...
        String chqSlNO = callStoredFunction(VARCHAR, "pkg_fin.fn_get_chq_no (?,?,?,?)", new Object[] {
     ...
     * @return LovGlTypeId1
     */
    public LovGlTypeIdVOImpl getLovGlTypeId1() {
        return (LovGlTypeIdVOImpl) findViewObject("LovGlTypeId1");
    }
     ...
     */
    public LovDistVouTypVOImpl getLovDistVouTyp1() {
        return (LovDistVouTypVOImpl) findViewObject("LovDistVouTyp1");
    }
     ...
     * @return GlSearchView
     */
    public ViewObjectImpl getGlSearchView() {
        return (ViewObjectImpl) findViewObject("GlSearchView");
    }
    ...
    public void glLineOp() {
        try {
            ...
            System.out.println("Voucher id for this Voucher--->" + vouId + "org-->" + orgId + "cld--" + cldId +
                               "go org--" + hoOrgId);
            callStoredFunction(NUMBER, "FIN.PKG_FIN_GL.FN_GL_LINE_HDR_LINE_OP(?,?,?,?,?)", new Object[] {
                               vouId, slocid, orgId, hoOrgId, cldId
            });
        } catch (Exception nfe) {
    ...
    public void forwardVoucherFun(Integer slocId, String orgId, Integer docId, Integer docTypeId, String docTxnId,
        ...
        System.out.println("forward function " + slocId + " " + orgId + " " + docId + " " + docTypeId + " " + docTxnId +
                           " " + docTxnDt + " " + wfId + " " + docUsrId + " " + docUsrIdFwd + " " + docFwdPri + " " +
                           txnMode + " " + comment);

        callStoredFunction(VARCHAR, "APP.WF_FWD (?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                           slocId, orgId, docId, docTypeId, docTxnId, docTxnDt, wfId, docUsrId, docUsrIdFwd, docFwdPri,
                           txnMode, comment
        });
    ...
    public void fnInsDocActivity(Integer P_SLOC_ID, Integer P_USR_ID_OWN, Integer P_USR_ID_OTHR1,
        ...
        System.out.println("PARAMS--- fnInsDocActivity " + P_SLOC_ID + "--   " + P_USR_ID_OWN + "   " + P_USR_ID_OTHR1 +
                           "  " + P_USR_ID_OTHR2 + " " + P_ACTIVITY + "  " + P_DISP_DOC_ID + ",  " + P_DISP_DOC_DATE +
                           ",  " + P_DOC_ID + " " + P_DOC_TYPE_ID);
        callStoredFunction(VARCHAR, "APP.PKG_APP_ACTIVITY.FN_INS_DOC_ACTIVITY(?,?,?,?,?,?,?,?,?,?)", new Object[] {
                           P_SLOC_ID, P_USR_ID_OWN, P_USR_ID_OTHR1, P_USR_ID_OTHR2, P_ACTIVITY, P_DISP_DOC_ID,
                           P_DISP_DOC_DATE, P_DOC_ID, P_DOC_TYPE_ID, P_DOC_SUB_TYPE_ID
        });
    }
    ...
    public String isOrgDocInWf(Integer P_SLOC_ID, String P_ORG_ID, Integer P_DOC_ID) {
        ...
        return callStoredFunction(VARCHAR, "APP.PKG_WF.fn_is_ORG_doc_in_wf(?,?,?)", new Object[] {
                                  P_SLOC_ID, P_ORG_ID, P_DOC_ID }).toString();
    }


    public String fnChkOrgDocActivity(Integer P_SLOC_ID, String P_ORG_ID, Integer P_DOC_ID, Integer P_DOC_TYPE_ID,
                                      String P_ACTIVITY) {
        System.out.println("fnChkOrgDocActivity  " + P_SLOC_ID + " " + P_ORG_ID + " " + P_DOC_ID + " " + P_DOC_TYPE_ID +
                           " " + P_ACTIVITY);
        return callStoredFunction(VARCHAR, "APP.PKG_APP_ACTIVITY.FN_CHK_ORG_DOC_ACTIVITY_PROP(?,?,?,?,?)", new Object[] {
                                  P_SLOC_ID, P_ORG_ID, P_DOC_ID, P_DOC_TYPE_ID, P_ACTIVITY
    }).toString();
    }
     ...
     */
    public GlSearchFieldVOImpl getGlSearchFieldVO() {
        return (GlSearchFieldVOImpl) findViewObject("GlSearchFieldVO");
    }
    ...
    public void glSearchAction() {
        ViewObjectImpl searchFieldVO = this.getGlSearchFieldVO();
        ViewObjectImpl glSearchViewVO = this.getGlSearchView();
        Row currentRow = searchFieldVO.getCurrentRow();
        System.out.println("----" + EbizParams.GLBL_APP_CLD_ID());
        System.out.println("----" + Integer.parseInt(EbizParams.GLBL_APP_SERV_LOC().toString()));
        System.out.println("----" + EbizParams.GLBL_APP_USR_ORG());
        System.out.println("----" + EbizParams.GLBL_HO_ORG_ID());
        glSearchViewVO.setNamedWhereClauseParam("BindCldId", EbizParams.GLBL_APP_CLD_ID());
        glSearchViewVO.setNamedWhereClauseParam("BindSlocId",
                                                Integer.parseInt(EbizParams.GLBL_APP_SERV_LOC().toString()));
        glSearchViewVO.setNamedWhereClauseParam("BindOrgId", EbizParams.GLBL_APP_USR_ORG());
        glSearchViewVO.setNamedWhereClauseParam("BindPrjId", currentRow.getAttribute("PrjId"));

        glSearchViewVO.setNamedWhereClauseParam("BindHoOrgId", EbizParams.GLBL_HO_ORG_ID());
        if (currentRow.getAttribute("GlVouTyp") != null && currentRow.getAttribute("GlVouTyp") != "")
            glSearchViewVO.setNamedWhereClauseParam("BindVoutype",
                                                    Integer.parseInt(currentRow.getAttribute("GlVouTyp").toString()));


        if (currentRow.getAttribute("GlCoaId") != null && currentRow.getAttribute("GlCoaId") != "")
            glSearchViewVO.setNamedWhereClauseParam("BindCoaId",
                                                    Integer.parseInt(currentRow.getAttribute("GlCoaId").toString()));

        if (currentRow.getAttribute("GlCogId") != null && currentRow.getAttribute("GlCogId") != "")
            glSearchViewVO.setNamedWhereClauseParam("BindCogId", currentRow.getAttribute("GlCogId").toString());

        if (currentRow.getAttribute("TransVouFromDt") != null && currentRow.getAttribute("TransVouFromDt") != "")
            glSearchViewVO.setNamedWhereClauseParam("BindFromDate", currentRow.getAttribute("TransVouFromDt"));

        if (currentRow.getAttribute("TransVouToDt") != null && currentRow.getAttribute("TransVouToDt") != "")
            glSearchViewVO.setNamedWhereClauseParam("BindToDate", currentRow.getAttribute("TransVouToDt"));

        if (currentRow.getAttribute("GlVouIdDisp") != null && currentRow.getAttribute("GlVouIdDisp") != "")
            glSearchViewVO.setNamedWhereClauseParam("BindDispID", currentRow.getAttribute("GlVouIdDisp"));

        glSearchViewVO.setNamedWhereClauseParam("BindGlExtDocNo", currentRow.getAttribute("GlExtDocNo"));

        glSearchViewVO.executeQuery();


    }

    public void glSrchpageResetAction() {
        this.getGlSearchFieldVO().executeQuery();
        ViewObjectImpl glSearchViewVO = this.getGlSearchView();
        glSearchViewVO.setNamedWhereClauseParam("BindSlocId", -1);
        glSearchViewVO.setNamedWhereClauseParam("BindCldId", EbizParams.GLBL_APP_CLD_ID());
        glSearchViewVO.setNamedWhereClauseParam("BindOrgId", EbizParams.GLBL_APP_USR_ORG());
        glSearchViewVO.setNamedWhereClauseParam("BindHoOrgId", EbizParams.GLBL_HO_ORG_ID());
        glSearchViewVO.setNamedWhereClauseParam("BindVoutype", null);
        glSearchViewVO.setNamedWhereClauseParam("BindCoaId", null);
        glSearchViewVO.setNamedWhereClauseParam("BindCogId", null);
        glSearchViewVO.setNamedWhereClauseParam("BindFromDate", null);
        glSearchViewVO.setNamedWhereClauseParam("BindToDate", null);
        glSearchViewVO.setNamedWhereClauseParam("BindDispID", null);
        glSearchViewVO.setNamedWhereClauseParam("BindGlExtDocNo", null);
        this.getGlSearchView().executeQuery();
    }

    public void setBindVar() {
        this.getGlSearchView().setNamedWhereClauseParam("BindSlocId", -1);
        this.getGlSearchView().executeQuery();
    }

    public void filterGLVO() {
        GlVOImpl gl1 = this.getGl1();
        ViewCriteria vc = gl1.getViewCriteria("GlVOCriteria");
        gl1.applyViewCriteria(vc);
        gl1.setNamedWhereClauseParam("BindCldId", EbizParams.GLBL_APP_CLD_ID());
        gl1.setNamedWhereClauseParam("BindHoOrgId", EbizParams.GLBL_HO_ORG_ID());
        gl1.setNamedWhereClauseParam("BindOrgId", EbizParams.GLBL_APP_USR_ORG());
        gl1.setNamedWhereClauseParam("BindSlocId", EbizParams.GLBL_APP_SERV_LOC());
        gl1.setNamedWhereClauseParam("BindVouId", resolvEl("#{pageFlowScope.PvouId}").toString());
        gl1.executeQuery();
    }
    ...
    public Boolean chkCcApplicableOrNot() {
        ...
        GlVOImpl impl = getGl1();
        Row currentRow = impl.getCurrentRow();

        Object hoOrg_id = currentRow.getAttribute("GlHoOrgId");
        Object cld_id = currentRow.getAttribute("GlCldId");
        Object orgId = currentRow.getAttribute("GlOrgId");
        Object slocId = currentRow.getAttribute("GlSlocId");
