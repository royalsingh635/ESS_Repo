...
public class ManualAdjustmentBean {
        ...
        if (lines != null) {
            ...
            if (currentRow != null) {
                ...
                ADFBeanUtils.callBindingsMethod("updateCostCenterAmt", new Object[] {
                                                totalTrxAmountBinding.getValue() }, new Object[] { "amountSp" });
    ...
    public String adjustAction() {
        ...
        if (object != null) {
            String msg = (String) resolvEl("#{bundle['MSG.1954']}");
    ...
    public void transactionAmountValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (!ADFUtil.isPrecisionValid(26, 6, (Number) object)) {
                String msg = resolvEl("#{bundle['MSG.1637']}");
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, msg, null));

            } else if (amount.compareTo(0) < 0) {

                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              resolvEl("#{bundle['MSG.1955']}"), null));
