...
public class TempVoucherAMImpl extends ApplicationModuleImpl implements TempVoucherAM, WFApprove {
    ...
    public String procTaxForHdr(String ruleId) {
        ...
        callStoredProcedure("FIN.INS_TEMP_TAX_LINE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                            cldId, slocId, hoOrgId, orgId, TvouPrjId, instId, vouId, tvouDt, slNo, taxRuleId, exmptFlg,
    ...
    public String procTdsForHdr(String ruleid) {
        ...
        callStoredProcedure("FIN.INS_TEMP_TDS_LINE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                            cldId, slocId, hoOrgId, orgId, TvouPrjId, instId, vouId, tvouDt, slNo, tdsRuleId, "N",
    ...
    public String insertTvouAdjDtlData(Object p_adv_amt, Row tvou_adj, Row tvou_adv_dtl) {
        ...
        if (tvou_adj.getAttribute("TvouCurrIdTrx").equals(tvou_adj.getAttribute("TvouAdjCurrIdSp"))) {
    ...
    public Number getClosingBalance(String table, Row row) {
        ...
        if (currentRow != null) {
            Object ClBalProj = currentRow.getAttribute("ClBalPostOut");
            if (ClBalProj != null) {
    ...
    //    public String isAccessibleValueValid(){
    //        //  Check whether manual tax/TDS applicable or not
    //        // if applicable then check whether Any tax/tds line present or not correspondingly
    //        // check TvouAmtSp of tax/tds line is smaller than accessible value or not
    //        TvouVOImpl impl = getTvou1();
    //        Row currentRow = impl.getCurrentRow();
    //        if(currentRow!=null){
    //            Object tvouManTax = currentRow.getAttribute("TvouManTax");
    //            Object tvouManTds = currentRow.getAttribute("TvouManTds");
    //
    //            if(tvouManTax!=null){
    //                if(tvouManTax.toString().equalsIgnoreCase("Y")){
    //                    String valid = validateManualTaxableAmount();
    //                }
    //            }
    //
    //            if(tvouManTds!=null){
    //                if(tvouManTds.toString().equalsIgnoreCase("Y")){
    //                    String valid = validateManualTaxableAmount();
    //
    //                }
    //            }
    ...
    //        return null;
    //    }
    //    public String validateManualTaxableAmount(){
    //        TvouLinesVOImpl impl = getTvouLinesLnk();
    //        RowSetIterator rsi = impl.createRowSetIterator(null);
    //        while(rsi.hasNext()){
    //            Row next = rsi.next();
    //            Object type = next.getAttribute("CoaTypeTrans");
    //            if(type!=null){
    //                if(type.equals(5022)){
    //                    Number tvouAmtSp = (Number) next.getAttribute("TvouAmtSp");
    //                    Number taxableAmt = (Number) next.getAttribute("TvouTaxtdsAssessVal");
    //                    if(tvouAmtSp.compareTo(taxableAmt)>0){
    //                        return "N";
    //                    }
    //
    //                }
