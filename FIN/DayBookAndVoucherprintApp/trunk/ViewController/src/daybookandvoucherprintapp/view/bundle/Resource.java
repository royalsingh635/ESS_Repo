package daybookandvoucherprintapp.view.bundle;
...
public class Resource extends ListResourceBundle {
    ...
    private static final Object[][] contents = { { "daybookandvoucherprintapp.model.views.FinCoaDtlVwVO_LABEL", "Fin Coa Dtl Vw Vo" } };
