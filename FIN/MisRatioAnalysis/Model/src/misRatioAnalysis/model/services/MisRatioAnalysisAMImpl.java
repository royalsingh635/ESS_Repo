...
Integer.parseInt(callStoredFunction(NUMERIC, "APP.FN_GET_MAX_FY(?,?,?)", new Object[] { cldId, orgId,
    ...
    public String refresh(String p_org_id, String p_cld_id,Integer p_sloc_id){
        System.out.println("this.getSession() = "+this.getSession()+" financialyear = "+financialyear);
        callStoredProcedure1("fin.proc_ins_mis_rpt_lr(?,?,?,?,?,?)", new Object[]{"1",p_cld_id,p_org_id,p_sloc_id,financialyear,"FY"});
        return null;
    }
