...
// ---------------------------------------------------------------------
public class TempVoucherAMImpl extends ApplicationModuleImpl implements TempVoucherAM, WFApprove {
    ...
    public String procTaxForHdr(String ruleId) {
        ...
        callStoredProcedure("FIN.INS_TEMP_TAX_LINE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                            cldId, slocId, hoOrgId, orgId, instId, vouId, tvouDt, slNo, taxRuleId, exmptFlg, finAmt,
                            currIdsp, userId, tvouDt, op
        });
    ...
    public String procTdsForHdr(String ruleid) {
        ...
        callStoredProcedure("FIN.INS_TEMP_TDS_LINE(?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                            cldId, slocId, hoOrgId, orgId, instId, vouId, tvouDt, slNo, tdsRuleId, finAmt, tvouSpId,
                            usrId, tvouDt, Op
        });
        rit.closeRowSetIterator();
    ...
    public void taxConsolidation() {
        ...
        callStoredFunction(NUMBER, "FIN.FN_TVOU_TAX(?,?,?,?,?,?,?,?,?)", new Object[] {
                           cldId, slocId, vouInsId, hoOrgId, orgId, vouId, vouTyp, vouSubTyp, tvouSpId
        });
    ...
    public void tvouOtherCharges() {
        ...
        callStoredFunction(NUMBER, "FIN.FN_TVOU_OC (?,?,?,?,?,?,?)", new Object[] {
                           cldId, slocId, instId, hoOrgId, orgId, vouId, currId
        });
    ...
    public String procTdsForHdrBill(String ruleid) {
        ...
        callStoredProcedure("FIN.INS_TEMP_TDS_LINE_EXP_REP(?,?,?,?,?,?,?)", new Object[] {
                            cldId, slocId, hoOrgId, orgId, vouId, ruleid, tvouDt
        });
        while (rit.hasNext()) {
            Row lineRow = rit.next();
        ...
        while (rit.hasNext()) {
            ...
            if (lineRow.getAttribute("TvouTaxFlg") != null) {
                ...
                if (lineRow.getAttribute("TvouTaxFlg").equals("Y") && lineRow.getAttribute("TvouCoaId") != null) {
                    ...
                    callStoredProcedure("FIN.INS_TEMP_TAX_LINE_EXP(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                                        cldId, slocId, hoOrgId, orgId, instId, vouId, tvouDt, tvouSlNo, billSlNo,
                                        taxRuleId, finAmt, currIdsp, usrId, tvouDt, Op
                    });
...
//            });
    ...
    private BigDecimal getlatestCurrencyRate(String CldId,String OrgId,Integer currIdBs,Integer currIdTxn,String conv,Date convDate,String convLogic,String convLogicDt){
        Object res = callStoredFunction(Types.NUMERIC, "app.fn_get_curr_conv_act(?,?,?,?,?,?,?,?)", new Object[]{CldId,OrgId,currIdBs,currIdTxn,conv,convDate,convLogic, convLogicDt});
        if(res!=null){
...
//            });
    ...
    public String insertTvouAdjDtlData(Object p_adv_amt, Row tvou_adj, Row tvou_adv_dtl) {
        ...
        tvouAdjDtlAutoRow.setAttribute("TvouAdjAmtAdj",
                                       roundOffAmt(((Number) p_adv_amt).divide((Number) tvou_adj.getAttribute("TvouCcOld")).multiply((Number) tvou_adj.getAttribute("TvouCurrCcTrx")))); // need to convert into invoice currency
        System.out.println("p_adv_amt = " + p_adv_amt + " after conv  =  " +
        ...
        tvouAdjDtlAutoRow.setAttribute("TvouRadjAmtAdj",
...
//        BigDecimal convRate = (BigDecimal) callStoredFunction(Types.NUMERIC, "FIN.FN_TVOU_CROSSCONVRATE(?,?,?,?,?)", new Object[] {
//                                                              tvouAdjDtlAutoRow.getAttribute("TvouCldId").toString(),
            ...
            while ((tvouAdvDtlAutoRit.hasNext() || tvouAdjAutoRit.hasNext())) {
                ...
                if (((Number) tvouAdvDtlAutoRow.getAttribute("TvouAdjAmtOT")).compareTo(0) == 1 &&
                    ...
                    if ("Y".equals(tvouAdjAutoRow.getAttribute("TvouAdjChkFlg")) &&
                        ...
                        amtDiff =
                            roundOffAmt((tvouAdvRemainOT.multiply((Number) tvouAdvDtlAutoRow.getAttribute("TvouCcOld")).divide(trxCc))).subtract((tvouAdjRemainOT.multiply((Number) tvouAdjAutoRow.getAttribute("TvouCcOld")).divide(trxCc)));
                        ...
                        //remaining advance is less than remaining bill amount
                            ...
                            tvouAdjAutoRow.setAttribute("TvouRemainOt",
                                                        amtDiff.divide((Number) tvouAdjAutoRow.getAttribute("TvouCcOld")).multiply(trxCc)); // in inv curr
                            ...
                            tvouAdvDtlAutoRow.setAttribute("TvouRemainOt", new Number(0));
                            tvouAdvDtlAutoRow.setAttribute("TvouAmtTrx",
                                                           tvouTrxAmt.add(trxAmtAdv)); // nee to change tvouAdvRemainOT into trx curr
...
//
//                BigDecimal convRate =
//                    (BigDecimal) callStoredFunction(Types.NUMERIC, "FIN.FN_TVOU_CROSSCONVRATE(?,?,?,?,?)", new Object[] {
//                                                    p_cld_id, p_ho_id,
//                                                    (Integer) tvouAdjDtlAutoRow.getAttribute("TvouCurrIdTrx"),
//                                                    (Integer) tvouAdjDtlAutoRow.getAttribute("TvouAdjCurrIdSp"), tvouTyp
//                });
//                
                TvouVOImpl impl = getTvou1();
                ...
                while (childDtlRit.hasNext()) {
                    ...
                    if (childRow.getAttribute("TvouAmtTrx") != null) {
                        ...
                        childRow.setAttribute("TvouAdjAmtAdj",
                                              roundOffAmt(trxAmt.multiply(TvouCurrCcTrx).divide(TvouCcCurr))); // need to convert into adj_dtl curr
    ...
    public String checkInstrumentAddedOrNot() {
        ...
        if (currentRow != null) {
            ...
            if (CoaTypeTrans != null) {
                ...
                } else if (CoaTypeTrans.equals(79)) {
                    ViewObjectImpl chq = getTvouLineChqVO1();
    ...
    public Number getClosingBalance(String table,Row row){
        ...
        if(currentRow!=null){
            Object ClBalProj = currentRow.getAttribute("ClBalOut");
            if(ClBalProj!=null){
            ...
            if (currentRow != null) {
                try {
                    if (st.getObject(10) != null) {
                        currentRow.setAttribute("OpBalOut", st.getObject(10));
    ...
    public Boolean costCentreUpdatee(String cld_id, Integer slocId, String hoOrg_id, String orgId, String tvouId,
        ...
        Boolean amount =
            amCC.updateCCAmount((String) cld_id, (Integer) slocId, (String) hoOrg_id, (String) orgId, tvouId, "L", 55,
                                (Integer) userId, ccId, amt, (String) resolvEl("#{pageFlowScope.P_CC_LEVEL1}"),
                                (String) resolvEl("#{pageFlowScope.P_CC_LEVEL2}"),
                                (String) resolvEl("#{pageFlowScope.P_CC_LEVEL3}"),
                                (String) resolvEl("#{pageFlowScope.P_CC_LEVEL4}"),
                                (String) resolvEl("#{pageFlowScope.P_CC_LEVEL5}"));
