...
public class printPostedVoucherServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            /* InputStream input = new FileInputStream(new File(path + "Direct_Print_voucher.jrxml"));
            ...
            System.out.println("Org = " + Org + "AmountX1 = " + AmountX1 + " AmountX2 = " + AmountX2 + " toDate = " +
                               toDate + " fromdate = " + fromdate + " VocNo =" + VocNo + " VouType = " + VouType +
                               " path" + path+" "+"Proj_Id "+prjId + " Ho Org Id "+hoOrgId + " Cld Id "+cldId +"Sloc Id "+slocId);

            JasperReport report = (JasperReport) JRLoader.loadObject(path + "Direct_Print_voucher.jasper");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PrintVoucher.pdf\"");
