...
public class ManualAdjustmentBean {
    ...
    public String FitlerArapWithDaysAndType() {
        ...
        if (entityBinding.getValue()!= null) {
            if (entityBinding.getValue().toString().equalsIgnoreCase("false")||entityBinding.getValue().toString().equalsIgnoreCase("N")) {
    ...
    public String backAction() {
        ...
        if(lines!=null){
            ...
            if(currentRow!=null){
                ...
                ADFBeanUtils.callBindingsMethod("updateCostCenterAmt", new Object[]{totalTrxAmountBinding.getValue()}, new Object[]{"amountSp"});
