package finirdetailapp.view.servlet;
...
public class PrintReportServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            path=path+"FIN/";
            if (linkType.equalsIgnoreCase("cashdetail")) {
                reportName = "CashRequisitionReport";
            }
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cash Requisition.pdf\"");
