...
public class bankStatusVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        ,
        TransBookBalanceNumber {
            public Object get(bankStatusVORowImpl obj) {
                return obj.getTransBookBalanceNumber();
            }

            public void put(bankStatusVORowImpl obj, Object value) {
                obj.setTransBookBalanceNumber((String) value);
            }
        }
        ;
    ...
    public static final int TRANSBOOKBALANCENUMBER = AttributesEnum.TransBookBalanceNumber.index();
    ...
    public void setTransBookBalance(String value) {
        this.setTransBookBalanceNumber((String)value);
        setAttributeInternal(TRANSBOOKBALANCE, divideValue(value));
    }
    ...
    public void settransTotalDebit(String value) {
        setAttributeInternal(TRANSTOTALDEBIT, totalCrInString(value));
    }
    ...
    public void setTransTotalCredit(String value) {
        setAttributeInternal(TRANSTOTALCREDIT, totalCrInString(value));
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute TransBookBalanceNumber.
     * @return the TransBookBalanceNumber
     */
    public String getTransBookBalanceNumber() {
        return (String) getAttributeInternal(TRANSBOOKBALANCENUMBER);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransBookBalanceNumber.
     * @param value value to set the  TransBookBalanceNumber
     */
    public void setTransBookBalanceNumber(String value) {
        setAttributeInternal(TRANSBOOKBALANCENUMBER, value);
    }
    ...
    public String totalCrInString(Object amount) {
        ...
        if (amount != null) {
          //  Number amountCoa = (Number) amount;
            ...
            System.out.println("Amount digit" +amt_digit);
    ...
    public Object resolvElAmt(String data) {
        ...
        System.out.println("Digit value in ResolveAmt" +digit);
    return digit;
    }
    /**
    ...
    public Object divideValue(String value) {
        String coaAmt = "0";
        if(value == null) {
        ...
        else
        {
           // String balValue = value.toString();
            System.out.println("balValue" +value);
            Integer len = (value.length());
            System.out.println("Length is " +len);
            if(len>3){
       String amtVal = value.substring(0 , len-3);
         String crDrVal = value.substring(len-3 , len);
