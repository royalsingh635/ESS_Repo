...
public class Chequeregister extends HttpServlet {
    ...
    Connection conn = st.getConnection(); */
            ...
            System.out.println("after rquest");
            String check = "P";
            System.out.println("pdf" + reporttype);
            //Report Type:----------------------
            ...
            System.out.println("Org:" + Org + " Amount1 :" + AmountX1 + " 2 " + AmountX2 + " toDate " + toDate +
                               ...
                               request.getParameter("cldid") + " status " + stat + " instTYPE-- " + instid + "coaId->" +
                               coaid);

            JasperReport report = null;
            if (request.getParameter("ConsChk").equalsIgnoreCase("true")) {
                System.out.println("Inside chk" + request.getParameter("ConsChk").toString());
                 report = (JasperReport) JRLoader.loadObject(path + "Cheque_Register_Consolidated.jasper");
            } else {
                 report = (JasperReport) JRLoader.loadObject(path + "Cheque_Register.jasper");
            }
            ...
            if ("PDF".equalsIgnoreCase(reporttype)) {
                ...
                System.out.println("in pdf case");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Register.csv\"");
