 ...
 */
            ...
            }else if (chqTypeId == 16) {
                reportName = "Housing_Finance_Bank.jasper";
            }else if (chqTypeId == 17) {
                reportName = "CoOperative_Bank_Of_Kenya.jasper";
            }else if (chqTypeId == 18) {
                reportName = "IM_Bank_Limited.jasper";
            }
