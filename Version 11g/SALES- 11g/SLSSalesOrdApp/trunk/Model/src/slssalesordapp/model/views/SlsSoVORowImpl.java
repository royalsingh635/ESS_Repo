...
public class SlsSoVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        EoTypeOnOrderTypeTrans {
            ...
            public void put(SlsSoVORowImpl obj, Object value) {
                obj.setEoTypeOnOrderTypeTrans((String)value);
            }
        }
        ,
        ExtDocDt {
    ...
    public void setEoId(Integer value) {
        ...
        //System.out.println("Eo in row is "+value);
    }
    ...
    public void setTaxRuleFlg(String value) {
        ...
        if (value != null) {
            if (value.toString().equals("I")) {
                ...
                //System.out.println("Value set to Y");
            }
        }
    ...
    public void setCurrIdSp(Integer value) {
        //System.out.println("Setting Currency to : "+value);
        if (value != null) {
            //System.out.println("Setting Currency to (IN) : "+value);
    ...
    public String getEoNmTrans() {
        ...
        try {
            ...
            // _log.info("Customer is-"+eoId);
        } catch (NullPointerException npe) {
            System.out.println("NullPointer" + npe);
        }
        if (eoId != null) {
            Row[] xx = getLovEoId1().getFilteredRows("EoId", eoId);
            if (xx.length > 0) {
                eoNm = xx[0].getAttribute("EoNm").toString();
            }
    ...
    public String getWhIdAddrTrans() {
        String whid = getWhIdDlvTrans();
        if (whid != null) {
            Row[] r = getLovWhIdVO1().getFilteredRows("WhId", whid);
            String addrid = null;
            ...
            if (addrid != null) {
                Row[] rd = getLovWhIdAddrsVO1().getFilteredRows("AddsId", addrid);
                if (rd.length > 0) {
    ...
    public Number getOrderTotalCostTrans() {
        ...
        if (getOrderType() != null) {
            if (getOrderType() == 311) {
                ...
                setTotAmtSp((Number)totalOrdCost.round(amt_digit));
                setTotAmtBs((Number)(totalOrdCost.multiply(curRate).round(amt_digit)));
                return totalOrdCost;
            } else {
                ...
                /**Set value to database field*/
                setTotAmtSp((Number)totCost.round(amt_digit));
                setTotAmtBs((Number)(totCost.multiply(curRate)).round(amt_digit));
                return totCost;
            }
    ...
    public Number getSoDiscAmtTrans() {
        ...
        //DiscType=='A' ? (DiscVal==null? 0 : DiscVal) : ((TaxAfterDiscFlg == null || TaxAfterDiscFlg == 'N') ? (ItmAmtSpSumTrans*(DiscVal==null? 0 : DiscVal)/100) :((CostBeforeDiscTrans)*(DiscVal==null? 0 : DiscVal)/100))
        
        
        //DiscType=='A' ? (DiscVal==null? 0 : DiscVal) : (
        //  (TaxAfterDiscFlg == null || TaxAfterDiscFlg == 'N') ? 
        //          (ItmAmtSpSumTrans*(DiscVal==null? 0 : DiscVal)/100) 
        // 
        // :((CostBeforeDiscTrans)*(DiscVal==null? 0 : DiscVal)/100))
        //return (Number)getAttributeInternal(SODISCAMTTRANS);
    }
    ...
    public String getRefSoDocIdTrans() {
        ...
        // _log.info("RefSoDocId From RowImpl-->" + docId);
        if (docId != null) {
            Row[] xx = getLovDispOrdIdVO1().getFilteredRows("DocId", docId);

            if (xx.length > 0) {
                if (xx[0].getAttribute("DispDocId") != null) {
            ...
            return (String)getAttributeInternal(REFSODOCIDTRANS);
        }
    ...
    public String getSoId() {
        if (getAttributeInternal(SOID) != null && getAttributeInternal(SOID) != " ") {
            String dispId = getAttributeInternal(SOID).toString();
    ...
    public Number getpayAmtPendTrans() {
        ...
        if (getOrderTotalCostTrans() != null) {
            totalCost = (Number)getOrderTotalCostTrans().round(amt_digit);
        }
        if (getPayAmtSumTrans() != null) {
            paidAmt = (Number)getPayAmtSumTrans().round(amt_digit);
        }
    ...
    public String getAddressTrans() {
        ...
        if (getShipAdds() != null) {
            RowSet addrsVO = this.getLovWhIdAddrsVO1();
            Row[] filteredRows = addrsVO.getFilteredRows("AddsId", getShipAdds());
            if (filteredRows.length > 0) {
                String a = "";
                if (filteredRows[0].getAttribute("Adds") != null) {
                    a = (String)filteredRows[0].getAttribute("Adds");
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute EoTypeOnOrderTypeTrans.
     * @param value value to set the  EoTypeOnOrderTypeTrans
     */
    public void setEoTypeOnOrderTypeTrans(String value) {
        setAttributeInternal(EOTYPEONORDERTYPETRANS, value);
    }
    ...
    public String getQuotIdTrans() {
        ...
        if (this.getQuotId() != null) {
            if (!this.getQuotId().toString().equals("")) {
                ...
                lovVO2.executeQuery();
                int i = lovVO2.getRangeSize();
                Row[] filteredRows = lovVO2.getFilteredRows("DocId", getQuotId());
                _log.info("Filtered rows in Quotation is : " + filteredRows.length + " on QuotId : " + getQuotId());

                if (filteredRows.length > 0) {
                    _log.info("Quot Display Id ++ : " + disp);
                    disp = new StringBuffer(filteredRows[0].getAttribute("DispDocId").toString());
                }
    ...
    public String getTransDocOriginOrg() {
        if (getAttributeInternal(TRANSDOCORIGINORG) == null) {
          ...
          //  System.out.println("refernce doc of org in slssorowimpl=" + refOrg);
            if (refOrg != null) {
                System.out.println("set 1");
                Row r[] = this.getLOVRefOrgV0_1().getFilteredRows("OrgId", refOrg);
              //  System.out.println("length  " + r.length);
                if (r.length > 0) {
                  //  System.out.println("r[0].getAttribute(\"OrgDesc\").toString() slssorowimpl" +
                                     //  r[0].getAttribute("OrgDesc").toString());
                    return r[0].getAttribute("OrgDesc").toString();
                }
            }
        }
      //  System.out.println("when not found slssorowimpl");
    ...
    public Number getGrossCostBeforeTaxTrans() {
        Number n = (Number) getAttributeInternal(GROSSCOSTBEFORETAXTRANS);
        setTotItmAmtGsSp(n);
    ...
    public void setTotItmAmtGsSp(Number value) {
        ...
        setTotItmAmtGsBs(value.multiply(cc));
    ...
    public Number getTransCreditDays() {
        if(getAttributeInternal(TRANSCREDITDAYS) == null && getEoId() != null){
            ...
            try {
                            ...
                            ret =    (BigDecimal)callStoredFunction(Types.NUMERIC, "FN_GET_EO_CR_DAYS(?,?,?,?,?)",
                                                               new Object[] {getSlocId(),getCldId(),getOrgId(),getEoId(),68 });
            } catch (Exception e) {
    ...
    public Number getTransCreditLimit() {
        if(getAttributeInternal(TRANSCREDITLIMIT) == null && getEoId() != null){
            ...
            try {
                            ...
                            ret =    (BigDecimal)callStoredFunction(Types.NUMERIC, "FN_GET_EO_CR_LIMIT(?,?,?,?,?)",
                                                               new Object[] {getSlocId(),getCldId(),getOrgId(),getEoId(),68 });
            } catch (Exception e) {
                FacesMessage message =
        ...
        if(getAttributeInternal(TRANSCURRENTBALANCE) == null && getEoId() != null && getCoaId() != null){
            ...
            try {/* 
                ...
                p_inc_op_bal varchar2 default 'Y') */
                            ...
                            ret =    (BigDecimal)callStoredFunction(Types.NUMERIC, "FIN.GET_COA_CL_BAL_ASONDT(?,?,?,?,?,?,?,?,?)",
                                                               new Object[] {getCldId(),
                                                                             getSlocId(),
                                                                             getHoOrgId(),
                                                                             getOrgId(), 
        ...
        if(getAttributeInternal(TRANSORDERBALANCE) == null && getEoId() != null && getCoaId() != null){
            ...
            try {/* 
                ...
                p_inc_op_bal varchar2 default 'Y') */
                            ...
                            ret =    (BigDecimal)callStoredFunction(Types.NUMERIC, "FN_GET_ORD_BAL(?,?,?,?,?,?)",
                                                               new Object[] {getCldId(),
                                                                             getSlocId(),
                                                                             getHoOrgId(),
                                                                             getOrgId(), 
