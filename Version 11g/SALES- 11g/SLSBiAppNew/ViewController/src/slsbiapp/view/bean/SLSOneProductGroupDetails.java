...
public class SLSOneProductGroupDetails {
    public SLSOneProductGroupDetails() {
    }
    ...
    public void setLabelTopNCustomers(StringBuffer labelTopNCustomers) {
        this.labelTopNCustomers = labelTopNCustomers;
    }
