package slssecondarysaleapp.view.servlet;
...
public class SecondarySalePrintReportServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (linkType.equalsIgnoreCase("secondary")) {
                reportName = "SLS_SecondarySales_Register";
            }
          ...
          //  parameters.put("RMATypeId", null);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Secondary Sales Report.pdf\"");
