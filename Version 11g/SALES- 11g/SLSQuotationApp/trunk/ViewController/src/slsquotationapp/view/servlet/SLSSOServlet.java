...
public class SLSSOServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            try {
                ...
                if (linkType.equalsIgnoreCase("sodetail")) {
                    reportName = "SLS_Quot_DetailReport";
                }
               ...
               // parameters.put("Status",FormStatus); 
                ...
                if ("pdf".equalsIgnoreCase(reporttype)) {
                    ...
                    response.setHeader("Content-Disposition", "attachement; filename=\"Sales Quotation.pdf\"");
