...
import oracle.adf.model.ADFmMessageBundle_ar;
...
public class SLSQuotationBean implements Serializable {
    ...
    private RichCommandImageLink saveBtnBind;
    ...
    private RichCommandImageLink addItemLineBtn;
    ...
    private RichCommandImageLink saveAndForwardBind;
    ...
    private RichCommandImageLink crossButtonBind;
    ...
    public void saveQuotationACTION(ActionEvent actionEvent) {
        ...
        binding.execute();
        OperationBinding dup=BindingContext.getCurrent().getCurrentBindingsEntry().getOperationBinding("chkTabValidations");
        dup.execute();
        dup.getResult();
        ...
        if ((Boolean)binding.getResult()) {
            ...
            if ((Boolean)binding.getResult()) {
                if (this.getBindings().getOperationBinding("isItemExistsForQuot").execute().equals((Object)false)) {
                    FacesMessage message =
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, "<html>" + "<body></br>" + "<span style='color:red;font-family:Arial;font-size:11px;font-weight:bold;'>" +
                                         resolvElDCMsg("#{bundle['MSG.833']}").toString() + "</span></br>" +
                                         "<b style='color:blue;font-family:Arial;font-size:10px;font-weight:bold;'> " +
                                         resolvElDCMsg("#{bundle['MSG.834']}").toString() + "</b>" + "</body>" +
                                         "</html>",
                ...
                //to check if orderwise tax is applied correctly or not
                    ...
                    if (this.getBindings().getOperationBinding("isItmWiseAppliedCorrectly").execute().equals((Object)true)) {
                        ...
                        binding = this.getBindings().getOperationBinding("Commit");
                        binding.execute();

                        if (binding.getErrors().isEmpty()) {
                            if (this.quot_form_mode == new StringBuffer("A")) {
                                FacesMessage message =
                                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.835']}").toString()); //"Quotation created Successfully!"
                                ...
                                FacesMessage message =
                                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.836']}").toString()); //"Quotation Saved Successfully!"
                                message.setSeverity(FacesMessage.SEVERITY_INFO);
                                FacesContext.getCurrentInstance().addMessage(null, message);
                                this.form_mode = new StringBuffer("V");
                                this.quot_form_mode = new StringBuffer("V");
                            ...
                            FacesMessage message =
                                new FacesMessage(resolvElDCMsg("#{bundle['MSG.837']}").toString()); //"There have been an error in saving quotation! Please try again!"
                            message.setSeverity(FacesMessage.SEVERITY_ERROR);
                            FacesContext.getCurrentInstance().addMessage(null, message);
                        }
                    } else {
            ...
            FacesMessage message = new FacesMessage("Please Select Entity Name...!!!");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        }
    ...
    public String delQuotationACTION() {
        ...
        if (binding.getErrors().isEmpty()) {
            FacesMessage message =
                new FacesMessage(resolvElDCMsg("#{bundle['MSG.841']}").toString()); //"Quotation deleted Successfully!"
            message.setSeverity(FacesMessage.SEVERITY_INFO);
            FacesContext.getCurrentInstance().addMessage(null, message);
            ...
            FacesMessage message =
                new FacesMessage(resolvElDCMsg("#{bundle['MSG.842']}").toString()); //"There have been an error in deleting quotation! Please try again!"
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(null, message);
        }
        return null;
    ...
    public void addEoPopUpOkBind(ActionEvent actionEvent) {
        ...
        if (this.eoNmPopUpBind.getValue() != null || this.eoTypePopUpBind.getValue() != null) {
            ...
            if (execute.toString().equals("INSERTED")) {
                if (true) {
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.843']}").toString()); //Entity Created Successfully!
                    message.setSeverity(FacesMessage.SEVERITY_INFO);
                    FacesContext.getCurrentInstance().addMessage(null, message);
                    ...
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.844']}").toString()); //There has been an error in inserting eo. Please try again!
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext.getCurrentInstance().addMessage(null, message);
                }
            } else {
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.848']}").toString()); //Duplicate Entity name found!
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
        ...
        if (tncLOVBind.getValue() != null) {
            if (!tncLOVBind.getValue().toString().equals("")) {
                ...
                if (methodBinding.getResult().equals((Object)true)) {
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.850']}").toString()); //Selected Term and Condition is already added! !
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
    ...
    public void addItemLineACTION(ActionEvent actionEvent) {
        ...
        if (this.getBindings().getOperationBinding("isItemNmBlank").execute().equals((Object)true)) {
            FacesMessage message = new FacesMessage(resolvElDCMsg("#{bundle['MSG.852']}").toString());
    ...
    public void schemeVCL(ValueChangeEvent valueChangeEvent) {
        if (valueChangeEvent.getNewValue() != null || !valueChangeEvent.getNewValue().equals("")) {
            ...
            OperationBinding methodBinding =
                this.getBindings().getOperationBinding("callFunction_FN_INS_QUOT_SCH_ITM");
            methodBinding.getParamsMap().put("schId", new StringBuffer(valueChangeEvent.getNewValue().toString()));
            methodBinding.execute();
    ...
    public void enquiryNoVCL(ValueChangeEvent valueChangeEvent) {
        //call_function_FN_ENQ_TO_QUOT
        System.out.println();
        if (valueChangeEvent.getNewValue() != null) {
            //System.out.println("Called");
            valueChangeEvent.getComponent().processUpdates(FacesContext.getCurrentInstance());
            OperationBinding methodBinding = this.getBindings().getOperationBinding("setItemsOnTheBasisOfEnquiry");
            methodBinding.getParamsMap().put("EnqNo", new StringBuffer(valueChangeEvent.getNewValue().toString()));
            methodBinding.execute();
    ...
    public void ItemIdVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            methodBinding.getParamsMap().put("itemNm", new StringBuffer(object.toString()));
            methodBinding.execute();
            Integer num = (Integer)methodBinding.getResult();
            System.out.println("value of num==== in item Name Valie :"+num);
            if (num > 0) {
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.853']}").toString()); //Selected item is already added in quotation
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
    ...
    public void percentageVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (val > 100) {
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.303']}").toString() + "!", resolvElDCMsg("#{bundle['MSG.854']}").toString() +
                                     "!"); //Invalid percentage! && Cannot enter value greater than 99.9999999
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message);
            } else if (val < 0) {
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.303']}").toString() + "!", resolvElDCMsg("#{bundle['MSG.857']}").toString() +
    ...
    public void quotDisValueVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (methodBinding.execute().equals((Object)false)) {
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.859']}").toString() + " !"); //Discount Value Cannot be greater than ToTal Quotation value
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message);
            } else if (val < 0) {
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.653']}").toString() + "!", resolvElDCMsg("#{bundle['MSG.857']}").toString() +
    ...
    public void greaterThanZeroVALID(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (n.compareTo(new Number(0)) <= 0) {
            FacesMessage message =
                new FacesMessage(resolvElDCMsg("#{bundle['MSG.198']}").toString() + " !"); //Value should be greater than zero
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            throw new ValidatorException(message);
        }
    }
        ...
        if (itmDiscTypeNew.getValue() != null) {
            ...
            if (object == null || ((Number)object).compareTo((Object)new Number(0)) == -1) {
               System.out.println("------------------------1");
                ...
                FacesMessage message =
                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.860']}").toString() + "!"); //Value cannot be greater than 99.99 in case of %
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message);
               ...
               methodBinding.execute();
                ...
                if (compareTo <= 0) {
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.861']}").toString() + " !"); //Value cannot be greater than Total Amount
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(message);
                }
            }
        ...
        if (object != null) {
            ...
            if (n.compareTo(new Number(0)) <= 0) {
                ...
                if (execute.equals((Object)false)) {
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.864']}").toString() + "!"); //Invalid precision
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(message);
                }
            }
    ...
    public void setSaveBtnBind(RichCommandImageLink saveBtnBind) {
        this.saveBtnBind = saveBtnBind;
    }

    public RichCommandImageLink getSaveBtnBind() {
        return saveBtnBind;
    }
    ...
    public void toleranceQuantityVALID(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (i == 1) {
                FacesMessage message =
                    new FacesMessage(FacesMessage.SEVERITY_INFO, resolvElDCMsg("#{bundle['MSG.866']}").toString() +
                                     ".", null); //Tolerance Amount should be less than Item quantity
                //message.setSeverity(FacesMessage.SEVERITY_INFO);
                throw new ValidatorException(message);
            } else if (i == 2) {
                FacesMessage message =
                    new FacesMessage(FacesMessage.SEVERITY_INFO, resolvElDCMsg("#{bundle['MSG.303']}").toString(),
                                     null); //Invalid % value.
                //message.setSeverity(FacesMessage.SEVERITY_INFO);
                throw new ValidatorException(message);
            }
    ...
    public void itemPriceVALID(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object != null) {
            negativeNumberVAL(facesContext, uIComponent, object);
            if (new Number(0).compareTo((Number)object) >= 0) {
                FacesMessage message =
                    new FacesMessage(FacesMessage.SEVERITY_INFO, resolvElDCMsg("#{bundle['MSG.198']}").toString(),
    ...
    public void setAddItemLineBtn(RichCommandImageLink addItemLineBtn) {
        this.addItemLineBtn = addItemLineBtn;
    }

    public RichCommandImageLink getAddItemLineBtn() {
    ...
    public String saveAndForward() {
        ...
        if (pendingAtUsr.compareTo(new Integer(-1)) == 0 || pendingAtUsr.compareTo(userId) == 0) {
            ...
            if (usrLvl != -1) {
                ...
                FacesMessage message =
                    new FacesMessage("WorkFlow level is not assigned for the Current user. Please assign a Level to the current User !");
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext.getCurrentInstance().addMessage(null, message);
                return null;
            }
        ...
        if (this.getBindings().getOperationBinding("isItemExistsForQuot").execute().equals((Object)false)) {
            FacesMessage message =
                new FacesMessage(FacesMessage.SEVERITY_ERROR, "<html>" + "<body></br>" + "<span style='color:red;font-family:Arial;font-size:11px;font-weight:bold;'>" +
                                 resolvElDCMsg("#{bundle['MSG.833']}").toString() + "</span></br>" +
                                 "<b style='color:blue;font-family:Arial;font-size:10px;font-weight:bold;'> " +
                                 resolvElDCMsg("#{bundle['MSG.834']}").toString() + " </b>" + "</body>" + "</html>",
                                 null); //MSG.833:No item is added to the Quotation. Cannot save!, MSG.834 :Please add atleast one item to the quotation.
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(null, message);
        }
        //to check if orderwise tax is applied correctly or not
                    ...
                    if (this.quot_form_mode == new StringBuffer("A")) {
                        ...
                        if (result != null) {
                            if (result.toString().equals("pendingAtOtherUser")) {
                                ...
                                FacesMessage message2 =
                                    new FacesMessage(resolvElDCMsg("#{bundle['MSG.1039']}").toString()); //MSG.1039:This Sales Invoice is pending at other user for approval. You cannot forward this!
                                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(null, message2);
                                return null;
            ...
            FacesMessage message =
                new FacesMessage(FacesMessage.SEVERITY_ERROR, "<html>" + "<body></br>" + "<span style='color:red;font-family:Arial;font-size:11px;font-weight:bold;'>" +
                                 resolvElDCMsg("#{bundle['MSG.840']}").toString() + "</span></br>" +
                                 "<b style='color:blue;font-family:Arial;font-size:10px;font-weight:bold;'>" +
                                 resolvElDCMsg("#{bundle['MSG.839']}").toString() + "  </b>" + "</body>" + "</html>",
                                 null); //MSG.840:Taxable amount has been changed after applying tax in Quotation!&&MSG.839 :Please apply tax on the total taxable amount.
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(null, message);
        }
        return null;
    ...
    public void setSaveAndForwardBind(RichCommandImageLink saveAndForwardBind) {
        this.saveAndForwardBind = saveAndForwardBind;
    }

    public RichCommandImageLink getSaveAndForwardBind() {
    ...
    public void sendReciptantMailAL(ActionEvent actionEvent) {
        ...
        if (val) {
            FacesMessage message = new FacesMessage("Mail has been Sent Successfully");
            message.setSeverity(FacesMessage.SEVERITY_INFO);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
            ...
            FacesMessage message = new FacesMessage("There is problem in Sending E-mail");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
        }
        ...
        if (object != null) {
            ...
            if (matcher.matches()) {
                ...
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                              resolvElDCMsg("#{bundle['MSG.283']}").toString(), null));
            }
        }
            ...
            if (docDatePgBind.getValue() != null) {
                ...
                try {
                    ...
                    if (validDt.dateValue().toString().compareTo(docDt.dateValue().toString()) < 0) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      "Valid Date should be on or after Quotation Date",
                                                                      null));
                    } else if (validDt.dateValue().toString().compareTo(currdate.dateValue().toString()) < 0) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      "Valid Date Date should be on or after Current Date",
                                                                      null));
                    }
                } catch (SQLException e) {
                }
            ...
            if (docDatePgBind.getValue() != null) {
                ...
                try {
                    ...
                    if (deliDt.dateValue().toString().compareTo(docDt.dateValue().toString()) < 0) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      "Delivery Date Date should be on or after Quotation Date",
                                                                      null));
                    } else if (deliDt.dateValue().toString().compareTo(currdate.dateValue().toString()) < 0) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      "Delivery Date Date should be on or after Current Date",
                                                                      null));
                    } else if (deliDt.dateValue().toString().compareTo(validdt.dateValue().toString()) > 0) {
                        throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                                      "Delivery Date Date should be on or before Valid Upto Date",
                                                                      null));
                    }
                } catch (SQLException e) {
                }
...
if(vce.getNewValue()!=null)
{
    ...
    public void setCrossButtonBind(RichCommandImageLink crossButtonBind) {
        this.crossButtonBind = crossButtonBind;
    }

    public RichCommandImageLink getCrossButtonBind() {
