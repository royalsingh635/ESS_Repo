        ...
        if (chk.getResult().equals((Object)true)) {
            ...
            if (binding.getResult().equals((Object)false)) {
                FacesMessage message =
                    new FacesMessage("There is some error in Generating Stage Id. Please Try Again !");
            ...
            String mes = "Stage name is not entered or Duplicate Stage Name is entered for one or more stages. Please enter valid values for all the stages !";
