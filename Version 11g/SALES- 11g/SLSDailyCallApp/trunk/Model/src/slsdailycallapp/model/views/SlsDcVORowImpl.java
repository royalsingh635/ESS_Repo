...
public class SlsDcVORowImpl extends ViewRowImpl {
    ...
    public void setEoId(Integer value) {
        ...
        eoIdVO1.setNamedWhereClauseParam("EoIdBind", value);
        eoIdVO1.executeQuery();
        Row[] allRowsInRange = eoIdVO1.getAllRowsInRange();
        if (allRowsInRange.length > 0) {
            setEoNmTrans(allRowsInRange[0].getAttribute("EoNm") == null ? null :
                         allRowsInRange[0].getAttribute("EoNm").toString());
        }
    ...
    public void setAssignedTo(Integer value) {
        if(value != null){
            ...
            Row[] allRowsInRange = eoIdVO1.getAllRowsInRange();
            if (allRowsInRange.length > 0) {
                setAssignToTrans(allRowsInRange[0].getAttribute("EoNm") == null ? null :
                             allRowsInRange[0].getAttribute("EoNm").toString());
            }
            //System.out.println("Setting Assigned to to : "+value);
    ...
    public String getDcId() {
        if(getAttributeInternal(DCID) != null){
            StringBuffer s = new StringBuffer(getAttributeInternal(DCID).toString());
    ...
    public void setEoAdds(String value) {
        //System.out.println("Setting Address to : "+value);
        RowSet addsVO1 = this.getLovEoAddsVO1();
        addsVO1.setNamedWhereClauseParam("AddsIdBind", value);
        addsVO1.executeQuery();
        //System.out.println("Address rows : "+ addsVO1.getEstimatedRowCount());
        Row[] allRowsInRange = addsVO1.getAllRowsInRange();
        if (allRowsInRange.length > 0) {
            setEoAddsShowTrans(allRowsInRange[0].getAttribute("Adds") == null ? null :
                               allRowsInRange[0].getAttribute("Adds").toString());
            //System.out.println("set Adddress : "+allRowsInRange[0].getAttribute("Adds"));
        }
        addsVO1.setNamedWhereClauseParam("AddsIdBind", null);
    ...
    public String getEoNmTrans() {
        if(getAttributeInternal(EONMTRANS) == null){
            if(this.getEoId() != null){
                ...
                Row[] allRowsInRange = eoIdVO1.getAllRowsInRange();
                if(allRowsInRange.length > 0){
                    setEoNmTrans(allRowsInRange[0].getAttribute("EoNm") == null ? null : allRowsInRange[0].getAttribute("EoNm").toString());
                    //System.out.println("Setting Eo Name is : "+getAttributeInternal(EONMTRANS));
                }
            }
        }
    ...
    public String getAssignToTrans() {
        if(getAttributeInternal(ASSIGNTOTRANS) == null){
            if(this.getAssignedTo() != null){
                RowSet eoIdVO1 = this.getLovEoNmFromEoIdVO1();
                eoIdVO1.setNamedWhereClauseParam("EoIdBind", this.getAssignedTo());
                eoIdVO1.executeQuery();
                Row[] allRowsInRange = eoIdVO1.getAllRowsInRange();
                if(allRowsInRange.length > 0){
                    setAssignToTrans(allRowsInRange[0].getAttribute("EoNm") == null ? null : allRowsInRange[0].getAttribute("EoNm").toString());
                    //System.out.println("Setting AssigneToTo : "+getAttributeInternal(ASSIGNTOTRANS));
                }
            }
        }
    ...
    public String getEoAddsShowTrans() {
        if(this.getEoAdds() != null && getAttributeInternal(EOADDSSHOWTRANS) == null){
            RowSet addsVO1 = this.getLovEoAddsVO1();
            addsVO1.setNamedWhereClauseParam("AddsIdBind", this.getEoAdds());
            addsVO1.executeQuery();
            Row[] allRowsInRange = addsVO1.getAllRowsInRange();
            if(allRowsInRange.length > 0){
                setEoAddsShowTrans(allRowsInRange[0].getAttribute("Adds") == null ? null : allRowsInRange[0].getAttribute("Adds").toString());
                //System.out.println("Setting Address to : "+getAttributeInternal(EOADDSSHOWTRANS));
            }
            addsVO1.setNamedWhereClauseParam("AddsIdBind", null);
