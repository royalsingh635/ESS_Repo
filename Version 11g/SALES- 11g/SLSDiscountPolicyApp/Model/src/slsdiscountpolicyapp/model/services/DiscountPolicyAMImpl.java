...
public class DiscountPolicyAMImpl extends ApplicationModuleImpl implements DiscountPolicyAM {
    ...
    public Boolean areValidationsValid(){
        ...
        if(discBasis.equals(0)){
            ...
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Discount Basis is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Discount Basis on which you want to define Discount.");
            ...
            i = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Start Date is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Start Date on which you want to define Discount.");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Discount Value should be greater or equal to zero !" +
                                  "</p></b>");
             saveMsg.append("<b>Please enter a valid Discount Value.");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Customer is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Customer for which you want ot define Discount.");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            i = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Item is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Item for which you want to define Discount. ");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            i = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Item Group is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Item Group for which you want to define Discount.");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            i = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Sales Executive is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Sales Executive for which you want to define Discount.");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            i = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Customer Category is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Please select the Customer Category for which you want to define Discount.");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
    ...
    public Integer addDiscountRows(){
        ...
        if(areValidationsValid() == true){
            ...
            Number discVal = (discValO == null ? new Number(0) : (Number) discValO);
            Integer discBasis = (discBasisO == null ? 0 : (Integer)discBasisO);
            StringBuilder replicateToOthrOrg = (replicateToOthrOrgO == null ? new StringBuilder("N") : new StringBuilder(replicateToOthrOrgO.toString()));
            ...
            try {
                Object returnVal =
                    callStoredFunction(Types.VARCHAR, "SLS.fn_ins_disc_plc(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] {
                                                                                                    ...
                                                                                                    getHoOrgId().toString(),
                                                                                                    getOrgId().toString(),
                                                                                                    (itmId.toString().equals("") ? null : itmId.toString()),
                                                                                                    (eoId == 0 ? null : eoId),
                                                                                                    (eoCatg == 0 ? null : eoCatg),
                                                                                                    (itmGrp.toString().equals("") ? null : itmGrp.toString()),
                                                                                                    (salesExec == 0 ? null : salesExec),
                                                                                                    null,
                                                                                                    discBasis,
                                                                                                    discTyp.toString(),
                                                                                                    discVal,
