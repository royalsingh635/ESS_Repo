...
public class SLSPriceMasterAppAMImpl extends ApplicationModuleImpl implements SLSPriceMasterAppAM {
     ...
     * @return PartyType1
     */
    public ViewObjectImpl getPartyType1() {
        return (ViewObjectImpl)findViewObject("PartyType1");
    }
        ...
        if (_pMRow != null) {
            ...
            try {
                System.out.println("Paramter are:  \n" +
                        sloc_id + "  " + cld_id + "  " + ho_org_id + "  " + org_id + "  " + itemID + "  " +
                        Eoid.toString() + "  " + catagId + "  " + userid.toString() + "  " + new Timestamp(nwtime) +
                        "  " + ddDate + "  " + itmUom + "  " + mrpRate + "  " + mrpTyp + "  " + mrpPrice + "  " +
                        MinPrice + "  " + priceApply + "  " + basePrice);
                String driver=getdrivername();
                 if(driver.equalsIgnoreCase("MySQL-AB JDBC Driver")){
                a =
   (String)callStoredFunctionForAllEo(VARCHAR, "SLS.FN_ins_price(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                      new Object[] { sloc_id, cld_id, ho_org_id, org_id, itemID, Eoid.toString(),
                                                     catagId, userid.toString(), new Timestamp(nwtime), ddDate, itmUom,
            ...
            try {
                if (bindVars != null) {
                    for (int z = 0; z < bindVars.length; z++) {
                        ...
                        System.out.println("Vars : "+bindVars[z]);
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if ("For All Dealers".equalsIgnoreCase(eoId) || "For All Retailers".equalsIgnoreCase(eoId) ||
                    ...
                    String driver=getdrivername();
                    if(driver.equalsIgnoreCase("MySQL-AB JDBC Driver")){
                        i=(String)callStoredFunction(VARCHAR, "call FN_ins_price_hist(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                      new Object[] { sloc_id, cld_id, org_id, ho_org_id, 0, catgId,
                                                                     usrIdCrt, catgType, new Timestamp(nwtime),  ddDate,
                                                                     itmId,itmUom, mrpRate, mrpTyp, mrpPrice, MinPrice,
                                                                     priceApply, basePrice });   
                    }
                    else
                    {
                    i =
                        (String)callStoredFunction(VARCHAR, "SLS.FN_ins_price_hist(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                   new Object[] { sloc_id, cld_id, org_id, ho_org_id, 0, catgId,
                                                                  usrIdCrt, catgType, new Timestamp(nwtime), ddDate,
                                                                  itmId, itmUom, mrpRate, mrpTyp, mrpPrice, MinPrice,
                                                                  priceApply, basePrice });
                    ...
                    if (eoRow.length > 0) {
                        ...
                        else
                        {
                         i =
                            (String)callStoredFunction(VARCHAR, "SLS.FN_ins_price_hist(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                       new Object[] { sloc_id, cld_id, org_id, ho_org_id, custId,
                                                                      catgId, usrIdCrt, "E", new Timestamp(nwtime),
                                                                      ddDate, itmId, itmUom, mrpRate, mrpTyp, mrpPrice,
                                                                      MinPrice, priceApply, basePrice });
                        }
    ...
    public String fnsToEditEoWise() {
        ...
        try {
            ...
            if(driver.equalsIgnoreCase("MySQL-AB JDBC Driver")){
                i =
                   (String)callStoredFunction(VARCHAR, "call FN_ins_price_hist(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                              new Object[] { sloc_id, cld_id, org_id, ho_org_id, eoEoId, eocatgId,
                                                             eousrIdCrt, catgType, new Timestamp(nwtime), ddDate, eoitmId,
                                                             eoitmUom, eomrpRate, eomrpTyp, eomrpPrice, eoMinPrice,
                                                             eopriceApply, eobasePrice });
            }
            else
            {
             i =
    ...
    public void addEntryInDBFromExcel(String itemID, final Integer Eoid, Date nwtime, Date ddDate, Number mrpRate,
        ...
        if(driver.equalsIgnoreCase("MySQL-AB JDBC Driver")){
            flag =
               (String)callStoredFunctionForAllEo(VARCHAR, "call FN_ins_price(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                  new Object[] { sloc_id, cld_id, ho_org_id, org_id, itemID,
                                                                 Eoid.toString(), Integer.parseInt(catagId),
                                                                 userid.toString(), new Timestamp(nwtime),
                                                                 ((ddDate == null) ? null : new Timestamp(ddDate)),
                                                                 ItemUOMId, mrprt, mrpTyp, mrpPc, MinPc,
                                                                 priceApply, basePc });   
        }
        else
        {
         flag =
            (String)callStoredFunctionForAllEo(VARCHAR, "SLS.FN_ins_price(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                               new Object[] { sloc_id, cld_id, ho_org_id, org_id, itemID,
                                                              ...
                                                              userid.toString(), new Timestamp(nwtime),
                                                              ((ddDate == null) ? null : new Timestamp(ddDate)),
                                                              ItemUOMId, mrpRate, mrpTyp, mrpPrice, MinPrice,
                                                              priceApply, basePrice });
        }
    ...
    public String CheckValidItmId(String itmId) {
        ...
        String driver=getdrivername();
        if(driver.equalsIgnoreCase("MySQL-AB JDBC Driver")){
            val=(String)callStoredFunction(Types.VARCHAR, "call SLS_CHECK_ITM_ID(?,?,?,?,?)", new Object[] { cld_id,
                                                                                                        sloc_id,
                                                                                                        ho_org_id,
                                                                                                        org_id,
                                                                                                        itmId });
        ...
        {
         val=(String)callStoredFunction(Types.VARCHAR, "SLS.SLS_CHECK_ITM_ID(?,?,?,?,?)", new Object[] { cld_id,
                                                                                                        sloc_id,
                                                                                                        ho_org_id,
                                                                                                        org_id,
                                                                                                        itmId });
    ...
    public StringBuffer getPath() {
        ...
        String driver=getdrivername();
        if(driver.equalsIgnoreCase("MySQL-AB JDBC Driver")){
            path= new StringBuffer((String)callStoredFunction(Types.VARCHAR, " call FN_GET_APP_DOC_ATTACH_PATH(?)",
                                                        new Object[] { getparamSlocId() }));
        }
        else
        {
         path= new StringBuffer((String)callStoredFunction(Types.VARCHAR, " APP.FN_GET_APP_DOC_ATTACH_PATH(?)",
                                                        new Object[] { getparamSlocId() }));
        }
     ...
     * @return LovItmGrp2
     */
    public ViewObjectImpl getLovItmGrp2() {
        return (ViewObjectImpl)findViewObject("LovItmGrp2");
    }
    ...
    public Boolean saveEoWisePrice() {
        ...
        Object catgIdO = row.getAttribute("CatgId");
        Integer catgId = (catgIdO == null ? 0 : (Integer)catgIdO);
        ...
        StringBuffer rateChngForTrans = (rateChngForTransO == null ? new StringBuffer("") : new StringBuffer(rateChngForTransO.toString()));
        StringBuilder itemIdTrans = (itemIdTransO == null ?  new StringBuilder("") : new StringBuilder(itemIdTransO.toString()));
        StringBuilder itemGrpIdTrans = (itemGrpIdTransO == null ?  new StringBuilder("") : new StringBuilder(itemGrpIdTransO.toString()));
        
        
        StringBuilder baseAmtPerTrans = (baseAmtPerTransO == null ? new StringBuilder("") : new StringBuilder(baseAmtPerTransO.toString()));
        StringBuilder baseAddSubTrans = (baseAddSubTransO == null ? new StringBuilder("") : new StringBuilder(baseAddSubTransO.toString()));
        Number baseAmtTrans = (baseAmtTransO == null ? new Number(0) : (Number)baseAmtTransO);
        
        System.out.println("AddSub : " + addSub + " AmtPer : " + amtPer + " Amt : " + amt + " EffectiveDt : " +
                           effectiveDtTransO + " ExpDt : " + expDtTransO);
        
        if (catgId.equals(0)) {
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select a Customer Category to change Item Price !" +
                                  "</p></b>");
            saveMsg.append("<b>Customer Category is not selected. Please select a Customer Category !");
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select a Basis to change Item Price !" +
                                  "</p>" + "</b>" + "<ul>" + "<li>For all Items</li>" +
                                  "<li>For an Specific Item Group</li>" + "<li>For an Specific Item</li>" + "</ul>");
            saveMsg.append("<b>Basis for Price Change is not selected. Please select a Change Basis !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select an Item Group !" +
                                  "</p></b>");
            saveMsg.append("<b>Item Group is not selected. Please select an Item Group for which you want to edit price !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select an Item !" + "</p></b>");
            saveMsg.append("<b>Item is not selected. Please select an Item for which you want to edit price!");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select change Amount Type for Base Price !" + "</p></b>");
            saveMsg.append("<b>Amount type is not selected. Please select Amount Type !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select Add/Sub for Base Amount !" + "</p></b>");
            saveMsg.append("<b>Add/Sub is not selected. Please select if you want to Add or Substract Amount from Base Price !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Amount for change in Base Price is Negative in Value !" +
                                  "</p></b>");
            saveMsg.append("<b>Amount should be a positive value greater than or equal zero. Please enter a Valid Amount !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Percentage value should be less than 100 for changing Base Amount !" +
                                  "</p></b>");
            saveMsg.append("<b>Invalid percentage value is selected. Please enter a valid Percentage value!");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "MRP Rate Value Change Type is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Price cannot be updated if Change Type is not selected. Please select a Value Change Type  !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "MRP Rate Add/Sub Type is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Add/Sub Type need to be selected for updation. Please select a Add/Sub Type !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Percentage value should be less than 100 for changing MRP Rate !" +
                                  "</p></b>");
            saveMsg.append("<b>Invalid percentage value is selected. Please enter a valid Percentage value!");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "MRP Rate change amount should be greater than or equal to zero !" +
                                  "</p></b>");
            saveMsg.append("<b>Amount need to be greater than zero. Please enter a valid Amount  !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            retVal = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Price Effective Date is not selected !" +
                                  "</p></b>");
            saveMsg.append("<b>Date from which the updated price will be effective, need to be selected. Please select a Price Effective Date !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            */
            ...
            try {
                flag =
            callStoredFunctionForAllEo(Types.NUMERIC, "SLS.FN_UPD_EO_PRICE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] { getparamSlocId(),
                                                                                                             getparamCldId(),
                                                                                                             getparamHoOrgId(),
                                                                                                             getparamOrgId(),
                                                                                                             itemIdTransO,
                                                                                                             ...
                                                                                                             amtPerTransO,
                                                                                                             amt,
                                                                                                             baseAddSubTrans.toString(),
                                                                                                             baseAmtPerTrans.toString(),
                                                                                                             baseAmtTrans});
            ...
            if (i.compareTo(new BigDecimal(-3)) == 0) {
                StringBuilder saveMsg =
                    new StringBuilder("<html><body><b><p style='color:red'>" + "Effective Date & Time already exist for some of the selected Items !" +
                                      "</p></b>");
                saveMsg.append("<b>The Effective Date for some of the Items Selected for Updation Confilicts with the effective date already saved in the Application with those Items. " +
                               "There cannot be Two Item Price on same Date & Time. Please select some other Effective Date and Time!");
                saveMsg.append("</body></html>");
                FacesMessage msg = new FacesMessage(saveMsg.toString());
                msg.setSeverity(FacesMessage.SEVERITY_WARN);
                FacesContext.getCurrentInstance().addMessage(null, msg);
                ...
                StringBuilder saveMsg =
                    new StringBuilder("<html><body><b><p style='color:red'>" + "Minimum Price cannot be less that Item Price !" +
                                      "</p></b>");
                saveMsg.append("<b>Newly Calculated Price for some Item or Items is less that Minimum Price of respective Items. So cannot Update Price !");
                saveMsg.append("</body></html>");
                FacesMessage msg = new FacesMessage(saveMsg.toString());
                msg.setSeverity(FacesMessage.SEVERITY_WARN);
                FacesContext.getCurrentInstance().addMessage(null, msg);
                ...
                StringBuilder saveMsg =
                    new StringBuilder("<html><body><b><p style='color:red'>" + "There have been some error in Updating Item Price !" +
                                      "</p></b>");
                saveMsg.append("<b>Please try again. If problem persists please contact ESS!");
                saveMsg.append("</body></html>");
                FacesMessage msg = new FacesMessage(saveMsg.toString());
                msg.setSeverity(FacesMessage.SEVERITY_WARN);
                FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            /* PriceMasterVOImpl impl = this.getPriceMaster2();
            RowSetIterator itr = impl.createRowSetIterator(null);
            while (itr.hasNext()) {
                Row itmRow = itr.next();
                Object minPriceObj = itmRow.getAttribute("MinPrice");
                Object mrpPriceObj = itmRow.getAttribute("MrpPrice");
                Number minPrice = (minPriceObj == null ? new Number(0) : (Number)minPriceObj);
                Number mrpPrice = (mrpPriceObj == null ? new Number(0) : (Number)mrpPriceObj);
                Number newAmt = new Number(0);
                Number newPrice = new Number(0);
                //Calculate amount to be added or substracted
                if (amtPer.toString().equals("A")) {
                    newAmt = amt;
                } else if (amtPer.toString().equals("P")) {
                    newAmt = mrpPrice.multiply(amt).divide(new Number(100));
                }
                //Add or substract the calculated amount
                if (addSub.toString().equals("A")) {
                    newPrice = mrpPrice.add(newAmt);
                } else {
                    newPrice = mrpPrice.subtract(newAmt);
                }


                if (minPrice.compareTo(newPrice) == 1) {
                    retVal = false;
                    StringBuffer msg = new StringBuffer();
                    msg.append("<html>" + "<body>");
                    msg.append("<b>The New Price for Item : ");
                    msg.append("<span style='color:blue;font-weight:bold;'>" + itmRow.getAttribute("ItmDesc") +
                               "</span>");
                    msg.append(" is less than its Minimum Price.</b>");
                    msg.append("</br></br><b> The New Price for the Item is : <span style='color:blue;font-weight:bold;'>" +
                               newPrice +
                               "</span> and the Minimum Price for this Item is : <span style='color:blue;font-weight:bold;'>" +
                               minPrice + "</span></b>");
                    msg.append("</br></br><b style='color:green;'>Please enter a Valid ItemPrice !</b>");
...
//                /* else{
//                    System.out.println("Updating MprPriceFor : "+);
//                    itmRow.setAttribute("MrpPrice", newPrice);
//                } 
            }
            itr.closeRowSetIterator();

            if (retVal == true) {
                itr = impl.createRowSetIterator(null);
                while (itr.hasNext()) {
                    Row itmRow = itr.next();
                    Object minPriceObj = itmRow.getAttribute("MinPrice");
                    Object mrpPriceObj = itmRow.getAttribute("MrpPrice");
                    ...
                    if (minPrice.compareTo(newPrice) == 1) {
                        ...
                        System.out.println("Updating MprPriceFor : " + itmRow.getAttribute("ItmDesc"));
                        itmRow.setAttribute("MrpPrice", newPrice);
                        itmRow.setAttribute("EffectiveDt", effectiveDtTrans);
                        itmRow.setAttribute("ExpiryDt", expDtTrans);
                        itmRow.setAttribute("EoPriceType", "E");
                    }
                }
                itr.closeRowSetIterator();
             */    
                ...
                Timestamp t = new Timestamp(d,false); */
            }
        return retVal;
    }
    ...
    public Boolean updatePrice() {
        ...
        StringBuilder baseAmtTyp = (baseAmtTypO == null ? new StringBuilder("") :  new StringBuilder(baseAmtTypO.toString()));
        StringBuilder baseAOrSub = (baseAOrSubO == null ? new StringBuilder("") :  new StringBuilder(baseAOrSubO.toString()));
        ...
        if (catgId.equals(0)) {
            ...
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Amount for change in Base Price is Negative in Value !" +
                                  "</p></b>");
            saveMsg.append("<b>Amount should be a positive value greater than zero. Please enter a Valid Amount !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
        ...
        //
            ...
            b = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select Amount Type for MRP Rate change !" + "</p></b>");
            saveMsg.append("<b>Amount type is not selected. Please select Amount Type !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            ...
            b = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Please select Add/Sub for MRP Rate !" + "</p></b>");
            saveMsg.append("<b>Add/Sub is not selected. Please select if you want to Add or Substract Amount from Price !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
            ...
            b = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Amount for change in MRP Rate change is Negative in Value !" +
                                  "</p></b>");
            saveMsg.append("<b>Amount should be a positive value greater than zero. Please enter a Valid Amount !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            ...
            b = false;
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Effective Date cannot be blank !" +
                                  "</p></b>");
            saveMsg.append("<b>Effective date is not selected. Please enter an Effective Date !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_WARN);
            FacesContext.getCurrentInstance().addMessage(null, msg);
...
callStoredFunctionForAllEo(Types.NUMERIC, "SLS.FN_UPD_EO_PRICE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] { getparamSlocId(),
            ...
            if (i.compareTo(new BigDecimal(-3)) == 0) {
                ...
                StringBuilder saveMsg =
                    new StringBuilder("<html><body><b><p style='color:red'>" + "Minimum Price cannot be less that Item Price !" +
                                      "</p></b>");
                saveMsg.append("<b>Newly Calculated Price for some Item or Items is less than Minimum Price of respective Items. So cannot Update Price !");
                saveMsg.append("</body></html>");
                FacesMessage msg = new FacesMessage(saveMsg.toString());
                msg.setSeverity(FacesMessage.SEVERITY_WARN);
                FacesContext.getCurrentInstance().addMessage(null, msg);
    ...
    public void filterDistinctVO() {
        String cldIdO = resolvEl("#{pageFlowScope.GLBL_APP_CLD_ID}").toString();
        Integer slocIdO = Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_APP_SERV_LOC}").toString());
        String orgIdO = resolvEl("#{pageFlowScope.GLBL_APP_USR_ORG}").toString();
        String hoOrgIdO = resolvEl("#{pageFlowScope.GLBL_HO_ORG_ID}").toString();
    ...
    public Integer addItemPrice() {
        ...
        Integer usrId = Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_HO_ORG_ID}").toString());
        ...
        /* if(EffectiveDtTrans != null ){
            Calendar now = Calendar.getInstance();
            TimeZone timeZone = TimeZone.getDefault();
            System.out.println("Default time zone : "+timeZone+ " cal time zone "+now.getTimeZone());
            ...
            long j = System.currentTimeMillis() % (1000 * 60 * 60 * 24);
            System.out.println("J : "+j+" date came out is  : "+new Timestamp(EffectiveDtTrans.getTime()+j));
            long secs = currDateTime % (1000 * 60 * 60 * 24);
            System.out.println(secs);
            rd.setSeed(100000);
            int R = rd.nextInt(2000000 - 1000000) + 1000000;
            long nwtime = EffectiveDtTrans.getTime() + secs;
            EffectiveDtTrans = new Timestamp(nwtime);
            nwtime = ExpiryDtTrans.getTime() + date.getTime();
            ExpiryDtTrans = new Timestamp(nwtime);
            System.out.println("Exp dt : "+ExpiryDtTrans);
        } */
        ...
        if(PopEoCatgIdTrans.equals(0)){
            ...
            i = 10;
                ...
                n = (Number)n.round(amt_digit);
                if (!isPrecisionValid(26, 6, n)) {
                    i = 9;
                } else {
                    Object flag =
                        callStoredFunctionForAllEo(VARCHAR, "SLS.FN_INS_PRICE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                                   new Object[] { slocId, cldId, hoOrgId, orgId, ItmIdTrans.toString(),
                                                                  PopUpEoIdTrans, PopEoCatgIdTrans, usrId, EffectiveDtTrans, ExpiryDtTrans,
                                                                  (ItmUomTransO == null ? null :
                                                                   ItmUomTransO.toString()), MrpRateTrans,
                                                                  MrpRateTypTrans.toString(), MrpTrans, MinPriceTrans,
                                                                  "N", BasePriceTrans });
                    StringBuilder r = (flag == null ? new StringBuilder("") : new StringBuilder(flag.toString()));
