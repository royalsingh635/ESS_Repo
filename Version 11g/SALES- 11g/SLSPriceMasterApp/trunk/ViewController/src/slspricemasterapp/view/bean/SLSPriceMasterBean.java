...
public class SLSPriceMasterBean {
    ...
    private RichCommandImageLink srchBtnBVar;
    ...
    private RichInputListOfValues transAddPartyNmBVar;
    String chk = "Y";
    ...
    // private RichCommandImageLink _checkLinkBind;
    private RichPopup savepopup;
    private RichCommandImageLink _saveBVar;
    private RichCommandImageLink _addLinkNBar;
    private RichInputText minPrceBVar;
    private RichCommandImageLink _deleteBVar;
    private RichCommandImageLink _editLinkBVar;
    private RichSelectOneRadio flagBVar;
    private RichSelectOneRadio flagEoWiseEdit;
    private RichCommandImageLink cancelLinkBVar;
    ...
    private RichCommandImageLink resetLinkBVar;
    ...
    public void searchcatg_changeListener(ValueChangeEvent valueChangeEvent) {
        ...
        if (catagSearchBVar.getValue().equals(null) || catagSearchBVar.getValue().toString().length() <= 0) {
            ...
            this.transAddPartyNmBVar.setValue("");

            AdfFacesContext.getCurrentInstance().addPartialTarget(transAddCatagNmBVar);
            AdfFacesContext.getCurrentInstance().addPartialTarget(transAddPartyNmBVar);
        } else {
            this.partyNmSearchbvar.setValue("");
            this.transAddPartyNmBVar.setValue("");
    ...
    public void setSrchBtnBVar(RichCommandImageLink srchBtnBVar) {
        this.srchBtnBVar = srchBtnBVar;
    }

    public RichCommandImageLink getSrchBtnBVar() {
        return srchBtnBVar;
    }
    ...
    public void setTransAddPartyNmBVar(RichInputListOfValues transAddPartyNmBVar) {
        this.transAddPartyNmBVar = transAddPartyNmBVar;
    }

    public RichInputListOfValues getTransAddPartyNmBVar() {
        return transAddPartyNmBVar;
    }
    ...
    public void set_saveBVar(RichCommandImageLink _saveBVar) {
        this._saveBVar = _saveBVar;
    }

    public RichCommandImageLink get_saveBVar() {
        return _saveBVar;
    }

    public void set_addLinkNBar(RichCommandImageLink _addLinkNBar) {
        this._addLinkNBar = _addLinkNBar;
    }

    public RichCommandImageLink get_addLinkNBar() {
        return _addLinkNBar;
    }
    ...
    public void set_deleteBVar(RichCommandImageLink _deleteBVar) {
        this._deleteBVar = _deleteBVar;
    }

    public RichCommandImageLink get_deleteBVar() {
        return _deleteBVar;
    }
    ...
    public void setCancelLinkBVar(RichCommandImageLink cancelLinkBVar) {
        this.cancelLinkBVar = cancelLinkBVar;
    }

    public RichCommandImageLink getCancelLinkBVar() {
        ...
        if (object != null) {
            ...
            if (chnageAmountBVar.getValue().equals("A")) {
                if (amt.compareTo(Number.zero()) == -1) {
                    ...
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.1169']}").toString()); //Amount can not negative...
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(message);
                ...
                if (amt.compareTo(Number.zero()) == -1) {
                    ...
                    FacesMessage message =
                        new FacesMessage(resolvElDCMsg("#{bundle['MSG.1171']}").toString()); //Percentage amount can not greater then 99.99%
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(message);
                } else {
                    // System.out.println("set 5");
        ...
        if (object != null) {
            ...
            if ("A".equalsIgnoreCase(mrpType)) {
                if (n.compareTo(0) < 0) {
                    // System.out.println("amout is negative....");
                    FacesMessage message =
                        new FacesMessage("MRP RATE Can not be negative"); //MRP Rate can not be either Zero or negative.
                    // FacesMessage message = new FacesMessage(resolvElDCMsg("#{bundle['MSG.994']}").toString());
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(message);
                } else {
                ...
                if (n.compareTo(0) == 0) {
                    //  System.out.println("amout is negative....");
                    FacesMessage message = new FacesMessage("MRP RATE Can not be negative");
                    // FacesMessage message = new FacesMessage(resolvElDCMsg("#{bundle['MSG.994']}").toString());
                    message.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(message);
            ...
            if (minPrice != null) {
                if (finalMrp.compareTo(minPrice) == -1) {
    ...
    public void setResetLinkBVar(RichCommandImageLink resetLinkBVar) {
        this.resetLinkBVar = resetLinkBVar;
    }

    public RichCommandImageLink getResetLinkBVar() {
    ...
    public void excelImportAction(ActionEvent actionEvent) {
        ...
        if (transAddCatagNmBVar.getValue() == null || transAddCatagNmBVar.getValue().toString().equalsIgnoreCase("")) {
            ...
            FacesMessage message = new FacesMessage("Please Select Category !!");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(null, message);
            setFile(null);
            return;
        ...
        try {
            ...
            FacesMessage message =
                new FacesMessage("Please Select File Again or File is corrupted.."); //resolvElDCMsg("#{bundle['MSG.973']}").toString()
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext.getCurrentInstance().addMessage(mrpPriceBVar.getClientId(), message);
            e.printStackTrace();
    ...
    public void saveEoPriceACTION(ActionEvent actionEvent) {
        ...
        if (ret.equals((Object)true)) {
            ...
            if (commitBinding.getErrors().isEmpty()) {
                ...
                FacesMessage message =
                    new FacesMessage("Price changed Sucessfully !"); //resolvElDCMsg("#{bundle['MSG.973']}").toString()
                message.setSeverity(FacesMessage.SEVERITY_INFO);
                FacesContext.getCurrentInstance().addMessage(null, message);
    ...
    public void negativeNumberVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        if (object != null) {
            ...
            if (!isPrecisionValid(26, 6, (Number)object)) {
                // FacesMessage message = new FacesMessage("Invalid number!","Cannot enter negative value!");
                FacesMessage message = new FacesMessage("Invalid Precision ! Please enter a valid value.");
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message);
            }
        }
    ...
    public void addNewItemACTION(ActionEvent actionEvent) {
        ...
        if (i == 11) {
            ...
            FacesMessage errMsg =
                new FacesMessage("Customer Category is not selected!", "Please select Customer Category for whome price will be Defined !");
            ...
            FacesMessage errMsg =
                new FacesMessage("Item is not selected!", "Please select an Item for whome price will be Defined !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            FacesMessage errMsg =
                new FacesMessage("Effective Date is not selected!", "Please select Effective Date from which price will be Applicable !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            FacesMessage errMsg =
                new FacesMessage("Base Price should be Greater than zero!", "Please enter valid Base Price !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            FacesMessage errMsg =
                new FacesMessage("Minimum Price should be Greater than Base Price!", "Please enter valid Minimum Price !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            FacesMessage errMsg = new FacesMessage("MRP Rate Type is not selected!", "Please select MRP Rate Type !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            FacesMessage errMsg =
                new FacesMessage("MRP Rate should be greater than zero!", "Please enter a valid MRP Rate !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            clientId = clientId.append("it23");
            FacesMessage errMsg =
                new FacesMessage("Invalid Percentage Value !", "Percentage value should be less than or equal to 100!");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            clientId = clientId.append("it21");
            FacesMessage errMsg =
                new FacesMessage("Calculated MRP have Invalid Precision !", "Please enter a valid MRP Rate and Base Price!");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            clientId = clientId.append("it22");
            FacesMessage errMsg =
                new FacesMessage("Minimum Price should be less than or Equal to final MRP!", "Please enter valid Minimum Price !");
            errMsg.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext ctx = FacesContext.getCurrentInstance();
            ctx.addMessage(clientId.toString(), errMsg);
            System.out.println("Client id is : " + clientId);
            ...
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "Item Price Saved sucessfully !" +
                                  "</p></b>");
            saveMsg.append("<b>New Item price is Defined Sucessfully !");
            ...
            //addPopupBind.hide();
            StringBuilder saveMsg =
                new StringBuilder("<html><body><b><p style='color:red'>" + "There was an error while inserting records !" +
                                  "</p></b>");
            saveMsg.append("<b>Please try again. If the problem persists Please call ESS !");
            saveMsg.append("</body></html>");
            FacesMessage msg = new FacesMessage(saveMsg.toString());
            msg.setSeverity(FacesMessage.SEVERITY_INFO);
            FacesContext.getCurrentInstance().addMessage(null, msg);
