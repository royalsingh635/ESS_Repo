...
public class SlsIntmSlipEOImpl extends EntityImpl {
    ...
    protected void create(AttributeList attributeList) {
        ...
        Timestamp usrIdCreateDt=new Timestamp(System.currentTimeMillis());
        setUsrIdCreateDt(usrIdCreateDt);
        Timestamp usrIdModDt=new Timestamp(System.currentTimeMillis());
        setUsrIdModDt(usrIdModDt);
        if(this.getDocIdAuto()!=null){
            String docId=this.getDocIdAuto();
            setDocId(docId);
            System.out.println(DOCID);
        }
        /* SlsIntimationSlipAMImpl amImpl=(SlsIntimationSlipAMImpl)resolvElDC("SlsIntimationSlipAMDataControl");
        amImpl.getFYidOrg(getCldId(), getOrgId()); */
    }
     ...
     */
     public String getDocIdAuto() {

        String cld_id = getCldId();
        Integer sloc_id = getSlocId();
        String org_id = getOrgId();
        Integer usr_id = Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_APP_USR}").toString());
        Integer doc_id = 21509;
        String docIdAuto =
            callStoredFunction(Types.VARCHAR, "app.get_txn_id(?,?,?,?,?)", new Object[] { cld_id,sloc_id,org_id,usr_id,doc_id}).toString();
        System.out.println(docIdAuto);
