...
public class SlsInvDtlVORowImpl extends ViewRowImpl {
    ...
    public BigDecimal getShipAmtSp() {
        if(getSlsInv() != null){
            Integer i = (getSlsInv().getAttribute("InvType") != null ? (Integer)getSlsInv().getAttribute("InvType") : 0);
            if (i.equals(480)) {
                ...
                BigDecimal previousAmt = (getAttributeInternal(SHIPAMTSP) == null ? new BigDecimal(0) : (BigDecimal)getAttributeInternal(SHIPAMTSP));
                if(previousAmt.compareTo(b) != 0){
                    setShipAmtSp(b);
                    BigDecimal j = (getSlsInv().getAttribute("CurrRate") != null ? 
