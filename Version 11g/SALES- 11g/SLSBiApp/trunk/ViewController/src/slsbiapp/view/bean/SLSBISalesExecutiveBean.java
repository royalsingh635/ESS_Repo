...
public class SLSBISalesExecutiveBean {
    ...
    private StringBuffer selectedCustomerDesc = new StringBuffer("Sample");
    private StringBuffer selectedCustomerId = new StringBuffer("Sample");
    public SLSBISalesExecutiveBean() {
    }
    ...
    public void goToOneSelectedCustomerACTION(ActionEvent actionEvent) {
        RichCommandLink ob = (RichCommandLink)actionEvent.getSource();
        ...
        selectedCustomerDesc = (custDesc == null ? new StringBuffer("") : new StringBuffer(custDesc));
        selectedCustomerId = (custId == null ? new StringBuffer("") : new StringBuffer(custId));
    ...
    public void setSelectedCustomerDesc(StringBuffer selectedCustomerDesc) {
        this.selectedCustomerDesc = selectedCustomerDesc;
    }

    public StringBuffer getSelectedCustomerDesc() {
        return selectedCustomerDesc;
    }

    public void setSelectedCustomerId(StringBuffer selectedCustomerId) {
        this.selectedCustomerId = selectedCustomerId;
    }

    public StringBuffer getSelectedCustomerId() {
