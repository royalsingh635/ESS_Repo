...
public class SLSBiOrganisationDetailsBean {
    ...
    public SLSBiOrganisationDetailsBean() {
    }
    ...
    /**
     * Method that sets the current row for oen item viiew
     * @return
     */
    public String goToItemDetailsACTION() {
        OperationBinding binding = this.getBindings().getOperationBinding("getCurrentlySelectedItmId");
        binding.execute();
        if(binding.getResult() != null){
            selectedItmId = (StringBuffer)binding.getResult();
        }
        
        return "goToSelectedProduct";
    }
    ...
    /**
     * Method action to naviagate to one page
     * @return
     */
    public String goToSelectedCustACTION() {
        return "goToSelectedCustomer";
    }
    /**
    ...
    public void goToOneProductGroupACTION(ActionEvent actionEvent) {
        ...
        System.out.println("SelectedGrpId : "+selectedProductGrpDesc+" SelectedGrpDesc : "+selectedProductGrpDesc);
