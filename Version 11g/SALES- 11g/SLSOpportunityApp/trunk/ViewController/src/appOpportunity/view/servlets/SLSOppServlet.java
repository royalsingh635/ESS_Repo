package appOpportunity.view.servlets;
...
public class SLSOppServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (linkType.equalsIgnoreCase("oppdetail")) {
                reportName = "SLS_Opp_DetailReport";
            }
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Sales Opportunity.pdf\"");
