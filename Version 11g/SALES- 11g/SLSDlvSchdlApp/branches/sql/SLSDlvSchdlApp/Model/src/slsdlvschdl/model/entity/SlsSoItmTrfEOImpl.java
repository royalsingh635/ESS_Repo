...
public class SlsSoItmTrfEOImpl extends EntityImpl {
    ...
    private StringBuffer cldid = new StringBuffer(resolvEl("#{pageFlowScope.GLBL_APP_CLD_ID}"));
    private StringBuffer orgid = new StringBuffer(resolvEl("#{pageFlowScope.GLBL_APP_USR_ORG}"));
    private StringBuffer hoorgid = new StringBuffer(resolvEl("#{pageFlowScope.GLBL_HO_ORG_ID}"));
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("slsdlvschdl.model.entity.SlsSoItmTrfEO");
    }
    ...
    public void setItmTrfQty(Number value) {
     //System.out.println("value : "+value);
       // System.out.println("getUomConvFctr() : "+getUomConvFctr());
        Number uomconv=new Number(1);
       if( getUomConvFctr() != null)
           uomconv=getUomConvFctr();
            if (value != null) {
                setItmTrfQtyBs(value.multiply(uomconv));
                setAttributeInternal(ITMTRFQTY, value);
            }else{
                setAttributeInternal(ITMTRFQTY, new Number(0));
            }
