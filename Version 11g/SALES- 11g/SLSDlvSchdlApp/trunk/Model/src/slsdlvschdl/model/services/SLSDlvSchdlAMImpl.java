...
public class SLSDlvSchdlAMImpl extends ApplicationModuleImpl implements SLSDlvSchdlAM {
    ...
    public Integer pendingCheck(Integer SlocId, String CldId, String OrgId, Integer DocNo) {
        ...
        if (drivr.equalsIgnoreCase("MySQL-AB JDBC Driver"))
                         {
                    System.out.println("inside loop");
                    obj = callProcedureOut(Types.NUMERIC, "call GET_DOC_WF_CUR_USR(?,?,?,?,?,?,?)", new Object[] { SlocId, CldId, OrgId,
                                                                                                                 DocNo, DocId, 0 });
                        }
             else
             {
...
callStoredFunction(Types.INTEGER, "APP.PKG_APP_WF.GET_DOC_WF_CUR_USR(?,?,?,?,?)", new Object[] { slocid,
                ...
                if (drivr.equalsIgnoreCase("MySQL-AB JDBC Driver"))
                                 {
                System.out.println("inside loop");
                obj = callProcedureOut(Types.INTEGER, "call GET_DOC_WF_CUR_USR(?,?,?,?,?,?,?)", new Object[] { slocid, cldid.toString(),
            ...
            try {
                ...
                if (drivr.equalsIgnoreCase("MySQL-AB JDBC Driver"))
                {
                 System.out.println("inside loop");
                                                         // sharon
                 /*
                  * result = (Integer)callProcedureOut(Types.INTEGER, "call WF_INS_TXN(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] { slocid,
                                                                                                                                                    cldid.toString(),
                                                                                                                                                    orgid.toString(),
                                                                                                                                                    21503,
                                                                                                                                                    docType,
                                                                                                                                                    ...
                                                                                                                                                    0,
                                                                                                                                                    "S" });*/
                 result = (Integer)callProcedureOut(Types.INTEGER, "call INS_TXN(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", new Object[] { slocid,
                                                                                                                                                                     cldid.toString(),
                                                                                                                                                                     orgid.toString(),
                                                                                                                                                                     21503,
                                                                                                                                                                     docType,
            ...
            if (checkPolicyApplied().toString().equals("Y")) {
                ...
                if (policyPrice.compareTo(new BigDecimal(0)) == 0) {
                    drivr = getdrivername();
                                    ...
                                    {
                                      System.out.println("inside loop");
                                         price=      (BigDecimal)callProcedureOut(Types.NUMERIC, "call FN_GET_EO_LATEST_PRICE(?,?,?,?,?,?,?,?,?,?,?,?)",
    ...
    public StringBuffer checkPolicyApplied() {
        ...
        try {
            ...
            String drivr = getdrivername();
                             ...
                             {
                               System.out.println("inside loop");
                               policyPrice = (String)callProcedureOut(Types.VARCHAR, "call fn_sls_chk_org_prf(?,?,?,?,?)", new Object[] { p_cldId,
                                                                                                                                    p_sloc_id,
                                                                                                                                    p_org_id,
                                                                                                                                    "USE_PRICE_PLC" });
