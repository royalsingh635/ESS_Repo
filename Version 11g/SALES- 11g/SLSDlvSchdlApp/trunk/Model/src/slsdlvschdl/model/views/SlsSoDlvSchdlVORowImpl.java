...
public class SlsSoDlvSchdlVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        LOVItemIdToNameVo1 {
            public Object get(SlsSoDlvSchdlVORowImpl obj) {
                return obj.getLOVItemIdToNameVo1();
            }
    ...
    public static final int LOVITEMIDTONAMEVO1 = AttributesEnum.LOVItemIdToNameVo1.index();
    ...
    public String getNewItemNameFromItmIdTrans() {
        RowSet idToNameVo1 = this.getLOVItemIdToNameVo1();
        Row[] filteredRows = idToNameVo1.getFilteredRows("ItmId", getItmId());
        if (filteredRows.length > 0)
    ...
    /**
     * Gets the view accessor <code>RowSet</code> LOVItemIdToNameVo1.
     */
    public RowSet getLOVItemIdToNameVo1() {
        return (RowSet)getAttributeInternal(LOVITEMIDTONAMEVO1);
    }
