...
// ---------------------------------------------------------------------
public class GraphTickerAMImpl extends ApplicationModuleImpl  {
    /**
  ...
  /*   public ViewObjectImpl getOrgtrendNew1() {
   ...
   /** Moved to refresh button on landing page */
    ...
    public void topCustomer(){
       ...
       // System.out.println("Date in customer= "+d+"cld_id = "+cld_id+" org_id = "+org_id);
        ViewObjectImpl customer = this.getTopCustomerOs1();
        customer.setNamedWhereClauseParam("BindCldId", cld_id);
        customer.setNamedWhereClauseParam("BindOrgId", org_id);
       
        customer.executeQuery();
        //System.out.println("customer.getRowCount() = "+customer.getRowCount());
    }
    ...
    public void bankInflowOoutflow(){
     ...
     //   Integer usr_id = Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_APP_USR}").toString()); 
        ...
        ViewObjectImpl bank = this.getBankInflowOutflow1();
    ...
    public void cashInflowOoutflow(){
     ...
     //   Integer usr_id = Integer.parseInt(resolvEl("#{pageFlowScope.GLBL_APP_USR}").toString()); 
        ...
        Integer inst=1;
        System.out.println("cld_id = "+cld_id+" ho_org_id = "+ho_org_id +" org_id = "+org_id +"sloc_id = "+sloc_id);
        ViewObjectImpl cash = this.getCashInflowOutflow1();
