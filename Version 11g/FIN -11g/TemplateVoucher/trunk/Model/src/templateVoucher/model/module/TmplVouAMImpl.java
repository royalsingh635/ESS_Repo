...
// ---------------------------------------------------------------------
public class TmplVouAMImpl extends ApplicationModuleImpl  {
    /**
    ...
    public void tvouLineOp() {
        ...
        try {
            callStoredFunction(NUMBER, "FIN.FN_TMPL_VOU_LINE_HDR_LINE_OP(?,?,?,?,?)",
                               new Object[] { CldId, slocId, HoOrgId, orgId, vouId });
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void generateDocNo() {
        ...
        try {
            callStoredFunction(VARCHAR, "APP.INS_DISP_DOC_TAB (?,?,?,?,?,?,?,?,?,?)",
                               new Object[] { CldId, slocId, 1, HoOrgId, orgId, vouId, 54, vouTypeId, usrId, vouDt });
        } catch (Exception e) {
    ...
    public String processTaxForHdr(Integer taxRuleId) {
       ...
       // Integer currIdsp = Integer.parseInt(tmplVoulineRow.getAttribute("TmplVouCurrIdSp").toString());
        ...
        System.out.println("tax rule in id in selection of vclllllllllllllllllllllll iss="+taxRuleId);
            System.out.println("<<<--- CldId = "+CldId+" slocId = "+slocId+" HoOrgId = "+HoOrgId+" orgId = "+orgId+" vouId = "+vouId+" tvouDt = "+tvouDt+" slNo = "+slNo+" taxRuleId = "+taxRuleId+" finAmt = "+finAmt+" currIdsp = "+currIdsp+" userId = "+userId+" usrDt = "+usrDt+"--->>>");
            callStoredProcedure("FIN.INS_TEMPLATE_TAX_LINE(?,?,?,?,?,?,?,?,?,?,?,?)",
                                new Object[] { CldId, slocId, HoOrgId, orgId, vouId, tvouDt, slNo, taxRuleId, finAmt,
                                               currIdsp, userId, usrDt });
    ...
    public void taxConsolidation() {
       ...
       // Integer vouSubTypId=Integer.parseInt(tmplVouRow.getAttribute("TmplVouSubTypeId").toString());
        Integer currIdSp=Integer.parseInt(tmplVouRow.getAttribute("TmplCurrIdSp").toString());
        System.out.println("CldId = "+CldId +" slocId = "+slocId+" orgId = "+orgId+" HoOrgId = "+HoOrgId+" vouId = "+vouId);
      ...
      // System.out.println("vouSubTypId typee id is====>>>"+vouSubTypId);
        ...
        try {
            callStoredFunction(NUMBER, "FIN.FN_TMPL_VOU_TAX(?,?,?,?,?,?,?,?,?)",
                               new Object[] { CldId, slocId, 1, HoOrgId, orgId, vouId,vouTypId, 0,currIdSp });
        } catch (Exception e) {
    ...
    public String processTdsForLine(Integer tdsRuleId) {
      ...
      //  tmplVouTdsRulerow.setAttribute("TmplVouCurrIdSp", tmplVouLnRow.getAttribute("TmplVouCurrIdSp"));
        ...
        try {
             ...
             callStoredProcedure("FIN.INS_TEMPLATE_TDS_LINE(?,?,?,?,?,?,?,?,?,?,?,?)",
                                new Object[] { CldId, slocId, HoOrgId, orgId, vouId, tvouDt, slNo, tdsRuleId, currSp,
                                               finAmt, usrId, usrDt }); 
    ...
    public void tdsConsolidation() {
      ...
      System.out.println("CldId = "+CldId +" slocId = "+slocId+" orgId = "+orgId+" HoOrgId = "+HoOrgId+" vouId = "+vouId);
        try {
            callStoredFunction(NUMBER, "FIN.FN_TMPL_VOU_TDS(?,?,?,?,?,?,?,?)",
                               new Object[] { CldId, slocId, HoOrgId, orgId, vouId,vouTpye,0,currId });
        } catch (Exception e) {
     ...
     * @return TmplVouOc1
     */
    public ViewObjectImpl getTmplVouOc1() {
        return (ViewObjectImpl)findViewObject("TmplVouOc1");
    }
    ...
    public void tvouOtherCharges() {
        ...
        try {
            callStoredFunction(NUMBER, "FIN.FN_TMPL_VOU_OC(?,?,?,?,?,?)",
                               new Object[] { CldId, slocId,HoOrgId,orgId,vouId,currRate });
        } catch (Exception e) {
            // TODO: Add catch code
     ...
     */
    public ViewObjectImpl getLovLatestCurr() {
        return (ViewObjectImpl)findViewObject("LovLatestCurr");
    }
    ...
    public Integer on_load_page() {
        ...
        callStoredFunction1(VARCHAR, "APP.fn_get_usr_doc_access_param(?,?,?,?,?,?,?,?,?)",
                            new Object[] { cld_id, sloc_id, org_id, 54, usr_id });
     ...
     * @return LovCoaForHd1
     */
    public ViewObjectImpl getLovCoaForHd1() {
        return (ViewObjectImpl)findViewObject("LovCoaForHd1");
    }
