...
public class Chequeprint extends HttpServlet {
    ...
    if (request.getParameter("Disp_Vou_Id") != null) {
        ...
        Disp_Vou_Id = null;
            ...
            System.out.println("vou to dt---"+Vou_To_Date+"voiu frm dat--"+ Vou_From_Date+"  DispVouID-"+Disp_Vou_Id);
            System.out.println("Org:" + Org +"SlocId---"+ sloc +" Amount1 :" + AmountX1 + " amt2 " + AmountX2 + " toDate " + toDate +
                               " Fromdate " + fromDate + " cldid " +
                               request.getParameter("cldid") +  "Bank_Coa_Id->"+Bank_Coa_Id); 
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Print.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Print.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Print.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Print.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Print.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Cheque_Print.xml\"");
