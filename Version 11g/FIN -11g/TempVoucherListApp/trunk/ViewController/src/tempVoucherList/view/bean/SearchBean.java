...
public class SearchBean {
    ...
    private RichInputText amountFrom;
    private RichInputText amountTo;
    ...
    public void resetValues(ActionEvent actionEvent) {
        ...
        //v.setNamedWhereClauseParam("org_id", bindOrgId.getValue());
    ...
    public void searchAction(ActionEvent actionEvent) {
        ...
        v.setNamedWhereClauseParam("BindAmtFrm", amountFrom.getValue());
        v.setNamedWhereClauseParam("BindAmtTo", amountTo.getValue());
        /** Execute view object */
        v.executeQuery();
     ...
     * @param amountFrom
     */
    public void setAmountFrom(RichInputText amountFrom) {
     ...
     * @return
     */
    public RichInputText getAmountFrom() {
        return amountFrom;
    }
     ...
     * @param amountTo
     */
    public void setAmountTo(RichInputText amountTo) {
     ...
     * @return
     */
    public RichInputText getAmountTo() {
        return amountTo;
    }
