...
public class CostCenterBean {
        ...
        if (CostCenterProfile.getAttribute("CcFinalize") != null) {
            ...
            if (finalize.equalsIgnoreCase("Y")) {
                ...
                if (count < NoofComponent) {
                    ...
                    FacesContext ctx = FacesContext.getCurrentInstance();
                    FacesMessage fm =
                        new FacesMessage(FacesMessage.SEVERITY_ERROR, resolvElDCMsg("#{bundle['MSG.137']}").toString() +
                                         NoofComponent, "");
    ...
    public String deleteAll(Integer P_PRF_ID, String P_DEL_MODE) {
        return (String)callStoredFunction(STRING, "APP.PKG_APP.FN_DEL_CC_ALL(?,?)",
                                          new Object[] { P_PRF_ID, P_DEL_MODE });
    }
                        ...
                        */
                            ...
                            if ((count > 0) && (count1 > 0)) {
                                ...
                                System.out.println("---->" + slocId + " " + cldId + " " + orgId + " " + hoOrgId + " " +
                                                   prfId);
                                String value =
                                    callStoredProcedureCostCenter("APP.PROC_GEN_COST_CENTER(?,?,?,?,?,?)", new Object[] { slocId,
                                                                                                                          cldId,
                                                                                                                          orgId,
                                                                                                                          hoOrgId,
                                                                                                                          prfId }).toString();
        ...
        if (dialogEvent.getOutcome().name().equals("ok")) {
            ...
            if (Mode.equalsIgnoreCase("E")) {
                ...
                if ((ccPos > 1) && (ccDepndnt.equalsIgnoreCase("Y"))) {
                    if ((ccDepndnt.equalsIgnoreCase("Y")) &&
                        (CostCenterStruct.getAttribute("CcEntIdParent") == null)) {
