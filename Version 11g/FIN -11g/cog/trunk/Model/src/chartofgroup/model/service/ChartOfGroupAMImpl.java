...
public class ChartOfGroupAMImpl extends ApplicationModuleImpl implements ChartOfGroupAM {
    ...
    /*  public void delete () {
    ViewObjectImpl cogpvo=this.getFinCog1();
    ViewObjectImpl cogcvo=this.getFinCogNewVO();
    Row rw[]=cogpvo.getFilteredRows("CogId", cogcvo.getCurrentRow().getAttribute("CogId"));
        if(rw.length>0) {
            System.out.println("row length find is=="+rw.length);
        }
    } */
