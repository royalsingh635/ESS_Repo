package tickerConfig.model.module;
...
import tickerConfig.model.view.FinTkrTmpVOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Tue Oct 29 15:12:13 IST 2013
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TickerConfigAMImpl extends ApplicationModuleImpl implements TickerConfigAM {
     ...
     */
    public TickerConfigAMImpl() {
    }
    
    

    /**
     * Container's getter for FinTkrTmp.
     * @return FinTkrTmp
     */
    public FinTkrTmpVOImpl getFinTkrTmp() {
        return (FinTkrTmpVOImpl)findViewObject("FinTkrTmp");
    }

    /**
     * Container's getter for FinTkrContainsCoaTmp.
     * @return FinTkrContainsCoaTmp
     */
    public ViewObjectImpl getFinTkrContainsCoaTmp() {
        return (ViewObjectImpl)findViewObject("FinTkrContainsCoaTmp");
    }

    /**
     * Container's getter for FinTkrNaTypTmp.
     * @return FinTkrNaTypTmp
     */
    public ViewObjectImpl getFinTkrNaTypTmp() {
        return (ViewObjectImpl)findViewObject("FinTkrNaTypTmp");
    }

    /**
     * Container's getter for FinTkrVouTypTmp.
     * @return FinTkrVouTypTmp
     */
    public ViewObjectImpl getFinTkrVouTypTmp() {
        return (ViewObjectImpl)findViewObject("FinTkrVouTypTmp");
    }

    /**
     * Container's getter for FinTkrCoaTmp.
     * @return FinTkrCoaTmp
     */
    public ViewObjectImpl getFinTkrCoaTmp() {
        return (ViewObjectImpl)findViewObject("FinTkrCoaTmp");
    }

    /**
     * Container's getter for FkFinTkrContainsCoa2TmpVL1.
     * @return FkFinTkrContainsCoa2TmpVL1
     */
    public ViewLinkImpl getFkFinTkrContainsCoa2TmpVL1() {
        return (ViewLinkImpl)findViewLink("FkFinTkrContainsCoa2TmpVL1");
    }
    ...
    /* public String TkrNameValid(String name){
        int count=0;
        if(name!=null)
        {
            ViewObjectImpl v = this.getFinTkrTmp();
            int totcount = v.getRowCount();
            v.setRangeSize(totcount);
            
            Row[] allRowsInRange = v.getAllRowsInRange();
            for(Row r:allRowsInRange)
            {
                if(r!=v.getCurrentRow())
                {
                    if(r.getAttribute("FinTkrNm")!=null){
                    String alertnm = r.getAttribute("FinTkrNm").toString();
                    if(name.equalsIgnoreCase(alertnm))
                    {
                        count=1;
                    }
