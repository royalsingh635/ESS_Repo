...
import voucherswappingapp.model.views.LOVToCoaNameImpl;
...
public class VoucherSwappingAMImpl extends ApplicationModuleImpl implements VoucherSwappingAM {
    ...
    /** Resetting all fields. Entry Point of TF. **/
    public void setAttributes() {
        ...
        // For resetting TOCoaDual.
        LOVToCoaNameImpl toCoaNmVO = this.getLOVToCoaName1();
        toCoaNmVO.executeQuery();
    ...
    public void resetAction() {
        ...
        /* LOVToCoaNameImpl toCoaNameVO = this.getLOVToCoaName1();
        toCoaNameVO.setNamedWhereClauseParam("cldidbind", -1);
        toCoaNameVO.executeQuery();

        LOVToCoaNameImpl toCoaDualVO = this.getLOVToCoaName1();
        toCoaDualVO.executeQuery(); */

    }

    /* public void setCoaName(String CoaNm){

            Row curr = this.getSearchDual1().getCurrentRow();
           // dulaVo.getCurrentRow().setAttribute("CoaIdTrans", null);
            //dulaVo.getCurrentRow().setAttribute("CoaNmTrans", null);

            ViewObjectImpl coaIdvo= this.getLovCoaFrId();
            coaIdvo.setNamedWhereClauseParam("cldidbind", curr.getAttribute("CldIdTrans"));
            coaIdvo.setNamedWhereClauseParam("slocidbind", curr.getAttribute("SlocIdTrans"));
            coaIdvo.setNamedWhereClauseParam("hoorgbind",curr.getAttribute("HoOrgIdTrans"));
            coaIdvo.setNamedWhereClauseParam("orgidbind", curr.getAttribute("OrgIdTrans"));
            coaIdvo.setNamedWhereClauseParam("coanmBind", CoaNm);
            coaIdvo.executeQuery();
            System.out.println("coa name value is "+CoaNm);
            Row [] fr2=coaIdvo.getFilteredRows("CoaNm", CoaNm);
            System.out.println("coa id after filter is "+fr2.length+" "+fr2[0].getAttribute("CoaId") );
            if(fr2.length>0){
                curr.setAttribute("CoaIdTrans", fr2[0].getAttribute("CoaId"));
            }
            this.getSearchDual1().executeQuery();
            System.out.println(curr.getAttribute("CoaIdTrans"));
    ...
    /**
     * Container's getter for LOVToCoaName1.
     * @return LOVToCoaName1
     */
    public LOVToCoaNameImpl getLOVToCoaName1() {
        return (LOVToCoaNameImpl)findViewObject("LOVToCoaName1");
    }

    /**
     * Container's getter for LovCoaFrId.
     * @return LovCoaFrId
     */
    public ViewObjectImpl getLovCoaFrId() {
        return (ViewObjectImpl)findViewObject("LovCoaFrId");
    }
}
