...
// ---------------------------------------------------------------------
public class CoaDetailsLOVImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CoaDetailsLOVImpl() {
    }

    /**
     * Returns the variable value for ChartOfGroupID.
     * @return variable value for ChartOfGroupID
     */
    public String getChartOfGroupID() {
        return (String)ensureVariableManager().getVariableValue("ChartOfGroupID");
    }

    /**
     * Sets <code>value</code> for variable ChartOfGroupID.
     * @param value value to bind as ChartOfGroupID
     */
    public void setChartOfGroupID(String value) {
        ensureVariableManager().setVariableValue("ChartOfGroupID", value);
    }

    /**
     * Returns the variable value for AccTypeID.
     * @return variable value for AccTypeID
     */
    public Long getAccTypeID() {
        return (Long)ensureVariableManager().getVariableValue("AccTypeID");
    }

    /**
     * Sets <code>value</code> for variable AccTypeID.
     * @param value value to bind as AccTypeID
     */
    public void setAccTypeID(Long value) {
        ensureVariableManager().setVariableValue("AccTypeID", value);
    }

    /**
     * Returns the variable value for CoaNameBindVar.
     * @return variable value for CoaNameBindVar
     */
    public String getCoaNameBindVar() {
        return (String)ensureVariableManager().getVariableValue("CoaNameBindVar");
    }

    /**
     * Sets <code>value</code> for variable CoaNameBindVar.
     * @param value value to bind as CoaNameBindVar
     */
    public void setCoaNameBindVar(String value) {
        ensureVariableManager().setVariableValue("CoaNameBindVar", value);
    }
