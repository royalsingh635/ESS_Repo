...
public class BalanceSheetServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //InputStream input = new FileInputStream(new File("D:/Report/BalanceSheet.jrxml"));
            InputStream input = new FileInputStream(new File(path + "BalanceSheet.jrxml"));
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.rtf\"");
...

            {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.html\"");
                exporter = new JRHtmlExporter();
                exporter.setParameter(JRExporterParameter.JASPER_PRINT, jasperPrint);
                exporter.setParameter(JRExporterParameter.OUTPUT_STREAM, ouputStream);
            } else if ("xls".equalsIgnoreCase(reporttype)) {
                response.setContentType("application/xls");
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BalanceSheet.xml\"");
