          ...
          //  System.out.println("time after connection"+System.currentTimeMillis() % 1000);
           ...
           // System.out.println("time before parameter setting"+System.currentTimeMillis() % 1000);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedger"+user+".pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedger"+user+".rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedger"+user+".xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedger"+user+".docx\"");
