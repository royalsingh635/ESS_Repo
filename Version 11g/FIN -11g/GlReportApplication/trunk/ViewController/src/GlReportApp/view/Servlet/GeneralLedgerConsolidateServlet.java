...
public class GeneralLedgerConsolidateServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       Context ctx = new InitialContext();
        ...
        //InputStream input = new FileInputStream(new File("D:/Report/GeneralLedgerConsolidate.jrxml"));
        InputStream input = new FileInputStream(new File(path + "GeneralLedgerConsolidate.jrxml"));
        ...
        JasperReport report = JasperCompileManager.compileReport(design); 
            ...
            if( "pdf".equalsIgnoreCase(reporttype) )
                    ...
                    response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedgerConsolidate.pdf\"");
                    ...
                    response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedgerConsolidate.rtf\"");
                    ...
                    response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedgerConsolidate.xls\"");
                    ...
                    response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedgerConsolidate.docx\"");
                    ...
                    response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedgerConsolidate.xlsx\"");
                   ...
                   response.setHeader("Content-Disposition", "attachement; filename=\"GeneralLedgerConsolidate.xml\"");
