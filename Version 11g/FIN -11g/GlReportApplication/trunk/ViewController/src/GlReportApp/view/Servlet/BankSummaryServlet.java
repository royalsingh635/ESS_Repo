...
public class BankSummaryServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (type.equalsIgnoreCase("D")) {
                input = new FileInputStream(new File(path + "Day_Book_Summary_Consolidate.jrxml"));
                // System.out.println("Printing Day_Book_Summary_Consolidate ");
            } else if (type.equalsIgnoreCase("B")) {
                input = new FileInputStream(new File(path + "Bank_cash_book_HeadWise_SubReport.jrxml"));
                // System.out.println("printing Bank_cash_book_HeadWise_SubReport");
            }
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book_Summary.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book_Summary.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book_Summary.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book_Summary.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book_Summary.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book_Summary.xml\"");
