...
public class TrialBalance_GroupWiseServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String amDef = "GlReportApplication.model.module.GlReportAMImpl";
               ...
               GlReportAMImpl am =
                    (GlReportAMImpl)Configuration.createRootApplicationModule(amDef,config);
         ...
         */
            ...
            //InputStream input = new FileInputStream(new File("D:/Report/TrialBalance_GroupWise.jrxml"));
            InputStream input = new FileInputStream(new File(path + "TrialBalance_GroupWise.jrxml"));
            ...
            //System.out.println("Cog_Id is---->>>"+CogId);
            ...
            //System.out.println("postflag value----->>"+Postflag);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TrialBalance_GroupWise.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TrialBalance_GroupWise.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TrialBalance_GroupWise.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TrialBalance_GroupWise.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TrialBalance_GroupWise.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TrialBalance_GroupWise.xml\"");
