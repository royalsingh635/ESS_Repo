    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (type.equalsIgnoreCase("D")) {
                ...
                if(bookType.equals(new Integer(80))||bookType.equals(new Integer(81))){
                    
                    input = new FileInputStream(new File(path + "Day_Book_Consolidate.jrxml"));
                }else{
                    parameters.put("BookType", bookType);
                    input = new FileInputStream(new File(path + "Day_Book_Consolidate_Others.jrxml"));
                }
               
               // System.out.println("Printing Day_Book_Consolidate");
            } else if (type.equalsIgnoreCase("B")) {
                
                if(bookType.equals(new Integer(80))||bookType.equals(new Integer(81))){
                    
                    input = new FileInputStream(new File(path + "Bank_cash_book_report.jrxml"));
                }else{
                    parameters.put("BookType", bookType);
                    input = new FileInputStream(new File(path + "Bank_cash_book_report_Others.jrxml"));
                }
            }
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Day_Book.xml\"");
