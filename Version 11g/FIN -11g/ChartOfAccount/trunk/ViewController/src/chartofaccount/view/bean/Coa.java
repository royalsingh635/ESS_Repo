...
public class Coa {
    ...
    private String defExngFlu =
        "N"; //this is default value of exchange flucation checkbox to use in validation.
    ...
    public void addDialogListner(DialogEvent dialogEvent) {
        ...
        if (coaNm == null) {
            ...
            try {
                flag =
(String)callStoredFunction(VARCHAR, "CHECK_COA_CREATE_ALLOWED(?,?,?,?)", new Object[] { NA_ID, HO_ORG_ID, CLD_ID,
                                                                                        SLOC_ID });
            ...
            if (a.equalsIgnoreCase("true") && pnl.equalsIgnoreCase("true")) {
                ...
                FacesMessage message =
                    new FacesMessage(":", resolvElDCMsg("#{bundle['MSG.228']}").toString()); //Multiple Ref in COA' for the selected NA is unchecked....
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                //  throw new ValidatorException(message);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message);
                    ...
                    if (prtBudgt.getValue().toString().equalsIgnoreCase("false") &&
                        ...
                        if (("I".equalsIgnoreCase(coaGrpTypBind.getValue().toString())) ||
                            ...
                            if (pnlItemPopup.getValue().equals(false) ||
                                ...
                                FacesContext fc = FacesContext.getCurrentInstance();
                                fc.addMessage(null, message);
                            } else if (coaCFBindVar.getValue().equals(true) ||
                                       "Y".equalsIgnoreCase(coaCFBindVar.getValue().toString())) {
                                saveData = "N";
                                ...
                                if (currentRow != null) {
                                    ...
                                    if (coaid != null) {
                                        ...
                                        if (coa != null) {
                                            ...
                                            u =
  callStoredFunction(Types.VARCHAR, "fn_coa_operations(?,?,?,?,?,?,?,?,?,?,?)",
                     new Object[] { CLD_ID, SLOC_ID, HO_ORG_ID, coa, null, null, null, null, usrId, date,
                                    "I" }).toString();
                                        }
                                    }
                                }
                            ...
                            if (u.equals("N"))
                                u =
  callStoredFunction2(Types.VARCHAR, "fn_coa_operations(?,?,?,?,?,?,?,?,?,?,?)", new Object[] { CLD_ID, SLOC_ID,
                                                                                                HO_ORG_ID, null, null,
                                                                                                null, null, null,
                                                                                                usrId, date,
                                                                                                "I" }).toString();
    ...
    public String edit() {
       ...
       */
        ...
        String check =
            (String)callStoredFunction(Types.VARCHAR, "FIN.fn_is_coa_nm_editable(?,?,?,?)", new Object[] { getCld(),
                                                                                                           getSloc(),
                                                                                                           getHo(),
                                                                                                           coaId });
    ...
    public void save(ActionEvent actionEvent) {
        ...
        if (prtBudgt.getValue().toString().equalsIgnoreCase("true") &&
            ...
            if (a.equalsIgnoreCase("true") && pnl1.equalsIgnoreCase("true")) {
                ...
                if ((("A".equalsIgnoreCase(coaGrpType.getValue().toString())) ||
                     ("L".equalsIgnoreCase(coaGrpType.getValue().toString()))) &&
                    (balSheet.getValue().equals(false))) {
                    saveData = "N";
                    _adfLog.info("ERROR = 1088 = COA should be a part of Balance Sheet for Assets/Liabilities!!");
                    String msg1 = resolvEl("#{bundle['MSG.1088']}").toString();
                    FacesMessage message = new FacesMessage(msg1);
                ...
                if (("I".equalsIgnoreCase(coaGrpType.getValue().toString())) ||
                    ...
                    if (pnl.getValue().equals(false) || "N".equalsIgnoreCase(pnl.getValue().toString())) {
                        ...
                        FacesContext fc = FacesContext.getCurrentInstance();
                        fc.addMessage(null, message);
                    } else if (coaCf.getValue().equals(true) || "Y".equalsIgnoreCase(coaCf.getValue().toString())) {
                        saveData = "N";
                        _adfLog.info("ERROR = 1090 = Income/Expences COA can not be a part of Cash Flow!!");
                        String msg1 = resolvEl("#{bundle['MSG.1090']}").toString();
                        FacesMessage message = new FacesMessage(msg1);
                        ...
                        if (currentRow != null) {
                            ...
                            if (coaid != null) {
                                ...
                                if (coa != null) {
                                    System.out.println("Current Coa Id --------" + coa);
                                    u =
  callStoredFunction(Types.VARCHAR, "fn_coa_operations(?,?,?,?,?,?,?,?,?,?,?)", new Object[] { CLD_ID, SLOC_ID,
                                                                                               HO_ORG_ID, coa, null,
                                                                                               null, null, null, usrId,
                                                                                               date, "I" }).toString();
                                }
                            }
                        }
  ...
  callStoredFunction2(Types.VARCHAR, "fn_coa_operations(?,?,?,?,?,?,?,?,?,?,?)", new Object[] { CLD_ID, SLOC_ID,
                    ...
                    if ((u.equals("Y") && "Y".equalsIgnoreCase(saveData))) {
                        ...
                        if (operationBinding.getErrors().isEmpty()) {
                            ...
                            String msg =
                                resolvElDCMsg("#{bundle['MSG.226']}").toString() + " " + coaNm + " " + resolvElDCMsg("#{bundle['MSG.227']}").toString();
    ...
    public void deleteAction(ActionEvent actionEvent) {
        ...
        String coaId = am.getFinCoa1().getCurrentRow().getAttribute("CoaId").toString();
        Integer check =
            (Integer)callStoredFunction(Types.INTEGER, "FIN.DELETE_COA(?,?,?,?)", new Object[] { getCld(), getSloc(),
                                                                                                 getHo(), coaId });
        if (check.intValue() == 0) {
            ...
            String msg =
                resolvElDCMsg("#{bundle['MSG.226']}").toString() + coaNm + resolvElDCMsg("#{bundle['MSG.229']}").toString();
            FacesMessage message = new FacesMessage(msg);
                        ...
                        if (coa != null) {
                            ...
                            if ((u.equals("Y"))) {
                                ...
                                if (operationBinding1.getErrors().isEmpty() &&
                                    ...
                                    String msg =
                                        resolvElDCMsg("#{bundle['MSG.226']}").toString() + coaNm + resolvElDCMsg("#{bundle['MSG.230']}").toString(); //deleted successfully
                                    FacesMessage message = new FacesMessage(msg);
                                    message.setSeverity(FacesMessage.SEVERITY_INFO);
                                    FacesContext fc = FacesContext.getCurrentInstance();
                                    fc.addMessage(null, message);
        ...
        if (val == true) {
            ...
            try {
                ...
                if (this.defExngFlu.equalsIgnoreCase("N")) {
                    ...
                    validate =
                            (String)callStoredFunction3(Types.VARCHAR, "fin.fn_is_exchangFlu_acc_exist(?,?,?,?)", new Object[] { getCld(),
                                                                                                                                 getSloc(),
                                                                                                                                 getHo() });
                }
            } catch (Exception e) {
            ...
            if (validate.equalsIgnoreCase("Y")) {
                ...
                msg4 =
"another account named " + this.coaNameRound_exchng + " " + resolvEl("#{bundle['MSG.232']}").toString();
    ...
    public void reservedRevenueFormVAL(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (object.equals(true)) {
            ...
            // System.out.println("COG NM :"+cognm);
            if (cognm != null) {
                Row[] xx = am.getLovCog1().getFilteredRows("CogNm", cognm);
                if (xx.length > 0) {
                    COGID = xx[0].getAttribute("CogId").toString();
        ...
        if (val == true) {
            ...
            try {
                ...
                if (this.defRoudOfValue.equalsIgnoreCase("N")) {
                    validate =
                            (String)callStoredFunction3(Types.VARCHAR, "fin.fn_is_roundoff_acc_exist(?,?,?,?)", new Object[] { getCld(),
                                                                                                                               getSloc(),
                                                                                                                               getHo() });
                }
            } catch (Exception e) {
            ...
            if (validate.equalsIgnoreCase("Y")) {
                msg4 =
"Other Coa named  " + this.getCoaNameRound_exchng() + " " + resolvEl("#{bundle['MSG.244']}").toString();
    ...
    public void activeCoaValueChangeListner(ValueChangeEvent valueChangeEvent) {
        ...
        if (valueChangeEvent.getNewValue().toString().equalsIgnoreCase("false")) {
            ...
            if (valueChangeEvent.getNewValue().toString().equalsIgnoreCase("true")){
                FacesContext.getCurrentInstance().addMessage(valueChangeEvent.getComponent().getClientId(), new FacesMessage(FacesMessage.SEVERITY_INFO,"Important Information",resolvElDCMsg("#{bundle['MSG.1331']}").toString()));
            }
        }
                    ...
                    if (currentRow != null) {
                        ...
                        if (coaIdInDB != null) {
                            ...
                            if (number != null) {
                                ...
                                if (coaId != null) {
                                    String result1 =
                                        (String)callStoredFunction2(VARCHAR, "fn_coa_allow_act(?,?,?,?,?)",
                                                                    new Object[] { cldId, slocId, HO_ORG_ID, coaId });
                    ...
                    if (currentRow != null) {
                        ...
                        if (coaIdInDB != null) {
                            ...
                            if (number != null) {
                                ...
                                if (coaId != null) {
                                   String result =
                                        (String)callStoredFunction(Types.VARCHAR, "fn_chk_coa_validity(?,?,?,?)",
                                                                       new Object[] { cldId, slocId, HO_ORG_ID, 
                                                                                      coaId });

                                    if (result.equalsIgnoreCase("N")) {
                                        FacesMessage message =
                                            new FacesMessage(FacesMessage.SEVERITY_ERROR,"Please Check the box","Coa Can't be made Inactive for all Organization.");
