...
public class CoaAdd {
    ...
    private RichSelectBooleanCheckbox partOfBudget; //this is default value of exchange flucation checkbox to use in validation.
    ...
    public void saveAdd(ActionEvent actionEvent) {
        ...
        if(this.coaName.getValue()==null){
            System.out.println("Object is null");
              String msg2 = "Please Fill the  Coa Name ";
...
//            System.out.println("budgetCalcLogic.getValue() = "+budgetCalcLogic.getValue());
        ...
        if(coaCogId.getValue()==null){
            ...
            saveData ="N";
            String msg1 = resolvEl("#{bundle['MSG.236']}").toString();
            FacesMessage message = new FacesMessage("Natural Account should not be empty");
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message); 
            ...
            saveData ="N";
            String msg1 = resolvEl("#{bundle['MSG.237']}").toString();
            FacesMessage message = new FacesMessage(msg1);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
            ...
            saveData ="N";
            String msg1 = resolvEl("#{bundle['MSG.238']}").toString();
            FacesMessage message = new FacesMessage(msg1);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
            ...
            saveData ="N";
            String msg1 = resolvEl("#{bundle['MSG.239']}").toString();
            FacesMessage message = new FacesMessage(msg1);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
            ...
            saveData ="N";
            String msg1 = " Part of budgeting  should be selected,if budget cal logic is selected";
            FacesMessage message = new FacesMessage(msg1);
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
            ...
            saveData ="N";
            FacesMessage message = new FacesMessage(":",resolvEl("#{bundle['MSG.228']}").toString());
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            //  throw new ValidatorException(message);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message);
           ...
           /*  else if ( (coaBehav.getValue().equals("A")||coaBehav.getValue().equals("E")) && balanceType.getValue().equals("Cr") ){      
            ...
            if(("I".equalsIgnoreCase(coaBehav.getValue().toString())) || ("E".equalsIgnoreCase(coaBehav.getValue().toString()))){
                ...
                if(pnlBind.getValue().equals(false) || "N".equalsIgnoreCase(pnlBind.getValue().toString())){
                    ...
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message); 
                }else if(cashFlowBind.getValue().equals(true) || "Y".equalsIgnoreCase(cashFlowBind.getValue().toString())){
                    saveData ="N";
    ...
    public void coaNameValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        System.out.println("Org Id is " +object) ;
            ...
            /**5.check for empty brackets
                 */
            if (coaNm.contains("()")) {
                String msg2 = resolvEl("#{bundle['MSG.49']}").toString();
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message2);
            }
            /**check for to dot not comes together
                 */
            if (coaNm.contains("..")) {
                String msg2 = resolvEl("#{bundle['MSG.109']}").toString();
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                throw new ValidatorException(message2);
            }
          ...
          try{
            System.out.println("--------------------------------value is "+this.defExngFlu);
             ...
             if (validate.equalsIgnoreCase("Y")) {
                 ...
                 msg4 = "another account named "+ this.coaNameRound_exchng +" "  + resolvEl("#{bundle['MSG.232']}").toString();
            ...
            try{   
                ...
                if(this.defRoudOfValue.equalsIgnoreCase("N")){
                  ...
                  String msg4 = "";
                   ...
                   if (validate.equalsIgnoreCase("Y")) {
                       msg4 = "Other Coa named  "+ this.getCoaNameRound_exchng()+" " + resolvEl("#{bundle['MSG.244']}").toString();
            ...
            // filtering data using method setWhereClause
                    if(true){
                        ...
                        if(rowI.length > 1){
                            ...
                            FacesMessage message2 = new FacesMessage("COA with this NATURAL ACCOUNT and ACCOUNT GROUP combination already exist.", "Only one COA can be created for one NATURAL ACCOUNT and ACCOUNT GROUP combination.");
                            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                            throw new ValidatorException(message2);
                        }
                    }
