...
// ---------------------------------------------------------------------
public class ChartOfAccountAMImpl extends ApplicationModuleImpl implements ChartOfAccountAM {
    /**
   ...
   /*  public OrgCoaVOImpl getOrgCoa1() {
     ...
     * @return LovAltGrp1
     */
    public ViewObjectImpl getLovAltGrp1() {
        return (ViewObjectImpl)findViewObject("LovAltGrp1");
    }
    ...
    public Integer on_load_page() {
        ...
        callStoredFunction(VARCHAR, "APP.fn_get_usr_doc_access_param(?,?,?,?,?,?,?,?,?)",
                           new Object[] { cld_id, sloc_id, org_id, 51, usr_id });
    ...
    public String validateOrgMadeInactiveSingleCoa(String org ){
        ...
        // org == N is used as a flag for one coa
                ...
                System.out.println("Current coa id for insertion is  -----" + coaId + "For ORganisation  ------" + org);
                        ...
                        if(coaId!=null){
                            try{
                               result= (String) callStoredFunctionReturnOne(this.VARCHAR,
                                                                             "fn_can_org_coa_made_inactive(?,?,?,?) ",
                                                                             new Object[]{this.getCldId()
                                                                                          ,this.getSlocId()
                                                                                          ,org,
                                                                                          coaId} );
                           // result="Y";
