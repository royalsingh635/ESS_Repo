...
public class CreditorAgeingConsSumServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          Context ctx = new InitialContext();
            ...
            //InputStream input = new FileInputStream(new File("D:/Report/SupplierAgeing_Summary.jrxml"));

            InputStream input = new FileInputStream(new File(path + "SupplierAgeing_Consolidate_Summary.jrxml"));
            ...
            String DateSel = String.valueOf(request.getParameter("DateSel"));
           ...
           /*  System.out.println(Cldid + "---------cld_id" + AmtSel + "---------AmtSel" + DateSel + "---------Datesel" +
                               " " + AsOnDate + "---------Asondate" + LineSel + "---------linesel"); */
            ...
            parameters.put("DateSelect", DateSel);
            ...
            System.out.println("Amt Sel:"+AmtSel+" Date Select :"+DateSel+" Line Selection:"+LineSel);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate_Summary.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate_Summary.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate_Summary.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate_Summary.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate_Summary.xml\"");
