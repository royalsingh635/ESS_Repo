...
public class CreditorAgeingConsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          Context ctx = new InitialContext();
            ...
            //      .getRealPath("/reports/SupplierAgeing.jrxml")));

            //InputStream input = new FileInputStream(new File("D:/Report/SupplierAgeing.jrxml"));

            InputStream input = new FileInputStream(new File(path1 + "SupplierAgeing_Consolidate.jrxml"));
           ...
           // System.out.println("1");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"SupplierAgeing_Consolidate.xml\"");
