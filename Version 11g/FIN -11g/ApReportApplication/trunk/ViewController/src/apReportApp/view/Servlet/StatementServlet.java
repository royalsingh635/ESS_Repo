...
public class StatementServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // InputStream input = new FileInputStream(new File("D:/Report/CreditorsStatement.jrxml"));
            InputStream input = new FileInputStream(new File(path + "CreditorsStatement.jrxml"));
            ...
            // System.out.println("Cloud Id id Startement-------------" + Cld_id + "   ----  " + PostFlag);

            //System.out.println(Org + "" + ToDate + "" + FromDate);
            ...
            //System.out.println(Cld_id + "" + ToDate + " " + FromDate + " " + Org + "" + PostFlag);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Creditors_Statement.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Creditors_Statement.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Creditors_Statement.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Creditors_Statement.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Creditors_Statement.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Creditors_Statement.xml\"");
