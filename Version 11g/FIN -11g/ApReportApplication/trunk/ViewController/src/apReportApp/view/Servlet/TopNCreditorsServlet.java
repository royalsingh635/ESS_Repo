...
public class TopNCreditorsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          Context ctx = new InitialContext();
           ...
           // InputStream input = new FileInputStream(new File("D:/Report/TopNCreditors.jrxml"));
           InputStream input = new FileInputStream(new File(path + "TopNCreditors.jrxml"));
            JasperDesign design = JRXmlLoader.load(input);
            JasperReport report = JasperCompileManager.compileReport(design);


            String Org = String.valueOf(request.getParameter("organisation"));
            Integer ValueOfN = Integer.parseInt(String.valueOf(request.getParameter("valueofn")));
            ...
            String Cld_id = (String)request.getParameter("cldid");
            String Cld_id1 = request.getParameter("cldid").toString();
         ...
         /*    System.out.println(Cld_id + "value in varaible");
            System.out.println("Valuebeore rep" + Org + "---------" + ValueOfN + "---------" + AmtX1 + "---------" + AmtX2 + "---------" + CurrID + "" +
                               ToDate + "---------" + FromDate + "---------" + Cld_id + "---------" + CurrencyGrouping + "---------" + AmtSel + "---------" +
                               CoaId + "---------" + Cld_id + "---------"); */

            //  System.out.println(String.valueOf(request.getParameter("cldid"))+"value from page flow");
...
/* 
           ...
           /*  System.out.println("Value after rep" + Org + "---------" + ValueOfN + "---------" + AmtX1 + "---------" + AmtX2 + "---------" + CurrID + "" +
                               ToDate + "---------" + FromDate + "---------" + Cld_id + "---------" + CurrencyGrouping + "---------" + AmtSel + "---------" +
                               CoaId + "---------" + Cld_id + "---------");
           ...
           // System.out.println("1");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TopNCreditors.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TopNCreditors.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TopNCreditors.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TopNCreditors.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TopNCreditors.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"TopNCreditors.xml\"");
