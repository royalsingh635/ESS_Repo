...
public class SupplierAgeingServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          Context ctx = new InitialContext();
            ...
            InputStream input = new FileInputStream(new File(path1 + "SupplierAgeing.jrxml"));
           ...
           // System.out.println("1");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeing.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeing.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeing.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeing.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeing.xml\"");
