...
public class BillKnockOffServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        st = am.getDBTransaction().createPreparedStatement("select 1 from dual", 0);
         conn = st.getConnection(); */
            ...
            //InputStream input = new FileInputStream(new File("D:/Report/BillKnockOff.jrxml"));

            InputStream input = new FileInputStream(new File(path + "BillKnockOff.jrxml"));
            ...
            // System.out.println(Cldid +"-------------bill knock off------cloud id");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BillKnockOff.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BillKnockOff.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BillKnockOff.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BillKnockOff.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BillKnockOff.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"BillKnockOff.xml\"");
