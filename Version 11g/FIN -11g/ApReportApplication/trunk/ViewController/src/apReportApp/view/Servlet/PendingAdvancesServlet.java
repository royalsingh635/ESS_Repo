...
public class PendingAdvancesServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
           ...
           // InputStream input = new FileInputStream(new File("D:/Report/PendingAdvances.jrxml"));

           InputStream input = new FileInputStream(new File(path1 + "PendingAdvances.jrxml"));
           ...
           // System.out.println(CldId + "------------prnding advances-------cld_id");
           ...
           // System.out.println("Report Created...");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PendingAdvances.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PendingAdvances.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PendingAdvances.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PendingAdvances.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PendingAdvances.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"PendingAdvances.xml\"");
