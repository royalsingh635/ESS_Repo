...
public class CustomerAgeingSummayServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          Context ctx = new InitialContext();
            ...
            InputStream input = new FileInputStream(new File(path + "SupplierAgeing_Summary.jrxml"));
           ...
           /*  System.out.println(Cldid + "---------cld_id" + AmtSel + "---------AmtSel" + DateSel + "---------Datesel" +
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeingSummary.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeingSummary.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeingSummary.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeingSummary.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"CreditorsAgeingSummary.xml\"");
