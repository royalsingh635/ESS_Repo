...
public class Consolidate_StatementServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
           ...
           // InputStream input = new FileInputStream(new File("D:/Report/Consolidate_Statement.jrxml"));
           InputStream input = new FileInputStream(new File(path1 + "Consolidate_Statement.jrxml"));
           ...
           // System.out.println("Connection Established");
            ...
            //   parameters.put("DeptNo", deptNo.getValue());
           ...
           // System.out.println("Report Created...");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Consolidate_Statement.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Consolidate_Statement.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Consolidate_Statement.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Consolidate_Statement.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Consolidate_Statement.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"Consolidate_Statement.xml\"");
