...
public class AssetLiabPrd {
    ...
    private String ho_orgid = resolvEl("#{pageFlowScope.GLBL_HO_ORG_ID}");
    ...
    public Number getTot() {
        ...
        ViewObjectImpl v = am.getAssetLiabilityPrd1();
    ...
    public String resetAssetLiabMstAction() {
        ...
        ViewObjectImpl vo1 = am.getAssetLiabilityMstVO();
        ...
        vo.executeQuery();
        vo1.setNamedWhereClauseParam("BindCldId", null);
        vo1.setNamedWhereClauseParam("BindSlocId", null);
        vo1.setNamedWhereClauseParam("BindOrgId", null);
        vo1.setNamedWhereClauseParam("BindHoOrgId", null);
        vo1.setNamedWhereClauseParam("BindCoaId", null);
        vo1.setNamedWhereClauseParam("BindStrDt", null);
        vo1.setNamedWhereClauseParam("BindEndDt", null);
        vo1.executeQuery();
    ...
    public void searchAction(ActionEvent actionEvent) {
        ...
        /* System.out.println("value of coa id == " + coaIdBind.getValue());
        System.out.println("value of start date in mst page is ==" + startDtBind.getValue());
        System.out.println("value of end date bind in mst page is ==" + endDtBind.getValue()); */
        Integer coaId = null;
        Date startdt = null;
        Date enddt = null;
        ViewObjectImpl searchvo = am1.getSearchVO1();
        ViewObjectImpl vo = am1.getAssetLiabilityMstVO();
        /*  if (searchvo.getCurrentRow().getAttribute("TransCoaId") != null) {
            coaId = Integer.parseInt(searchvo.getCurrentRow().getAttribute("TransCoaId").toString());
        }
        if (searchvo.getCurrentRow().getAttribute("StartDtTrans") != null) {
           startdt = (Date)searchvo.getCurrentRow().getAttribute("StartDtTrans");
       }
       if (searchvo.getCurrentRow().getAttribute("EndDttrans") != null) {
           enddt = (Date)searchvo.getCurrentRow().getAttribute("EndDttrans");
       } */
        ...
        vo.setNamedWhereClauseParam("BindHoOrgId", ho_orgid);
        vo.setNamedWhereClauseParam("BindOrgId", resolvEl("#{pageFlowScope.GLBL_APP_USR_ORG}"));
        vo.setNamedWhereClauseParam("BindCoaId", coaId);
        vo.setNamedWhereClauseParam("BindStrDt", startdt);
        vo.setNamedWhereClauseParam("BindEndDt", enddt);
        vo.executeQuery();
        AdfFacesContext.getCurrentInstance().addPartialTarget(assetMStTableBind);
    ...
    public void assetLibSearchAction(ActionEvent actionEvent) {
        ...
        System.out.println("value of start date is ==" + transStartBind.getValue());
        System.out.println("end date is == " + transEndBind.getValue()); */
        String vouid = null;
        Date strtdt = null;
        Date enddt = null;
        ViewObjectImpl assetLiabilityPrd1 = am.getAssetLiabilityPrd1();
        ...
        /*  if ((Date)searchvo.getCurrentRow().getAttribute("TransStrtDt")!= null) {
            strtdt = (Date)searchvo.getCurrentRow().getAttribute("TransStrtDt");
        }
        if ((Date)searchvo.getCurrentRow().getAttribute("TransEndDt") != null) {
            enddt = (Date)searchvo.getCurrentRow().getAttribute("TransEndDt");
        } */
        /*  assetLiabilityPrd1.setNamedWhereClauseParam("BindSlocId", sloc_id);
        assetLiabilityPrd1.setNamedWhereClauseParam("BindCldId", cld_id);
        assetLiabilityPrd1.setNamedWhereClauseParam("BindOrgId", resolvEl("#{pageFlowScope.GLBL_APP_USR_ORG}"));
        assetLiabilityPrd1.setNamedWhereClauseParam("BindHoOrgId", ho_orgid); */
    ...
    public Number getBaseAmt() {
        AssetLiabilityPrdAMImpl am = (AssetLiabilityPrdAMImpl)resolvElDC("AssetLiabilityPrdAMDataControl");
        ViewObjectImpl vo = am.getAssetLiabilityMstVO();
        ...
        //System.out.println("summ in first page  is"+sum);
        return sum;
