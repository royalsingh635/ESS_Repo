...
public class TaxTypeBean {
    ...
    public String editTax() {
        ...
        if (v != null) {
            ...
            if (r != null) {
                ...
                if (TaxId != null) {
                    Object result =
                        callStoredFunction2(Types.VARCHAR, "app.fn_is_tax_editable(?,?,?,?)", new Object[] { CldId,
                                                                                                             SlocId,
                                                                                                             HoOrgId,
                                                                                                             TaxId });
                    ...
                    if (result != null) {
                        ...
                        /*  if(result.toString().equalsIgnoreCase("N")){
                            FacesMessage message = new FacesMessage("You can't edit the Tax. Child Record Exists!");
        ...
        if (dialogEvent.getOutcome().name().equals("ok")) {
            ...
            if (flag.equalsIgnoreCase("E")) {
                     ...
                     currentRow.setAttribute("mode", "E"); */
                        ...
                        String result =
                            (String)callStoredFunction2(Types.VARCHAR, "fin.fn_is_na_nm_unique(?,?,?,?,?)", new Object[] { CldId,
                                                                                                                           SlocId,
                                                                                                                           HoOrgId,
                                                                                                                           naName,
                                                                                                                           naId });
        ...
        if (object != null) {
            if (taxNameBindVar.getValue() != null) {
                ...
                if (a.compareTo(hundred) > 0) {
                    throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, errorlessthan100,
                                                                  null));
    ...
    public Integer getCoaCount(Long P_TAX_ID, String P_HO_ORG_ID, String P_CLD_ID, Integer P_SLOC_ID) {
        Integer retVal = 0;
        BigDecimal val =
            (BigDecimal)callStoredFunction2(INTEGER, "APP.GET_COA_COUNT_FROM_TAX(?,?,?,?)", new Object[] { P_TAX_ID,
                                                                                                           P_HO_ORG_ID,
                                                                                                           P_CLD_ID,
                                                                                                           P_SLOC_ID });
    ...
    public Integer getNaId(String param_cld_id, Integer param_sloc_id, String param_ho_org_id, String param_na_name,
        ...
        BigDecimal val =
            (BigDecimal)callStoredFunction2(INTEGER, "FN_INS_TAX_TO_NA(?,?,?,?,?,?,?,?)", new Object[] { param_cld_id,
                                                                                                         param_sloc_id,
                                                                                                         param_ho_org_id,
                                                                                                         param_na_name,
                                                                                                         param_tax_id,
                ...
                if (appTax1 != null) {
                    ...
                    if (currentRow != null) {
                        ...
                        if (CldId != null && HoOrgId != null && TaxNaId != null && TaxSlocId != null) {
                            Object callStoredFunction2 =
                                callStoredFunction2(Types.VARCHAR, "app.fn_tax_allow_deactivation(?,?,?,?)",
                                                    new Object[] { CldId, TaxSlocId, HoOrgId, TaxNaId });
    ...
    public void TaxActivationValueChangeListner(ValueChangeEvent valueChangeEvent) {
        ...
        if(valueChangeEvent.getNewValue()!= null){
            if(valueChangeEvent.getNewValue().toString().equalsIgnoreCase("true")&& valueChangeEvent.getOldValue().toString().equalsIgnoreCase("false")){
                    FacesContext fctx = FacesContext.getCurrentInstance();
                    FacesMessage message = new FacesMessage("Please Ensure whether its NA is Active or not");
            ...
            if (flag.equalsIgnoreCase("E")) {
                ...
                if (appTaxType != null) {
                    ...
                    if (currentRow != null) {
                        ...
                        callStoredProcedureWithOutParam("app.proc_get_tax_type_usage_stat(?,?,?,?,?,?,?,?)",
                                                        new Object[] { CldId.toString(), (Integer)TaxTypeSlocId,
                                                                       HoOrgId.toString(), (Integer)TaxTypeId });
