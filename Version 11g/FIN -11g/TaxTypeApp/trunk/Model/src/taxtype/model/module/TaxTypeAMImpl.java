...
import taxtype.model.views.AppTaxVOImpl;
// ---------------------------------------------------------------------
// ---    File generated by Oracle ADF Business Components Design Time.
// ---    Mon Dec 05 10:41:47 PST 2011
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TaxTypeAMImpl extends ApplicationModuleImpl  {
    /**
     * This is the default constructor (do not remove).
     */
    public TaxTypeAMImpl() {
    }

    /**
     * Container's getter for AppTaxType1.
     * @return AppTaxType1
     */
    public AppTaxTypeVOImpl getAppTaxType1() {
        return (AppTaxTypeVOImpl)findViewObject("AppTaxType1");
    }
    ...
    /**
     * Container's getter for TaxTypeToTaxVL1.
     * @return TaxTypeToTaxVL1
     */
    public ViewLinkImpl getTaxTypeToTaxVL1() {
        return (ViewLinkImpl)findViewLink("TaxTypeToTaxVL1");
    }


    public void setBindVar(Integer SlocId, String OrgId, String CldId) {
        AppTaxTypeVOImpl appTaxType1 = this.getAppTaxType1();
        if(appTaxType1!= null){
            appTaxType1.setSlocIdBindVar(SlocId);
            appTaxType1.setOrgIdBindVar(OrgId);
            appTaxType1.setCloudIdBindVar(CldId);
            appTaxType1.executeQuery();
        }
