...
public class CustomerAgeing extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            InputStream input = new FileInputStream(new File(path + "DetorsAgeing.jrxml"));
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing.xml\"");
