...
public class AR_StatementServlet extends HttpServlet {
...
/* 
            ...
            //InputStream input = new FileInputStream(new File("D:/Report/AR_Statement.jrxml"));

            InputStream input = new FileInputStream(new File(path + "AR_Statement.jrxml"));
            ...
            String vouchertype = String.valueOf(request.getParameter("vouchertype"));
            String glbl_cld_id = String.valueOf(request.getParameter("glbl_cld_id"));
...
System.out.println("Org = "+Org+" Amt = "+Amt+" AmtX1="+AmtX1+" AmtX2="+AmtX2+" CurrID="+CurrID+" ToDate="+ToDate+" FromDate = "+FromDate+" CoaId = "+CoaId+" glbl_cld_id ="+glbl_cld_id+" vouchertype = "+vouchertype+"path = "+path);
            ...
            parameters.put("cld_id", glbl_cld_id);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DebtorStatement.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DebtorStatement.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DebtorStatement.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DebtorStatement.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DebtorStatement.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DebtorStatement.xml\"");
