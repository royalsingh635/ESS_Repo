...
public class DebtorAgeingConsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            //InputStream input = new FileInputStream(new File("D:/Report/DetorsAgeing.jrxml"));
            InputStream input = new FileInputStream(new File(path + "DetorsAgeing_Consolidate.jrxml"));
            ...
            //System.out.println(AmtSel + "" + DateSelect + "" + AsOnDate + "" + cld_id + "");
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Consolidate.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Consolidate.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Consolidate.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Consolidate.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Consolidate.xml\"");
