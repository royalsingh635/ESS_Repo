...
public class AR_PendingAdvancesServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       // PreparedStatement st = null;
        ...
        try {
           ...
           // InputStream input = new FileInputStream(new File("D:/Report/AR_PendingAdvances.jrxml"));
           InputStream input = new FileInputStream(new File(path + "AR_PendingAdvances.jrxml"));
            ...
            //System.out.println("cld_id-----------" + glbl_cld_id);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_PendingAdvances.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_PendingAdvances.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_PendingAdvances.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_PendingAdvances.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_PendingAdvances.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_PendingAdvances.xml\"");
