...
public class AR_BillKnockOffServlet extends HttpServlet {
 ...
 ps =
          ...
          rs = ps.executeQuery();
           ...
           // InputStream input = new FileInputStream(new File("D:/Report/AR_BillKnockOff.jrxml"));
           InputStream input = new FileInputStream(new File(path + "AR_BillKnockOff.jrxml"));
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"InvoiceKnock-off.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"InvoiceKnock-off.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"InvoiceKnock-off.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"InvoiceKnock-off.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"InvoiceKnock-off.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"InvoiceKnock-off.xml\"");
