...
public class DebtorAgeingSummaryServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
          ...
          rs = ps.executeQuery();
           ...
           InputStream input = new FileInputStream(new File(path + "DetorsAgeing_Summary.jrxml"));
...
System.out.println("Org="+Org+"Amt = "+Amt+" AmtX1 = "+AmtX1+" AmtX2 ="+AmtX2+" CurrID = "+CurrID+"ToDate = "+ToDate+"FromDate = "+FromDate+"CoaId = "+CoaId+" cld_id = "+cld_id+" AsOnDate = "+AsOnDate+"DateSelect = "+DateSelect+"AmtSel="+AmtSel+"LineSel="+LineSel+"path = "+path);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Summary.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Summary.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Summary.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Summary.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"DetorsAgeing_Summary.xml\"");
