...
public class AR_Consolidate_StatementServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
           ...
           // InputStream input = new FileInputStream(new File("D:/Report/AR_Consolidate_Statement.jrxml"));
           InputStream input = new FileInputStream(new File(path + "AR_Consolidate_Statement.jrxml"));
            ...
            String vou = String.valueOf(request.getParameter("voucher"));
           // System.out.println("from servelet === " + vou);
            ...
            if ("pdf".equalsIgnoreCase(reporttype)) {
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_Consolidate_Statement.pdf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_Consolidate_Statement.rtf\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_Consolidate_Statement.xls\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_Consolidate_Statement.docx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_Consolidate_Statement.xlsx\"");
                ...
                response.setHeader("Content-Disposition", "attachement; filename=\"AR_Consolidate_Statement.xml\"");
