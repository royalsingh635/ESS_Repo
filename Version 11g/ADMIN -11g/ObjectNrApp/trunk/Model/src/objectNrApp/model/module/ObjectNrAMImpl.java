...
// ---------------------------------------------------------------------
public class ObjectNrAMImpl extends ApplicationModuleImpl implements ObjectNrAM {
    /**
    ...
    public ObjectNrAMImpl() {
    }

    /**
     * Container's getter for AppEntityView.
     * @return AppEntityView
     */
    
    
    
    public ViewObjectImpl getAppEntityView() {
        return (ViewObjectImpl)findViewObject("AppEntityView");
    }

    /**
     * Container's getter for AppObj.
     * @return AppObj
     */
    public ViewObjectImpl getAppObj() {
        return (ViewObjectImpl)findViewObject("AppObj");
    }

    /**
     * Container's getter for AppEntityViewToAppObjVL1.
     * @return AppEntityViewToAppObjVL1
     */
    public ViewLinkImpl getAppEntityViewToAppObjVL1() {
        return (ViewLinkImpl)findViewLink("AppEntityViewToAppObjVL1");
    }
