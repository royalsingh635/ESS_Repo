...
public class AppSecUsrRoleLnkEOImpl extends EntityImpl {
    ...
    public void setUsrRoleId(Integer value) {
        System.out.println("Role Id "+value);
        try{
    ...
    public void setUsrOrgId(String value) {
        System.out.println("Curent Org "+value);
        try{ 
    ...
    protected void create(AttributeList attributeList) {
            super.create(attributeList);
             this.setUsrIdCreate(Integer.parseInt(this.resolvEl("#{pageFlowScope.GLBL_APP_USR}")));
             this.setUsrIdMod(Integer.parseInt(this.resolvEl("#{pageFlowScope.GLBL_APP_USR}")));
