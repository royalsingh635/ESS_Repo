...
public class ItemProfileAMImpl extends ApplicationModuleImpl implements ItemProfileAM {
    ...
    public String getGroupPath(Integer SlocId,String CldId,String hoOrgId,String groupId) {
        String path =
            (String)callStoredFunction(Types.VARCHAR, "PKG_APP_ITM.GET_ITM_GRP_PATH(?,?,?,?)", new Object[] {SlocId,CldId,hoOrgId,groupId });
        return path;
    }
    ...
    public String isItemDeletable(Integer SlocId,String CldId,String hoOrgId,String OrgId,String itemId) {
        ...
        try{
         isDeletable =(String)callStoredFunction(Types.VARCHAR, "PKG_APP_ITM.IS_ITM_DELETABLE(?,?,?,?,?)", new Object[] {SlocId,CldId,hoOrgId,OrgId,itemId });
    ...
    public String getWfNo(Integer SlocId,String CldId,String OrgId,Integer DocNo) 
       {
           try {
               Object obj=callStoredFunction(Types.VARCHAR, "APP.PKG_APP_WF.GET_WF_ID(?,?,?,?)",
       ...
       adfLog.info(" doc id "+DocId);
        return Integer.parseInt(callStoredFunction(NUMBER, "APP.PKG_APP_WF.INS_TXN(?,?,?,?,?,?,?,?,?,?,?,?,?)",
                                           new Object[] { SlocId, CldId, OrgId, DocNo, WfNo, DocId,
