    ...
    // private String _password = "Password";
     ...
     public String doLogin() {
         ...
         try {
             ...
             //set the server location to use in next page.
             session.setAttribute("sloc_Id", getUsrSlocId());
 ...
 //    }
     ...
     public Integer getUsrSlocId() {
         try {
             Integer _usrSlocId =
                 Integer.parseInt(callStoredFunction(NUMERIC, "APP.FN_GET_DEF_SERVR_LOC_ID()", new Object[] { }).toString());
             //System.out.println("parameter values-->" + " usr_sloc id :" + usr_sloc);
     ...
     public EbizMainAppAMImpl getAm() {
         ...
         return (EbizMainAppAMImpl)Configuration.createRootApplicationModule("ebizframemainapplication.model.EbizMainAppAMImpl",
                                                                             "EbizMainAppAMLocal");
