package appGlblCurr.model.module;

import appGlblCurr.model.module.common.AppModuleAM;
import appGlblCurr.model.views.AppGlblCurrVOImpl;
...
public class AppModuleAMImpl extends ApplicationModuleImpl implements AppModuleAM {
    ...
    public Integer on_load_page()
            ...
            callStoredFunction(VARCHAR,"fn_get_usr_doc_access_param(?,?,?,?,?,?,?,?,?)",
                                       new Object[] { cld_id, sloc_id, org_id, 8,usr_id});
    ...
    /**
     * Container's getter for AppGlblCurr.
     * @return AppGlblCurr
     */
    public ViewObjectImpl getAppGlblCurr() {
        return (ViewObjectImpl)findViewObject("AppGlblCurr");
    }
