...
public class AppItemAttBean {
    ...
    public void saveAttTypeAction(ActionEvent actionEvent) {
        ...
        if(obj != null)
        {
            ...
            if(b)
            {
                FacesMessage message = new FacesMessage("Attribute Type Already Exist.");
            ...
            if("Y".equalsIgnoreCase(retV)){
                FacesMessage message = new FacesMessage("Attribute Prefix Is Requered.");
                message.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
    ...
    public void delete()
    {
        ...
        if(count > 0)
        {
            FacesMessage message = new FacesMessage("Can't delete it,Attribute Value used in Item Profile.");
