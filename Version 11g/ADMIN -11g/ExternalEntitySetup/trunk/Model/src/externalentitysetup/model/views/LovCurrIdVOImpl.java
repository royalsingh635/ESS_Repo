...
public class LovCurrIdVOImpl extends ViewObjectImpl {
    ...
    /**
     * Returns the variable value for curBind.
     * @return variable value for curBind
     */
    public String getcurBind() {
        return (String)ensureVariableManager().getVariableValue("curBind");
    }

    /**
     * Sets <code>value</code> for variable curBind.
     * @param value value to bind as curBind
     */
    public void setcurBind(String value) {
        ensureVariableManager().setVariableValue("curBind", value);
    }
}
