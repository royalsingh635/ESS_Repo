...
public class GraphTrendConfigBean {
    ...
    private Long Graphid=GraphIdget();
    private Integer SlocId=slocIdGet();
        ...
        if (operationBinding.getErrors().isEmpty()) {
            ...
            if (mode.equals("A")) {
                ...
                if (a.equals("Y")) {
                    ...
                    System.out.println("@@@@ if=Y "+mode.toString());
                    ...
                    String msg = resolvElDCMsg("#{bundle['MSG.561']}").toString();
...
System.out.println("mode=V");
                ...
                System.out.println("mode=V in if");
                    ...
                    System.out.println("in else where mode=U="+a);
                    if(a.equals("Y")){
                    System.out.println("a.equalsTo Y");
                        OperationBinding operationBindingcomm = bindings.getOperationBinding("Commit");
                        operationBindingcomm.execute();
                        if (operationBindingcomm.getErrors().isEmpty()) {
                            System.out.println("in if when a.equals=Y");
                            RetVal = "Cancel";
                        }
                    }
                    else{
    ...
    public void trendNameValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
      ...
      if(trendname.startsWith(" ") || trendname.endsWith(" ")){
          String msg2=resolvElDCMsg("#{bundle['MSG.204']}").toString();
          ...
          throw new ValidatorException(message2);
                ...
                //check for valid DESCRIPTION.. Char+Numbers allowed.Can have brackets and hyphen or dot .No two hyphens/dots/hyphen+dots can be adjacent.
                        ...
                        String error=resolvElDCMsg("#{bundle['MSG.562']}").toString();
