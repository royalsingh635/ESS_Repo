...
public class TransferOrderAMImpl extends ApplicationModuleImpl implements TransferOrderAM {
    ...
    public void setDestOrgandWh()
    {
           ...
           if(getMmTrfOrd1().getCurrentRow()!=null){
            ...
            String wh = (String)getMmTrfOrd1().getCurrentRow().getAttribute("WhId");
            //getMmTrfOrd1().getCurrentRow().setAttribute("OrgIdDest", orgId);
            if(getMmTrfOrd1().getCurrentRow().getAttribute("WhIdSrc")!=null && getMmTrfOrd1().getCurrentRow().getAttribute("WhIdSrc").toString().equals(wh))
            {
    ...
    public void setSrcOrgandWh()
    {
           ...
           // getMmTrfOrd1().getCurrentRow().setAttribute("OrgIdSrc", orgId); 
            if(getMmTrfOrd1().getCurrentRow().getAttribute("WhIdDest")!=null && getMmTrfOrd1().getCurrentRow().getAttribute("WhIdDest").toString().equals(wh))
            {
                    getMmTrfOrd1().getCurrentRow().setAttribute("WhIdSrc",wh); 
                }
            else 
   ...
   public void chkSrcWhandSet()
   {
    ...
    public void setFyId(){
        ...
        String fyId=(String)(callStoredFunction(Types.VARCHAR, "app.GET_ORG_FY_ID(?,?,?)",new Object[] {glbl_cld_id,glbl_org_id,getMmTrfOrd1().getCurrentRow().getAttribute("TrfDt")}));
    ...
    public void setTrfNo(){
        ...
        if(getMmTrfOrd1().getCurrentRow().getAttribute("FyId")!=null && (!(getMmTrfOrd1().getCurrentRow().getAttribute("TrfNo")!=null))){
        String trfNo=(String)callStoredFunction(Types.VARCHAR, "FN_MM_GEN_ID(?,?,?,?,?,?)",new Object[] {glbl_sloc_id,glbl_cld_id,glbl_org_id,tableName,null,Integer.parseInt(getMmTrfOrd1().getCurrentRow().getAttribute("FyId").toString())});
    ...
    public void setOrdQtyBs(Object ordQty){
     ...
     public void delChildRec(String docId){
        ...
        rq1.setWhereClause("CldId = '"+glbl_cld_id+"' AND SlocId = "+glbl_sloc_id+" AND OrgId = '"+glbl_org_id+"' AND DocId = '"+docId+"'");
    ...
    public void getSrcDocDtl(String MRSno, String docId){
        ...
        rq.setWhereClause("MrsTxnId ='"+MRSno+"' AND CldId = '"+glbl_cld_id+"' AND SlocId = '"+glbl_sloc_id+"' AND OrgId = '"+glbl_org_id+"' ");
        ...
        for(Row rw :rows ){
            ...
            rq3.setWhereClause("CldId = '"+glbl_cld_id+"' AND SlocId = "+glbl_sloc_id+" AND HoOrgId = '"+ho_org_id+"' AND ItmId = '"+rw1.getAttribute("ItmId")+"'");
            ...
            rq4.setWhereClause("CldId = '"+glbl_cld_id+"' AND SlocId = "+glbl_sloc_id+" AND OrgId = '"+glbl_org_id+"' AND DocId = '"+docId+"'");
          ...
          BigDecimal uomConvFctr =
                (BigDecimal)callStoredFunction(Types.NUMERIC,"APP.FN_GET_UOM_CONV_FCTR(?,?,?,?,?,?)",new Object[] {glbl_sloc_id,glbl_cld_id,glbl_org_id,ItmId,ItmUom,ItmUomBs});
    ...
    public String getWfNo(Integer SlocId,String CldId,String OrgId,Integer DocNo)
    {
        try {
            ...
            Object obj=callStoredFunction(Types.VARCHAR,"APP.WF_GET_ID(?,?,?,?,?)",new Object[] {SlocId, CldId,OrgId, DocNo,type });
                return obj.toString();
        }catch (Exception e) {
                return "0";
         }
    ...
    public Integer getUsrLvl(Integer SlocId,String CldId,String OrgId,Integer UsrId,String WfNo,String DocNo){
      //  String DocId = getMmTrfOrd1().getCurrentRow().getAttribute("DocId").toString();
        ...
        Object obj= callStoredFunction(NUMBER,"APP.WF_GET_USR_LEVEL (?,?,?,?,?,?,?)", new Object[] {SlocId,CldId,OrgId,UsrId,WfNo,DocNo,type });
        if(obj!=null){
    ...
    public Integer insIntoTxn(Integer SlocId,String CldId,String OrgId,Integer DocNo,String WfNo,Integer usr_idFrm,Integer usr_idTo,Integer levelTo,Integer levelFrm,String action,String remark,Number amount ){
        ...
        if(curr.getAttribute("TrfType")!=null){
         ...
         return Integer.parseInt(callStoredFunction(NUMBER,"APP.WF_INS_TXN(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",new Object[] { SlocId, CldId,OrgId, DocNo,type, WfNo, DocId,usr_idFrm,usr_idTo, levelFrm, levelTo, action, remark,amount}).toString());
    }
    ...
    String DocId = getMmTrfOrd1().getCurrentRow().getAttribute("DocId").toString();
        ...
        return Integer.parseInt(callStoredFunction(NUMBER,"APP.WF_GET_CUR_USR(?,?,?,?,?,?)", new Object[] {SlocId,CldId,OrgId,DocNo,DocId,type}).toString());
}
        ...
        if(status.equals("A")){
           ...
           if(trfType==373)
             type=  330;//int
              ...
              type= 366;//ext
            Object obj= callStoredFunction(NUMBER, "MM_UPDT_STK_RESV(?,?,?,?,?,?,?)", new Object[] { cldId,slocId,orgId,whid,fyid,type,txnId});
    ...
    public void setItmUomBs(){
        ...
        RowQualifier rq3 = new RowQualifier(tunevo);
        rq3.setWhereClause("CldId = '"+glbl_cld_id+"' AND SlocId = "+glbl_sloc_id+" AND HoOrgId = '"+ho_org_id+"' AND ItmId = '"+id+"'");
        Row r1[] = tunevo.getFilteredRows(rq3);
        String UomBasic = (String)r1[0].getAttribute("UomBasic");
        ...
        BigDecimal uomConvFctr =
            (BigDecimal)callStoredFunction(Types.NUMERIC,"APP.FN_GET_UOM_CONV_FCTR(?,?,?,?,?,?)",new Object[] {glbl_sloc_id,glbl_cld_id,orgId,id,itmUom,ItmUomBs});
        oracle.jbo.domain.Number num=null;
    ...
    public void setItmUom(String itmUom){
        ...
        BigDecimal uomConvFctr =
            (BigDecimal)callStoredFunction(Types.NUMERIC,"APP.FN_GET_UOM_CONV_FCTR(?,?,?,?,?,?)",new Object[] {glbl_sloc_id,glbl_cld_id,orgId,itmId,itmUom,ItmUomBs});
        oracle.jbo.domain.Number num=null;
   ...
   public void resetItemAndQty()
   {
    ...
    public void setItemCancel(String st,Integer oldst)
    {
        ...
        {   
           // System.out.println("St= Y");
            ...
            rq.setWhereClause("OrgId ='"+orgId+"' AND CldId ='"+cldId+"' AND SlocId ="+slocId+" AND DocId ='"+docId+"' AND PendQty > 0 ");
    ...
    public Integer checkResQty(String Res)
    {
        ...
        Number AuthQty=new Number(0);
            ...
            try {
                avlstk = new Number(getMmTrfOrdItm2().getCurrentRow().getAttribute("TransAvlStk").toString());
            } catch (SQLException e) {
                System.out.println("String to Number cast Exception");  
            }
    ...
    public void updtStkAftrCncl()
    {
            ...
            if(trfType==373)
             type=  330;//int
              ...
              type= 366;//ext
            Object obj1= callStoredFunction(NUMBER, "MM_UPDT_STK_RESV_CNCL(?,?,?,?,?,?)", new Object[] { cldId,slocId,orgId,txnId,fyid,type});
    ...
    {
            String wh = (String)getMmTrfOrd1().getCurrentRow().getAttribute("WhId");
            if(getMmTrfOrd1().getCurrentRow().getAttribute("OrgIdDest")!=null && (getMmTrfOrd1().getCurrentRow().getAttribute("OrgIdDest").toString().equals(getMmTrfOrd1().getCurrentRow().getAttribute("OrgId").toString())))
            {  
                getMmTrfOrd1().getCurrentRow().setAttribute("OrgIdDest", null);
                getMmTrfOrd1().getCurrentRow().setAttribute("WhIdDest",null);
                getMmTrfOrd1().getCurrentRow().setAttribute("WhIdSrc",wh); 
    ...
    public void setDestWhandSrcOrgwh()
    {
            ...
            String wh = (String)getMmTrfOrd1().getCurrentRow().getAttribute("WhId");
           if(getMmTrfOrd1().getCurrentRow().getAttribute("OrgIdSrc")!=null && getMmTrfOrd1().getCurrentRow().getAttribute("OrgIdSrc").toString().equals(org)) 
           {
                   getMmTrfOrd1().getCurrentRow().setAttribute("OrgIdSrc", null);
                   getMmTrfOrd1().getCurrentRow().setAttribute("WhIdSrc",null); 
                   getMmTrfOrd1().getCurrentRow().setAttribute("WhIdDest",wh); 
