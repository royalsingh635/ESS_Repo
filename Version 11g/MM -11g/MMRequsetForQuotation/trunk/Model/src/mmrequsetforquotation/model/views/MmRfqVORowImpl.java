...
public class MmRfqVORowImpl extends ViewRowImpl {
    ...
    public String getTransSrcDocNo() {
        ...
        RowQualifier rq = new RowQualifier(am.getLovPRDocNo());
        rq.setWhereClause("CldId ='"+getCldId()+"' and SlocId = "+getSlocId()+" and OrgId= '"+getOrgId()+"' and PrTxnId = '"+getDocIdSrc()+"' ");
        Row [] prRow = am.getLovPRDocNo().getFilteredRows(rq);
        if(prRow.length>0){
