...
public class MmMtlGeItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransTxnQty {
            ...
            public void put(MmMtlGeItmVORowImpl obj, Object value) {
                obj.setTransTxnQty((Number)value);
            }
        }
        ,
        LovItmIdVO {
    ...
    public Number getDlvQty() {
        if(getAttributeInternal(DLVQTY)!=null)
        {
            ...
            if(this.getUomConvFctr()!=null)
                qtySp=(Number)getAttributeInternal(DLVQTY);
            Number qtyBs=qtySp.multiply(this.getUomConvFctr());
            setDlvQtyBs(qtyBs);
            }
    ...
    public Number getPendQty() {
        if(getAttributeInternal(PENDQTY)!=null)
        {
                Number qtySp=new Number(0);
            if(this.getUomConvFctr()!=null)
                qtySp=(Number)getAttributeInternal(PENDQTY);
            Number qtyBs=qtySp.multiply(this.getUomConvFctr());
            setPendQtyBs(qtyBs);
            }
    ...
    public Number getRcptQty() {
        if(getAttributeInternal(RCPTQTY)!=null)
        {
                Number qtySp=new Number(0);
            if(this.getUomConvFctr()!=null)
                qtySp=(Number)getAttributeInternal(RCPTQTY);
            Number qtyBs=qtySp.multiply(this.getUomConvFctr());
            setRcptQtyBs(qtyBs);
            }
    ...
    public Number getReturnQty() {
        if(getAttributeInternal(RETURNQTY)!=null)
        {
                Number qtySp=new Number(0);
            if(this.getUomConvFctr()!=null)
                qtySp=(Number)getAttributeInternal(RETURNQTY);
            Number qtyBs=qtySp.multiply(this.getUomConvFctr());
    ...
    public Number getTotRcptQty() {
        if(getAttributeInternal(TOTRCPTQTY)!=null)
        {
                Number qtySp=new Number(0);
            if(this.getUomConvFctr()!=null)
                qtySp=(Number)getAttributeInternal(TOTRCPTQTY);
            Number qtyBs=qtySp.multiply(this.getUomConvFctr());
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransTxnQty.
     * @param value value to set the  TransTxnQty
     */
    public void setTransTxnQty(Number value) {
        setAttributeInternal(TRANSTXNQTY, value);
    }
