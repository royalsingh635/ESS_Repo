   ...
   private String docTxnId=null;
    ...
    public StockAdjustmentBean() 
    {
        ...
        else if(mode.equals("E"))
        {
            ...
            {itemVisible=false;childReadonly=true;}
    ...
    public void StockTypeListener(ValueChangeEvent valueChangeEvent) {
      ...
      Integer stkType = (Integer)valueChangeEvent.getNewValue();
       if(stkType == 350)
         ...
         {itemVisible=true;itemDisable=true;}
...
public String createNewItem() {
    ...
    public void SrNoListener(ValueChangeEvent valueChangeEvent) {
      ...
      Boolean flag = (Boolean)valueChangeEvent.getNewValue();
        if(flag)
        {
            ...
            if(validate)
             {showPopup(popUpBind1, true); bindSrCheckBox.setValue(false);}
            else
    ...
    public void LotValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if(bcNumber.compareTo(BigDecimal.ZERO) !=0)          
        {
          ...
          if(n.compareTo(oracle.jbo.domain.Number.zero()) <0)
              {throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,(String)evaluateEL("#{bundle['MSG.553']}"),null));}
        if(n!=null)
        {boolean valid = isPrecisionValid(26, 6, n);
          if(!valid)
              {throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,(String)evaluateEL("#{bundle['MSG.57']}"),null));}
        ...
        Boolean b = (Boolean)op.getResult();
         if(b)
         {throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,evaluateEL("#{bundle['MSG.609']}").toString(),null));}
        }
        }
    }}
    ...
    public void QtyValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
       ...
       if(object == null || object.toString().length()<=0)
        {throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,(String)evaluateEL("#{bundle['MSG.572']}"),null));
        }
       else
       {   BigDecimal bcNumber = (BigDecimal)object;
           Number n=null;
           ...
           {throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,"You Can not Subtract more than "+b+" Quantity.",null));}
