...
public class MMStockAdjustmentAMImpl extends ApplicationModuleImpl {
  ...
  public boolean copyAllItemByGroup()
  {
      ...
      rq.setWhereClause("GrpId = '"+grpId+"' AND OrgId = '"+orgId+"' AND CldId = '"+cldId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND FyId = "+fyId+"");
     ...
     {   for(Row row:rows)
         {
             ...
             rq.setWhereClause("DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND CldId = '"+cldId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+row.getAttribute("ItmId").toString()+"'");
...
/*    public void updateBinByLot()
  ...
  */  
    ...
    public boolean isItemSerialized(String ItemId)
    {
        ...
        ViewObjectImpl voItm = getITM1();
        RowQualifier rq = new RowQualifier(voItm);
        rq.setWhereClause("ItmId = '"+ItemId+"' AND CldId = '"+cldId+"' AND FyId = "+fyId+" AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"'");
        Row rows[] = voItm.getFilteredRows(rq);
    ...
    public void executeViewObject(String voName)
    {
        ...
        else if(voName.equals("SRFacet"))
        {
               ...
               else{voSrchSr.setNamedWhereClauseParam("bindTotStk", 1);}                 
      ...
      if(oldValue == null && !newValue.equals("0"))
       {
          ...
          row.setAttribute("ItmUom",getAdjustItmRow(trnsVo.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("ItmUom"));
       ...
       else
       {
           ...
           trnsVo= getSrchLot1();
           Row rows[]=voItmLot.getFilteredRows("LotId",  trnsVo.getCurrentRow().getAttribute("LotId")); // Make RowQualifier to set more Parameters. 
        ...
        if(!checkItemExists(trnsVo.getCurrentRow().getAttribute("ItmId").toString()))
         ...
         currRow.setAttribute("requiredQty",getAdjustItmRow(trnsVo.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("AdjtQty"));
        ...
        else
        {
            ...
            if(rows != null && rows.length == 1)
            {
                    ...
                    rq.setWhereClause("ItmId = '"+trnsVo.getCurrentRow().getAttribute("ItmId").toString()+"' AND CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"'");
      ...
      if(oldValue == null && !newValue.equals("0"))
       {
          ...
          row.setAttribute("AdjtType",newRow.getAttribute("AdjtType"));
          row.setAttribute("ItmUom",getAdjustItmRow(trnsBinVo.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("ItmUom"));
       ...
       else
       {
           ...
           rq.setWhereClause("ItmId = '"+trnsBinVo.getCurrentRow().getAttribute("ItmId").toString()+"' AND LotId = '"+trnsBinVo.getCurrentRow().getAttribute("LotId")+"' AND BinId = '"+trnsBinVo.getCurrentRow().getAttribute("BinId")+"'");
        ...
        if(!checkItemExists(trnsBinVo.getCurrentRow().getAttribute("ItmId").toString()))
         ...
         currRow.setAttribute("requiredQty",getAdjustItmRow(trnsBinVo.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("AdjtQty"));
        ...
        else
        {
            ...
            if(rows != null && rows.length == 1)
            {
                    ...
                    rq.setWhereClause("ItmId = '"+trnsBinVo.getCurrentRow().getAttribute("ItmId").toString()+"' AND CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"'");
  ...
  //---------------------------------------------------------------------------BIN END-------------------------------------------------------------------------  
    ...
    public void addRowInAdjtSr()
    {
        ...
        row.setAttribute("ItmUom", getAdjustItmRow(voSrchtrns.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("ItmUom"));
        ...
        if(!checkItemExists(voSrchtrns.getCurrentRow().getAttribute("ItmId").toString()))
         ...
         currRow.setAttribute("requiredQty",getAdjustItmRow(voSrchtrns.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("AdjtQty"));
        ...
        else
        {
            ...
            if(rows !=null && rows.length == 1)
            {
                    ...
                    rq.setWhereClause("ItmId = '"+voSrchtrns.getCurrentRow().getAttribute("ItmId").toString()+"' AND CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"'");
    ...
    public void refreshUserSrVOAction()
    {
        try{
        ViewObjectImpl userSrSumVo = getShowSrSum1();
        userSrSumVo.getCurrentRow().setAttribute("requiredQty", getAdjustItmRow(userSrSumVo.getCurrentRow().getAttribute("ItmId").toString()).getAttribute("AdjtQty"));
   ...
   public Row getAdjustItmRow(String itemId)
   {
    ...
    public BigDecimal isStkItmSummQty(BigDecimal obj,String type)
    {
     ...
     //  System.out.println("type : "+type);
        ...
        rq.setWhereClause("CldId = '"+cldId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND FyId = "+fyId+" AND ItmId ='"+object+"'");
  ...
  */
               ...
               if(trns != null && trns.length == 1)
                {
                 ...
                 if((itmQty.compareTo(trsQty) != 0) || !(trns[0].getAttribute("AdjType").toString().equals(itm.getAttribute("AdjtType").toString())))
    ...
    { //this.getDBTransaction().postChanges();
        try{
            ...
            Row rows[]=userSrSumVo.getAllRowsInRange();
             ...
             {     for(Row row:rows)
                    {   if(row!=null)
                        row.setAttribute("requiredQty", getAdjustItmRow(row.getAttribute("ItmId").toString()).getAttribute("AdjtQty"));
                        row.setAttribute("AdjType", getAdjustItmRow(row.getAttribute("ItmId").toString()).getAttribute("AdjtType"));
                    }
             }
    ...
    public boolean duplicateValue(String itmName)
    {
        ...
        ViewObjectImpl v = getSTKADJTITM2();
            ...
            //  Row[] rArray = v.getAllRowsInRange();
              ...
              rq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"'");
    ...
    {  
        ...
        RowQualifier rq = new RowQualifier(voStkItm);
        rq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+"");
        ...
        rq1.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+txnId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+"");
   ...
   public void cleanUpStkItmVo()
   {
    ...
    {   
        ...
        if(getCurrentRowStkNo() == null)
        {
            ...
            String stkAdjNo=(String)(callStoredFunction(Types.VARCHAR, "MM.FN_MM_GEN_ID(?,?,?,?,?,?)",new Object[] {slocId,cldId,orgId,tableName,null,fyId})); 
        ...
        Integer inserted=(Integer)(callStoredFunction(Types.INTEGER, " MM.mm_ins_stk_adjt(?,?,?,?,?)",new Object[] {cldId,slocId,orgId,whId,docId}));  
    }
        ...
        if(row != null)
         {
            type=(Integer)row.getAttribute("StkAdjtType");
             if(type == 350){stockType = "ST";}
             else if(type == 351){stockType= "AD";}
         }
        ...
        if(row != null)
         {
            type=(Integer)row.getAttribute("StkAdjtStat");
             if(type == 353){stockStatus = "SU";}
             else if(type == 352){stockStatus= "PD";}
         }
    ...
    public void removeRowInLotBinSr()                       //delete Row from Lot,Bin,Sr as user done Delete action on Item.
    {
        ...
        lotrq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+itemId+"'");
        ...
        binrq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+itemId+"'");
        ...
        srrq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+itemId+"'");
    ...
    public void removeZeroRowInLotBinSr()                       //delete Row  from Lot,Bin,Sr where Adjt Qty is ZERO.
    {
        ...
        ViewObjectImpl voItmLot =getSTKADJTLOT1(); 
        RowQualifier lotrq = new RowQualifier(voItmLot);
        lotrq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+itemId+"' AND AdjtQty = 0");
        Row lotRows[]=voItmLot.getFilteredRows(lotrq);
         if(lotRows != null && lotRows.length>0)
        { for(Row row:lotRows)
            {row.remove();}
        ...
        ViewObjectImpl voItmBin =getSTKADJTBIN1();
        RowQualifier binrq = new RowQualifier(voItmBin);
        binrq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+itemId+"' AND AdjtQty = 0");
        Row binRows[]=voItmBin.getFilteredRows(binrq);
         if(binRows != null && binRows.length>0)
        { for(Row row:binRows)
            {row.remove();}
        ...
        ViewObjectImpl voStkAdjSr= getSTKADJTSR1();
        RowQualifier srrq = new RowQualifier(voStkAdjSr);
        srrq.setWhereClause("CldId = '"+cldId+"' AND DocId = '"+docId+"' AND OrgId = '"+orgId+"' AND SlocId = "+slocId+" AND WhId = '"+whId+"' AND ItmId = '"+itemId+"' AND AdjtQty = 0");
        Row srRows[]=voStkAdjSr.getFilteredRows(srrq);
         if(srRows != null && srRows.length>0)
        { for(Row row:srRows)
            {row.remove();}
    ...
    public Integer getUsrLvl(Integer SlocId,String CldId,String OrgId,Integer UsrId,String WfNo,String DocNo)
     ...
     Object obj= callStoredFunction(NUMBER,"APP.WF_GET_USR_LEVEL (?,?,?,?,?,?,?)", new Object[] {SlocId,CldId,OrgId,UsrId,WfNo,DocNo,0 }); 
        ...
        String DocId=getSTKADJT1().getCurrentRow().getAttribute("DocId").toString();
            return Integer.parseInt(callStoredFunction(NUMBER,"APP.WF_INS_TXN(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",new Object[] { SlocId, CldId,OrgId, DocNo,0, WfNo, DocId,usr_idFrm,usr_idTo, levelFrm, levelTo, action, remark,amount}).toString());
        ...
        String authStat=(String)evaluateEL("#{pageFlowScope.RETURN_PARA}");
         ...
         if(authStat.equals("A"))
          {
             ...
             Integer updated=(Integer)(callStoredFunction(Types.INTEGER, " MM.mm_updt_stk_adjt(?,?,?,?,?,?)",new Object[] {cldId,slocId,orgId,whId,docId,fyId})); 
         ...
         //    System.out.println("RETURN : "+ret);
           ...
           //  System.out.println("Key : "+key);
             ...
             String VoucherId=callStoredFunction(Types.VARCHAR, " MM_GET_RCPT_PROV_GL(?,?,?,?,?,?)",new Object[] {cldId,slocId,orgId,docId,"S","NO"}).toString();
             System.out.println(VoucherId);
        
              FacesMessage message = new FacesMessage("Stock Updated with Voucher Id:"+VoucherId);   
