...
import mmappgrpdef.model.views.AppItmCoaLinkVOImpl;
...
ADFLogger adf_log=(ADFLogger)ADFLogger.createADFLogger(AppGrpdefAMImpl.class);
    ...
    public boolean isGroupNameValid(String grpNm)
    {
        ...
        System.out.println("All param="+CldId+" "+SlocId+" "+HoOrgId+" "+parentId+" "+grpNm.trim()+" "+grpId);
        String chk =(String)(callDBFunction(Types.VARCHAR, "APP.CHK_GRP_NM(?,?,?,?,?,?)", new Object[] {CldId,SlocId,HoOrgId,parentId,grpNm.trim(),grpId}));        
      ...
      ViewObjectImpl vo = this.getFormGrp1();
       Row row = vo.getCurrentRow();
        ...
        if(row.getAttribute("GrpIdParent")!=null)
            parentId=(String)row.getAttribute("GrpIdParent");
        String grpId=(String)row.getAttribute("GrpId");
        String chk =(String)(callDBFunction(Types.VARCHAR, "APP.FN_CHK_GRP_SHORT_CODE(?,?,?,?,?,?)", new Object[] {CldId,SlocId,HoOrgId,parentId,shortCode.trim(),grpId}));        
    ...
    System.out.println("Setting values as parent");
        ...
        rq.setWhereClause("CldId='"+CldId+"' and SlocId="+SlocId+" and HoOrgId='"+HoOrgId+"' and GrpId='"+GrpIdParent+"'" );
        ...
        else
        {
                ...
                rqform.setWhereClause("CldId='"+CldId+"' and SlocId="+SlocId+" and HoOrgId='"+HoOrgId+"' and GrpId='"+GrpIdParent+"'" );
        ...
        while(cr.hasNext()){
           Row rr1=cr.next();
            ...
            if(rr1!=curr){
                ...
                adf_log.info("both parent IDsvalue is "+rr1.getAttribute("GrpIdParent")+"     "+curr.getAttribute("GrpIdParent"));
                
                
                if(hoOrgId.equalsIgnoreCase(phoOrg) && cldId.equalsIgnoreCase(pcldId) && slocId.equals(pslocId) ){
                if(((String)rr1.getAttribute("GrpNm")).equalsIgnoreCase(Pname) && ((String)rr1.getAttribute("GrpIdParent")).equalsIgnoreCase("0")){
                adf_log.info("both value matched "+(String)rr1.getAttribute("GrpNm")+" current pname is "+Pname);
                    flag= "N";
                }
                }
            }
    ...
    public String chkSiblings(String Pname){
       ...
       r1.setWhereClause("GrpIdParent ='" +curr.getAttribute("GrpIdParent") +"' and upper(GrpNm)= upper('"+Pname+"')");//)
       ...
       flag="N";
           ...
           r2.setWhereClause("GrpId ='" +curr.getAttribute("GrpIdParent") +"' and upper(GrpNm)= upper('"+Pname+"')");//)
