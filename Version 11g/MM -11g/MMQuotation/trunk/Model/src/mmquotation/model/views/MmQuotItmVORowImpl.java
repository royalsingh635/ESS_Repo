...
public class MmQuotItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransItmsugg {
            ...
            public void put(MmQuotItmVORowImpl obj, Object value) {
                obj.setTransItmsugg((String)value);
            }
        }
        ,
        ItmGrpIdTrans {
    ...
    public void setQuotQty(Number value) {
        ...
        Number totalSp=value.multiply(getItmPrice());
        if(getItmPrice()!=null || getItmAmtBs()!=null){              
            if(getDiscType().equalsIgnoreCase("P") && getTotDiscAmtSp()!=null){
                    try{
                        Number totAftDisc = (Number)totalSp.minus((totalSp.multiply(getTotDiscAmtSp()).divide(new Number(100)))).round(2);
                    ...
                    try{
                        ...
                        setItmAmtSp_Trans((Number)totalSp.minus(getTotDiscAmtSp()).round(2));
                        setItmAmtSpAftTax_Trans((Number)totalSp.minus(getTotDiscAmtSp()).round(2));
                    }catch (SQLException e) {
                        }
                }else{
        ...
        setAttributeInternal(QUOTQTY, value.round(2));
    }
    ...
    public Number getItmPrice() {
        if(getAttributeInternal(ITMPRICE) != null && getAm().getMmQuot1().getCurrentRow().getAttribute("CurrConvFctr")!=null)
        {
           ...
           setItmPriceBs(curr.multiply(price));
            }
        else
    ...
    public Number getItmPriceBs() {
        ...
        if(getItmPrice()!=null && getAm().getMmQuot1().getCurrentRow().getAttribute("CurrConvFctr")!=null)
        {
            Number price=getItmPrice();
            Number curr = (Number)getAm().getMmQuot1().getCurrentRow().getAttribute("CurrConvFctr");
            return price.multiply(curr);
            }
        else
            return (new Number(0));
    ...
    public Number getItmAmtBs_Trans() { 
        ...
        if(getItmAmtSpAftTax_Trans()!=null && currFctr!=null){
            amtBs=getItmAmtSpAftTax_Trans().multiply(currFctr);
            setItmAmtBs(amtBs);
            return amtBs;
        }else{
    ...
    public Number getItmAmtSp_Trans() {
          ...
          if(getQuotQty()!=null && getItmPrice()!=null){
              totalSp=getItmPrice().multiply(getQuotQty());
                  if(getDiscType().equalsIgnoreCase("P") && getTotDiscAmtSp()!=null){
                      try{
                      ...
                      try{
                         ...
                         transSp= (Number)totalSp.minus(getTotDiscAmtSp()).round(2);
    ...
    public Number getValidQuotQty_Trans() {
        ...
        Integer fy=-1;
               ...
               Integer fyid=(Integer)(callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID (?,?,?)", new Object[] {CldID,P_ORGID,dt}));
              fy=fyid;
              if(fy==-1 || fy==0 || fy==null)
                  fy=2;

        if(p_quot_item_id != null){
          valideQty=(BigDecimal)callStoredFunction(Types.NUMERIC, "MM.PKG_MM_STK.GET_VALID_QTY(?,?,?,?,?,?)", new Object[]{P_SLOCID, CldID , P_Ho_Org_Id , P_ORGID,p_quot_item_id,fy});
        }
        Number retval=null;
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransItmsugg.
     * @param value value to set the  TransItmsugg
     */
    public void setTransItmsugg(String value) {
        setAttributeInternal(TRANSITMSUGG, value);
    }
    ...
    public String getItmGrpDetailTrans() {
       ...
       adfLog.info("function return "+attdetail+" grp and itm id is "+getItmGrpIdTrans()+" "+getItmId() +"row length"+rr1.length);
        if(attdetail!=null){
            return attdetail.toString();
        }else{
