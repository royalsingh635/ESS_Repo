...
public class MMProfileSetupAMImpl extends ApplicationModuleImpl implements MMProfileSetupAM {
    ...
    public void glblMMPfrValue() {
        ...
        String glbl_HoOrggId =
            callStoredFunction(Types.VARCHAR, "FN_INS_ORG_MM_PRF(?,?,?)", new Object[] { glbl_CldId, glbl_SlocId,
                                                                                         glbl_OrgId }).toString();
    ...
    public Integer checkHoProfile() {
        ...
        Integer glbl_HoOrggId =
            (Integer)callStoredFunction(Types.INTEGER, "APP.FN_INS_ORG_MM_PRF(?,?,?)", new Object[] { glbl_CldId,
                                                                                                      glbl_SlocId,
                                                                                                      glbl_OrgId });
