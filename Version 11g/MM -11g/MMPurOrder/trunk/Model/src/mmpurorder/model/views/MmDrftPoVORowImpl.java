...
public class MmDrftPoVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        TransCurrBsNotation {
            ...
            public void put(MmDrftPoVORowImpl obj, Object value) {
                obj.setTransCurrBsNotation((String)value);
            }
        }
        ,
        TransPricePlcNm {
    ...
    public void setPoAmtBs(Number value) {
        ...
        setAttributeInternal(POAMTBS, value.round(2));
    }
    ...
    public void setPoAmtSp(Number value) {
        ...
        setAttributeInternal(POAMTSP, value.round(2));
    }
                                      ...
                                      else
                                      {
                                          if(getEoId()!=null){
                                              RowQualifier rq=new RowQualifier(getAm().getAppEoPricePlc());
                                                             rq.setWhereClause("CldId='"+cld_id+"' and SlocId="+sloc_id+" and HoOrgId='"+hoOrg_id+"' and EoId="+getEoId());
    ...
    public String getTransEoPolicyNm() {
        ...
        if(getTransEoPolicyId()!=null)
        {
            ...
            {
                    RowQualifier rq=new RowQualifier(getAm().getAppEoPricePlc());
                                   rq.setWhereClause("CldId='"+cld_id+"' and SlocId="+sloc_id+" and HoOrgId='"+hoOrg_id+"' and PlcId='"+getTransEoPolicyId()+"' and EoId="+getEoId());
                                   Row[] r=    getAm().getAppEoPricePlc().getFilteredRows(rq);
                                   if(r.length>0)
                                   {
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute TransCurrBsNotation.
     * @param value value to set the  TransCurrBsNotation
     */
    public void setTransCurrBsNotation(String value) {
        setAttributeInternal(TRANSCURRBSNOTATION, value);
    }
    ...
    public String getIsPolicyValid() {
        ...
        {
            RowQualifier rq=new RowQualifier(getAm().getAppEoPricePlc());
            rq.setWhereClause("CldId='"+getCldId()+"' and SlocId="+getSlocId()+" and HoOrgId='"+getTransHoOrgId()+"' and EoId="+getEoId()+" and PlcId='"+getTransEoPolicyId()+"'");
            Row r[]=getAm().getAppEoPricePlc().getFilteredRows(rq);
            if(r.length>0)
    ...
    public String getTransEoCfaNm() {
        if(getEoIdCfa()!=null){
           ...
           vo.setNamedWhereClauseParam("SlocIdBind", getSlocId());
           vo.setNamedWhereClauseParam("HoOrgIdBind", getTransHoOrgId());
           vo.setNamedWhereClauseParam("EoTypeBind", 84);
           vo.setNamedWhereClauseParam("EoIdBind", getEoIdCfa());
           vo.executeQuery();
         
           Row []rr = vo.getFilteredRows("EoId", getEoIdCfa());
            System.out.println(vo.getRowCount()+   "getTransEoCfaNm    "+rr.length);
           if(rr.length>0){
               return rr[0].getAttribute("EoNm").toString();
           }else
    ...
    public String getTransShpingCompanyadds() {
        if(getEoIdShpCo()!=null){
           ...
           vo.executeQuery();
           Row []rr = vo.getFilteredRows("EoId", getEoIdShpCo());
            System.out.println(vo.getRowCount()+   "getTransShpingCompanyadds    "+rr.length);
           if(rr.length>0){
               if(rr[0].getAttribute("ShipAddsDflt")!=null)
    ...
    public String getTransCfaAdds() {
        if(getEoIdCfa()!=null){
           ...
           vo.executeQuery();
           Row []rr = vo.getFilteredRows("EoId", getEoIdCfa());
            System.out.println(vo.getRowCount()+   "getTransCfaAdds    "+rr.length);
           if(rr.length>0){
               if(rr[0].getAttribute("ShipAddsDflt")!=null)
                  return rr[0].getAttribute("ShipAddsDflt").toString();
               else
    ...
    public Number getTransPoDiscountAmt() {
        ...
        {
            setDiscAmtBs(disc.multiply(getCurrConvFctr()));
            setDiscAmtSp(disc);
            }
        else
        {
    ...
    public void setTransPoDiscountAmt(Number value) {
        ...
        setAttributeInternal(TRANSPODISCOUNTAMT, value.round(2));
    }
    ...
    public Number getTransTotalPoCostBs() {
        ...
        return (Number)sp.multiply(cur).round(2);
    ...
    public void setTransTotalPoCostBs(Number value) {
        ...
        setAttributeInternal(TRANSTOTALPOCOSTBS,value.round(2));
    }
    ...
    public void setTransPmtAmt(Number value) {
       /*  Number amtSpTax = getTransTotalPoCostSp();
        ...
        setAttributeInternal(TRANSPMTAMT, value.round(2));
    }
    ...
    public void setOpenOrdVal(Number value) {
        if(value==null)
            value=new Number(0);
        setAttributeInternal(OPENORDVAL, value.round(2));
    }
