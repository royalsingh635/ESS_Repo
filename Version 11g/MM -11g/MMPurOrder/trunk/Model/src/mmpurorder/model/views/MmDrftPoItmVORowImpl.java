...
public class MmDrftPoItmVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        lovSwitcherForItmId {
            ...
            public void put(MmDrftPoItmVORowImpl obj, Object value) {
                obj.setlovSwitcherForItmId((String)value);
            }
        }
        ,
        TransItemId {
    ...
    public void setItmAmtBs(Number value) {
        ...
        setAttributeInternal(ITMAMTBS, value.round(2));
    }
    ...
    public void setItmAmtSp(Number value) {
        ...
        setAttributeInternal(ITMAMTSP, value.round(2));
    }
    ...
    public void setOrdQty(Number value) {
        ...
        setAttributeInternal(ORDQTY, value.round(6));
    }
    ...
    public void setTlrncQtyVal(Number value) {
        ...
        setAttributeInternal(TLRNCQTYVAL, value.round(2));
    }
    ...
    public Number getTransCurrConvFctr() {
        ...
        else
        {
            if(getAm().getMmDrftPo().getCurrentRow().getAttribute("CurrConvFctr")!=null)
               return (Number)getAm().getMmDrftPo().getCurrentRow().getAttribute("CurrConvFctr");
            else
            return (new Number(1));
        }
    ...
    public void setTransItmAmtBs(Number value) { 
        ...
        setAttributeInternal(TRANSITMAMTBS, value.round(2));
    }
        ...
        Number zero=new Number(0);
          ...
          //  Number oc=zero;
              ...
              // System.out.println("Oc Amt="+oc);
               amt=amt.add((pr.multiply(ord)).subtract(dis));
        return amt;
    ...
    public void setTransItmAmtSp(Number value) {
        ...
        setAttributeInternal(TRANSITMAMTSP, value.round(2));
    }
    ...
    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute lovSwitcherForItmId.
     * @param value value to set the  lovSwitcherForItmId
     */
    public void setlovSwitcherForItmId(String value) {
        setAttributeInternal(LOVSWITCHERFORITMID, value);
    }
    ...
    public void setTransDiscAmt(Number value) {
        ...
        setAttributeInternal(TRANSDISCAMT, value.round(2));
    }
    ...
    public Number getTransItemTaxAmt() {
        ...
        RowQualifier rowQualifier = new RowQualifier(trVo);  
             rowQualifier.setWhereClause("ItmId= '"+getItmId()+"' and ItmUom='"+getItmUom()+"'");  
    ...
    public void setTransItemTaxAmt(Number value) {
        ...
        setAttributeInternal(TRANSITEMTAXAMT, value.round(2));
    }
    ...
    public Number getTransItmAmtBsTax() {
        ...
        Number currency= getTransCurrConvFctr();
        if(currency==null){
            currency=new Number(0);
        }
        Number bsAmt=amtSpTax.multiply(currency);
    ...
    public void setTransItmAmtBsTax(Number value) {
        ...
        setAttributeInternal(TRANSITMAMTBSTAX, value.round(2));
    }
    ...
    public Number getTransItmAmtSpTax() {
      ...
      Number   hund=new Number(100);
       ...
       b=(pr.multiply(ord)).subtract(dis);
     
        Number c=a.add(b).add(oc);
    ...
    public void setTransItmAmtSpTax(Number value) {
        ...
        setAttributeInternal(TRANSITMAMTSPTAX, value.round(2));
    }
    ...
    public void setTransItemAmtWoutDc(Number value) {
        ...
        setAttributeInternal(TRANSITEMAMTWOUTDC, value.round(2));
    }
    ...
    public Long getTransChkPolicy() {
       ...
       // System.out.println("supp="+eo);
        Object retval=callStoredFunction(NUMBER, "APP.APP_GET_POLICY_PRICE(?,?,?,?,?,?,?)",
                                                                 new Object[] { p_cldId,pslocId,p_hoOrgId, pOrgId, eo, getItmId(),"PO" });
    ...
    public Number getTransItmOcAmt() {
        PurOrderAMImpl am = (PurOrderAMImpl)this.getApplicationModule();
          if(am.getMmDrftPo().getCurrentRow().getAttribute("TransSumOcAmt")!=null)
          {
             ...
             /*  System.out.println("Itmid="+getItmId()+" price= "+itmPrice+" and qty="+qty+" and disc="+disc+" and tax="+tax);
              System.out.println("ItmAmt="+itmAmt);
              System.out.println("Total Oc="+totalOc);
              System.out.println("ItmPerc="+itmPerc); */
   ...
   //      System.out.println("Where Clause is=> ItmId='"+getItmId()+"' and ItmUom='"+getItmUom()+"'");
    ...
    public Number getDiscAmtSp() {
        ...
        discBs=discSp.multiply(currConvFctr);
        setDiscAmtBs(discBs);
        if(getAttributeInternal(DISCAMTSP)!=null)
    ...
    public void setTotDiscAmtSp(Number value) {
        if(value==null)
            value=new Number(0);
        setAttributeInternal(TOTDISCAMTSP, value.round(2));
    }
