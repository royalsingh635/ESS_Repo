...
public class QuotationAnaBean {
    ...
    public String saveButton() {
        ...
        if(paramSetIdNewBind.getValue()==null){
            String msg2 = "The Parameter Set not selected or Created for Quotation Analysis . Please Select Parameter Set First.";
        ...
        for(Row r : row1){
           ...
           Number wtg= (Number)r.getAttribute("ParamWtg");
            ...
            if(count.compareTo(new Number(100))==0){
                ...
                String msg2 = "Total Active parameters weightage not equals 100";
                FacesMessage message2 = new FacesMessage(msg2);
                message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                FacesContext fc = FacesContext.getCurrentInstance();
                fc.addMessage(null, message2);
            ...
            String msg2 = "This Parameter Set Does't have any Active Parameter";
            FacesMessage message2 = new FacesMessage(msg2);
            message2.setSeverity(FacesMessage.SEVERITY_ERROR);
            FacesContext fc = FacesContext.getCurrentInstance();
            fc.addMessage(null, message2);
    ...
    System.out.println("performance evluation button call");
        ...
        return "Back";
            ...
            {
                    FacesMessage message2 = new FacesMessage("Something went wrong with user level in Workflow.Please Contact to ESS!");
                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
    ...
    public void RateValidator(FacesContext facesContext, UIComponent uIComponent, Object object) {
        ...
        if (rate.compareTo(maxRate) == 1 || rate.compareTo(minRate) == -1) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,
                                                         resolvElDCMsg("#{bundle['MSG.321']}").toString(),
                                                          resolvElDCMsg("#{bundle['MSG.322']}").toString() + minRate + " "+resolvElDCMsg("#{bundle['LBL.323']}").toString()+" " + maxRate));
        }
    }
...
System.out.println("sloc_id    "+sloc_id+"cld_id   "+cld_id+"org_id  "+org_id);
 OperationBinding chkUsr = getBindings().getOperationBinding("pendingPOCheck");
        ...
        if(pending.compareTo(new Integer(-1))==0 || pending.compareTo(usr_id)==0) {        
                    ...
                    String msg2 = "This Quotation Analysis is pending at ["+name+"] for approval, You can not edit this.";
                    FacesMessage message2 = new FacesMessage(msg2);
                    message2.setSeverity(FacesMessage.SEVERITY_ERROR);
                    FacesContext fc = FacesContext.getCurrentInstance();
                    fc.addMessage(null, message2);
