   ...
   //   System.out.println("after " + soItem.getRowCount());
    if(suggOrdBasis.getValue()!=null){
        if (Integer.parseInt(suggOrdBasis.getValue().toString()) == 166) {
          ...
          String cldId = (String)resolveElExp("#{pageFlowScope.GLBL_APP_CLD_ID}");
          String orgId = (String)resolveElExp("#{pageFlowScope.GLBL_APP_USR_ORG}");
          Integer slocId = Integer.parseInt(resolveElExp("#{pageFlowScope.GLBL_APP_SERV_LOC}").toString());
          //  System.out.println("Inside reorder level");
          soFromDate.setRequired(false);
          soToDate.setRequired(false);
          itemQ.setWhereClause("CURRENT_STK < REORDER_LVL and CldId='"+ cldId +"' and OrgId= '"+orgId +"' and SlocId ="+slocId);
            itemQ.executeQuery();
         ...
         /*    itemQ.setWhereClause(" ");
          ...
          //  setMode("E");
            ...
            itemQ.setWhereClause("CURRENT_STK < SAFE_QTY and CldId='"+ cldId +"' and OrgId= '"+orgId +"' and SlocId ="+slocId);
            itemQ.executeQuery();
            soFromDate.setRequired(false);
            soToDate.setRequired(false);
            RowSetIterator rowSetIterator = itemQ.createRowSetIterator(null);
