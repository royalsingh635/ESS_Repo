...
import suggestedorder.model.views.MmSoItmPoVOImpl;
...
import suggestedorder.model.views.ViewSoSearchVOImpl;
// ---------------------------------------------------------------------
...
public class SuggestedOrderAMImpl extends ApplicationModuleImpl implements SuggestedOrderAM {
     ...
     * @return MmSoItm
     */
    public ViewObjectImpl getMmSoItm() {
        return (ViewObjectImpl)findViewObject("MmSoItm");
    }
     ...
     */
    public ViewObjectImpl getMmSoItmForQueryVO() {
        return (ViewObjectImpl)findViewObject("MmSoItmForQueryVO");
    }
     ...
     * @return MmSoItmVO1
     */
    public ViewObjectImpl getMmSoItmVO1() {
        return (ViewObjectImpl)findViewObject("MmSoItmVO1");
    }
    ...
    public Integer getFyId(String cld,String org,Timestamp ts){
        Integer fyId = (Integer)callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID(?,?,?)", new Object[] {cld,org,ts});
        return fyId;
    }
    ...
    public String getGroupId(Integer sloc,String cld,String org) {
     ...
     //  System.out.println("group func"+sloc+"--"+org+"--"+cld+"-"+fyId);
        ...
        String soId =(String)callStoredFunction(VARCHAR, "MM.FN_MM_GEN_ID(?,?,?,?,?,?)", new Object[] {sloc,cld,org, "MM$SO$EO$ITM$GRP" ,null,fyId});
      // System.out.println("group" + soId);
        return soId;
    }
    
    
    public void generateRFQ(Integer p_SLOCID, String p_CLDID,String p_ORGID, String p_SOGRPID, String p_DOCID, Integer p_USRID) {
        ...
        Integer fyid=(Integer)(callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID (?,?,?)", new Object[] {p_CLDID,p_ORGID,dt}));
         Integer ret =(Integer)(callStoredFunction(INTEGER, "MM.GEN_RFQ_FRM_SO (?,?,?,?,?,?)", new Object[] {p_SLOCID,p_CLDID,p_ORGID,p_SOGRPID,p_USRID,fyid}));
    ...
    public void generatePO(Integer p_SLOCID, String p_CLDID,String p_ORGID, String p_SOGRPID, Integer p_POTYPE, Integer p_USRID) {
    ...
    System.out.println("PoType"+p_POTYPE);
      //package name : MM.PKG_MM_SO.GEN_DRFT_PO_FRM_SO
        Integer ret =
            ...
            (Integer)(callStoredFunction(INTEGER, "MM.GEN_DRFT_PO_FRM_SO (?,?,?,?,?,?,?)", new Object[] { p_SLOCID,
                                                                                                                    p_CLDID,
                                                                                                                    p_ORGID,
                                                                                                                    p_SOGRPID,
                                                                                                                    p_POTYPE,
       ...
       System.out.println(ret + " ....generatePO" + p_SLOCID + " " + p_ORGID + " " + p_SOGRPID + " " + p_POTYPE + " " + p_USRID + " "+p_CLDID);
    }

    public Integer insSuppItmGrp(Integer p_SLOCID,String p_CLDID, String p_ORGID, String p_SOGRPID, Integer p_EOID, Integer p_USRID) {
        Integer ret =
            Integer.parseInt(callStoredFunction(INTEGER, "MM.PKG_MM_SO.INS_SUPP_ITM_GRP (?,?,?,?,?,?)", new Object[] { p_SLOCID,
                                                                                                                       p_CLDID,
                                                                                                                      p_ORGID,
                                                                                                                      p_SOGRPID,
                                                                                                                      p_EOID,
     ...
     */
    public ViewObjectImpl getViewGrpEoTempVO() {
        return (ViewObjectImpl)findViewObject("ViewGrpEoTempVO");
    }
    ...
    public void getStock(Integer slocid,String cldid, String itmId, String orgid, Date date) {
        ...
        callStoredFunctionHistory("PKG_MM_STK.GET_STK(?,?,?,?,?,?,?,?,?,?)",
                                  new Object[] { slocid,cldid, itmId, orgid, date, null ,fyId});
           }
    ...
    public void setPrItmToSoItm()
    {
        ...
        while (createRowSetIterator.hasNext()) 
        {
            ...
            if (next.getAttribute("selectPr").equals("Y")) {
                    ...
                    rw.setWhereClause("CldId = '"+cldId+"' AND SlocId = "+slocId+" AND OrgId='"+orgId+"' AND PrTxnId = '"+next.getAttribute("PrTxnId")+"'");  
    ...
    public String genSoNumber() {
        ...
        {   Integer fyId = (Integer)callStoredFunction(Types.INTEGER, "APP.GET_ORG_FY_ID(?,?,?)", new Object[] {cldId,orgId,new Timestamp(System.currentTimeMillis())});
            String soId = (String)callStoredFunction(Types.VARCHAR, "MM.FN_MM_GEN_ID(?,?,?,?,?,?)", new Object[] {slocid,cldId,orgId,"MM$SO",null,fyId});
    ...
    {
        java.sql.Date dt = (java.sql.Date)callStoredFunction(Types.DATE, "MM.MM_GET_LAST_OPN_FY_DATE(?,?,?)", new Object[] {cldId,slocId,orgId});
        return new Date(dt);
    }
    ...
    public ViewObjectImpl getSoQueryVO1() {
       ...
       public Integer getPricePolcy(Integer eoId,String itmId)
        ...
        Integer reply = (Integer)callStoredFunction(Types.INTEGER, "APP.APP_GET_POLICY_PRICE(?,?,?,?,?,?,?)", new Object[]{cldId,slocid,hoOrgId,orgId,eoId,itmId,"PO"});
